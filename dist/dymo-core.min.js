...
new Float32Array(2048),t=e.extract(h,1024),n=0;t;){for(k=0;k<t;k++)for(var m=0;m<g.length;m++)g[m][k+n]=h[k*g.length+m%g.length];n+=t;t=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var p=0;p<e.length;p++)a[f*e.length+p%e.length]=e[p][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),k=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(k,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=k[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b,c){function d(){0<p&&p--;0==p&&b&&b(p)}function e(a){h.splice(h.indexOf(a),1)}function f(){for(var a=[],b=0;b<h.length;b++)for(var d=$jscomp.makeIterator(h[b].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();t=a;c&&c()}function g(b,c){p++;var e=new XMLHttpRequest;e.open("GET",b,!0);e.responseType="arraybuffer";e.onload=function(){a.decodeAudioData(e.response,function(a){c?c(a):(k[b]=
a,d())})};e.error=function(){};e.send()}var k={},h=[],t=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var n=a.createConvolver();n.connect(a.destination);var m=a.createDelay();m.delayTime.value=.5;m.connect(a.destination);var r=a.createGain();r.gain.value=.6;m.connect(r);r.connect(m);var p=0;this.setReverbFile=function(a){g(a,function(a){n.buffer=a;d()})};this.loadBuffers=function(a){a=a.getAllSourcePaths();for(var b=0,c=a.length;b<c;b++)k[a[b]]||
g(a[b])};this.getBuffer=function(a){return k[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,l=0,f=h.length;l<f;l++)h[l].hasDymo(a)&&
(d=h[l].getNavigator()),h[l].hasDymo(b)&&(e=h[l].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b+1,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,k,n,m,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSources(a);if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return t};
this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e,f){function g(a,c){var d=b.createGain();d.connect(c);d.gain.value=0;a.connect(d);return d}function k(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=z||x<c.duration)c=r(c,m(z,c),m(x+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=x/d;c=r(c,0,m(d+.02,c));x=d}else if(0!=z||x<c.duration)c=r(c,m(z,c),m(x+.02,c));p(c,c.length);A.buffer=c;l[PLAYBACK_RATE]=A.playbackRate;h(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function h(a,b){t(a,b.getValue());b.addObserver(v)}
function t(a,b,c){c&&(b+=v.getParameterValue(a));0>b&&0<=G.indexOf(a)&&(b=0);l[a]&&(l[a].value||0==l[a].value?l[a].value=b:l[a].setValue(b));0<=H.indexOf(a)&&(0==l[DISTANCE].value&&(l[DISTANCE].value=-.01),D.setPosition(l[PAN].value,l[HEIGHT].value,l[DISTANCE].value))}function n(){y=!1;var a=b.currentTime;l[AMPLITUDE].setValueAtTime(l[AMPLITUDE].value,a);l[AMPLITUDE].linearRampToValueAtTime(0,a+.02);A.stop(a+.04)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function r(a,c,d){d=Math.min(a.length-
c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),l=0;l<a.numberOfChannels;l++)for(var f=e.getChannelData(l),p=a.getChannelData(l),q=0;q<d;q++)f[q]=p[c+q];return e}function p(a,b){for(var c=.02*a.sampleRate,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),l=0;l<c;l++)e[l]*=l/c,e[b-l-1]*=l/c}function q(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));u("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function u(a,
c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var v=this,y,w,l={},B=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],G=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],A=b.createBufferSource(),C=b.createGain();C.connect(b.destination);var E=g(C,d);d=g(C,e);
var D=b.createPanner();D.connect(C);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(D);A.connect(e);var F=a.getSegment(),z=F[0],x=F[1];z||(z=0);!x&&c&&(x=c.duration-z);c?k():q(a.getSourcePath(),z,z+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=r(c,0,m(d+.02,c)),x=d):c=r(c,0,m(x+.02,c));p(c,c.length);A.buffer=c});l[AMPLITUDE]=C.gain;l[TIME_STRETCH_RATIO]={value:0};l[REVERB]=E.gain;l[DELAY]=d.gain;
l[FILTER]=e.frequency;l[PAN]={value:0};l[HEIGHT]={value:0};l[DISTANCE]={value:0};l[LOOP]={value:0};h(AMPLITUDE,a.getParameter(AMPLITUDE));h(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));h(REVERB,a.getParameter(REVERB));h(DELAY,a.getParameter(DELAY));h(FILTER,a.getParameter(FILTER));h(PAN,a.getParameter(PAN));h(HEIGHT,a.getParameter(HEIGHT));h(DISTANCE,a.getParameter(DISTANCE));h(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){t(a.getName(),a.getChange(),!0)};this.getDymo=
function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return A.loop&&y};this.getParameterValue=function(a){if(l[a])return l[a].value||0==l[a].value?l[a].value:l[a].getValue()};this.play=function(b){A.onended=function(){for(var b=0;b<B.length;b++){var c=a.getParameter(B[b]);c&&c.removeObserver(v)}A.disconnect();C.disconnect();E.disconnect();f&&f(v)};b||(b=0);A.start(b);y=!0};this.pause=function(){y?(n(),w=!0):w&&(w=!1,this.play())};this.stop=function(){y&&n()}}
;function SchedulerThread(a,b,c,d,e,f,g,k){function h(){w=v?v:q();n(w);B||(B=w.keys().next().value.getParameter(ONSET).getValue());var a;a=l?l-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(w.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){g()},a);v=q();0<v.size?(l=r(b),a=1E3*(l-c.currentTime-SCHEDULE_AHEAD_TIME),y=setTimeout(function(){h()},a)):(l=r(b),a=1E3*(l-c.currentTime),setTimeout(function(){t()},a+100))}function t(){0==u.size&&
0==v.size&&(window.clearTimeout(y),b.reset(),k&&k())}function n(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,u.get(c)||u.set(c,[]),u.get(c).push(a.get(c))}function m(a){var b=u.get(a.getDymo());b.slice(b.indexOf(a),1);0>=b.length&&u.delete(a.getDymo());g();t()}function r(a){if(v){var b=v.keys().next().value.getParameter(ONSET).getValue(),c=b-B;B=b;if(!isNaN(b))return a+c}for(var b=0,c=$jscomp.makeIterator(w.values()),d=c.next();!d.done;d=c.next())b=Math.max(b,
p(d.value));return a+b}function p(a){var b=a.getDymo().getParameter(PLAYBACK_RATE).getValue();return a.getDuration()/b}function q(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return a.getIndex()}));for(var l=new Map,p=0;p<a.length;p++)if(a[p].getSourcePath()){var q=d[a[p].getSourcePath()];l.set(a[p],new Source(a[p],c,q,e,f,m))}return l}}var u=new Map,v,y,w=[],l,B;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));h();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};
this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=u.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=u.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].stop();v.delete(a[b])}};this.getAllSources=function(){return u};this.getSources=function(a){return u.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();f[b]=a;f[b].addObserver(e)}var e=this,f={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,f);var g;this.addParameter=d;this.getParameter=function(a){return f[a]};this.startUpdate=function(){g=setInterval(b,f[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(g);g=null;c&&c()};this.observedParameterChanged=function(a){a==f[AUTO_CONTROL_FREQUENCY]?
...
function(){return n&&!y?n.getBasePath():y};this.setSourcePath=function(a){w=a};this.getSourcePath=function(){if(n&&!w)return n.getSourcePath();if(w)return this.getBasePath()+w};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){r.push(a)};this.getSimilars=function(a){return r};this.getFeatures=function(){return p};
this.setFeature=function(a,b){p[a]=b};this.getFeature=function(a){if(a===LEVEL)return this.getLevel();if(a===INDEX)return this.getIndex();if(p.hasOwnProperty(a))return p[a];if(n)return n.getFeature(a);for(var b=[],c=0;c<m.length;c++)if(m[c]){var d=m[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(p[a])return p[a]};this.getMappings=function(){return u};this.getSegment=function(){return[this.getFeature("time"),q[DURATION_RATIO].getValue()*
this.getFeature("duration")]};this.addParameter=function(a){q[a.getName()]=a};this.getParameter=function(a){return q[a]};this.addMapping=function(a){u.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(t):c.stop(t))};this.updatePartOrder=function(a){m&&m[0]&&!isNaN(m[0].getFeature(a))?m.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):m&&m.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=
function(){for(var a=this.toFlatJson(),b=0;b<m.length;b++)a.parts.push(m[b].toJsonHierarchy());return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};k(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);w&&(c.source=w);for(var d in p)c[d]=this.getFeatureJson(d);if(0<u.length)for(c.mappings=[],d=0;d<u.length;d++)c.mappings.push(u[d].toJson());0<m.length&&(c.parts=
[]);if(0<r.length)for(c.similars=[],d=0;d<r.length;d++)c.similars.push(r[d].getUri());return c};this.getFeatureJson=function(a){return{value:p[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
...
return d}};function OntologyLoader2(a,b,c){};function DymoLoader(a){function b(a,d,e,f,h){var g=new XMLHttpRequest;g.open("GET",a,!0);g.onload=function(){if(0>this.responseText.indexOf("Cannot GET")){var g;a:{try{JSON.parse(this.responseText)}catch(t){g=!1;break a}g=!0}g&&(d?(0<=a.indexOf(r)&&(a=a.replace(r,"")),d=d.replace('"'+a+'"',this.responseText)):d=this.responseText);(g=c(d))?(0>g.indexOf(r)&&(g=r+g),b(g,d,e,f,h)):d&&(g=h(JSON.parse(d),e),f(g))}};g.error=function(a){console.log(a)};g.send()}function c(a){var b=a.indexOf(".json");if(0<=
...
return h(b,c,d,f,e,l)}return h(b,c,d,[a],e)}function h(a,b,c,d,e,f){b=a.relative;for(var g=[],h=0;h<a.domainDims.length;h++){var k=a.domainDims[h],n=k.name,r=k["@type"];r==FEATURE?g.push(n):r==PARAMETER?(k=c?t(c,n,0):new Parameter(n,0),g.push(k)):(r=e&&e[n]?e[n]:m(k),"value"in k&&r.update(k.value),e&&!e[n]&&(e[n]=r),g.push(r))}return new Mapping(g,b,a["function"],d,a.range,f)}function t(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function n(a,b){for(var c=
...
e,f,g,k,h,t,n;k=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*k,h=e*k,f=2*e,t=f+a,n=f+d,c[n+0]=b[t+0]*h+this.pMidBuffer[f+0]*g,c[n+1]=b[t+1]*h+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
