...
$jscomp.string.endsWith=function(a,b){$jscomp.string.noRegExp_(a,"endsWith");var c=this.toString();a+="";void 0===b&&(b=c.length);for(var d=Math.max(0,Math.min(b|0,c.length)),e=a.length;0<e&&0<d;)if(c[--d]!=a[--e])return!1;return 0>=e};$jscomp.string.endsWith$install=function(){String.prototype.endsWith||(String.prototype.endsWith=$jscomp.string.endsWith)};var SCHEDULE_AHEAD_TIME=.1,FADE_LENGTH=.02,DYMO_ONTOLOGY_URI="http://tiny.cc/dymo-ontology#";var RDFS_URI="http://www.w3.org/2000/01/rdf-schema#",CONTEXT_URI="http://tiny.cc/dymo-context/",TYPE="http://www.w3.org/1999/02/22-rdf-syntax-ns#type",FIRST="http://www.w3.org/1999/02/22-rdf-syntax-ns#first",REST="http://www.w3.org/1999/02/22-rdf-syntax-ns#rest",NIL="http://www.w3.org/1999/02/22-rdf-syntax-ns#nil",NAME="http://schema.org/name",CDT="http://tiny.cc/charm-ontology#cdt",ADT="http://tiny.cc/charm-ontology#adt",VALUE="http://tiny.cc/charm-ontology#value",HAS_PART="http://tiny.cc/charm-ontology#hasPart",
DYMO="http://tiny.cc/dymo-ontology#Dymo",DYMO_TYPE="http://tiny.cc/dymo-ontology#DymoType",CONJUNCTION="http://tiny.cc/dymo-ontology#Conjunction",DISJUNCTION="http://tiny.cc/dymo-ontology#Disjunction",SEQUENCE="http://tiny.cc/dymo-ontology#Sequence",FEATURE="http://tiny.cc/dymo-ontology#Feature",PARAMETER="http://tiny.cc/dymo-ontology#Parameter",FEATURE_TYPE="http://tiny.cc/dymo-ontology#FeatureType",PARAMETER_TYPE="http://tiny.cc/dymo-ontology#ParameterType",LEVEL_FEATURE="http://tiny.cc/dymo-ontology#LevelFeature",
INDEX_FEATURE="http://tiny.cc/dymo-ontology#IndexFeature",ONSET_FEATURE="http://tiny.cc/dymo-ontology#OnsetFeature",DURATION_FEATURE="http://tiny.cc/dymo-ontology#DurationFeature",TIME_FEATURE="http://tiny.cc/dymo-ontology#TimeFeature",SEGMENT_LABEL_FEATURE="http://tiny.cc/dymo-ontology#SegmentLabelFeature",CUSTOM_FEATURE="http://tiny.cc/dymo-ontology#CustomFeature",AUDIO_PARAMETER="http://tiny.cc/dymo-ontology#AudioParameter",HAS_STANDARD_VALUE="http://tiny.cc/dymo-ontology#hasStandardValue",IS_INTEGER=
"http://tiny.cc/dymo-ontology#isInteger",PLAY="http://tiny.cc/dymo-ontology#Play",LOOP="http://tiny.cc/dymo-ontology#Loop",ONSET="http://tiny.cc/dymo-ontology#Onset",DURATION_RATIO="http://tiny.cc/dymo-ontology#DurationRatio",AMPLITUDE="http://tiny.cc/dymo-ontology#Amplitude",PLAYBACK_RATE="http://tiny.cc/dymo-ontology#PlaybackRate",TIME_STRETCH_RATIO="http://tiny.cc/dymo-ontology#TimeStretchRatio",PAN="http://tiny.cc/dymo-ontology#Pan",DISTANCE="http://tiny.cc/dymo-ontology#Distance",HEIGHT="http://tiny.cc/dymo-ontology#Height",
REVERB="http://tiny.cc/dymo-ontology#Reverb",DELAY="http://tiny.cc/dymo-ontology#Delay",FILTER="http://tiny.cc/dymo-ontology#Filter",STRUCTURAL_PARAMETER="http://tiny.cc/dymo-ontology#StructuralParameter",PART_COUNT="http://tiny.cc/dymo-ontology#PartCount",PART_DURATION_RATIO="http://tiny.cc/dymo-ontology#PartDurationRatio",PART_PROPORTION="http://tiny.cc/dymo-ontology#PartProportion",CUSTOM_PARAMETER="http://tiny.cc/dymo-ontology#CustomParameter",HAS_SOURCE="http://tiny.cc/dymo-ontology#hasSource",
HAS_PARAMETER="http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_PARAMETER_TYPE="http://tiny.cc/dymo-ontology#hasParameterType",HAS_FEATURE_TYPE="http://tiny.cc/dymo-ontology#hasFeatureType",HAS_SIMILAR="http://tiny.cc/dymo-ontology#hasSimilar",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",MAPPING="http://tiny.cc/mobile-audio-ontology#Mapping",FUNCTION="http://tiny.cc/mobile-audio-ontology#Function",MOBILE_CONTROL="http://tiny.cc/mobile-audio-ontology#MobileControl",
SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",UI_CONTROL="http://tiny.cc/mobile-audio-ontology#UiControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",ACCELEROMETER_X="http://tiny.cc/mobile-audio-ontology#AccelerometerX",ACCELEROMETER_Y="http://tiny.cc/mobile-audio-ontology#AccelerometerY",ACCELEROMETER_Z="http://tiny.cc/mobile-audio-ontology#AccelerometerZ",TILT_X="http://tiny.cc/mobile-audio-ontology#TiltX",TILT_Y="http://tiny.cc/mobile-audio-ontology#TiltY",
TILT_Z="http://tiny.cc/mobile-audio-ontology#TiltZ",GEOLOCATION_LATITUDE="http://tiny.cc/mobile-audio-ontology#GeolocationLatitude",GEOLOCATION_LONGITUDE="http://tiny.cc/mobile-audio-ontology#GeolocationLongitude",GEOLOCATION_DISTANCE="http://tiny.cc/mobile-audio-ontology#GeolocationDistance",COMPASS_HEADING="http://tiny.cc/mobile-audio-ontology#CompassHeading",BEACON="http://tiny.cc/mobile-audio-ontology#Beacon",SLIDER="http://tiny.cc/mobile-audio-ontology#Slider",TOGGLE="http://tiny.cc/mobile-audio-ontology#Toggle",
BUTTON="http://tiny.cc/mobile-audio-ontology#Button",CUSTOM_CONTROL="http://tiny.cc/mobile-audio-ontology#CustomControl",RANDOM="http://tiny.cc/mobile-audio-ontology#Random",BROWNIAN="http://tiny.cc/mobile-audio-ontology#Brownian",RAMP="http://tiny.cc/mobile-audio-ontology#Ramp",MOBILE_PARAMETER="http://tiny.cc/mobile-audio-ontology#MobileParameter",GLOBAL_PARAMETER="http://tiny.cc/mobile-audio-ontology#GlobalParameter",CONTROL_PARAMETER="http://tiny.cc/mobile-audio-ontology#ControlParameter",LISTENER_ORIENTATION=
"http://tiny.cc/mobile-audio-ontology#ListenerOrientation",AUTO_CONTROL_FREQUENCY="http://tiny.cc/mobile-audio-ontology#AutoControlFrequency",AUTO_CONTROL_TRIGGER="http://tiny.cc/mobile-audio-ontology#AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE="http://tiny.cc/mobile-audio-ontology#BrownianMaxStepSize",LEAPING_PROBABILITY="http://tiny.cc/mobile-audio-ontology#LeapingProbability",CONTINUE_AFTER_LEAPING="http://tiny.cc/mobile-audio-ontology#ContinueAfterLeaping",NAVIGATOR="http://tiny.cc/mobile-audio-ontology#Navigator",
ONE_SHOT_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#OneShotNavigator",SEQUENTIAL_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SimilarityNavigator",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MAPPING_TARGET="http://tiny.cc/mobile-audio-ontology#MappingTarget",MAPPING_RANGE="http://tiny.cc/mobile-audio-ontology#MappingRange",MAPPING_OWNERS="http://tiny.cc/mobile-audio-ontology#MappingOwners",
HAS_DYMO="http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING="http://tiny.cc/mobile-audio-ontology#hasMapping",HAS_DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#hasDomainDimension",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",HAS_RANGE="http://tiny.cc/mobile-audio-ontology#hasRange",IS_RELATIVE=
"http://tiny.cc/mobile-audio-ontology#isRelative",HAS_INITIAL_VALUE="http://tiny.cc/mobile-audio-ontology#hasInitialValue",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",
TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo";function DymoManager(a,b,c,d,e){function g(a,b){p=b[0];p.dymos=a[0];l=a[1];for(var e in b[1]){var g=b[1][e];h.isSubclassOf(g.getType(),UI_CONTROL)&&(m[e]=new UIControl(g,d));h.isSubclassOf(g.getType(),SENSOR_CONTROL)&&(n[e]=g)}c||(c="bower_components/dymo-core/audio/impulse_rev.wav");f.initEffectSends(h,c)}var f=new Scheduler(a,e);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var h,l,p,m={},n={};this.loadDymoAndRenderingFromStore=function(a,b){h=a;var c=new DymoLoader(f);c.setStore(h);g(c.createDymoFromStore(),
c.createRenderingFromStore());f.loadBuffers(p.dymos,b)};this.loadDymoAndRendering=function(a,b,c,d){var e=new DymoLoader(f,function(){e.loadDymoFromJson(a,function(a){e.loadRenderingFromJson(b,function(b){h=e.getStore();g(a,b);f.loadBuffers(p.dymos,d);c&&c()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(f,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(f,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};
this.replacePartOfTopDymo=function(a,b){var c=p.dymos[0].getPart(a);p.dymos[0].replacePart(a,b);f.stop(c)};this.updateNavigatorPosition=function(a,b,c){f.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return f.getNavigatorPosition(a,b)};this.syncNavigators=function(a,b,c){f.syncNavigators(a,b,c)};this.startPlayingUri=function(a){f.play(l[a])};this.stopPlayingUri=function(a){f.stop(l[a])};this.startPlaying=function(){for(var a=0;a<p.dymos.length;a++)p.dymos[a].updatePartOrder(ONSET),
f.play(p.dymos[a])};this.stopPlaying=function(){for(var a=0;a<p.dymos.length;a++)f.stop(p.dymos[a])};this.getTopDymo=function(){return p.dymos[0]};this.getRendering=function(){return p};this.getUIControls=function(){return m};this.getUIControl=function(a){return m[a]};this.getSensorControls=function(){return n}};var URI_TO_TERM={"http://tiny.cc/dymo-ontology#LevelFeature":"level","http://tiny.cc/dymo-ontology#IndexFeature":"index","http://tiny.cc/dymo-ontology#OnsetFeature":"onset","http://tiny.cc/dymo-ontology#DurationFeature":"duration","http://tiny.cc/dymo-ontology#TimeFeature":"time","http://tiny.cc/dymo-ontology#SegmentLabelFeature":"segmentLabel","http://tiny.cc/dymo-ontology#hasSource":"source","http://tiny.cc/dymo-ontology#hasParameter":"parameters","http://tiny.cc/dymo-ontology#hasFeature":"features",
"http://tiny.cc/dymo-ontology#hasParameterType":"paramType","http://tiny.cc/dymo-ontology#hasFeatureType":"featureType","http://tiny.cc/dymo-ontology#hasSimilar":"similars","http://tiny.cc/mobile-audio-ontology#hasDymo":"dymo","http://tiny.cc/mobile-audio-ontology#hasMapping":"mappings","http://tiny.cc/mobile-audio-ontology#hasDomainDimension":"domainDims","http://tiny.cc/mobile-audio-ontology#hasFunction":"function","http://tiny.cc/mobile-audio-ontology#hasArgument":"args","http://tiny.cc/mobile-audio-ontology#hasBody":"body",
"http://tiny.cc/mobile-audio-ontology#toTarget":"targets","http://tiny.cc/mobile-audio-ontology#hasRange":"range","http://tiny.cc/mobile-audio-ontology#isRelative":"relative","http://tiny.cc/mobile-audio-ontology#hasInitialValue":"init","http://tiny.cc/mobile-audio-ontology#isSmooth":"smooth","http://tiny.cc/mobile-audio-ontology#isAverageOf":"average","http://tiny.cc/mobile-audio-ontology#hasUuid":"uuid","http://tiny.cc/mobile-audio-ontology#hasMajor":"major","http://tiny.cc/mobile-audio-ontology#hasMinor":"minor",
"http://tiny.cc/mobile-audio-ontology#hasDuration":"rampDuration","http://tiny.cc/mobile-audio-ontology#hasNavigator":"navigator","http://tiny.cc/mobile-audio-ontology#toDymo":"dymo"};function DymoNode(a,b,c,d){this.POSITION_PARAMS=[PAN,HEIGHT,DISTANCE];this.dymo=a;this.parameters={};this.init(b,c,d)}
...
DymoNode.prototype.removeAndDisconnect=function(){for(var a in this.parameters){var b=this.dymo.getParameter(a);b&&b.removeObserver(this)}this.dryGain.disconnect();this.reverbGain&&this.reverbGain.disconnect();this.delayGain&&this.delayGain.disconnect()};function AudioProcessor(a){function b(a){return{extract:function(b,e,g){for(var f=[],h=0;h<a.numberOfChannels;h++)f.push(a.getChannelData(h));for(h=0;h<e;h++)for(var l=0;l<f.length;l++)b[h*f.length+l%f.length]=f[l][h+g];return Math.min(e,f[0].length-g)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;for(var g=b(c),e=new SimpleFilter(g,e),g=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate),f=[],h=0;h<c.numberOfChannels;h++)f.push(g.getChannelData(h));for(var l=
new Float32Array(2048),p=e.extract(l,1024),m=0;p;){for(h=0;h<p;h++)for(var n=0;n<f.length;n++)f[n][h+m]=l[h*f.length+n%f.length];m+=p;p=e.extract(l,1024)}return g}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var g=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),f=a.createScriptProcessor(1024,
2,b.numberOfChannels),h=new Float32Array(2048);f.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=g.extract(h,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var f=0;f<c.length;f++)c[f][e]=h[e*c.length+f%c.length]};this.start=function(a){setTimeout(function(){f.connect(c)},a)};this.stop=function(){f.disconnect()}};function Scheduler(a,b){function c(){0<m&&m--;0==m&&n&&n()}function d(a){h.splice(h.indexOf(a),1)}function e(){for(var a=[],c=0;c<h.length;c++)for(var d=$jscomp.makeIterator(h[c].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();l=a;b&&b(l)}function g(b,c){m++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,b)})};
d.error=function(){};d.send()}var f={},h=[],l=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var p,m=0,n;this.initEffectSends=function(b,d){0<b.find(null,null,REVERB).length&&(p=a.createConvolver(),p.connect(a.destination),g(d,function(a){p.buffer=a;c()}));if(0<b.find(null,null,DELAY).length){var e=a.createDelay();e.delayTime.value=.5;e.connect(a.destination);var f=a.createGain();f.gain.value=.6;e.connect(f);f.connect(e)}};this.loadBuffers=
function(a,b){n=b;for(var d=[],e=0,h=a.length;e<h;e++)d=d.concat(a[e].getAllSourcePaths());e=0;for(h=d.length;e<h;e++)f[d[e]]||g(d[e],function(a,b){f[b]=a;c()})};this.getBuffer=function(a){return f[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<
d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,f=0,g=h.length;f<g;f++)h[f].hasDymo(a)&&(d=h[f].getNavigator()),h[f].hasDymo(b)&&(e=h[f].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,f,p,void 0,e,d);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=
function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSources(a);if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return l};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function DymoSource(a,b,c,d,e,g){function f(b,d){var e=b[0],f=b[1],f=1!=d?f+.3:f+FADE_LENGTH;if(c||isNaN(e+f)){if(0!=e||f<c.duration)c=m(c,p(e,c),p(f,c));return h(c,f,d)}n(a.getSourcePath(),e,e+f,function(a){return h(a,f,d)})}function h(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=m(a,0,p(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var e=c.sampleRate*FADE_LENGTH,f=0;f<c.numberOfChannels;f++)for(var g=c.getChannelData(f),h=0;h<e;h++)g[h]*=h/e,g[d-h-1]*=h/e;return a}function l(){u=!1;var a=
b.currentTime;t.parameters[AMPLITUDE].setValueAtTime(t.parameters[AMPLITUDE].value,a);t.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);r.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function m(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),f=0;f<a.numberOfChannels;f++)for(var g=e.getChannelData(f),h=a.getChannelData(f),l=0;l<d;l++)g[l]=h[c+l];return e}function n(a,b,c,d){var e=a.lastIndexOf("/");e&&
(a=a.substring(e+1));k("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function k(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var t=this,u,q,v,r=b.createBufferSource();r.connect(this.getInput());(function(){var b=a.getSegment();b[0]||(b[0]=0);!b[1]&&c&&
(b[1]=c.duration-b[0]);if(a.hasParameter(DURATION_RATIO)){var d=a.getParameter(DURATION_RATIO).getValue();0<d&&1>d&&(b[1]*=d)}v=b[1];d=a.hasParameter(TIME_STRETCH_RATIO)?a.getParameter(TIME_STRETCH_RATIO).getValue():1;r.buffer=f(b,d)})();this.addParameter(PLAYBACK_RATE,r.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return v};this.isLoopingAndPlaying=function(){return r.loop&&u};this.play=function(a){r.onended=function(){r.disconnect();
t.removeAndDisconnect();g&&g(t)};a||(a=0);r.start(a);u=!0};this.pause=function(){u?(l(),q=!0):q&&(q=!1,this.play())};this.stop=function(){u&&l()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,g,f,h){function l(){w=r?r:t();p(w);if(!z){var a=w.keys().next().value;a.hasParameter(ONSET)&&(z=a.getParameter(ONSET).getValue())}a=x?x-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(w.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){f()},a);(r=t())&&0<r.size?(x=k(b),a=x[1],x=x[0],a.getDymo().hasParameter(LOOP)&&a.getDymo().getParameter(LOOP).getValue()&&(x-=FADE_LENGTH),a=1E3*(x-c.currentTime-SCHEDULE_AHEAD_TIME),
y=setTimeout(function(){l()},a)):(x=k(b),a=1E3*(x-c.currentTime),setTimeout(function(){n()},a+100))}function p(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,q.get(c)||q.set(c,[]),q.get(c).push(a.get(c))}function m(a){var b=q.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&q.delete(a.getDymo());f();n()}function n(){if(0==q.size&&(!r||0==r.size)){window.clearTimeout(y);b.reset();for(var c=a.getAllDymosInHierarchy(),d=0,e=c.length;d<e;d++){var f=v.get(c[d]);
f&&f.removeAndDisconnect()}h&&h()}}function k(a){if(r){var b=r.keys().next().value,c;b.hasParameter(ONSET)&&(c=b.getParameter(ONSET).getValue());b=c-z;z=c;if(!isNaN(c))return a+b}c=0;for(var d,b=$jscomp.makeIterator(w.values()),e=b.next();!e.done;e=b.next()){var e=e.value,f=e.getDuration();f>c&&(c=f,d=e)}return[a+c,d]}function t(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var f=new Map,w=0;w<a.length;w++)if(a[w].getSourcePath()){var h=
d[a[w].getSourcePath()],h=new DymoSource(a[w],c,h,e,g,m);u(h);f.set(a[w],h)}return f}}function u(a){var b=a;for(a=a.getDymo().getParent();a;){if(v.has(a)){b.connect(v.get(a).getInput());return}var d=new DymoNode(a,c,e,g);b.connect(d.getInput());v.set(a,d);a=a.getParent();b=d}b.connect(c.destination)}var q=new Map,v=new Map,r,y,w=[],x,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));l();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};
this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].stop();r&&(r.delete(a[b]),0>=r.size&&(r=void 0))}};this.getAllSources=function(){return q};this.getSources=function(a){return q.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();g[b]=a;g[b].addObserver(e)}var e=this,g={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,g);var f;this.addParameter=d;this.getParameter=function(a){return g[a]};this.startUpdate=function(){f=setInterval(b,g[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(f);f=null;c&&c()};this.observedParameterChanged=function(a){a==g[AUTO_CONTROL_FREQUENCY]?
f&&(this.reset(),this.startUpdate()):a==g[AUTO_CONTROL_TRIGGER]&&(f?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){k.loadData(a,!0,b)})}function d(a,b,c){loadFile(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(t)&&(a=a.replace(t,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(t)&&(f=t+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function g(b){var c=k.findFirstObjectUri(b,CDT),c=new DynamicMusicObject(b,c,a);c.setBasePath(t);q[b]=c;c.setSourcePath(k.findFirstObjectValue(b,HAS_SOURCE));for(var d=k.findAllObjectUris(b,HAS_FEATURE),e=0;e<d.length;e++)c.setFeature(k.findFirstObjectUri(d[e],TYPE),k.findFirstObjectValue(d[e],VALUE));d=k.findAllObjectUris(b,HAS_PARAMETER);for(e=0;e<d.length;e++)m(c,k.findFirstObjectUri(d[e],TYPE),k.findFirstObjectValue(d[e],VALUE));b=k.findParts(b);console.log(b);for(e=0;e<b.length;e++)c.addPart(g(b[e]));
return c}function f(a){for(var b=q[a],c=k.findAllObjectUris(a,HAS_SIMILAR),d=0;d<c.length;d++)b.addSimilar(q[c[d]]);c=k.findAllObjectUris(a,HAS_MAPPING);h(c);for(d=0;d<c.length;d++)b.addMapping(l(c[d],b));a=k.findParts(a);for(d=0;d<a.length;d++)f(a[d])}function h(a){for(var b=0;b<a.length;b++)for(var c=k.findAllObjectUris(a[b],HAS_DOMAIN_DIMENSION),d=0;d<c.length;d++){var e=k.findFirstObjectUri(c[d],TYPE),f=k.findFirstObjectValue(c[d],NAME);f||(f=c[d]);if(k.isSubclassOf(e,MOBILE_CONTROL)&&!u[c[d]]){var g=
c[d],h=e,e=void 0;h==ACCELEROMETER_X||h==ACCELEROMETER_Y||h==ACCELEROMETER_Z?e=new AccelerometerControl(h):h==TILT_X||h==TILT_Y?e=new TiltControl(h):h==GEOLOCATION_LATITUDE||h==GEOLOCATION_LONGITUDE?e=new GeolocationControl(h):h==GEOLOCATION_DISTANCE?e=new DistanceControl:h==COMPASS_HEADING?e=new CompassControl:h==BEACON?(e=k.findFirstObjectValue(g,HAS_UUID),f=k.findFirstObjectValue(g,HAS_MAJOR),h=k.findFirstObjectValue(g,HAS_MINOR),e=new BeaconControl(e,f,h)):h==SLIDER||h==TOGGLE||h==BUTTON||h==
CUSTOM_CONTROL?(e=new Control(f,h),f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e.update(f)):h==RANDOM?e=new RandomControl:h==BROWNIAN?(f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new BrownianControl(f)):h==RAMP&&(e=Math.round(1E3*k.findFirstObjectUri(g,HAS_DURATION)),f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new RampControl(e,f));k.findFirstObjectValue(g,IS_SMOOTH)&&e.setSmooth&&e.setSmooth(!0);g=k.findFirstObjectValue(g,IS_AVERAGE_OF);!isNaN(g)&&e.setAverageOf&&e.setAverageOf(g);u[c[d]]=
e}}}function l(b,c){var d=k.findAllObjectUris(b,TO_TARGET);if(0<d.length){var e=[],f=k.findFunction(d[0]);if(f)d=Object.keys(q).map(function(a){return q[a]}),Array.prototype.push.apply(e,d.filter(f));else for(var g=0;g<d.length;g++)k.findFirstObjectUri(d[g],TYPE)==DYMO?e.push(q[d[g]]):e.push(u[d[g]]);return p(b,c,e,f)}return p(b,c,[a])}function p(a,b,c,d){for(var e=k.findFirstObjectUri(a,IS_RELATIVE),f=[],g=k.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),h=0;h<g.length;h++){var l=k.findFirstObjectUri(g[h],
TYPE),p=k.findFirstObjectValue(g[h],NAME);p||(p=g[h]);l==FEATURE_TYPE||k.isSubclassOf(l,FEATURE_TYPE)?f.push(p):l==PARAMETER_TYPE||k.isSubclassOf(l,PARAMETER_TYPE)?(l=b?m(b,p):new Parameter(p,0),f.push(l)):f.push(u[g[h]])}g=$jscomp.makeIterator(k.findArgsAndBody(k.findFirstObjectUri(a,HAS_FUNCTION)));b=g.next().value;g=g.next().value;a=k.findFirstObjectUri(a,HAS_RANGE);for(h=0;h<c.length;h++)c[h]instanceof DynamicMusicObject&&!c[h].getParameter(a)&&m(c[h],a);return new Mapping(f,e,{args:b,body:g},
c,a,d)}function m(a,b,c){var d=a.getParameter(b);d?d.update(c):(isNaN(c)&&(c=k.findFirstObjectValue(b,HAS_STANDARD_VALUE,null),isNaN(c)&&(c=0)),d=k.findFirstObjectValue(b,IS_INTEGER,null),d=new Parameter(b,c,d),a.addParameter(d));return d}function n(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}var k=new DymoStore(b),t="",u={},q={};this.setStore=function(a){k=a};this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+
1;t=a.substring(0,d);c(a,function(){b(this.createDymoFromStore())})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(this.createDymoFromStore())})};this.loadRenderingFromJson=function(a,b){c(a,function(){b(this.createRenderingFromStore())})};this.loadGraphFromJson=function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=q[CONTEXT_URI+"dymo"+c],f=q[CONTEXT_URI+"dymo"+a[c][d]];e&&f&&e.addSimilar(f)}b(void 0)})};this.createDymoFromStore=
function(){for(var a=[],b=k.findTopDymos(),c=0;c<b.length;c++)a.push(g(b[c])),f(b[c]);return[a,q]};this.createRenderingFromStore=function(){var a=k.findFirstSubjectUri(TYPE,RENDERING),b=new Rendering(q[k.findFirstObjectUri(a,HAS_DYMO)]),c=k.findAllObjectUris(a,HAS_MAPPING);h(c);for(var d=0;d<c.length;d++)b.addMapping(l(c[d]));if(a=k.findFirstObjectUri(a,HAS_NAVIGATOR))c=k.findFirstObjectUri(a,TO_DYMO),c=k.findFunction(c),b.addNavigator(n(k.findFirstObjectUri(a,TYPE)),c);return[b,u]}};function DymoStore(a){function b(a,b,d){g.triplesToRdf(a,function(a){c(a,b,d)})}function c(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,d){jsonld.frame(d,{"@id":b},function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context",function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context-simple",function(a,b){e(b);b=JSON.stringify(b,null,2);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");b=b.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");
...
TYPE,DYMO);b&&this.addPart(b,a);c&&this.addPart(a,c);d&&this.addTriple(a,HAS_SOURCE,N3.Util.createLiteral(d))};this.addPart=function(a,b){this.addObjectToList(a,HAS_PART,b)};this.setFeature=function(a,b,c){var d=this.findFirstObjectUriOfType(a,HAS_FEATURE,b);d?this.removeTriple(d,VALUE):(d=this.createBlankNode(),this.addTriple(a,HAS_FEATURE,d),this.addTriple(d,TYPE,b));this.addTriple(d,VALUE,N3.Util.createLiteral(c))};this.findTopDymos=function(){var a=this.findAllSubjectUris(TYPE,DYMO),b=this.findAllSubjectUris(HAS_PART),
c=[].concat.apply([],b.map(function(a){return g.findParts(a)}));return a.filter(function(a){return 0>c.indexOf(a)})};this.findParts=function(a){return this.findObjectListUris(a,HAS_PART)};this.findParents=function(a){var b=this.findContainingLists(a);return b[0].filter(function(a,c){return b[1][c]==HAS_PART})};this.findAllObjectsInHierarchy=function(a){var b=[a];a=this.findParts(a);for(var c=0;c<a.length;c++)b=b.concat(this.findAllObjectsInHierarchy(a[c]));return b};this.findFunction=function(a){var b=
$jscomp.makeIterator(this.findArgsAndBody(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))};this.findArgsAndBody=function(a){var b=this.findAllObjectValues(a,HAS_ARGUMENT);a=this.findFirstObjectValue(a,HAS_BODY);return[b,a]};this.findFeature=function(a,b){var c=this.findFirstObjectUriOfType(a,HAS_FEATURE,b);if(c)return this.findFirstObjectValue(c,VALUE)};this.getLevel=function(a){var b=0;for(a=this.findParents(a)[0];a;)b++,a=this.findParents(a)[0];return b};this.getMaxLevel=
function(){for(var a=this.findAllSubjectUris(TYPE,DYMO),b=0,c=0;c<a.length;c++)b=Math.max(b,this.getLevel(a[c]));return b};this.toJsonld=function(a){var b=this.findTopDymos()[0];this.toRdf(function(d){c(d,b,a)})};this.toJsonGraph=function(a,b,c){var e={nodes:[],links:[]},m={},n=this.findAllSubjectUris(TYPE,a),k=this.find(null,b,null);async.map(n,d,function(d,u){e.nodes=u;for(var q=0;q<n.length;q++)m[n[q]]=e.nodes[q];e.links=[];for(q=0;q<k.length;q++)if(0==g.find(k[q].object,TYPE,a).length){if(0<g.find(k[q].object,
FIRST).length){var v=g.findObjectListUris(k[q].subject,b),v=v.map(function(a){return{source:m[k[q].subject],target:m[a],value:1}});e.links=e.links.concat(v)}}else e.links.push({source:m[k[q].subject],target:m[k[q].object],value:1});c(e)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a,b){function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeToJsonld=function(b,e){e||(e="dymo.json");a.toJsonld(function(a){c(b+e,a)})}};function EasyStore(){function a(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}var b=this,c=N3.Store();this.addTriple=function(a,b,g){return c.addTriple(a,b,g)};this.removeTriple=function(a,b,g){g||(g=this.findFirstObjectUri(a,b));return c.removeTriple(a,b,g)};this.createBlankNode=function(){return c.createBlankNode()};this.addObjectToList=function(a,b,c){var f=this.findFirstObjectUri(a,b),h=this.createBlankNode();if(f){a=f;for(b=this.findFirstObjectUri(a,REST);b!=
NIL;)a=b,b=this.findFirstObjectUri(a,REST);this.removeTriple(a,REST,NIL);this.addTriple(a,REST,h)}else this.addTriple(a,b,h);this.addTriple(h,FIRST,c);this.addTriple(h,REST,NIL)};this.loadData=function(b,e,g){a(b,e,function(a){N3.Parser().parse(a,function(a,b,d){b?c.addTriple(b):g&&g()})})};this.loadFileIntoStore=function(a,c,g){loadFile(a,function(a){b.loadData(a,c,g)})};this.find=function(a,b,g){return c.find(a,b,g)};this.findFirstObjectUri=function(a,b){var g=c.find(a,b);if(0<g.length)return g[0].object};
this.findFirstObjectUriOfType=function(a,b,g){a=c.find(a,b).map(function(a){return a.object});a=a.filter(function(a){return 0<c.find(a,TYPE,g).length});if(0<a.length)return a[0]};this.findFirstSubjectUri=function(a,b){var g=c.find(null,a,b);if(0<g.length)return g[0].subject};this.findFirstObjectValue=function(a,b){var c=this.findFirstObjectUri(a,b);if(c){var f=N3.Util.getLiteralValue(c);"http://www.w3.org/2001/XMLSchema#string"!=N3.Util.getLiteralType(c)&&(f=Number(f));return f}};this.findAllSubjectUris=
function(a,b){return c.find(null,a,b).map(function(a){return a.subject})};this.findAllObjectUris=function(a,b){return c.find(a,b,null).map(function(a){return a.object})};this.findAllObjectValues=function(a,b){return this.findAllObjectUris(a,b).map(function(a){return N3.Util.getLiteralValue(a)})};this.findObjectListUris=function(a,b){var c=[],f=this.findFirstObjectUri(a,b);if(f)for(c.push(this.findFirstObjectUri(f,FIRST)),f=this.findFirstObjectUri(f,REST);f!=NIL;)c.push(this.findFirstObjectUri(f,FIRST)),
f=this.findFirstObjectUri(f,REST);return c};this.findContainingLists=function(a){var b=[],c=[];a=this.findAllSubjectUris(FIRST,a);for(var f=0;f<a.length;f++){for(var h=a[f],l=this.findFirstSubjectUri(REST,h);l;)h=l,l=this.findFirstSubjectUri(REST,h);h=this.find(null,null,h)[0];b[f]=h.subject;c[f]=h.predicate}return[b,c]};this.recursiveFindAllTriplesExcept=function(a,b){for(var g=c.find(a,null,null),f=[],h=g.length-1;0<=h;h--)0<c.find(g[h].object,TYPE,b).length?g.splice(h,1):f=f.concat(this.recursiveFindAllTriplesExcept(g[h].object,
b));return g.concat(f)};this.isSubclassOf=function(a,b){for(var c=this.findFirstObjectUri(a,RDFS_URI+"subClassOf");c;){if(c==b)return!0;c=this.findFirstObjectUri(c,RDFS_URI+"subClassOf")}return!1};this.toRdf=function(a){var b=c.find(null,null,null);this.triplesToRdf(b,a)};this.triplesToRdf=function(a,b){for(var c=N3.Writer({format:"application/nquads"}),f=0;f<a.length;f++)c.addTriple(a[f]);c.end(function(a,c){b(c)})};this.logData=function(){var a=c.find(null).map(function(a){return a.subject+"\n"+
...
Control.prototype.setValue=function(a,b){if(void 0==this.value||1E-6<Math.abs(a-this.value))this.value=a,this.updateMappings(b)};Control.prototype.updateMappings=function(a){for(var b=0;b<this.mappings.length;b++)this.mappings[b]!=a&&this.mappings[b].updateParameter(this.value,this)};function DynamicMusicObject(a,b,c){function d(a,b){b[a.getUri()]=a;for(var c=0;c<a.getParts().length;c++)d(a.getParts()[c],b)}function e(a,b,c,d){var f=a-b,g=d.getParts();if(d.getLevel()==c&&0==f)return d;if(d.getLevel()>=c-1)return f<g.length?g[f]:b+g.length;for(d=0;d<g.length;d++)if(b=e(a,b,c,g[d]),isNaN(b))return b}function g(a,b,c){c(a,b);a=a.getParts();for(var d=0,e=a.length;d<e;d++)g(a[d],b,c)}function f(a,b,c){var d=b.toFlatJson();a.nodes.push(d);c&&a.links.push(l(c,d));for(c=0;c<b.getParts().length;c++)f(a,
b.getParts()[c],d)}function h(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(l(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)h(a,b.getParts()[e],c)}function l(a,b){return{source:a,target:b,value:1}}var p=this,m=null,n=[],k=[],t={},u={},q=[],v=[],r="",y;this.setType=function(a){b=a};this.getType=function(){return b};
this.getUri=function(){return a};this.setParent=function(a){m=a;a=m.getMappings();for(var b=this.getMapOfDymosInSubtree(),b=Object.keys(b).map(function(a){return b[a]}),c=0;c<a.length;c++){var d=a[c].getDymoConstraint();d&&(d=a[c].getTargets().concat(b.filter(d)),a[c].setTargets(d))}};this.removeParent=function(){for(var a=0;a<v.length;a++)v[a].disconnect();v=[];for(var b=m.getMappings(),c=this,a=0;a<b.length;a++){var d=b[a].getTargets(),d=d.filter(function(a){return!a.isSubDymoOf(c)});b[a].setTargets(d)}m=
null};this.getParent=function(){return m};this.isSubDymoOf=function(a){for(var b=this;b;){if(b==a)return!0;b=b.getParent()}return!1};this.getMapOfDymosInSubtree=function(){var a={};d(this,a);return a};this.getLevel=function(){return m?m.getLevel()+1:0};this.getIndex=function(){if(m)return m.getParts().indexOf(this)};this.addPart=function(a){n.push(a);a.setParent(this)};this.removePart=function(a){n.splice(n.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){n[a]&&n[a].removeParent(this);
n[a]=b;b.setParent(this)};this.getPart=function(a){return n[a]};this.getParts=function(){return n};this.hasParts=function(){return 0<n.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){r=a};this.getBasePath=function(){return m&&!r?m.getBasePath():r};this.setSourcePath=function(a){y=a};this.getSourcePath=function(){if(m&&!y)return m.getSourcePath();if(y)return this.getBasePath()+y};this.getAllSourcePaths=function(){var a=[];g(this,a,function(b,c){var d=b.getSourcePath();
d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];g(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){k.push(a)};this.getSimilars=function(a){return k};this.getFeatures=function(){return t};this.setFeature=function(a,b){t[a]=b};this.getFeature=function(a){if(a===LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(t.hasOwnProperty(a))return t[a];if(m)return m.getFeature(a);for(var b=[],c=0;c<n.length;c++)if(n[c]){var d=
n[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(t[a])return t[a]};this.getMappings=function(){return q};this.getSegment=function(){return[this.getFeature(TIME_FEATURE),this.getFeature(DURATION_FEATURE)]};this.addParameter=function(a){u[a.getName()]=a};this.getParameter=function(a){return u[a]};this.hasParameter=function(a){return a in u};this.addMapping=function(a){q.push(a)};this.observedParameterChanged=function(a){a.getName()==
PLAY&&c&&(0<a.getChange()?c.play(p):c.stop(p))};this.updatePartOrder=function(a){n&&n[0]&&!isNaN(n[0].getFeature(a))?n.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):n&&n[0]&&n[0].hasParameter(a)&&n.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=function(){for(var a=this.toFlatJson(),b=0;b<n.length;b++)a.parts.push(n[b].toJsonHierarchy());return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};f(a,this);return a};
this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};h(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);y&&(c.source=y);for(var d in t)c[d]=this.getFeatureJson(d);if(0<q.length)for(c.mappings=[],d=0;d<q.length;d++)c.mappings.push(q[d].toJson());0<n.length&&(c.parts=[]);if(0<k.length)for(c.similars=[],d=0;d<k.length;d++)c.similars.push(k[d].getUri());return c};this.getFeatureJson=function(a){return{value:t[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+
a.slice(1)}}};function Mapping(a,b,c,d,e,g){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=g;this.init()}
...
PolygonTools.getInterpolatedPolygonFunctionArgs=function(a){var b=getPolygonOrPointString(a);a=getPolygonOrPointString(PolygonTools.getCentroid(a));return["a","b","return PolygonTools.howFarIsPointInPolygon("+b+","+a+", {0:a, 1:b});"]};function getPolygonOrPointString(a){return JSON.stringify(a).replace(/"/g,"'")};function DymoNavigator(a,b){function c(a){var b=e(a);if(b){h[a.getLevel()]=b;if(b.getType()==ONE_SHOT_NAVIGATOR)return b.getCurrentParts();a=b.getCurrentParts();return(a=d(a))?a:d(b.getNextParts())}return[a]}function d(a){if(a&&0<a.length){for(var b=[],d=0,e=a.length;d<e;d++){var f=c(a[d]);f&&(f.length?b=b.concat(f):b.push(f))}if(0<b.length)return b}}function e(a){if(!f.has(a)){for(var c=0,d=g.length;c<d;c++)g[c][0](a)&&a.hasParts()&&f.set(a,g[c][1].getCopy(a));f.has(a)||(b&&a.hasParts()?f.set(a,
b.getCopy(a)):f.set(a,new OneShotNavigator(a)))}return f.get(a)}var g=[],f,h;f=new Map;h=[];this.reset=function(a){if(a){var b=a.getAllDymosInHierarchy();b.splice(b.indexOf(a),1);a=0;for(var c=b.length;a<c;a++){var d=f.delete(b[a]);(d=h.indexOf(d))&&h.splice(d,1)}}else f=new Map,h=[]};this.addSubsetNavigator=function(a,b){g.push([a,b])};this.getPosition=function(b,c){c||(c=a);for(var d=0;d<b;){if(!f.has(c))return;c=f.get(c).getCurrentParts()[0];d++}if(f.has(c))return f.get(c).getPartsNavigated()};
...
d=d?[d]:void 0;return d}};this.getNextParts=function(){c++;return this.getCurrentParts()}};function SimilarityNavigator(a){function b(b){if(b&&0<b.length)for(var g=0;g<b.length;g++)if(0<b[g].getSimilars().length&&Math.random()<c.leapingProbability.getValue()){var f=b[g].getSimilars(),h=Math.floor(Math.random()*f.length);if(c.continueAfterLeaping.getValue()){var l=a.getParts().indexOf(h);l&&(d=l+1)}b[g]=f[h]}return b}var c=this,d=0;this.leapingProbability=new Parameter(LEAPING_PROBABILITY,.5);this.continueAfterLeaping=new Parameter(CONTINUE_AFTER_LEAPING,0,!0);this.resetPartsPlayed=function(){d=
...
e,g,f,h,l,p,m;h=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)f=(this.overlapLength-e)*h,l=e*h,g=2*e,p=g+a,m=g+d,c[m+0]=b[p+0]*l+this.pMidBuffer[g+0]*f,c[m+1]=b[p+1]*l+this.pMidBuffer[g+1]*f},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
