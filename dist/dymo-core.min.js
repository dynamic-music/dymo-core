...
$jscomp.string.endsWith=function(a,b){$jscomp.string.noRegExp_(a,"endsWith");var c=this.toString();a+="";void 0===b&&(b=c.length);for(var d=Math.max(0,Math.min(b|0,c.length)),e=a.length;0<e&&0<d;)if(c[--d]!=a[--e])return!1;return 0>=e};$jscomp.string.endsWith$install=function(){String.prototype.endsWith||(String.prototype.endsWith=$jscomp.string.endsWith)};var SCHEDULE_AHEAD_TIME=.1,FADE_LENGTH=.02;var RDF_URI="http://www.w3.org/1999/02/22-rdf-syntax-ns#",RDFS_URI="http://www.w3.org/2000/01/rdf-schema#",SCHEMA_URI="http://schema.org/",CHARM_URI="http://tiny.cc/charm-ontology#",DYMO_URI="http://tiny.cc/dymo-ontology#",MOBILE_URI="http://tiny.cc/mobile-audio-ontology#",CONTEXT_URI="http://tiny.cc/dymo-context/",DYMO="http://tiny.cc/dymo-ontology#Dymo",FEATURE="http://tiny.cc/dymo-ontology#Feature",PARAMETER="http://tiny.cc/dymo-ontology#Parameter",DYMO_TYPE="http://tiny.cc/dymo-ontology#DymoType",
CONJUNCTION="http://tiny.cc/dymo-ontology#Conjunction",DISJUNCTION="http://tiny.cc/dymo-ontology#Disjunction",SEQUENCE="http://tiny.cc/dymo-ontology#Sequence",LEVEL="http://tiny.cc/dymo-ontology#Level",INDEX="http://tiny.cc/dymo-ontology#Index",AUDIO_PARAMETER="http://tiny.cc/dymo-ontology#AudioParameter",PLAY="http://tiny.cc/dymo-ontology#Play",LOOP="http://tiny.cc/dymo-ontology#Loop",ONSET="http://tiny.cc/dymo-ontology#Onset",DURATION_RATIO="http://tiny.cc/dymo-ontology#DurationRatio",AMPLITUDE=
"http://tiny.cc/dymo-ontology#Amplitude",PLAYBACK_RATE="http://tiny.cc/dymo-ontology#PlaybackRate",TIME_STRETCH_RATIO="http://tiny.cc/dymo-ontology#TimeStretchRatio",PAN="http://tiny.cc/dymo-ontology#Pan",DISTANCE="http://tiny.cc/dymo-ontology#Distance",HEIGHT="http://tiny.cc/dymo-ontology#Height",REVERB="http://tiny.cc/dymo-ontology#Reverb",DELAY="http://tiny.cc/dymo-ontology#Delay",FILTER="http://tiny.cc/dymo-ontology#Filter",STRUCTURAL_PARAMETER="http://tiny.cc/dymo-ontology#StructuralParameter",
...
"http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_NAVIGATOR="http://tiny.cc/dymo-ontology#hasNavigator",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",MAPPING="http://tiny.cc/mobile-audio-ontology#Mapping",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",FUNCTION="http://tiny.cc/mobile-audio-ontology#Function",MOBILE_CONTROL="http://tiny.cc/mobile-audio-ontology#MobileControl",CUSTOM_CONTROL="http://tiny.cc/mobile-audio-ontology#CustomControl",
SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",U_I_CONTROL="http://tiny.cc/mobile-audio-ontology#UIControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",ACCELEROMETER_X="http://tiny.cc/mobile-audio-ontology#AccelerometerX",ACCELEROMETER_Y="http://tiny.cc/mobile-audio-ontology#AccelerometerY",ACCELEROMETER_Z="http://tiny.cc/mobile-audio-ontology#AccelerometerZ",TILT_X="http://tiny.cc/mobile-audio-ontology#TiltX",TILT_Y="http://tiny.cc/mobile-audio-ontology#TiltY",
...
BUTTON="http://tiny.cc/mobile-audio-ontology#Button",RANDOM="http://tiny.cc/mobile-audio-ontology#Random",BROWNIAN="http://tiny.cc/mobile-audio-ontology#Brownian",RAMP="http://tiny.cc/mobile-audio-ontology#Ramp",MOBILE_PARAMETER="http://tiny.cc/mobile-audio-ontology#MobileParameter",GLOBAL_PARAMETER="http://tiny.cc/mobile-audio-ontology#GlobalParameter",CONTROL_PARAMETER="http://tiny.cc/mobile-audio-ontology#ControlParameter",LISTENER_ORIENTATION="http://tiny.cc/mobile-audio-ontology#ListenerOrientation",
AUTO_CONTROL_FREQUENCY="http://tiny.cc/mobile-audio-ontology#AutoControlFrequency",AUTO_CONTROL_TRIGGER="http://tiny.cc/mobile-audio-ontology#AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE="http://tiny.cc/mobile-audio-ontology#BrownianMaxStepSize",LEAPING_PROBABILITY="http://tiny.cc/mobile-audio-ontology#LeapingProbability",CONTINUE_AFTER_LEAPING="http://tiny.cc/mobile-audio-ontology#ContinueAfterLeaping",HAS_DYMO="http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING="http://tiny.cc/mobile-audio-ontology#hasMapping",
HAS_DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#hasDomainDimension",FROM_CONTROL="http://tiny.cc/mobile-audio-ontology#fromControl",FROM_FEATURE="http://tiny.cc/mobile-audio-ontology#fromFeature",FROM_PARAMETER="http://tiny.cc/mobile-audio-ontology#fromParameter",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo",
TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",TO_PARAMETER="http://tiny.cc/mobile-audio-ontology#toParameter",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",DYMO_TYPES=[CONJUNCTION,DISJUNCTION,SEQUENCE],PARAMETERS=[PLAY,LOOP,ONSET,DURATION_RATIO,AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,PAN,DISTANCE,HEIGHT,REVERB,DELAY,FILTER,PART_COUNT,LISTENER_ORIENTATION,AUTO_CONTROL_FREQUENCY,AUTO_CONTROL_TRIGGER],CONTROLS=
[SLIDER,TOGGLE,BUTTON,CUSTOM_CONTROL,ACCELEROMETER_X,ACCELEROMETER_Y,ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,RANDOM,BROWNIAN,RAMP],UI_CONTROLS=[SLIDER,TOGGLE,BUTTON,CUSTOM_CONTROL],SENSOR_CONTROLS=[ACCELEROMETER_X,ACCELEROMETER_Y,ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,BEACON];function DymoManager(a,b,c,d){var e=new Scheduler(a,function(){});c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.setReverbFile(c);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g={},l={};this.loadDymoAndRendering=function(a,b,c,p){var u=new DymoLoader(e,function(){u.loadDymoFromJson(a,function(a){u.loadRenderingFromJson(b,a[1],function(b){f=b[0];f.dymo=a[0];for(var h in b[1]){var q=b[1][h];0<=UI_CONTROLS.indexOf(q.getType())&&(g[h]=new UIControl(q,d));0<=SENSOR_CONTROLS.indexOf(q.getType())&&
...
1))}}function f(a){var b=g()[0],c=q(b,a);m(b,a);return[c,a]}function g(){var a=n.find(null,CHARM_URI+"hasPart",null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function l(a){var b=$jscomp.makeIterator(h(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function h(a){var b=n.findAllObjectValues(a,
MOBILE_URI+"hasArgument");a=n.findFirstObjectValue(a,MOBILE_URI+"hasBody");return[b,a]}function q(b,c){var d=n.findFirstObjectUri(b,CHARM_URI+"cdt"),d=new DynamicMusicObject(b,d,a);d.setBasePath(t);c[b]=d;d.setSourcePath(n.findFirstObjectValue(b,DYMO_URI+"hasSource"));for(var e=n.findAllObjectUris(b,DYMO_URI+"hasFeature"),f=0;f<e.length;f++)d.setFeature(e[f],n.findFirstObjectUri(e[f],CHARM_URI+"value"));e=n.findAllObjectUris(b,DYMO_URI+"hasParameter");for(f=0;f<e.length;f++)r(d,n.findFirstObjectUri(e[f],
RDF_URI+"type"),n.findFirstObjectValue(e[f],CHARM_URI+"value"));e=n.findAllObjectUris(b,CHARM_URI+"hasPart");for(f=0;f<e.length;f++)d.addPart(q(e[f],c));return d}function m(a,b){for(var c=b[a],d=n.findAllObjectUris(a,DYMO_URI+"hasSimilar"),e=0;e<d.length;e++)c.addSimilar(b[d[e]]);d=n.findAllObjectUris(a,MOBILE_URI+"hasMapping");for(e=0;e<d.length;e++)c.addMapping(p(d[e],b,c));c=n.findAllObjectUris(a,CHARM_URI+"hasPart");for(e=0;e<c.length;e++)m(c[e],b)}function p(b,c,d,e){var f=n.findAllObjectUris(b,
MOBILE_URI+"toTarget"),h=n.findAllObjectUris(b,MOBILE_URI+"toDymo");if(0<f.length){for(var h=[],g=0;g<f.length;g++){var q=n.findFirstSubjectUri(SCHEMA_URI+"name",f[g]);h.push(e[q])}return u(b,c,d,h,e)}if(0<h.length){f=[];if(q=l(h[0]))g=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(f,g.filter(q));else for(g=0;g<h.length;g++)f.push(c[h[g]]);return u(b,c,d,f,e,q)}return u(b,c,d,[a],e)}function u(a,b,c,d,e,f){b=n.findFirstObjectUri(a,MOBILE_URI+"isRelative");for(var g=[],q=n.findAllObjectUris(a,
MOBILE_URI+"hasDomainDimension"),l=0;l<q.length;l++){var p=n.findFirstObjectUri(q[l],RDF_URI+"type"),m=n.findFirstObjectValue(q[l],SCHEMA_URI+"name");m||(m=q[l]);p==FEATURE?g.push(m):p==PARAMETER?(p=c?r(c,m,0):new Parameter(m,0),g.push(p)):g.push(e[q[l]])}e=$jscomp.makeIterator(h(n.findFirstObjectUri(a,MOBILE_URI+"hasFunction")));c=e.next().value;e=e.next().value;a=n.findFirstObjectUri(a,MOBILE_URI+"toParameter");return new Mapping(g,b,{args:c,body:e},d,a,f)}function r(a,b,c){var d=a.getParameter(b);
d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function v(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function w(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};c.error=function(a){console.log(a)};c.send()}function y(a,b,c){w(a,function(a){n.loadData(a,b,c)})}var n=new EasyStore,t="";(function(){y("http://tiny.cc/dymo-ontology",!1,function(){y("http://tiny.cc/mobile-audio-ontology",!1,
function(){b&&b()})})})();this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;t=a.substring(0,d);c(a,function(){b(f({}))})};this.parseDymoFromJson=function(a,b){n.loadData(a,!0,function(){b(f({}))})};this.loadRenderingFromJson=function(a,b,d){b||(b={});c(a,function(){for(var a=b,c=n.findFirstSubjectUri(RDF_URI+"type",MOBILE_URI+"Rendering"),e=new Rendering(a[n.findFirstObjectUri(c,MOBILE_URI+"hasDymo")]),k=n.findAllObjectUris(c,MOBILE_URI+"hasMapping"),f={},g=0;g<k.length;g++)for(var h=
n.findAllObjectUris(k[g],MOBILE_URI+"hasDomainDimension"),q=0;q<h.length;q++){var m=n.findFirstObjectUri(h[q],RDF_URI+"type"),u=n.findFirstObjectValue(h[q],SCHEMA_URI+"name");u||(u=h[q]);if(n.isSubclassOf(m,MOBILE_URI+"MobileControl")&&!f[h[q]]){var t;t=h[q];var r=m,m=void 0;r==ACCELEROMETER_X||r==ACCELEROMETER_Y||r==ACCELEROMETER_Z?m=new AccelerometerControl(r):r==TILT_X||r==TILT_Y?m=new TiltControl(r):r==GEOLOCATION_LATITUDE||r==GEOLOCATION_LONGITUDE?m=new GeolocationControl(r):r==GEOLOCATION_DISTANCE?
m=new DistanceControl:r==COMPASS_HEADING?m=new CompassControl:r==BEACON?m=new BeaconControl(void 0,void 0,void 0):r==SLIDER||r==TOGGLE||r==BUTTON||r==CUSTOM_CONTROL?m=new Control(u,r):r==RANDOM?m=new RandomControl:r==BROWNIAN?m=new BrownianControl(0):r==RAMP&&(u=n.findFirstObjectValue(t,CHARM_URI+"value"),m=new RampControl(3E3,u));n.findFirstObjectUri(t,MOBILE_URI+"isSmooth")&&m.setSmooth&&m.setSmooth(!0);t=Number(n.findFirstObjectUri(t,MOBILE_URI+"isAverageOf"));!isNaN(t)&&m.setAverageOf&&m.setAverageOf(t);
t=m;u=Number(n.findFirstObjectUri(h[q],CHARM_URI+"value"));isNaN(u)||t.update(u);f[h[q]]=t}}for(g=0;g<k.length;g++)e.addMapping(p(k[g],a,void 0,f));if(a=n.findFirstObjectUri(c,DYMO_URI+"hasNavigator"))c=n.findFirstObjectUri(a,MOBILE_URI+"toDymo"),c=l(c),e.addNavigator(v(n.findFirstObjectUri(a,RDF_URI+"type")),c);d([e,f])})};this.loadGraphFromJson=function(a,b,c){d(a,"",function(a){for(var d=0;d<a.length;d++)if(a[d])for(var e=0;e<a[d].length;e++){var f=b[CONTEXT_URI+"dymo"+d],k=b[CONTEXT_URI+"dymo"+
a[d][e]];f&&k&&f.addSimilar(k)}c(void 0)})}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
