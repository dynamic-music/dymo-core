...
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){k.loadData(a,!0,b)})}function d(a,b,c){y(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(m){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(h)&&(a=a.replace(h,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(h)&&(f=h+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function f(){var a=g()[0],b=q(a);p(a);return[b,A]}function g(){var a=k.find(null,HAS_PART,null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function l(a){var b=$jscomp.makeIterator(m(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function m(a){var b=k.findAllObjectValues(a,HAS_ARGUMENT);
a=k.findFirstObjectValue(a,HAS_BODY);return[b,a]}function q(b){var c=k.findFirstObjectUri(b,CDT),c=new DynamicMusicObject(b,c,a);c.setBasePath(h);A[b]=c;c.setSourcePath(k.findFirstObjectValue(b,HAS_SOURCE));for(var d=k.findAllObjectUris(b,HAS_FEATURE),e=0;e<d.length;e++)c.setFeature(d[e],k.findFirstObjectUri(d[e],VALUE));d=k.findAllObjectUris(b,HAS_PARAMETER);for(e=0;e<d.length;e++)r(c,k.findFirstObjectUri(d[e],TYPE),k.findFirstObjectValue(d[e],VALUE));b=k.findAllObjectUris(b,HAS_PART);for(e=0;e<
b.length;e++)c.addPart(q(b[e]));return c}function p(a){for(var b=A[a],c=k.findAllObjectUris(a,HAS_SIMILAR),d=0;d<c.length;d++)b.addSimilar(A[c[d]]);c=k.findAllObjectUris(a,HAS_MAPPING);n(c);for(d=0;d<c.length;d++)b.addMapping(u(c[d],b));a=k.findAllObjectUris(a,HAS_PART);for(d=0;d<a.length;d++)p(a[d])}function n(a){for(var b=0;b<a.length;b++)for(var c=k.findAllObjectUris(a[b],HAS_DOMAIN_DIMENSION),d=0;d<c.length;d++){var e=k.findFirstObjectUri(c[d],TYPE),h=k.findFirstObjectValue(c[d],NAME);h||(h=c[d]);
if(k.isSubclassOf(e,MOBILE_CONTROL)&&!z[c[d]]){var f;f=c[d];var g=e,e=void 0;g==ACCELEROMETER_X||g==ACCELEROMETER_Y||g==ACCELEROMETER_Z?e=new AccelerometerControl(g):g==TILT_X||g==TILT_Y?e=new TiltControl(g):g==GEOLOCATION_LATITUDE||g==GEOLOCATION_LONGITUDE?e=new GeolocationControl(g):g==GEOLOCATION_DISTANCE?e=new DistanceControl:g==COMPASS_HEADING?e=new CompassControl:g==BEACON?(h=k.findFirstObjectValue(f,HAS_UUID),e=k.findFirstObjectValue(f,HAS_MAJOR),g=k.findFirstObjectValue(f,HAS_MINOR),e=new BeaconControl(h,
e,g)):g==SLIDER||g==TOGGLE||g==BUTTON||g==CUSTOM_CONTROL?e=new Control(h,g):g==RANDOM?e=new RandomControl:g==BROWNIAN?(h=k.findFirstObjectValue(f,HAS_INITIAL_VALUE),e=new BrownianControl(h)):g==RAMP&&(e=Math.round(1E3*k.findFirstObjectUri(f,HAS_DURATION)),h=k.findFirstObjectValue(f,HAS_INITIAL_VALUE),e=new RampControl(e,h));k.findFirstObjectUri(f,IS_SMOOTH)&&e.setSmooth&&e.setSmooth(!0);f=Number(k.findFirstObjectUri(f,IS_AVERAGE_OF));!isNaN(f)&&e.setAverageOf&&e.setAverageOf(f);f=e;h=Number(k.findFirstObjectUri(c[d],
VALUE));isNaN(h)||f.update(h);z[c[d]]=f}}}function u(b,c){var d=k.findAllObjectUris(b,TO_TARGET);if(0<d.length){var e=[],h=l(d[0]);if(h)d=Object.keys(A).map(function(a){return A[a]}),Array.prototype.push.apply(e,d.filter(h));else for(var f=0;f<d.length;f++)k.findFirstObjectUri(d[f],TYPE)==DYMO?e.push(A[d[f]]):e.push(z[d[f]]);return t(b,c,e,h)}return t(b,c,[a])}function t(a,b,c,d){for(var e=k.findFirstObjectUri(a,IS_RELATIVE),h=[],f=k.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),g=0;g<f.length;g++){var q=
k.findFirstObjectUri(f[g],TYPE),l=k.findFirstObjectValue(f[g],NAME);l||(l=f[g]);q==FEATURE_TYPE||k.isSubclassOf(q,FEATURE_TYPE)?h.push(l):q==PARAMETER_TYPE||k.isSubclassOf(q,PARAMETER_TYPE)?(q=b?r(b,l,0):new Parameter(l,0),h.push(q)):h.push(z[f[g]])}f=$jscomp.makeIterator(m(k.findFirstObjectUri(a,HAS_FUNCTION)));b=f.next().value;f=f.next().value;a=k.findFirstObjectUri(a,HAS_RANGE);return new Mapping(h,e,{args:b,body:f},c,a,d)}function r(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,
c),a.addParameter(d));return d}function v(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function y(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};c.error=function(a){console.log(a)};c.send()}function w(a,b,c){y(a,function(a){k.loadData(a,b,c)})}var k=new EasyStore,h="",z={},A={};(function(){w("http://tiny.cc/dymo-ontology",!1,function(){w("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();
this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;h=a.substring(0,d);c(a,function(){b(f())})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(f())})};this.loadRenderingFromJson=function(a,b){c(a,function(){var a=k.findFirstSubjectUri(TYPE,RENDERING),c=new Rendering(A[k.findFirstObjectUri(a,HAS_DYMO)]),d=k.findAllObjectUris(a,HAS_MAPPING);n(d);for(var e=0;e<d.length;e++)c.addMapping(u(d[e]));if(a=k.findFirstObjectUri(a,HAS_NAVIGATOR))d=
k.findFirstObjectUri(a,TO_DYMO),d=l(d),c.addNavigator(v(k.findFirstObjectUri(a,TYPE)),d);b([c,z])})};this.loadGraphFromJson=function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=A[CONTEXT_URI+"dymo"+c],h=A[CONTEXT_URI+"dymo"+a[c][d]];e&&h&&e.addSimilar(h)}b(void 0)})}};function DymoWriter(a,b){function c(a){if(a&&a instanceof Object)for(var b in a)"@id"==b&&a[b].includes("_:b")?delete a[b]:c(a[b])}function d(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeToJsonld=function(a,b){b||(b="dymo.json");this.getJsonld(function(c){d(a+b,c)})};this.getJsonld=function(a){this.getRdf(function(b){b=b.split("_b").join("b");
jsonld.fromRDF(b,{format:"application/nquads"},function(b,d){jsonld.frame(d,{"@id":"http://tiny.cc/dymo-context/dymo0"},function(b,d){jsonld.compact(d,"http://tiny.cc/dymo-context",function(b,d){jsonld.compact(d,"http://tiny.cc/dymo-context-simple",function(b,d){c(d);d=JSON.stringify(d,null,2);d=d.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");a(d)})})})})})};this.getRdf=function(b){for(var c=a.find(null,null,null),d=N3.Writer({format:"application/nquads"}),l=0;l<c.length;l++)d.addTriple(c[l]);
...
e,f,g,l,m,q,p;l=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*l,m=e*l,f=2*e,q=f+a,p=f+d,c[p+0]=b[q+0]*m+this.pMidBuffer[f+0]*g,c[p+1]=b[q+1]*m+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
