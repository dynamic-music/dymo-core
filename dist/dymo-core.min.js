...
ONE_SHOT_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#OneShotNavigator",REPEATED_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#RepeatedNavigator",SEQUENTIAL_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SimilarityNavigator",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MAPPING_TARGET="http://tiny.cc/mobile-audio-ontology#MappingTarget",MAPPING_RANGE="http://tiny.cc/mobile-audio-ontology#MappingRange",
MAPPING_OWNERS="http://tiny.cc/mobile-audio-ontology#MappingOwners",HAS_DYMO="http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING="http://tiny.cc/mobile-audio-ontology#hasMapping",HAS_DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#hasDomainDimension",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",
HAS_RANGE="http://tiny.cc/mobile-audio-ontology#hasRange",IS_RELATIVE="http://tiny.cc/mobile-audio-ontology#isRelative",HAS_INITIAL_VALUE="http://tiny.cc/mobile-audio-ontology#hasInitialValue",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION=
"http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo";function DymoManager(a,b,c,d,e){function g(a,b){m=b[0];m.dymos=a[0];k=a[1];for(var e in b[1]){var g=b[1][e];h.isSubclassOf(g.getType(),UI_CONTROL)&&(n[e]=new UIControl(g,d));h.isSubclassOf(g.getType(),SENSOR_CONTROL)&&(p[e]=g)}c||(c="bower_components/dymo-core/audio/impulse_rev.wav");f.initEffectSends(h,c)}var f=new Scheduler(a,e);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var h,k,m,n={},p={};this.loadDymoAndRenderingFromStore=function(a,b){h=a;var c=new DymoLoader(f);c.setStore(h);g(c.createDymoFromStore(),
...
2,b.numberOfChannels),h=new Float32Array(2048);f.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=g.extract(h,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var f=0;f<c.length;f++)c[f][e]=h[e*c.length+f%c.length]};this.start=function(a){setTimeout(function(){f.connect(c)},a)};this.stop=function(){f.disconnect()}};function Scheduler(a,b){function c(a){f.splice(f.indexOf(a),1)}function d(){for(var a=[],c=0;c<f.length;c++)for(var d=$jscomp.makeIterator(f[c].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();h=a;b&&b(h)}function e(b,c){m++;var e=new XMLHttpRequest;e.open("GET",b,!0);e.responseType="arraybuffer";e.onload=function(){a.decodeAudioData(e.response,function(a){c(a,b)})};e.error=function(){};e.send()}var g=
...
a)};this.syncNavigators=function(a,b,c){for(var d,e,g=0,h=f.length;g<h;g++)f[g].hasDymo(a)&&(d=f[g].getNavigator()),f[g].hasDymo(b)&&(e=f[g].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,g,k,void 0,d,c);f.push(b)};this.pause=function(a){if(a)for(var b=0;b<f.length;b++)f[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<f.length;b++)f[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<f.length;c++){var d=f[c].getSources(a);
if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return h};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function DymoSource(a,b,c,d,e,g){function f(b,d){var e=b[0],f=b[1],f=1!=d?f+.3:f+FADE_LENGTH;if(c||isNaN(e+f)){if(0!=e||f<c.duration)c=n(c,m(e,c),m(f,c));return h(c,f,d)}p(a.getSourcePath(),e,e+f,function(a){return h(a,f,d)})}function h(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=n(a,0,m(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var e=c.sampleRate*FADE_LENGTH,f=0;f<c.numberOfChannels;f++)for(var g=c.getChannelData(f),h=0;h<e;h++)g[h]*=h/e,g[d-h-1]*=h/e;return a}function k(){v=!1;var a=
b.currentTime;l.parameters[AMPLITUDE].setValueAtTime(l.parameters[AMPLITUDE].value,a);l.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);t.stop(a+2*FADE_LENGTH)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function n(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),f=0;f<a.numberOfChannels;f++)for(var g=e.getChannelData(f),h=a.getChannelData(f),k=0;k<d;k++)g[k]=h[c+k];return e}function p(a,b,c,d){var e=a.lastIndexOf("/");e&&
(a=a.substring(e+1));u("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function u(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var l=this,v,q,r,t=b.createBufferSource();t.connect(this.getInput());(function(){var b=a.getSegment();b[0]||(b[0]=0);!b[1]&&c&&
(b[1]=c.duration-b[0]);if(a.hasParameter(DURATION_RATIO)){var d=a.getParameter(DURATION_RATIO).getValue();0<d&&1>d&&(b[1]*=d)}r=b[1];d=a.hasParameter(TIME_STRETCH_RATIO)?a.getParameter(TIME_STRETCH_RATIO).getValue():1;t.buffer=f(b,d)})();this.addParameter(PLAYBACK_RATE,t.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return r};this.isLoopingAndPlaying=function(){return t.loop&&v};this.play=function(a){t.onended=function(){t.disconnect();
l.removeAndDisconnect();g&&g(l)};a||(a=0);t.start(a);v=!0};this.pause=function(){v?(k(),q=!0):q&&(q=!1,this.play())};this.stop=function(){v&&k()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,g,f,h){function k(){w=t?t:l();m(w);if(!z){var a=w.keys().next().value;a.hasParameter(ONSET)&&(z=a.getParameter(ONSET).getValue())}a=x?x-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(w.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){f()},a);(t=l())&&0<t.size?(x=u(b),a=x[1],x=x[0],a.getDymo().hasParameter(LOOP)&&a.getDymo().getParameter(LOOP).getValue()&&(x-=FADE_LENGTH),a=1E3*(x-c.currentTime-SCHEDULE_AHEAD_TIME),
y=setTimeout(function(){k()},a)):(x=u(b),a=1E3*(x-c.currentTime),setTimeout(function(){p()},a+100))}function m(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,q.get(c)||q.set(c,[]),q.get(c).push(a.get(c))}function n(a){var b=q.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&q.delete(a.getDymo());f();p()}function p(){if(0==q.size&&(!t||0==t.size)){window.clearTimeout(y);b.reset();for(var c=a.getAllDymosInHierarchy(),d=0,e=c.length;d<e;d++){var f=r.get(c[d]);
f&&f.removeAndDisconnect()}h&&h()}}function u(a){if(t){var b=t.keys().next().value,c;b.hasParameter(ONSET)&&(c=b.getParameter(ONSET).getValue());b=c-z;z=c;if(!isNaN(c))return a+b}c=0;for(var d,b=$jscomp.makeIterator(w.values()),e=b.next();!e.done;e=b.next()){var e=e.value,f=e.getDuration();f>c&&(c=f,d=e)}return[a+c,d]}function l(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var f=new Map,w=0;w<a.length;w++)if(a[w].getSourcePath()){var h=
d[a[w].getSourcePath()],h=new DymoSource(a[w],c,h,e,g,n);v(h);f.set(a[w],h)}return f}}function v(a){var b=a;for(a=a.getDymo().getParent();a;){if(r.has(a)){b.connect(r.get(a).getInput());return}var d=new DymoNode(a,c,e,g);b.connect(d.getInput());r.set(a,d);a=a.getParent();b=d}b.connect(c.destination)}var q=new Map,r=new Map,t,y,w=[],x,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));k();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};
this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].stop();t&&(t.delete(a[b]),0>=t.size&&(t=void 0))}};this.getAllSources=function(){return q};this.getSources=function(a){return q.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();g[b]=a;g[b].addObserver(e)}var e=this,g={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,g);var f;this.addParameter=d;this.getParameter=function(a){return g[a]};this.startUpdate=function(){f=setInterval(b,g[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(f);f=null;c&&c()};this.observedParameterChanged=function(a){a==g[AUTO_CONTROL_FREQUENCY]?
f&&(this.reset(),this.startUpdate()):a==g[AUTO_CONTROL_TRIGGER]&&(f?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){l.loadData(a,!0,b)})}function d(a,b,c){loadFile(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(v)&&(a=a.replace(v,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(v)&&(f=v+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function g(b){var c=l.findFirstObjectUri(b,CDT),c=new DynamicMusicObject(b,c,a);c.setBasePath(v);r[b]=c;c.setSourcePath(l.findFirstObjectValue(b,HAS_SOURCE));for(var d=l.findAllObjectUris(b,HAS_FEATURE),e=0;e<d.length;e++)c.setFeature(l.findFirstObjectUri(d[e],TYPE),l.findFirstObjectValue(d[e],VALUE));d=l.findAllObjectUris(b,HAS_PARAMETER);for(e=0;e<d.length;e++)n(c,l.findFirstObjectUri(d[e],TYPE),l.findFirstObjectValue(d[e],VALUE));b=l.findParts(b);for(e=0;e<b.length;e++)c.addPart(g(b[e]));
return c}function f(a){for(var b=r[a],c=l.findAllObjectUris(a,HAS_SIMILAR),d=0;d<c.length;d++)b.addSimilar(r[c[d]]);c=l.findAllObjectUris(a,HAS_MAPPING);h(c);for(d=0;d<c.length;d++)b.addMapping(k(c[d],b));a=l.findParts(a);for(d=0;d<a.length;d++)f(a[d])}function h(a){for(var b=0;b<a.length;b++)for(var c=l.findAllObjectUris(a[b],HAS_DOMAIN_DIMENSION),d=0;d<c.length;d++){var e=l.findFirstObjectUri(c[d],TYPE),f=l.findFirstObjectValue(c[d],NAME);f||(f=c[d]);if(l.isSubclassOf(e,MOBILE_CONTROL)&&!q[c[d]]){var g=
c[d],h=e,e=void 0;h==ACCELEROMETER_X||h==ACCELEROMETER_Y||h==ACCELEROMETER_Z?e=new AccelerometerControl(h):h==TILT_X||h==TILT_Y?e=new TiltControl(h):h==GEOLOCATION_LATITUDE||h==GEOLOCATION_LONGITUDE?e=new GeolocationControl(h):h==GEOLOCATION_DISTANCE?e=new DistanceControl:h==COMPASS_HEADING?e=new CompassControl:h==BEACON?(e=l.findFirstObjectValue(g,HAS_UUID),f=l.findFirstObjectValue(g,HAS_MAJOR),h=l.findFirstObjectValue(g,HAS_MINOR),e=new BeaconControl(e,f,h)):h==SLIDER||h==TOGGLE||h==BUTTON||h==
CUSTOM_CONTROL?(e=new Control(f,h),f=l.findFirstObjectValue(g,HAS_INITIAL_VALUE),e.update(f)):h==RANDOM?e=new RandomControl:h==BROWNIAN?(f=l.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new BrownianControl(f)):h==RAMP&&(e=Math.round(1E3*l.findFirstObjectUri(g,HAS_DURATION)),f=l.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new RampControl(e,f));l.findFirstObjectValue(g,IS_SMOOTH)&&e.setSmooth&&e.setSmooth(!0);g=l.findFirstObjectValue(g,IS_AVERAGE_OF);!isNaN(g)&&e.setAverageOf&&e.setAverageOf(g);q[c[d]]=
e}}}function k(b,c){var d=l.findAllObjectUris(b,TO_TARGET);if(0<d.length){var e=[],f=l.findFunction(d[0]);if(f)d=Object.keys(r).map(function(a){return r[a]}),Array.prototype.push.apply(e,d.filter(f));else for(var g=0;g<d.length;g++)l.findFirstObjectUri(d[g],TYPE)==DYMO?e.push(r[d[g]]):e.push(q[d[g]]);return m(b,c,e,f)}return m(b,c,[a])}function m(a,b,c,d){for(var e=l.findFirstObjectUri(a,IS_RELATIVE),f=[],g=l.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),h=0;h<g.length;h++){var k=l.findFirstObjectUri(g[h],
TYPE),m=l.findFirstObjectValue(g[h],NAME);m||(m=g[h]);k==FEATURE_TYPE||l.isSubclassOf(k,FEATURE_TYPE)?f.push(m):k==PARAMETER_TYPE||l.isSubclassOf(k,PARAMETER_TYPE)?(k=b?n(b,m):new Parameter(m,0),f.push(k)):f.push(q[g[h]])}g=$jscomp.makeIterator(l.findArgsAndBody(l.findFirstObjectUri(a,HAS_FUNCTION)));b=g.next().value;g=g.next().value;a=l.findFirstObjectUri(a,HAS_RANGE);for(h=0;h<c.length;h++)c[h]instanceof DynamicMusicObject&&!c[h].getParameter(a)&&n(c[h],a);return new Mapping(f,e,{args:b,body:g},
c,a,d)}function n(a,b,c){var d=a.getParameter(b);d?d.update(c):(isNaN(c)&&(c=l.findFirstObjectValue(b,HAS_STANDARD_VALUE,null),isNaN(c)&&(c=0)),d=l.findFirstObjectValue(b,IS_INTEGER,null),d=new Parameter(b,c,d),a.addParameter(d));return d}function p(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}var u=this,l=new DymoStore(b),v="",q={},r={};this.setStore=function(a){l=a};this.getStore=function(){return l};this.loadDymoFromJson=function(a,b){var d=
a.lastIndexOf("/")+1;v=a.substring(0,d);c(a,function(){b(u.createDymoFromStore())})};this.parseDymoFromJson=function(a,b){l.loadData(a,!0,function(){b(u.createDymoFromStore())})};this.loadRenderingFromJson=function(a,b){c(a,function(){b(u.createRenderingFromStore())})};this.loadGraphFromJson=function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=r[CONTEXT_URI+"dymo"+c],f=r[CONTEXT_URI+"dymo"+a[c][d]];e&&f&&e.addSimilar(f)}b(void 0)})};this.createDymoFromStore=
function(){for(var a=[],b=l.findTopDymos(),c=0;c<b.length;c++)a.push(g(b[c])),f(b[c]);return[a,r]};this.createRenderingFromStore=function(){var a=l.findFirstSubjectUri(TYPE,RENDERING),b=new Rendering(r[l.findFirstObjectUri(a,HAS_DYMO)]),c=l.findAllObjectUris(a,HAS_MAPPING);h(c);for(var d=0;d<c.length;d++)b.addMapping(k(c[d]));if(a=l.findFirstObjectUri(a,HAS_NAVIGATOR))c=l.findFirstObjectUri(a,TO_DYMO),c=l.findFunction(c),b.addNavigator(p(l.findFirstObjectUri(a,TYPE)),c);return[b,q]}};function DymoStore(a){function b(a,b,d){g.triplesToRdf(a,function(a){c(a,b,d)})}function c(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,d){jsonld.frame(d,{"@id":b},function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context",function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context-simple",function(a,b){e(b);b=JSON.stringify(b,null,2);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");b=b.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");
...
HAS_FEATURE,b);if(c)return this.findAllObjectValues(c,VALUE)};this.findAllFeatureValues=function(a){var b=[];a=this.findAllObjectUris(a,HAS_FEATURE);for(var c=0;c<a.length;c++)b.push(this.findAllObjectValues(a[c],VALUE));return b};this.getLevel=function(a){var b=0;for(a=this.findParents(a)[0];a;)b++,a=this.findParents(a)[0];return b};this.getMaxLevel=function(){for(var a=this.findAllSubjectUris(TYPE,DYMO),b=0,c=0;c<a.length;c++)b=Math.max(b,this.getLevel(a[c]));return b};this.toJsonld=function(a){var b=
this.findTopDymos()[0];this.toRdf(function(d){c(d,b,a)})};this.toJsonGraph=function(a,b,c){var e={nodes:[],links:[]},n={},p=this.findAllSubjectUris(TYPE,a),u=this.find(null,b,null);async.map(p,d,function(d,v){e.nodes=v;for(var q=0;q<p.length;q++)n[p[q]]=e.nodes[q];e.links=[];for(q=0;q<u.length;q++)if(0==g.find(u[q].object,TYPE,a).length){if(0<g.find(u[q].object,FIRST).length){var r=g.findObjectListUris(u[q].subject,b),r=r.map(function(a){return{source:n[u[q].subject],target:n[a],value:1}});e.links=
e.links.concat(r)}}else e.links.push({source:n[u[q].subject],target:n[u[q].object],value:1});c(e)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a,b){function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeToJsonld=function(b,e){e||(e="dymo.json");a.toJsonld(function(a){c(b+e,a)})}};function EasyStore(){function a(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}function b(a){var b=c.findFirstObjectUri(a,FIRST);if(b){var d=[];d.push(b);for(a=c.findFirstObjectUri(a,REST);a!=NIL;)d.push(c.findFirstObjectUri(a,FIRST)),a=c.findFirstObjectUri(a,REST);return d}}var c=this,d=N3.Store();this.addTriple=function(a,b,c){return d.addTriple(a,b,c)};this.removeTriple=function(a,b,c){c||(c=this.findFirstObjectUri(a,b));return d.removeTriple(a,b,c)};this.createBlankNode=
function(){return d.createBlankNode()};this.addObjectToList=function(a,b,c){var d=this.findFirstObjectUri(a,b),k=this.createBlankNode();if(d){a=d;for(b=this.findFirstObjectUri(a,REST);b!=NIL;)a=b,b=this.findFirstObjectUri(a,REST);this.removeTriple(a,REST,NIL);this.addTriple(a,REST,k)}else this.addTriple(a,b,k);this.addTriple(k,FIRST,c);this.addTriple(k,REST,NIL)};this.loadData=function(b,c,f){a(b,c,function(a){N3.Parser().parse(a,function(a,b,c){b?d.addTriple(b):f&&f()})})};this.loadFileIntoStore=
function(a,b,d){loadFile(a,function(a){c.loadData(a,b,d)})};this.find=function(a,b,c){return d.find(a,b,c)};this.findFirstObjectUri=function(a,b){var c=d.find(a,b);if(0<c.length)return c[0].object};this.findFirstObjectUriOfType=function(a,b,c){a=d.find(a,b).map(function(a){return a.object});a=a.filter(function(a){return 0<d.find(a,TYPE,c).length});if(0<a.length)return a[0]};this.findFirstSubjectUri=function(a,b){var c=d.find(null,a,b);if(0<c.length)return c[0].subject};this.findFirstObjectValue=function(a,
b){var c=this.findFirstObjectUri(a,b);if(c){var d=N3.Util.getLiteralValue(c);"http://www.w3.org/2001/XMLSchema#string"!=N3.Util.getLiteralType(c)&&(d=Number(d));return d}};this.findAllSubjectUris=function(a,b){return d.find(null,a,b).map(function(a){return a.subject})};this.findAllObjectUris=function(a,c){for(var f=d.find(a,c,null).map(function(a){return a.object}),h=0;h<f.length;h++){var k=b(f[h]);k&&(f[h]=k)}return flattenArray(f)};this.findAllObjectValues=function(a,b){return this.findAllObjectUris(a,
b).map(function(a){return N3.Util.getLiteralValue(a)})};this.findObjectListUris=function(a,c){var d=this.findFirstObjectUri(a,c);return b(d)};this.findContainingLists=function(a){var b=[],c=[];a=this.findAllSubjectUris(FIRST,a);for(var d=0;d<a.length;d++){for(var k=a[d],m=this.findFirstSubjectUri(REST,k);m;)k=m,m=this.findFirstSubjectUri(REST,k);k=this.find(null,null,k)[0];b[d]=k.subject;c[d]=k.predicate}return[b,c]};this.recursiveFindAllTriplesExcept=function(a,b){for(var c=d.find(a,null,null),h=
[],k=c.length-1;0<=k;k--)0<d.find(c[k].object,TYPE,b).length?c.splice(k,1):h=h.concat(this.recursiveFindAllTriplesExcept(c[k].object,b));return c.concat(h)};this.isSubclassOf=function(a,b){for(var c=this.findFirstObjectUri(a,RDFS_URI+"subClassOf");c;){if(c==b)return!0;c=this.findFirstObjectUri(c,RDFS_URI+"subClassOf")}return!1};this.toRdf=function(a){var b=d.find(null,null,null);this.triplesToRdf(b,a)};this.triplesToRdf=function(a,b){for(var c=N3.Writer({format:"application/nquads"}),d=0;d<a.length;d++)c.addTriple(a[d]);
c.end(function(a,c){b(c)})};this.logData=function(){var a=d.find(null).map(function(a){return a.subject+"\n"+a.predicate+"\n"+a.object}),b;for(b in a)console.log(a[b])}};function Control(a,b,c){this.name=a;this.type=b;this.parameters=c;this.mappings=[]}Control.prototype.getName=function(){return this.name};Control.prototype.getParameter=function(a){if(this.parameters)return this.parameters[a]};Control.prototype.getValue=function(){return this.value};Control.prototype.getType=function(){return this.type};Control.prototype.setUpdateFunction=function(a){this.updateFunction=a};
...
this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};h(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);y&&(c.source=y);for(var d in l)c[d]=this.getFeatureJson(d);if(0<q.length)for(c.mappings=[],d=0;d<q.length;d++)c.mappings.push(q[d].toJson());0<p.length&&(c.parts=[]);if(0<u.length)for(c.similars=[],d=0;d<u.length;d++)c.similars.push(u[d].getUri());return c};this.getFeatureJson=function(a){return{value:l[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+
