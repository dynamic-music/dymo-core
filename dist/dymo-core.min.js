...
$jscomp.string.endsWith=function(a,b){$jscomp.string.noRegExp_(a,"endsWith");var c=this.toString();a+="";void 0===b&&(b=c.length);for(var d=Math.max(0,Math.min(b|0,c.length)),e=a.length;0<e&&0<d;)if(c[--d]!=a[--e])return!1;return 0>=e};$jscomp.string.endsWith$install=function(){String.prototype.endsWith||(String.prototype.endsWith=$jscomp.string.endsWith)};var SCHEDULE_AHEAD_TIME=.1,FADE_LENGTH=.02;var RDFS_URI="http://www.w3.org/2000/01/rdf-schema#",CONTEXT_URI="http://tiny.cc/dymo-context/",TYPE="http://www.w3.org/1999/02/22-rdf-syntax-ns#type",NAME="http://schema.org/name",CDT="http://tiny.cc/charm-ontology#cdt",ADT="http://tiny.cc/charm-ontology#adt",VALUE="http://tiny.cc/charm-ontology#value",HAS_PART="http://tiny.cc/charm-ontology#hasPart",DYMO="http://tiny.cc/dymo-ontology#Dymo",FEATURE="http://tiny.cc/dymo-ontology#Feature",PARAMETER="http://tiny.cc/dymo-ontology#Parameter",DYMO_TYPE=
"http://tiny.cc/dymo-ontology#DymoType",CONJUNCTION="http://tiny.cc/dymo-ontology#Conjunction",DISJUNCTION="http://tiny.cc/dymo-ontology#Disjunction",SEQUENCE="http://tiny.cc/dymo-ontology#Sequence",LEVEL_FEATURE="http://tiny.cc/dymo-ontology#LevelFeature",INDEX_FEATURE="http://tiny.cc/dymo-ontology#IndexFeature",ONSET_FEATURE="http://tiny.cc/dymo-ontology#OnsetFeature",AUDIO_PARAMETER="http://tiny.cc/dymo-ontology#AudioParameter",PLAY="http://tiny.cc/dymo-ontology#Play",LOOP="http://tiny.cc/dymo-ontology#Loop",
ONSET="http://tiny.cc/dymo-ontology#Onset",DURATION_RATIO="http://tiny.cc/dymo-ontology#DurationRatio",AMPLITUDE="http://tiny.cc/dymo-ontology#Amplitude",PLAYBACK_RATE="http://tiny.cc/dymo-ontology#PlaybackRate",TIME_STRETCH_RATIO="http://tiny.cc/dymo-ontology#TimeStretchRatio",PAN="http://tiny.cc/dymo-ontology#Pan",DISTANCE="http://tiny.cc/dymo-ontology#Distance",HEIGHT="http://tiny.cc/dymo-ontology#Height",REVERB="http://tiny.cc/dymo-ontology#Reverb",DELAY="http://tiny.cc/dymo-ontology#Delay",FILTER=
"http://tiny.cc/dymo-ontology#Filter",STRUCTURAL_PARAMETER="http://tiny.cc/dymo-ontology#StructuralParameter",PART_COUNT="http://tiny.cc/dymo-ontology#PartCount",PART_DURATION_RATIO="http://tiny.cc/dymo-ontology#PartDurationRatio",PART_PROPORTION="http://tiny.cc/dymo-ontology#PartProportion",NAVIGATOR="http://tiny.cc/dymo-ontology#Navigator",ONE_SHOT_NAVIGATOR="http://tiny.cc/dymo-ontology#OneShotNavigator",SEQUENTIAL_NAVIGATOR="http://tiny.cc/dymo-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR=
"http://tiny.cc/dymo-ontology#SimilarityNavigator",HAS_SOURCE="http://tiny.cc/dymo-ontology#hasSource",HAS_PARAMETER="http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_NAVIGATOR="http://tiny.cc/dymo-ontology#hasNavigator",HAS_SIMILAR="http://tiny.cc/dymo-ontology#hasSimilar",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",MAPPING="http://tiny.cc/mobile-audio-ontology#Mapping",FUNCTION="http://tiny.cc/mobile-audio-ontology#Function",MOBILE_CONTROL=
"http://tiny.cc/mobile-audio-ontology#MobileControl",SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",UI_CONTROL="http://tiny.cc/mobile-audio-ontology#UiControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",ACCELEROMETER_X="http://tiny.cc/mobile-audio-ontology#AccelerometerX",ACCELEROMETER_Y="http://tiny.cc/mobile-audio-ontology#AccelerometerY",ACCELEROMETER_Z="http://tiny.cc/mobile-audio-ontology#AccelerometerZ",TILT_X="http://tiny.cc/mobile-audio-ontology#TiltX",
...
TOGGLE="http://tiny.cc/mobile-audio-ontology#Toggle",BUTTON="http://tiny.cc/mobile-audio-ontology#Button",CUSTOM_CONTROL="http://tiny.cc/mobile-audio-ontology#CustomControl",RANDOM="http://tiny.cc/mobile-audio-ontology#Random",BROWNIAN="http://tiny.cc/mobile-audio-ontology#Brownian",RAMP="http://tiny.cc/mobile-audio-ontology#Ramp",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MOBILE_PARAMETER="http://tiny.cc/mobile-audio-ontology#MobileParameter",GLOBAL_PARAMETER="http://tiny.cc/mobile-audio-ontology#GlobalParameter",
CONTROL_PARAMETER="http://tiny.cc/mobile-audio-ontology#ControlParameter",LISTENER_ORIENTATION="http://tiny.cc/mobile-audio-ontology#ListenerOrientation",AUTO_CONTROL_FREQUENCY="http://tiny.cc/mobile-audio-ontology#AutoControlFrequency",AUTO_CONTROL_TRIGGER="http://tiny.cc/mobile-audio-ontology#AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE="http://tiny.cc/mobile-audio-ontology#BrownianMaxStepSize",LEAPING_PROBABILITY="http://tiny.cc/mobile-audio-ontology#LeapingProbability",CONTINUE_AFTER_LEAPING="http://tiny.cc/mobile-audio-ontology#ContinueAfterLeaping",
HAS_DYMO="http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING="http://tiny.cc/mobile-audio-ontology#hasMapping",HAS_DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#hasDomainDimension",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo",TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",TO_PARAMETER=
"http://tiny.cc/mobile-audio-ontology#toParameter",IS_RELATIVE="http://tiny.cc/mobile-audio-ontology#isRelative",HAS_INITIAL_VALUE="http://tiny.cc/mobile-audio-ontology#hasInitialValue",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration";function DymoManager(a,b,c,d){var e=new Scheduler(a,function(){});c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.setReverbFile(c);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g,l={},h={};this.loadDymoAndRendering=function(a,b,c,u){var p=new DymoLoader(e,function(){p.loadDymoFromJson(a,function(a){p.loadRenderingFromJson(b,a[1],function(b){f=p.getStore();g=b[0];g.dymo=a[0];for(var q in b[1]){var k=b[1][q];f.isSubclassOf(k.getType(),UI_CONTROL)&&(l[q]=new UIControl(k,d));f.isSubclassOf(k.getType(),
SENSOR_CONTROL)&&(h[q]=k)}e.loadBuffers(g.dymo,u);c&&c()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};this.replacePartOfTopDymo=function(a,b){var c=g.dymo.getPart(a);g.dymo.replacePart(a,b);e.stop(c)};this.updateNavigatorPosition=function(a,b,c){e.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=
function(a,b){return e.getNavigatorPosition(a,b)};this.syncNavigators=function(a,b,c){e.syncNavigators(a,b,c)};this.startPlaying=function(){g.dymo.updatePartOrder(ONSET);e.play(g.dymo)};this.stopPlaying=function(){e.stop(g.dymo)};this.getTopDymo=function(){return g.dymo};this.getRendering=function(){return g};this.getUIControls=function(){return l};this.getUIControl=function(a){return l[a]};this.getSensorControls=function(){return h}};function AudioProcessor(a){function b(a){return{extract:function(b,e,f){for(var g=[],l=0;l<a.numberOfChannels;l++)g.push(a.getChannelData(l));for(l=0;l<e;l++)for(var h=0;h<g.length;h++)b[l*g.length+h%g.length]=g[h][l+f];return Math.min(e,g[0].length-f)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;for(var f=b(c),e=new SimpleFilter(f,e),f=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate),g=[],l=0;l<c.numberOfChannels;l++)g.push(f.getChannelData(l));for(var h=
new Float32Array(2048),q=e.extract(h,1024),n=0;q;){for(l=0;l<q;l++)for(var r=0;r<g.length;r++)g[r][l+n]=h[l*g.length+r%g.length];n+=q;q=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),l=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(l,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=l[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b,c){function d(a){0<p&&p--;0==p&&(b&&b(p),a&&a())}function e(a){h.splice(h.indexOf(a),1)}function f(){for(var a=[],b=0;b<h.length;b++)for(var d=$jscomp.makeIterator(h[b].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();q=a;c&&c()}function g(b,c){p++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,
b)})};d.error=function(){};d.send()}var l={},h=[],q=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var n=a.createConvolver();n.connect(a.destination);var r=a.createDelay();r.delayTime.value=.5;r.connect(a.destination);var u=a.createGain();u.gain.value=.6;r.connect(u);u.connect(r);var p=0;this.setReverbFile=function(a){g(a,function(a){n.buffer=a;d()})};this.loadBuffers=function(a,b){for(var c=a.getAllSourcePaths(),e=0,f=c.length;e<f;e++)l[c[e]]||
g(c[e],function(a,c){l[c]=a;d(b)})};this.getBuffer=function(a){return l[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,m=0,
B=h.length;m<B;m++)h[m].hasDymo(a)&&(d=h[m].getNavigator()),h[m].hasDymo(b)&&(e=h[m].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,l,n,r,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSources(a);if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};
this.getUrisOfPlayingDymos=function(){return q};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e,f){function g(a,c){var d=b.createGain();d.connect(c);d.gain.value=0;a.connect(d);return d}function l(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=z||x<c.duration)c=u(c,r(z,c),r(x+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=x/d;c=u(c,0,r(d+FADE_LENGTH,c));x=d}else if(0!=z||x<c.duration)c=u(c,r(z,c),r(x+FADE_LENGTH,c));p(c,c.length);A.buffer=c;m[PLAYBACK_RATE]=A.playbackRate;h(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function h(a,b){q(a,
b.getValue());b.addObserver(y)}function q(a,b,c){c&&(b+=y.getParameterValue(a));0>b&&0<=C.indexOf(a)&&(b=0);m[a]&&(m[a].value||0==m[a].value?m[a].value=b:m[a].setValue(b));0<=H.indexOf(a)&&(0==m[DISTANCE].value&&(m[DISTANCE].value=-.01),F.setPosition(m[PAN].value,m[HEIGHT].value,m[DISTANCE].value))}function n(){k=!1;var a=b.currentTime;m[AMPLITUDE].setValueAtTime(m[AMPLITUDE].value,a);m[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);A.stop(a+2*FADE_LENGTH)}function r(a,b){if(a||0==a)return Math.round(a*
b.sampleRate)}function u(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),m=0;m<a.numberOfChannels;m++)for(var B=e.getChannelData(m),f=a.getChannelData(m),C=0;C<d;C++)B[C]=f[c+C];return e}function p(a,b){for(var c=a.sampleRate*FADE_LENGTH,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),m=0;m<c;m++)e[m]*=m/c,e[b-m-1]*=m/c}function v(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));w("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+
b+"&toSecond="+c,function(a){d(a)})}function w(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var y=this,k,t,m={},B=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],C=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],A=b.createBufferSource(),D=b.createGain();
D.connect(b.destination);var G=g(D,d);d=g(D,e);var F=b.createPanner();F.connect(D);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(F);A.connect(e);var E=a.getSegment(),z=E[0],x=E[1];z||(z=0);!x&&c&&(x=c.duration-z);E=a.getParameter(DURATION_RATIO).getValue();0<E&&1>E&&(x*=E);c?l():isNaN(z+x)||v(a.getSourcePath(),z,z+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=u(c,0,r(d+FADE_LENGTH,c)),x=d):
c=u(c,0,r(x+FADE_LENGTH,c));p(c,c.length);A.buffer=c});m[AMPLITUDE]=D.gain;m[TIME_STRETCH_RATIO]={value:0};m[REVERB]=G.gain;m[DELAY]=d.gain;m[FILTER]=e.frequency;m[PAN]={value:0};m[HEIGHT]={value:0};m[DISTANCE]={value:0};m[LOOP]={value:0};h(AMPLITUDE,a.getParameter(AMPLITUDE));h(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));h(REVERB,a.getParameter(REVERB));h(DELAY,a.getParameter(DELAY));h(FILTER,a.getParameter(FILTER));h(PAN,a.getParameter(PAN));h(HEIGHT,a.getParameter(HEIGHT));h(DISTANCE,
a.getParameter(DISTANCE));h(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){q(a.getName(),a.getChange(),!0)};this.getDymo=function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return A.loop&&k};this.getParameterValue=function(a){if(m[a])return m[a].value||0==m[a].value?m[a].value:m[a].getValue()};this.play=function(b){A.onended=function(){for(var b=0;b<B.length;b++){var c=a.getParameter(B[b]);c&&c.removeObserver(y)}A.disconnect();D.disconnect();
G.disconnect();f&&f(y)};b||(b=0);A.start(b);k=!0};this.pause=function(){k?(n(),t=!0):t&&(t=!1,this.play())};this.stop=function(){k&&n()}};function SchedulerThread(a,b,c,d,e,f,g,l){function h(){k=w?w:p();n(k);m||(m=k.keys().next().value.getParameter(ONSET).getValue());var a;a=t?t-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(k.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){g()},a);(w=p())&&0<w.size?(t=u(b),a=t[1],t=t[0],a.getDymo().getParameter(LOOP).getValue()&&(t-=FADE_LENGTH),a=1E3*(t-c.currentTime-SCHEDULE_AHEAD_TIME),y=setTimeout(function(){h()},a)):(t=u(b),a=1E3*
(t-c.currentTime),setTimeout(function(){q()},a+100))}function q(){0!=v.size||w&&0!=w.size||(window.clearTimeout(y),b.reset(),l&&l())}function n(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,v.get(c)||v.set(c,[]),v.get(c).push(a.get(c))}function r(a){var b=v.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&v.delete(a.getDymo());g();q()}function u(a){if(w){var b=w.keys().next().value.getParameter(ONSET).getValue(),c=b-m;m=b;if(!isNaN(b))return a+c}for(var b=
0,d,c=$jscomp.makeIterator(k.values()),e=c.next();!e.done;e=c.next()){var e=e.value,f;f=e;var g=f.getDymo().getParameter(PLAYBACK_RATE).getValue();f=f.getDuration()/g;f>b&&(b=f,d=e)}return[a+b,d]}function p(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var m=new Map,g=0;g<a.length;g++)if(a[g].getSourcePath()){var h=d[a[g].getSourcePath()];m.set(a[g],new Source(a[g],c,h,e,f,r))}return m}}var v=new Map,w,y,k=[],t,m;b||(b=new DymoNavigator(a,
...
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){k.loadData(a,!0,b)})}function d(a,b,c){w(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(t)&&(a=a.replace(t,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(t)&&(f=t+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function f(a){var b=g()[0],c=q(b,a);n(b,a);return[c,a]}function g(){var a=k.find(null,HAS_PART,null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function l(a){var b=$jscomp.makeIterator(h(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function h(a){var b=k.findAllObjectValues(a,HAS_ARGUMENT);
a=k.findFirstObjectValue(a,HAS_BODY);return[b,a]}function q(b,c){var d=k.findFirstObjectUri(b,CDT),d=new DynamicMusicObject(b,d,a);d.setBasePath(t);c[b]=d;d.setSourcePath(k.findFirstObjectValue(b,HAS_SOURCE));for(var e=k.findAllObjectUris(b,HAS_FEATURE),f=0;f<e.length;f++)d.setFeature(e[f],k.findFirstObjectUri(e[f],VALUE));e=k.findAllObjectUris(b,HAS_PARAMETER);for(f=0;f<e.length;f++)p(d,k.findFirstObjectUri(e[f],TYPE),k.findFirstObjectValue(e[f],VALUE));e=k.findAllObjectUris(b,HAS_PART);for(f=0;f<
e.length;f++)d.addPart(q(e[f],c));return d}function n(a,b){for(var c=b[a],d=k.findAllObjectUris(a,HAS_SIMILAR),e=0;e<d.length;e++)c.addSimilar(b[d[e]]);d=k.findAllObjectUris(a,HAS_MAPPING);for(e=0;e<d.length;e++)c.addMapping(r(d[e],b,c));c=k.findAllObjectUris(a,HAS_PART);for(e=0;e<c.length;e++)n(c[e],b)}function r(b,c,d,e){var f=k.findAllObjectUris(b,TO_TARGET),g=k.findAllObjectUris(b,TO_DYMO);if(0<f.length){for(var g=[],h=0;h<f.length;h++){var q=k.findFirstSubjectUri(NAME,f[h]);g.push(e[q])}return u(b,
c,d,g,e)}if(0<g.length){f=[];if(q=l(g[0]))h=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(f,h.filter(q));else for(h=0;h<g.length;h++)f.push(c[g[h]]);return u(b,c,d,f,e,q)}return u(b,c,d,[a],e)}function u(a,b,c,d,e,f){b=k.findFirstObjectUri(a,IS_RELATIVE);for(var g=[],q=k.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),l=0;l<q.length;l++){var r=k.findFirstObjectUri(q[l],TYPE),n=k.findFirstObjectValue(q[l],NAME);n||(n=q[l]);r==FEATURE?g.push(n):r==PARAMETER?(r=c?p(c,n,0):new Parameter(n,
0),g.push(r)):g.push(e[q[l]])}e=$jscomp.makeIterator(h(k.findFirstObjectUri(a,HAS_FUNCTION)));c=e.next().value;e=e.next().value;a=k.findFirstObjectUri(a,TO_PARAMETER);return new Mapping(g,b,{args:c,body:e},d,a,f)}function p(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function v(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function w(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};
c.error=function(a){console.log(a)};c.send()}function y(a,b,c){w(a,function(a){k.loadData(a,b,c)})}var k=new EasyStore,t="";(function(){y("http://tiny.cc/dymo-ontology",!1,function(){y("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;t=a.substring(0,d);c(a,function(){b(f({}))})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(f({}))})};this.loadRenderingFromJson=function(a,
b,d){b||(b={});c(a,function(){for(var a=b,c=k.findFirstSubjectUri(TYPE,RENDERING),e=new Rendering(a[k.findFirstObjectUri(c,HAS_DYMO)]),f=k.findAllObjectUris(c,HAS_MAPPING),m={},g=0;g<f.length;g++)for(var h=k.findAllObjectUris(f[g],HAS_DOMAIN_DIMENSION),q=0;q<h.length;q++){var n=k.findFirstObjectUri(h[q],TYPE),u=k.findFirstObjectValue(h[q],NAME);u||(u=h[q]);if(k.isSubclassOf(n,MOBILE_CONTROL)&&!m[h[q]]){var t;t=h[q];var p=n,n=void 0;p==ACCELEROMETER_X||p==ACCELEROMETER_Y||p==ACCELEROMETER_Z?n=new AccelerometerControl(p):
p==TILT_X||p==TILT_Y?n=new TiltControl(p):p==GEOLOCATION_LATITUDE||p==GEOLOCATION_LONGITUDE?n=new GeolocationControl(p):p==GEOLOCATION_DISTANCE?n=new DistanceControl:p==COMPASS_HEADING?n=new CompassControl:p==BEACON?(u=k.findFirstObjectValue(t,HAS_UUID),n=k.findFirstObjectValue(t,HAS_MAJOR),p=k.findFirstObjectValue(t,HAS_MINOR),n=new BeaconControl(u,n,p)):p==SLIDER||p==TOGGLE||p==BUTTON||p==CUSTOM_CONTROL?n=new Control(u,p):p==RANDOM?n=new RandomControl:p==BROWNIAN?(u=k.findFirstObjectValue(t,HAS_INITIAL_VALUE),
n=new BrownianControl(u)):p==RAMP&&(n=Math.round(1E3*k.findFirstObjectUri(t,HAS_DURATION)),u=k.findFirstObjectValue(t,HAS_INITIAL_VALUE),n=new RampControl(n,u));k.findFirstObjectUri(t,IS_SMOOTH)&&n.setSmooth&&n.setSmooth(!0);t=Number(k.findFirstObjectUri(t,IS_AVERAGE_OF));!isNaN(t)&&n.setAverageOf&&n.setAverageOf(t);t=n;u=Number(k.findFirstObjectUri(h[q],VALUE));isNaN(u)||t.update(u);m[h[q]]=t}}for(g=0;g<f.length;g++)e.addMapping(r(f[g],a,void 0,m));if(a=k.findFirstObjectUri(c,HAS_NAVIGATOR))c=k.findFirstObjectUri(a,
TO_DYMO),c=l(c),e.addNavigator(v(k.findFirstObjectUri(a,TYPE)),c);d([e,m])})};this.loadGraphFromJson=function(a,b,c){d(a,"",function(a){for(var d=0;d<a.length;d++)if(a[d])for(var e=0;e<a[d].length;e++){var f=b[CONTEXT_URI+"dymo"+d],m=b[CONTEXT_URI+"dymo"+a[d][e]];f&&m&&f.addSimilar(m)}c(void 0)})}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
...
b.getParts()[c],d)}function l(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)l(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var q=this,n=null,r=[],u=[],p={},v={},w=[],y=[],k="",t;v[PLAY]=new Parameter(PLAY,0,!0);v[LOOP]=new Parameter(LOOP,0,!0);
...
this.addPart=function(a){r.push(a);a.setParent(this)};this.removePart=function(a){r.splice(r.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){r[a]&&r[a].removeParent(this);r[a]=b;b.setParent(this)};this.getPart=function(a){return r[a]};this.getParts=function(){return r};this.hasParts=function(){return 0<r.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){k=a};this.getBasePath=function(){return n&&!k?n.getBasePath():k};this.setSourcePath=function(a){t=
a};this.getSourcePath=function(){if(n&&!t)return n.getSourcePath();if(t)return this.getBasePath()+t};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){u.push(a)};this.getSimilars=function(a){return u};this.getFeatures=function(){return p};this.setFeature=function(a,b){p[a]=b};this.getFeature=function(a){if(a===
LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(p.hasOwnProperty(a))return p[a];if(n)return n.getFeature(a);for(var b=[],c=0;c<r.length;c++)if(r[c]){var d=r[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(p[a])return p[a]};this.getMappings=function(){return w};this.getSegment=function(){return[this.getFeature("time"),this.getFeature("duration")]};this.addParameter=function(a){v[a.getName()]=
a};this.getParameter=function(a){return v[a]};this.addMapping=function(a){w.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(q):c.stop(q))};this.updatePartOrder=function(a){r&&r[0]&&!isNaN(r[0].getFeature(a))?r.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):r&&r.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=function(){for(var a=this.toFlatJson(),b=0;b<r.length;b++)a.parts.push(r[b].toJsonHierarchy());
return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};l(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);t&&(c.source=t);for(var d in p)c[d]=this.getFeatureJson(d);if(0<w.length)for(c.mappings=[],d=0;d<w.length;d++)c.mappings.push(w[d].toJson());0<r.length&&(c.parts=[]);if(0<u.length)for(c.similars=[],d=0;d<u.length;d++)c.similars.push(u[d].getUri());return c};
this.getFeatureJson=function(a){return{value:p[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
...
e,f,g,l,h,q,n;l=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*l,h=e*l,f=2*e,q=f+a,n=f+d,c[n+0]=b[q+0]*h+this.pMidBuffer[f+0]*g,c[n+1]=b[q+1]*h+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
