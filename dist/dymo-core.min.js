...
g.push(k):l==PARAMETER?(k=c?p(c,k,0):new Parameter(k,0),g.push(k)):(n=e&&e[k]?e[k]:u(n),e&&!e[k]&&(e[k]=n),g.push(n))}return new Mapping(g,b,a["function"],d,a.parameter,f)}function p(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function l(a,b){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=b["dymo"+c],f=b["dymo"+a[c][d]];e&&f&&e.addSimilar(f)}}function u(a){var c=a.type,d=a.name;if(c==ACCELEROMETER_X)return q(0);if(c==ACCELEROMETER_Y)return q(1);
if(c==ACCELEROMETER_Z)return q(2);if(c==TILT_X)return q(3);if(c==TILT_Y)return q(4);if(c==GEOLOCATION_LATITUDE)return r(0);if(c==GEOLOCATION_LONGITUDE)return r(1);if(c==GEOLOCATION_DISTANCE)return r(2);if(c==COMPASS_HEADING)return b.compassWatcher||(b.compassWatcher=new CompassWatcher),a=b.compassWatcher.headingControl,a;if(c==SLIDER||c==TOGGLE||c==BUTTON||c==CUSTOM)return new Control(d,c);if(c==RANDOM)return new RandomControl;if(c==BROWNIAN)return new BrownianControl(parseFloat(a.value));if(c==RAMP)return c=
Math.round(1E3*parseFloat(a.duration)),new RampControl(c,parseFloat(a.value))}function q(a){b.accelerometerWatcher||(b.accelerometerWatcher=new AccelerometerWatcher);if(0==a)return b.accelerometerWatcher.xControl;if(1==a)return b.accelerometerWatcher.yControl;if(2==a)return b.accelerometerWatcher.zControl;if(3==a)return b.accelerometerWatcher.tiltXControl;if(4==a)return b.accelerometerWatcher.tiltYControl}function r(a){b.geolocationWatcher||(b.geolocationWatcher=new GeolocationWatcher);return 0==
