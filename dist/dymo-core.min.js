...
$jscomp.inherits=function(a,b){function c(){}c.prototype=b.prototype;a.prototype=new c;a.prototype.constructor=a;for(var d in b)if(Object.defineProperties){var e=Object.getOwnPropertyDescriptor(b,d);e&&Object.defineProperty(a,d,e)}else a[d]=b[d]};$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var k=a[e];if(b.call(c,k,e,a))return{i:e,v:k}}return{i:-1,v:void 0}};
$jscomp.polyfill=function(a,b,c,d){if(b){c=$jscomp.global;a=a.split(".");for(d=0;d<a.length-1;d++){var e=a[d];e in c||(c[e]={});c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&$jscomp.defineProperty(c,a,{configurable:!0,writable:!0,value:b})}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6-impl","es3");
$jscomp.polyfill("Array.from",function(a){return a?a:function(a,c,d){$jscomp.initSymbolIterator();c=null!=c?c:function(a){return a};var b=[],k=a[Symbol.iterator];if("function"==typeof k)for(a=k.call(a);!(k=a.next()).done;)b.push(c.call(d,k.value));else for(var k=a.length,h=0;h<k;h++)b.push(c.call(d,a[h]));return b}},"es6-impl","es3");$jscomp.array=$jscomp.array||{};
...
c("seal");var e=0,k=function(a){this.id_=(e+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};k.prototype.set=function(a,c){b(a);if(!$jscomp.owns(a,d))throw Error("WeakMap key fail: "+a);a[d][this.id_]=c;return this};k.prototype.get=function(a){return $jscomp.owns(a,d)?a[d][this.id_]:void 0};k.prototype.has=function(a){return $jscomp.owns(a,d)&&$jscomp.owns(a[d],this.id_)};k.prototype.delete=
...
$jscomp.initSymbolIterator();var b=new WeakMap,c=function(a){this.data_={};this.head_=k();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};c.prototype.set=function(a,b){var c=d(this,a);c.list||(c.list=this.data_[c.id]=[]);c.entry?c.entry.value=b:(c.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,value:b},c.list.push(c.entry),this.head_.previous.next=c.entry,this.head_.previous=c.entry,this.size++);return this};c.prototype.delete=
...
a.value]})};c.prototype.keys=function(){return e(this,function(a){return a.key})};c.prototype.values=function(){return e(this,function(a){return a.value})};c.prototype.forEach=function(a,b){for(var c=this.entries(),f;!(f=c.next()).done;)f=f.value,a.call(b,f[1],f[0],this)};c.prototype[Symbol.iterator]=c.prototype.entries;var d=function(a,c){var d;d=c&&typeof c;"object"==d||"function"==d?b.has(c)?d=b.get(c):(d=""+ ++h,b.set(c,d)):d="p_"+c;var f=a.data_[d];if(f&&$jscomp.owns(a.data_,d))for(a=0;a<f.length;a++){var g=
f[a];if(c!==c&&g.key!==g.key||c===g.key)return{id:d,list:f,index:a,entry:g}}return{id:d,list:f,index:-1,entry:void 0}},e=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},k=function(){var a={};return a.previous=a.next=a.head=a},h=0;return c},"es6-impl","es3");
$jscomp.polyfill("Array.prototype.values",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a,c){return c})}},"es6","es3");$jscomp.EXPOSE_ASYNC_EXECUTOR=!0;$jscomp.FORCE_POLYFILL_PROMISE=!1;
...
a[b]=null;this.onSettledCallbacks_=null}};var e=new b;d.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};d.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(g){c.reject(g)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{g(a(b))}catch(u){e(u)}}:b}var g,e,f=new d(function(a,b){g=a;e=b});this.callWhenSettled_(c(a,g),
c(b,e));return f};d.prototype.catch=function(a){return this.then(void 0,a)};d.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?e.asyncExecute(c):this.onSettledCallbacks_.push(function(){e.asyncExecute(c)})};d.resolve=function(a){return a instanceof d?a:new d(function(b,c){b(a)})};d.reject=function(a){return new d(function(b,c){c(a)})};
d.race=function(a){return new d(function(b,c){for(var g=$jscomp.makeIterator(a),e=g.next();!e.done;e=g.next())d.resolve(e.value).callWhenSettled_(b,c)})};d.all=function(a){var b=$jscomp.makeIterator(a),c=b.next();return c.done?d.resolve([]):new d(function(a,e){function f(b){return function(c){g[b]=c;m--;0==m&&a(g)}}var g=[],m=0;do g.push(void 0),m++,d.resolve(c.value).callWhenSettled_(f(g.length-1),e),c=b.next();while(!c.done)})};$jscomp.EXPOSE_ASYNC_EXECUTOR&&(d.$jscomp$new$AsyncExecutor=function(){return new b});
...
function DymoManager(a,b,c,d,e,k,h){function l(a,b,c,e){p=b;f=c[0];q=a.getMappings();for(var h in c[1])a=c[1][h],DYMO_STORE.isSubclassOf(a.getType(),UI_CONTROL)&&(n[h]=new UIControl(a,k)),DYMO_STORE.isSubclassOf(a.getType(),SENSOR_CONTROL)&&(m[h]=a);d||(d="bower_components/dymo-core/audio/impulse_rev.wav");g.init(d,b,e)}DYMO_STORE=new DymoStore(e);var g=new Scheduler(a,h);c&&(OPTIMIZED_MODE=!0);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var p,f,n={},m={},q={};this.loadDymoAndRenderingFromStore=function(a,
b){DYMO_STORE=a;a=new DymoLoader(DYMO_STORE);l(a,a.createDymoFromStore(),a.createRenderingFromStore(),b)};this.loadDymoAndRendering=function(a,b,c,f){var d=new DymoLoader(DYMO_STORE);d.loadDymoFromJson(a,function(a){d.loadRenderingFromJson(b,function(b){l(d,a,b,f);c&&c()})})};this.loadDymoFromJson=function(a,b){(new DymoLoader(DYMO_STORE)).loadDymoFromJson(a,b)};this.parseDymoFromJson=function(a,b){(new DymoLoader(DYMO_STORE)).parseDymoFromJson(a,b)};this.replacePartOfTopDymo=function(a,b){a=DYMO_STORE.replacePartAt(p[0],
b,a);g.stop(a)};this.updateNavigatorPosition=function(a,b,c){g.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return g.getNavigatorPosition(a,b)};this.syncNavigators=function(a,b,c){g.syncNavigators(a,b,c)};this.startPlayingUri=function(a){g.play(a)};this.stopPlayingUri=function(a){g.stop(a)};this.startPlaying=function(){for(var a=0;a<p.length;a++)DYMO_STORE.updatePartOrder(p[a],ONSET),g.play(p[a],f.getNavigator())};this.stopPlaying=function(){for(var a=0;a<p.length;a++)g.stop(p[a])};
this.getStore=function(){return DYMO_STORE};this.getTopDymo=function(){return p[0]};this.getRendering=function(){return f};this.getMappings=function(){return q};this.getUIControls=function(){return n};this.getUIControl=function(a){return n[a]};this.getSensorControls=function(){return m}};function DymoNode(a,b,c,d){this.POSITION_PARAMS=[PAN,HEIGHT,DISTANCE];this.dymoUri=a;this.parameters={};this.init(b,c,d)}
...
DymoNode.prototype.removeAndDisconnect=function(){for(var a in this.parameters)DYMO_STORE.removeParameterObserver(this.dymoUri,a,this);this.dryGain.disconnect();this.reverbGain&&this.reverbGain.disconnect();this.delayGain&&this.delayGain.disconnect()};function AudioProcessor(a){function b(a){return{extract:function(b,c,k){for(var d=[],e=0;e<a.numberOfChannels;e++)d.push(a.getChannelData(e));for(e=0;e<c;e++)for(var g=0;g<d.length;g++)b[e*d.length+g%d.length]=d[g][e+k];return Math.min(c,d[0].length-k)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;var k=b(c),e=new SimpleFilter(k,e);d=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate);for(var k=[],h=0;h<c.numberOfChannels;h++)k.push(d.getChannelData(h));c=
new Float32Array(2048);for(var l=e.extract(c,1024),g=0;l;){for(h=0;h<l;h++)for(var p=0;p<k.length;p++)k[p][h+g]=c[h*k.length+p%k.length];g+=l;l=e.extract(c,1024)}return d}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var k=new SimpleFilter({extract:function(a,c,f){for(var d=[],g=0;g<b.numberOfChannels;g++)d.push(b.getChannelData(g));for(g=0;g<c;g++)for(var e=0;e<d.length;e++)a[g*d.length+e%d.length]=d[e][g+f];return Math.min(c,d[0].length-f)}},e),h=a.createScriptProcessor(1024,
2,b.numberOfChannels),l=new Float32Array(2048);h.onaudioprocess=function(a){for(var c=[],f=0;f<b.numberOfChannels;f++)c.push(a.outputBuffer.getChannelData(f));a=k.extract(l,1024);0==a&&d.stop();for(f=0;f<a;f++)for(var g=0;g<c.length;g++)c[g][f]=l[f*c.length+g%c.length]};this.start=function(a){setTimeout(function(){h.connect(c)},a)};this.stop=function(){h.disconnect()}};function Scheduler(a,b){function c(a,b){for(var c=[],f=0,d=a.length;f<d;f++)var g=DYMO_STORE.findAllObjectsInHierarchy(a[f]),c=c.concat(g.map(function(a){return DYMO_STORE.getSourcePath(a)}));f=0;for(d=c.length;f<d;f++)c[f]&&!l[c[f]]&&k(c[f],function(a,c){l[c]=a;0<n&&n--;0==n&&b&&b()});0==n&&b&&b()}function d(a){g.splice(g.indexOf(a),1)}function e(a){OPTIMIZED_MODE||(a=Array.from(a.getAllSources().keys()),a=flattenArray(a.map(function(a){return DYMO_STORE.findAllParents(a)})),a=removeDuplicates(a),
a.sort(),p=a,b&&b(p))}function k(b,c){n++;var f=new XMLHttpRequest;f.open("GET",b,!0);f.responseType="arraybuffer";f.onload=function(){a.decodeAudioData(f.response,function(a){c(a,b)})};f.error=function(){};f.send()}var h=this,l={},g=[],p=[],f,n=0;this.init=function(b,d,g){DYMO_STORE.addParameter(null,LISTENER_ORIENTATION,0,h);c(d,g);b&&0<DYMO_STORE.find(null,null,REVERB).length&&(f=a.createConvolver(),f.connect(a.destination),k(b,function(a){f.buffer=a;0<n&&n--;0==n&&g&&g()}));0<DYMO_STORE.find(null,
null,DELAY).length&&(b=a.createDelay(),b.delayTime.value=.5,b.connect(a.destination),d=a.createGain(),d.gain.value=.6,b.connect(d),d.connect(b));DYMO_STORE.addTypeObserver(PLAY,VALUE,h)};this.getBuffer=function(a){return l[DYMO_STORE.getSourcePath(a)]};this.updateNavigatorPosition=function(a,b,c){for(var f=0,d=g.length;f<d;f++)g[f].hasDymo(a)&&g[f].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,f=g.length;c<f;c++)if(g[c].hasDymo(a))return g[c].getNavigator().getPosition(b,
a)};this.syncNavigators=function(a,b,c){for(var f,d,n=0,e=g.length;n<e;n++)g[n].hasDymo(a)&&(f=g[n].getNavigator()),g[n].hasDymo(b)&&(d=g[n].getNavigator());d&&(b=d.getPosition(c,b),f.setPosition(b,c,a))};this.play=function(b,c){b=new SchedulerThread(b,c,a,l,f,void 0,e,d);g.push(b)};this.pause=function(a){if(a)for(var b=0;b<g.length;b++)g[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<g.length;b++)g[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<g.length;c++){var f=g[c].getSources(a);
if(f)for(var d=0;d<f.length;d++)b=b.concat(f)}return b};this.getUrisOfPlayingDymos=function(){return p};this.observedValueChanged=function(b,c,f){c==LISTENER_ORIENTATION?(f=f/180*Math.PI,a.listener.setOrientation(Math.sin(f),0,-Math.cos(f),0,1,0)):c==PLAY&&(b=DYMO_STORE.findSubject(HAS_PARAMETER,b),0<f?this.play(b):this.stop(b))}};function DymoSource(a,b,c,d,e,k){function h(b,d){var g=b[0],e=b[1],e=1!=d?e+.3:e+FADE_LENGTH;if(c||isNaN(g+e)){if(0!=g||e<c.duration)c=f(c,p(g,c),p(e,c));return l(c,e,d)}n(DYMO_STORE.getSourcePath(a),g,g+e,function(a){return l(a,e,d)})}function l(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=f(a,0,p(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var g=c.sampleRate*FADE_LENGTH,n=0;n<c.numberOfChannels;n++)for(var e=c.getChannelData(n),m=0;m<g;m++)e[m]*=m/g,e[d-m-1]*=m/g;return a}function g(){u=
!1;var a=b.currentTime;q.parameters[AMPLITUDE].setValueAtTime(q.parameters[AMPLITUDE].value,a);q.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);r.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function f(a,c,f){f=Math.min(a.length-c,f);for(var d=b.createBuffer(a.numberOfChannels,f,a.sampleRate),g=0;g<a.numberOfChannels;g++)for(var n=d.getChannelData(g),e=a.getChannelData(g),m=0;m<f;m++)n[m]=e[c+m];return d}function n(a,b,c,f){var d=a.lastIndexOf("/");
d&&(a=a.substring(d+1));m("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){f(a)})}function m(a,c){var f=new XMLHttpRequest;f.open("GET",a,!0);f.responseType="arraybuffer";f.onload=function(){b.decodeAudioData(f.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};f.send()}DymoNode.call(this,a,b,d,e);var q=this,u,v,w,r=b.createBufferSource();r.connect(this.getInput());(function(){var b=[DYMO_STORE.findFeatureValue(a,TIME_FEATURE),
DYMO_STORE.findFeatureValue(a,DURATION_FEATURE)];b[0]||(b[0]=0);!b[1]&&c&&(b[1]=c.duration-b[0]);var f=DYMO_STORE.findParameterValue(a,DURATION_RATIO);f&&0<f&&1>f&&(b[1]*=f);w=b[1];f=DYMO_STORE.findParameterValue(a,TIME_STRETCH_RATIO);r.buffer=h(b,f?f:1)})();this.addParameter(PLAYBACK_RATE,r.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return w};this.isLoopingAndPlaying=function(){return r.loop&&u};this.play=function(b){r.onended=
function(){r.disconnect();q.removeAndDisconnect();k&&k(q)};b||(b=0);DYMO_STORE.findParameterValue(a,LOOP)&&(r.loop=!0);r.start(b);u=!0};this.pause=function(){u?(g(),v=!0):v&&(v=!1,this.play())};this.stop=function(){u&&g()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,k,h,l){function g(){var a=y;y=x?x:q();p(y);if(!z){var b=y.keys().next().value;z=DYMO_STORE.findParameterValue(b,ONSET)}b=t?t-c.currentTime:SCHEDULE_AHEAD_TIME;for(var f=c.currentTime+b,d=$jscomp.makeIterator(y.values()),e=d.next();!e.done;e=d.next())e=e.value,e.play(f);a=$jscomp.makeIterator(a.values());for(e=a.next();!e.done;e=a.next())e=e.value,DYMO_STORE.findParameterValue(e.getDymoUri(),LOOP)&&e.stop();setTimeout(function(){h(v)},b);(x=q())&&0<x.size?(t=m(f),
a=t[1],t=t[0],DYMO_STORE.findParameterValue(a.getDymoUri(),LOOP)&&(t-=FADE_LENGTH),a=1E3*(t-c.currentTime-SCHEDULE_AHEAD_TIME),A=setTimeout(function(){g()},a)):(t=m(f),a=1E3*(t-c.currentTime),setTimeout(function(){n()},a+100))}function p(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,w.get(c)||w.set(c,[]),w.get(c).push(a.get(c))}function f(a){var b=w.get(a.getDymoUri());b.splice(b.indexOf(a),1);0>=b.length&&w.delete(a.getDymoUri());h(v);n()}function n(){if(0==
w.size&&(!x||0==x.size)){window.clearTimeout(A);b.reset();for(var c=DYMO_STORE.findAllObjectsInHierarchy(a),f=0,d=c.length;f<d;f++){var g=r.get(c[f]);g&&g.removeAndDisconnect()}l&&l()}}function m(a){if(x){var b=x.keys().next().value,b=DYMO_STORE.findParameterValue(b,ONSET),c=b-z;z=b;if(!isNaN(b))return a+c}for(var b=0,f,c=$jscomp.makeIterator(y.values()),d=c.next();!d.done;d=c.next()){var d=d.value,g=d.getDuration();g>b&&(b=g,f=d)}return[a+b,f]}function q(){var a=b.getNextParts();if(a){u(a);for(var g=
new Map,n=0;n<a.length;n++){var m=DYMO_STORE.getSourcePath(a[n]);if(m){m=new DymoSource(a[n],c,d[m],e,k,f);a:{for(var p=m,h=DYMO_STORE.findParents(m.getDymoUri())[0];h;){if(r.has(h)){p.connect(r.get(h).getInput());break a}var q=new DymoNode(h,c,e,k);p.connect(q.getInput());r.set(h,q);h=DYMO_STORE.findParents(h)[0];p=q}p.connect(c.destination)}g.set(a[n],m)}}return g}}function u(a){console.log(a.map(function(a){a=DYMO_STORE.findPartIndex(a);return isNaN(a)?"top":a}))}var v=this,w=new Map,r=new Map,
x,A,y=new Map,t,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));g();this.hasDymo=function(b){if(DYMO_STORE.findAllObjectsInHierarchy(a).indexOf(b))return!0};this.getNavigator=function(){return b};this.stop=function(a){a=DYMO_STORE.findAllObjectsInHierarchy(a);for(var b=0,c=a.length;b<c;b++){var f=w.get(a[b]);if(f)for(var d=0;d<f.length;d++)f[d].stop();x&&(x.delete(a[b]),0>=x.size&&(x=void 0))}};this.getAllSources=function(){return w};this.getSources=function(a){return w.get(a)}};var AutoControl=function(a,b,c){Control.call(this,a,b,AUTO_CONTROL);c||(c=100);DYMO_STORE.addParameter(a,AUTO_CONTROL_FREQUENCY,c,this);DYMO_STORE.addParameter(a,AUTO_CONTROL_TRIGGER,0,this);this.intervalID=null};$jscomp.inherits(AutoControl,Control);AutoControl.prototype.startUpdate=function(a){var b=this;a||(a=DYMO_STORE.findParameterValue(this.uri,AUTO_CONTROL_FREQUENCY));this.intervalID=setInterval(function(){return b.update()},a)};AutoControl.prototype.update=function(){};
AutoControl.prototype.reset=function(){clearInterval(this.intervalID);this.intervalID=null};AutoControl.prototype.observedValueChanged=function(a,b,c){b==AUTO_CONTROL_FREQUENCY?this.intervalID&&(this.reset(),this.startUpdate(c)):b==AUTO_CONTROL_TRIGGER&&(!this.intervalID&&0<c?this.startUpdate():this.intervalID&&0==c&&this.reset())};var DataControl=function(a,b,c,d){d||(d=1001);AutoControl.call(this,a,DATA_CONTROL,d);this.url=b;this.jsonMap=c};$jscomp.inherits(DataControl,AutoControl);DataControl.prototype.update=function(){var a=this;fetch(this.url).then(function(a){return a.json()}).then(function(b){return a.jsonMap(b)}).then(function(b){console.log("data received:",b);a.updateValue(b)})};function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(d){a.getType()==TOGGLE?c.value=1==d?!0:!1:c.value=d;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.updateValue(1):0==this.value?a.updateValue(0):a.updateValue(this.value)}};function DymoGenerator(a,b){function c(b,c,f){var g=d();a.addDymo(g,b,null,c,f);b||(m=g);return g}function d(){var a=CONTEXT_URI+"dymo"+x;x++;return a}function e(a){var b=[];if(a&&0<a.length){for(var c=0;c<a.length;c++)a[c].value&&a[c].value.constructor!==Array&&(a[c].value=[a[c].value]);for(var c=a[0].value.length,f=0;f<c;f++)if("string"==typeof a[0].value[f])b[f]=a[0].value[f];else if(w==SUMMARY.FIRST)b[f]=a[0].value[f];else if(w==SUMMARY.MEAN)b[f]=a.reduce(function(a,b){return a+b.value[f]},0)/
a.length;else if(w==SUMMARY.MEDIAN){a.sort(function(a,b){return a.value[f]-b.value[f]});var d=Math.floor(a.length/2);b[f]=a[d].value[f];0==a.length%2&&(b[f]+=a[d-1].value[f])}return 1==b.length?b[0]:b}return 0}function k(){0==x?m=c(void 0,r):u&&(m=c(n,r),u=!1)}function h(b,c,f){f||(f=m);var d=f;for(f=a.findLevel(f);f<c;){var g=a.findParts(d);if(0<g.length){g=g.map(function(b){return[a.findFeatureValue(b,TIME_FEATURE),b]});g.sort(function(a,b){return a[0]-b[0]});for(var e=0;e<g.length;e++)if(g[e][0]<=
b)d=g[e][1];else if(0==e)d=g[e][1];else break;f++}else break}return d}function l(a,b){void 0==a.max?(a.min=b,a.max=b):(a.min=Math.min(b,a.min),a.max=Math.max(b,a.max))}function g(a,b){for(var c=0;c<v.length;c++)if(v[c].name==a||v[c].uri==b)return v[c];return p(a,b)}function p(c,f,d,g){!c&&f&&(c=URI_TO_TERM[f]);c&&!f&&(f=CONTEXT_URI+c);c=void 0!=d&&void 0!=g?{name:c,uri:f,min:d,max:g}:{name:c,uri:f,min:1E3,max:0};2>v.length?v.push(c):v.splice(v.length-2,0,c);a.findObject(f,TYPE)||a.addTriple(f,TYPE,
FEATURE_TYPE);b(c);return c}var f=this,n,m,q,u,v,w=SUMMARY.MEAN,r,x=0;this.resetDymo=function(){m=n=void 0;u=!1;v=[];p("level",LEVEL_FEATURE);p("random",null,0,1)};this.setStore=function(b){a=b};this.getStore=function(){return a};this.addRendering=function(){var b=CONTEXT_URI+"rendering0";b++;q=b;a.addRendering(q,m)};this.addMapping=function(b,c,f,d){a.addMapping(b,c,f,d)};this.addNavigator=function(b,c,f){a.addNavigator(q,b,c,f)};this.getCurrentTopDymo=function(){return m};this.getFeatures=function(){return v};
this.setSummarizingMode=function(a){w=a};this.setCurrentSourcePath=function(a){r=a};this.setAudioFileChanged=function(){u=!0;if(m){var b=d();a.addDymo(b,null,m);m=b}};this.addDymo=function(a,b,f){return c(a,b,f)};this.addFeature=function(b,c,f){f||(f=m);Benchmarker.startTask("addFeature");k();b=g(b);f=a.findAllObjectsInHierarchy(f);for(var d=0;d<f.length;d++){var n=a.findFeatureValue(f[d],TIME_FEATURE),p=a.findFeatureValue(f[d],DURATION_FEATURE),h=c;isNaN(n)||(h=h.filter(function(a){return n<=a.time&&
(isNaN(p)||a.time<n+p)}));if(1>h.length)var q=c.filter(function(a){return a.time.value<=n}),h=0<q.length?[q[h.length-1]]:[c[0]];Benchmarker.startTask("summarize");h=e(h);this.setDymoFeature(f[d],b.uri,h)}};this.addSegmentation=function(b,d){k();for(var g=a.findMaxLevel(),e=0;e<b.length;e++){var n=h(b[e].time,g,d),m=b[e].time,p;if(b[e].duration)p=b[e].duration;else if(b[e+1])p=b[e+1].time-m;else{var q=a.findFeatureValue(n,TIME_FEATURE),x=a.findFeatureValue(n,DURATION_FEATURE);q&&x&&(p=q+x-m)}if(0<
p){q=c(n);this.setDymoFeature(q,TIME_FEATURE,m);this.setDymoFeature(q,DURATION_FEATURE,p);var l=q,m=a.findFeatureValue(n,TIME_FEATURE),q=a.findFeatureValue(l,TIME_FEATURE);if(isNaN(m)||Array.isArray(m)||q<m)f.setDymoFeature(n,TIME_FEATURE,q),m=q;x=a.findFeatureValue(n,DURATION_FEATURE);l=a.findFeatureValue(l,DURATION_FEATURE);(isNaN(x)||Array.isArray(x)||m+x<q+l)&&f.setDymoFeature(n,DURATION_FEATURE,q+l-m)}}};this.setDymoFeature=function(b,c,f){a.setFeature(b,c,f);if(!isNaN(f))l(g(null,c),f);else if(f instanceof
Array)for(b=0;b<f.length;b++)l(g(null,c),f[b])};this.resetDymo()};function DymoTemplates(){}DymoTemplates.createSingleSourceDymoFromFeatures=function(a,b,c,d,e){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,e)};DymoTemplates.createConjunctionDymo=function(a,b,c,d,e){var k=a.addDymo(b,null,CONJUNCTION);b=c.map(function(b,c){return new Promise(function(g){var e=a.addDymo(k,b);DymoTemplates.loadMultipleFeatures(a,e,d[c],null,g)})});Promise.all(b).then(function(a){return e(k)})};
DymoTemplates.createSimilarityDymoFromFeatures=function(a,b,c,d,e,k){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,function(){Similarity.addSimilaritiesTo(a.getCurrentTopDymo(),a.getStore(),e);a.addRendering();a.addNavigator(SIMILARITY_NAVIGATOR,{d:LEVEL_FEATURE},"return d == 0");a.addNavigator(REPEATED_NAVIGATOR,{d:LEVEL_FEATURE},"return d == 1");k()})};
DymoTemplates.createSimilaritySuccessorDymoFromFeatures=function(a,b,c,d,e,k){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,function(){Similarity.addSimilaritiesTo(a.getCurrentTopDymo(),a.getStore(),e);Similarity.addSuccessionGraphTo(a.getCurrentTopDymo(),a.getStore(),e);a.addRendering();a.addNavigator(GRAPH_NAVIGATOR,{d:LEVEL_FEATURE},"return d == 0");a.addNavigator(REPEATED_NAVIGATOR,{d:LEVEL_FEATURE},"return d == 1");k()})};
DymoTemplates.createAnnotatedBarAndBeatDymo=function(a,b,c){for(var d=[b[0],b[0]],e=["1",""],k=1;k<b.length;k++)d[k+1]=b[k],e[k+1]="";DymoTemplates.loadMultipleFeatures(a,null,d,e,c)};function getUris(a,b,c,d){for(var e=[],k=[],h=0,l=c.length;h<l;h++){var g=b.filter(function(a){return 0<a.indexOf(c[h])})[0];g&&(e.push(a+g),k.push(d[h]))}return[e,k]}
DymoTemplates.loadMultipleFeatures=function(a,b,c,d,e){Benchmarker.startTask("loadFeatures");var k=new FeatureLoader(a,b);a=c.map(function(a,b){return new Promise(function(c){return k.loadFeature(a,d?d[b]:null,c)})});Promise.all(a).then(function(a){return e()})};
DymoTemplates.createSebastianDymo=function(a,b,c){var d=a.getFeature("onset"),e=a.getFeature("pitch"),k=a.addDymo();a.setDymoFeature(k,d,0);a.setDymoFeature(k,e,0);c.get("getsourcefilesindir/",{params:{directory:"audio/Chopin_Op028-04_003_20100611-SMD/"}}).success(function(b){b=b.filter(function(a){return 4<a.split("_").length-1});for(var c=0;c<b.length;c++){var g=b[c].split("_"),p=g[g.length-1],p=Number.parseInt(p.substring(1,p.indexOf(".")),10)/1E3,g=Number.parseInt(g[g.length-3].substring(1),10),
f=a.addDymo(k,"audio/Chopin_Op028-04_003_20100611-SMD/"+b[c]);a.setDymoFeature(f,d,p);a.setDymoFeature(f,e,g)}DYMO_STORE.updatePartOrder(k,d.name)})};
DymoTemplates.createSebastianDymo2=function(a,b){var c=a.getFeature("onset"),d=a.getFeature("pitch"),e=a.addDymo();a.setDymoFeature(e,c,0);a.setDymoFeature(e,d,0);$http.get("getsourcefilesindir/",{params:{directory:"audio/scale_out/scale_single/"}}).success(function(b){b=b.filter(function(a){return 4<a.split("_").length-1});for(var k=0;k<b.length;k++){var l=b[k].split("_"),g=Number.parseInt(l[4].substring(1),10)/1E3,l=Number.parseInt(l[2].substring(1),10),p=a.addDymo(e,"audio/scale_out/scale_single/"+
b[k]);a.setDymoFeature(p,c,g);a.setDymoFeature(p,d,l)}DYMO_STORE.updatePartOrder(e,c.name)})};
DymoTemplates.createSebastianDymo3=function(a,b){var c=a.addDymo();a.setDymoFeature(c,ONSET_FEATURE,0);a.setDymoFeature(c,PITCH_FEATURE,0);a.setDymoFeature(c,DURATION_FEATURE,0);a.setDymoFeature(c,"velocity",0);a.setDymoFeature(c,"onsetS",0);a.setDymoFeature(c,"durationS",0);b.get("getsourcefilesindir/",{params:{directory:"audio/Chopin_Op028-11_003_20100611-SMD-cut/"}}).success(function(b){b=b.filter(function(a){return 4<a.split("_").length-1});for(var d=0;d<b.length;d++){var k=b[d].split("_"),h=
Number.parseInt(k[4].substring(1),10),l=Number.parseInt(k[6].substring(2),10)/1E3,g=Number.parseInt(k[7].substring(2),10)/1E3,p=Number.parseInt(k[8].substring(2),10),f=Number.parseInt(k[9].substring(2),10)/1E3,k=Number.parseInt(k[10].substring(2),10)/1E3,n=a.addDymo(c,"audio/Chopin_Op028-11_003_20100611-SMD-cut/"+b[d]);a.setDymoFeature(n,PITCH_FEATURE,h);a.setDymoFeature(n,ONSET_FEATURE,l);a.setDymoFeature(n,DURATION_FEATURE,g);a.setDymoFeature(n,"velocity",p);a.setDymoFeature(n,"onsetS",f);a.setDymoFeature(n,
"durationS",k);n.getParameter(ONSET).update(l)}DYMO_STORE.updatePartOrder(c,ONSET_FEATURE)})};
DymoTemplates.createAchBachDymo=function(a,b){var c=a.getFeature(ONSET_FEATURE),d=a.getFeature(PITCH_FEATURE),e=a.getFeature(DURATION_FEATURE),k=a.getFeature("onsetS"),h=a.getFeature("durationS"),l=a.getFeature("time"),g=a.addDymo();a.setDymoFeature(g,c,0);a.setDymoFeature(g,d,0);a.setDymoFeature(g,e,0);$http.get("audio/achachbach10/01-AchGottundHerr.txt").success(function(b){b=b.split("\n");for(var f=0;f<b.length;f++)b[f]=b[f].split("\t");b.sort(function(a,b){return a[0]-b[0]});for(var n=[],f=0;f<
b.length;f++){var m=b[f][0],p=b[f][1],u=Number.parseInt(b[f][3],10);if(n[u]){var v=n[u][0],w=p-n[u][2];b[v][4]=m-n[u][1];b[v][5]=w}n[u]=[f,m,p]}for(f=b.length-4;f<b.length;f++)b[f][4]=2700,b[f][5]=2700;for(f=0;f<b.length;f++)if(6==b[f].length){var n=b[f],m=Number.parseInt(n[2],10),p=Number.parseInt(n[0],10)/1E3,u=Number.parseInt(n[1],10)/1E3,v=Number.parseInt(n[4],10)/1E3,w=Number.parseInt(n[5],10)/1E3,r;1==n[3]?r=a.addDymo(g,"audio/achachbach10/01-AchGottundHerr-violin.wav"):2==n[3]?r=a.addDymo(g,
"audio/achachbach10/01-AchGottundHerr-clarinet.wav"):3==n[3]?r=a.addDymo(g,"audio/achachbach10/01-AchGottundHerr-saxphone.wav"):4==n[3]&&(r=a.addDymo(g,"audio/achachbach10/01-AchGottundHerr-bassoon.wav"));a.setDymoFeature(r,d,m);a.setDymoFeature(r,l,p);a.setDymoFeature(r,c,p);a.setDymoFeature(r,e,v);a.setDymoFeature(r,k,u);a.setDymoFeature(r,h,w);r.getParameter(ONSET).update(p)}DYMO_STORE.updatePartOrder(g,c.name)});$http.get("getsourcefilesindir/",{params:{directory:"audio/achachbach10/"}}).success(function(a){a=
a.filter(function(a){return 0<=a.indexOf("wav")});for(var b=0;b<a.length;b++);})};function createRandomTriangle(){return[{0:Math.random(),1:Math.random()},{0:Math.random(),1:Math.random()},{0:Math.random(),1:Math.random()}]};function FeatureLoader(a,b){function c(c,f,g){w(c,function(n){d(n,function(d){e(d,function(e){0<e.length?(p(c,f,e),g&&g()):k(d,function(f){var d=f.name;d||(d=c.split("_"),d=d[d.length-1].split(".")[0]);a.addFeature(d,f.values,b);g&&g()})})})})}function d(a,b){var c=N3.Store();N3.Parser().parse(a,function(a,f,d){f?c.addTriple(f):b(c)})}function e(a,b){for(var c=[],f=a.find(null,"http://purl.org/NET/c4dm/event.owl#time",null),d=0,e=f.length;d<e;d++){var n=h(a,f[d].object,"http://purl.org/NET/c4dm/timeline.owl#at");
n||(n=h(a,f[d].object,"http://purl.org/NET/c4dm/timeline.owl#beginsAt"));var m=h(a,f[d].object,"http://purl.org/NET/c4dm/timeline.owl#duration"),n={time:g(n),label:l(h(a,f[d].subject,"http://www.w3.org/2000/01/rdf-schema#label"))};m&&(n.duration=g(m));c.push(n)}b(c)}function k(a,b){var c=l(h(a,null,"http://purl.org/dc/elements/1.1/title")),f=l(h(a,null,"http://purl.org/ontology/af/value")),f=f.split(" ").map(function(a){return parseFloat(a)}),d=l(h(a,null,"http://purl.org/ontology/af/dimensions")),
d=d.split(" ").map(function(a){return Number.parseInt(a,10)}),e=h(a,null,"http://purl.org/ontology/vamp/computed_by"),n=g(h(a,e,"http://purl.org/ontology/vamp/step_size"));a=g(h(a,e,"http://purl.org/ontology/vamp/sample_rate"));for(var e=[],m=0;m<f.length;){for(var p=[],k=0;k<d[0];k++)p[k]=f[m+k];e.push({time:{value:m*n/a},value:p});m+=d[0]}b({name:c,values:e})}function h(a,b,c){a=a.find(b,c,null);if(0<a.length)return a[0].object}function l(a){if(a)return N3.Util.getLiteralValue(a)}function g(a){a=
N3.Util.getLiteralValue(a);"P"==a.charAt(0)&&(a=a.substring(2,a.length-1));return Number(a)}function p(c,f,d){r[c]=d.sort(function(a,b){return a.time.value-b.time.value});d=r[c];f&&r[c][0].label&&(d=d.filter(function(a){return a.label.value==f}));a.addSegmentation(d,b)}function f(a,b,c){w(a,function(a){n(JSON.parse(a),b,c)})}function n(a,b,c){"file_metadata"==Object.keys(a)[0]?m(a,b,c):q(a,b,c)}function m(c,f,d){c=c[Object.keys(c)[1]][0];var g=c.annotation_metadata.annotator.output_id;"beats"==g||
"onsets"==g||"segmentation"==g?(c=c.data,f&&c[0].value&&(c=c.filter(function(a){return a.value==f})),a.addSegmentation(c,b)):a.addFeature(g,c.data,b);d&&d()}function q(c,f,d){var g=c["@type"];"afv:BarandBeatTracker"==g||"afv:Onsets"==g?(c=c["afo:values"],f&&c[0]["afo:value"]&&(c=c.filter(function(a){return a["afo:value"]==f})),c=u(c),a.addSegmentation(c,b)):(c=v(c["afo:values"]),a.addFeature(g,c,b));d&&d()}function u(a){for(var b=[],c=0;c<a.length;c++)b.push({time:{value:a[c]["tl:at"]},label:{value:a[c]["afo:value"]}});
return b}function v(a){for(var b=[],c=0;c<a.length;c++)b.push({time:{value:a[c]["tl:at"]},value:[a[c]["afo:value"]]});return b}function w(a,b){var c=new XMLHttpRequest;c.addEventListener("load",function(){b(this.responseText)});c.addEventListener("error",function(){b(this.responseText)});c.open("GET",a);c.send()}var r={};this.loadFeature=function(a,b,d){if(a.constructor==Object)n(a,b,d);else{var g=a.split("."),g=g[g.length-1];"n3"==g?c(a,b,d):"json"==g&&f(a,b,d)}}};var SUMMARY={MEAN:"mean",MEDIAN:"median",FIRST:"first"};function Similarity(){}Similarity.addSimilaritiesTo=function(a,b,c){for(a=[a];0<a.length;){if(1<a.length){var d=Similarity.toVectors(a,b),d=Similarity.getCosineSimilarities(d);Similarity.addSimilaritiesAbove(b,d,c)}a=Similarity.getAllParts(a,b)}};
Similarity.addSuccessionGraphTo=function(a,b,c){for(a=[a];0<a.length;){if(1<a.length){for(var d=0;d<a.length-1;d++)b.addSuccessor(a[d],a[d+1]);var d=Similarity.toVectors(a,b),d=Similarity.getCosineSimilarities(d),e;for(e in d)for(var k in d[e])d[e][k]>c&&(addSuccessorToPredecessorOf(e,k,a,b),addSuccessorToPredecessorOf(k,e,a,b))}a=Similarity.getAllParts(a,b)}};function addSuccessorToPredecessorOf(a,b,c,d){a=c.indexOf(a);0<a&&d.addSuccessor(c[a-1],b)}
Similarity.addSimilaritiesAbove=function(a,b,c){for(var d in b)for(var e in b[d])b[d][e]>c&&(a.addSimilar(d,e),a.addSimilar(e,d))};Similarity.addHighestSimilarities=function(a,b,c){var d=[],e;for(e in b)for(var k in b[e])d.push([b[e][k],e,k]);d=d.sort(function(a,b){return b[0]-a[0]});b=0;for(c=Math.min(d.length,c);b<c;b++)e=d[b],a.addSimilar(e[1],e[2]),a.addSimilar(e[2],e[1])};Similarity.getAllParts=function(a,b){for(var c=[],d=0,e=a.length;d<e;d++)c=c.concat(b.findParts(a[d]));return c};
Similarity.toVectors=function(a,b,c){for(var d=[],e=0,k=a.length;e<k;e++){for(var h=[],l=b.findAllFeatureValues(a[e]).filter(function(a){return"string"!=typeof a}),g=0,p=l.length;g<p;g++){var f=l[g];c&&1<f.length&&(f=Similarity.reduce(f));1<f.length?h=h.concat(f):(f=Number(f),h.push(f))}d[e]=h}for(var n=[],m=[],e=0;e<d[0].length;e++){b=[];for(g=0;g<a.length;g++)isNaN(d[g][e])||b.push(d[g][e]);n[e]=math.mean(b);m[e]=math.var(b)}d=d.map(function(a){return a.map(function(a,b){return(a-n[b])/m[b]})});
g={};for(e=0;e<d.length;e++)g[a[e]]=d[e];return g};Similarity.reduce=function(a){var b=Array.apply(null,Array(a.length)).map(Number.prototype.valueOf,1);return Similarity.getCosineSimilarity(a,b)};Similarity.getCosineSimilarities=function(a){var b={},c;for(c in a)for(var d in a)c<d&&(b[c]||(b[c]={}),b[c][d]=Similarity.getCosineSimilarity(a[c],a[d]));return b};Similarity.getCosineSimilarity=function(a,b){return a.length==b.length?math.dot(a,b)/(math.norm(a)*math.norm(b)):0};var DYMO_CONTEXT={"@context":{"@base":"http://tiny.cc/dymo-context/",xsd:"http://www.w3.org/2001/XMLSchema#",rdfs:"http://www.w3.org/2000/01/rdf-schema#",owl:"http://www.w3.org/2002/07/owl#",sch:"http://schema.org/",mo:"http://purl.org/ontology/mo/",mt:"http://purl.org/ontology/studio/multitrack#",ch:"http://tiny.cc/charm-ontology#",dy:"http://tiny.cc/dymo-ontology#",mb:"http://tiny.cc/mobile-audio-ontology#",name:"sch:name",cdt:{"@id":"ch:cdt","@type":"@vocab"},adt:{"@id":"ch:adt","@type":"@vocab"},
...
Brownian:"mb:Brownian",Ramp:"mb:Ramp",MobileParameter:"mb:MobileParameter",GlobalParameter:"mb:GlobalParameter",ControlParameter:"mb:ControlParameter",ListenerOrientation:"mb:ListenerOrientation",AutoControlFrequency:"mb:AutoControlFrequency",AutoControlTrigger:"mb:AutoControlTrigger",BrownianMaxStepSize:"mb:BrownianMaxStepSize",LeapingProbability:"mb:LeapingProbability",ContinueAfterLeaping:"mb:ContinueAfterLeaping",Navigator:"mb:Navigator",OneShotNavigator:"mb:OneShotNavigator",RepeatedNavigator:"mb:RepeatedNavigator",
SequentialNavigator:"mb:SequentialNavigator",SimilarityNavigator:"mb:SimilarityNavigator",GraphNavigator:"mb:GraphNavigator",ArgumentValue:"mb:ArgumentValue",MappingTarget:"mb:MappingTarget",MappingRange:"mb:MappingRange",MappingOwners:"mb:MappingOwners",dymo:{"@id":"mb:hasDymo","@type":"@id"},mappings:"mb:hasMapping","function":"mb:hasFunction",args:"mb:hasArgument","var":"mb:hasVariable",val:{"@id":"mb:hasValue","@type":"@vocab"},body:"mb:hasBody",targets:{"@id":"mb:toTarget","@type":"@id"},range:{"@id":"mb:hasRange",
"@type":"@vocab"},unidirectional:{"@id":"mb:isUnidirectional","@type":"xsd:boolean"},init:{"@id":"mb:hasInitialValue","@type":"xsd:float"},url:{"@id":"mb:hasUrl","@type":"xsd:string"},map:{"@id":"mb:hasJsonMap","@type":"xsd:string"},smooth:{"@id":"mb:isSmooth","@type":"xsd:boolean"},average:{"@id":"mb:isAverageOf","@type":"xsd:integer"},uuid:{"@id":"mb:hasUuid","@type":"xsd:string"},major:{"@id":"mb:hasMajor","@type":"xsd:integer"},minor:{"@id":"mb:hasMinor","@type":"xsd:integer"},rampDuration:{"@id":"mb:hasDuration",
"@type":"xsd:integer"},navigators:"mb:hasNavigator",dymos:"mb:navDymos"}},DYMO_SIMPLE_CONTEXT={"@context":{"@base":"http://tiny.cc/dymo-context/",xsd:"http://www.w3.org/2001/XMLSchema#",rdfs:"http://www.w3.org/2000/01/rdf-schema#",owl:"http://www.w3.org/2002/07/owl#",sch:"http://schema.org/",mo:"http://purl.org/ontology/mo/",mt:"http://purl.org/ontology/studio/multitrack#",ch:"http://tiny.cc/charm-ontology#",dy:"http://tiny.cc/dymo-ontology#",mb:"http://tiny.cc/mobile-audio-ontology#",name:"sch:name",
cdt:"ch:cdt",adt:"ch:adt",value:"ch:value",parts:"ch:hasPart",Dymo:"dy:Dymo",DymoType:"dy:DymoType",Conjunction:"dy:Conjunction",Disjunction:"dy:Disjunction",Sequence:"dy:Sequence",Feature:"dy:Feature",Parameter:"dy:Parameter",FeatureType:"dy:FeatureType",ParameterType:"dy:ParameterType",level:"dy:LevelFeature",index:"dy:IndexFeature",onset:"dy:OnsetFeature",pitch:"dy:PitchFeature",duration:"dy:DurationFeature",time:"dy:TimeFeature",segmentLabel:"dy:SegmentLabelFeature",CustomFeature:"dy:CustomFeature",
AudioParameter:"dy:AudioParameter",hasStandardValue:"dy:hasStandardValue",isInteger:"dy:isInteger",Play:"dy:Play",Loop:"dy:Loop",Onset:"dy:Onset",DurationRatio:"dy:DurationRatio",Amplitude:"dy:Amplitude",PlaybackRate:"dy:PlaybackRate",TimeStretchRatio:"dy:TimeStretchRatio",Pan:"dy:Pan",Distance:"dy:Distance",Height:"dy:Height",Reverb:"dy:Reverb",Delay:"dy:Delay",Filter:"dy:Filter",StructuralParameter:"dy:StructuralParameter",PartCount:"dy:PartCount",PartDurationRatio:"dy:PartDurationRatio",PartProportion:"dy:PartProportion",
CustomParameter:"dy:CustomParameter",source:"dy:hasSource",parameters:"dy:hasParameter",features:"dy:hasFeature",paramType:"dy:hasParameterType",featureType:"dy:hasFeatureType",similars:"dy:hasSimilar",successors:"dy:hasSuccessor",Rendering:"mb:Rendering",Mapping:"mb:Mapping",Function:"mb:Function",Argument:"mb:Argument",MobileControl:"mb:MobileControl",SensorControl:"mb:SensorControl",UiControl:"mb:UiControl",DataControl:"mb:DataControl",AutoControl:"mb:AutoControl",AccelerometerX:"mb:AccelerometerX",
AccelerometerY:"mb:AccelerometerY",AccelerometerZ:"mb:AccelerometerZ",TiltX:"mb:TiltX",TiltY:"mb:TiltY",TiltZ:"mb:TiltZ",GeolocationLatitude:"mb:GeolocationLatitude",GeolocationLongitude:"mb:GeolocationLongitude",GeolocationDistance:"mb:GeolocationDistance",CompassHeading:"mb:CompassHeading",Beacon:"mb:Beacon",Slider:"mb:Slider",Toggle:"mb:Toggle",Button:"mb:Button",CustomControl:"mb:CustomControl",Random:"mb:Random",Brownian:"mb:Brownian",Ramp:"mb:Ramp",MobileParameter:"mb:MobileParameter",GlobalParameter:"mb:GlobalParameter",
ControlParameter:"mb:ControlParameter",ListenerOrientation:"mb:ListenerOrientation",AutoControlFrequency:"mb:AutoControlFrequency",AutoControlTrigger:"mb:AutoControlTrigger",BrownianMaxStepSize:"mb:BrownianMaxStepSize",LeapingProbability:"mb:LeapingProbability",ContinueAfterLeaping:"mb:ContinueAfterLeaping",Navigator:"mb:Navigator",OneShotNavigator:"mb:OneShotNavigator",RepeatedNavigator:"mb:RepeatedNavigator",SequentialNavigator:"mb:SequentialNavigator",SimilarityNavigator:"mb:SimilarityNavigator",
GraphNavigator:"mb:GraphNavigator",ArgumentValue:"mb:ArgumentValue",MappingTarget:"mb:MappingTarget",MappingRange:"mb:MappingRange",MappingOwners:"mb:MappingOwners",dymo:"mb:hasDymo",mappings:"mb:hasMapping","function":"mb:hasFunction",args:"mb:hasArgument","var":"mb:hasVariable",val:"mb:hasValue",body:"mb:hasBody",targets:"mb:toTarget",range:"mb:hasRange",unidirectional:"mb:isUnidirectional",init:"mb:hasInitialValue",url:"mb:hasUrl",map:"mb:hasJsonMap",smooth:"mb:isSmooth",average:"mb:isAverageOf",
uuid:"mb:hasUuid",major:"mb:hasMajor",minor:"mb:hasMinor",rampDuration:"mb:hasDuration",navigators:"mb:hasNavigator",dymos:"mb:navDymos"}};var OPTIMIZED_MODE=!1,SCHEDULE_AHEAD_TIME=.1,FADE_LENGTH=.02,DYMO_ONTOLOGY_URI="http://tiny.cc/dymo-ontology#",DYMO_STORE;var URI_TO_TERM={"http://tiny.cc/dymo-ontology#LevelFeature":"level","http://tiny.cc/dymo-ontology#IndexFeature":"index","http://tiny.cc/dymo-ontology#OnsetFeature":"onset","http://tiny.cc/dymo-ontology#PitchFeature":"pitch","http://tiny.cc/dymo-ontology#DurationFeature":"duration","http://tiny.cc/dymo-ontology#TimeFeature":"time","http://tiny.cc/dymo-ontology#SegmentLabelFeature":"segmentLabel","http://tiny.cc/dymo-ontology#hasSource":"source","http://tiny.cc/dymo-ontology#hasParameter":"parameters",
...
"http://tiny.cc/mobile-audio-ontology#AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE="http://tiny.cc/mobile-audio-ontology#BrownianMaxStepSize",LEAPING_PROBABILITY="http://tiny.cc/mobile-audio-ontology#LeapingProbability",CONTINUE_AFTER_LEAPING="http://tiny.cc/mobile-audio-ontology#ContinueAfterLeaping",NAVIGATOR="http://tiny.cc/mobile-audio-ontology#Navigator",ONE_SHOT_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#OneShotNavigator",REPEATED_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#RepeatedNavigator",
SEQUENTIAL_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SimilarityNavigator",GRAPH_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#GraphNavigator",ARGUMENT_VALUE="http://tiny.cc/mobile-audio-ontology#ArgumentValue",MAPPING_TARGET="http://tiny.cc/mobile-audio-ontology#MappingTarget",MAPPING_RANGE="http://tiny.cc/mobile-audio-ontology#MappingRange",MAPPING_OWNERS="http://tiny.cc/mobile-audio-ontology#MappingOwners",HAS_DYMO=
"http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING="http://tiny.cc/mobile-audio-ontology#hasMapping",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_VARIABLE="http://tiny.cc/mobile-audio-ontology#hasVariable",HAS_VALUE="http://tiny.cc/mobile-audio-ontology#hasValue",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",HAS_RANGE="http://tiny.cc/mobile-audio-ontology#hasRange",
IS_UNIDIRECTIONAL="http://tiny.cc/mobile-audio-ontology#isUnidirectional",HAS_INITIAL_VALUE="http://tiny.cc/mobile-audio-ontology#hasInitialValue",HAS_URL="http://tiny.cc/mobile-audio-ontology#hasUrl",HAS_JSON_MAP="http://tiny.cc/mobile-audio-ontology#hasJsonMap",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",
HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",NAV_DYMOS="http://tiny.cc/mobile-audio-ontology#navDymos";function OntologyLoader2(a,b,c){};function DymoLoader(a){function b(b,f){c(b,"",function(b){a.loadData(b,!0,f)})}function c(a,b,f){loadFile(a,function(g){if(0>g.indexOf("Cannot GET")){var e;a:{try{JSON.parse(g)}catch(r){e=!1;break a}e=!0}e&&(b?(0<=a.indexOf(p)&&(a=a.replace(p,"")),b=b.replace('"'+a+'"',g)):b=g);(g=d(b))?(0>g.indexOf(p)&&(g=p+g),c(g,b,f)):b&&f(JSON.parse(b))}})}function d(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return d(a.substring(b+
1))}}function e(b){b=b?a.findAllObjects(b,HAS_MAPPING):a.findAllSubjects(TYPE,MAPPING);for(var c=a.recursiveFindAllSubClasses(MOBILE_CONTROL),d=0;d<c.length;d++)for(var g=a.findAllSubjects(TYPE,c[d]),e=0;e<g.length;e++){var m=a.findObjectValue(g[e],NAME);m||(m=g[e]);if(!f[g[e]]){var p=g[e],h=g[e],l=m,t=c[d],m=void 0;t==ACCELEROMETER_X||t==ACCELEROMETER_Y||t==ACCELEROMETER_Z?m=new AccelerometerControl(t):t==TILT_X||t==TILT_Y?m=new TiltControl(t):t==GEOLOCATION_LATITUDE||t==GEOLOCATION_LONGITUDE?m=
new GeolocationControl(t):t==GEOLOCATION_DISTANCE?m=new DistanceControl:t==COMPASS_HEADING?m=new CompassControl:t==BEACON?(m=a.findObjectValue(h,HAS_UUID),l=a.findObjectValue(h,HAS_MAJOR),t=a.findObjectValue(h,HAS_MINOR),m=new BeaconControl(m,l,t)):t==SLIDER||t==TOGGLE||t==BUTTON||t==CUSTOM_CONTROL?(m=new Control(h,l,t),l=a.findObjectValue(h,HAS_INITIAL_VALUE),m.updateValue(l)):t==RANDOM?m=new RandomControl(h):t==BROWNIAN?(l=a.findObjectValue(h,HAS_INITIAL_VALUE),m=new BrownianControl(h,l)):t==RAMP?
(m=Math.round(1E3*a.findObject(h,HAS_DURATION)),l=a.findObjectValue(h,HAS_INITIAL_VALUE),m=new RampControl(h,m,l)):t==DATA_CONTROL&&(m=a.findObjectValue(h,HAS_URL),l=a.findObjectValue(h,HAS_JSON_MAP),l=new Function("json",l),m=new DataControl(h,m,l));a.findObjectValue(h,IS_SMOOTH)&&m.setSmooth&&m.setSmooth(!0);h=a.findObjectValue(h,IS_AVERAGE_OF);!isNaN(h)&&m.setAverageOf&&m.setAverageOf(h);f[p]=m}}for(c=0;c<b.length;c++)n[b[c]]||(e=DYMO_STORE.findSubject(HAS_MAPPING,b[c]),DYMO_STORE.findObject(e,
TYPE)!=DYMO&&(e=null),d=b[c],g=b[c],p=e,e=a.findObjectValue(g,IS_UNIDIRECTIONAL),h=a.findObject(g,HAS_FUNCTION),p=k(h,e,p),h=a.findAllObjects(g,TO_TARGET),h=0<h.length?(m=k(h[0],!0))?m:h:void 0,g=a.findObject(g,HAS_RANGE),g=new Mapping(p,h,g,e),n[d]=g)}function k(b,c,f){var d=$jscomp.makeIterator(a.findFunction(b));b=d.next().value;var g=d.next().value,d=d.next().value;if(b&&g&&d)return f=$jscomp.makeIterator(h(g,f)),g=f.next().value,f=f.next().value,new DymoFunction(b,g,f,d,c)}function h(b,c){for(var d=
[],g=[],e=0;e<b.length;e++){var n=a.findObject(b[e],TYPE);n==FEATURE_TYPE||a.isSubtypeOf(n,FEATURE_TYPE)?(n==FEATURE_TYPE&&(n=b[e]),d.push(n),g.push(FEATURE_TYPE)):n==PARAMETER_TYPE||a.isSubclassOf(n,PARAMETER_TYPE)||a.isSubclassOf(a.findObject(n,TYPE),PARAMETER_TYPE)?(n==CUSTOM_PARAMETER&&(n=b[e]),n=c?a.setParameter(c,n):b[e],d.push(n),g.push(PARAMETER_TYPE)):(d.push(f[b[e]]),g.push(MOBILE_CONTROL))}return[d,g]}function l(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):a==GRAPH_NAVIGATOR?
new GraphNavigator(void 0):a==ONE_SHOT_NAVIGATOR?new OneShotNavigator(void 0):a==REPEATED_NAVIGATOR?new RepeatedNavigator(void 0):new SequentialNavigator(void 0)}var g=this,p="",f={},n={};this.getMappings=function(){return n};this.loadDymoFromJson=function(a,c){var f=a.lastIndexOf("/")+1;p=a.substring(0,f);b(a,function(){c(g.createDymoFromStore())})};this.parseDymoFromJson=function(b,c){a.loadData(b,!0,function(){c(g.createDymoFromStore())})};this.loadRenderingFromJson=function(a,c){b(a,function(){c(g.createRenderingFromStore())})};
this.parseDymoFromTurtle=function(b,c){a.loadData(b,!1,function(){c(g.createDymoFromStore())})};this.createDymoFromStore=function(){for(var b=a.findTopDymos(),c=0;c<b.length;c++)a.addBasePath(b[c],p),e();return b};this.createRenderingFromStore=function(){var b=a.findSubject(TYPE,RENDERING),c=new Rendering(a.findObject(b,HAS_DYMO));e(b);for(var b=a.findAllObjects(b,HAS_NAVIGATOR),d=0;d<b.length;d++){var g=k(a.findObject(b[d],NAV_DYMOS),!0);c.addSubsetNavigator(g,l(a.findObject(b[d],TYPE)))}return[c,
f]}};function DymoStore(a){function b(a,c){for(var f=0;f<a.length;f++){var d=c(a[f]);if(d)return d}for(f=0;f<a.length;f++)if(d=b(h.findParents(a[f]),c))return d}function c(a,b,c){h.triplesToRdf(a,function(a){d(a,b,c)})}function d(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,f){jsonld.frame(f,{"@id":b},function(a,b){jsonld.compact(b,DYMO_CONTEXT,function(a,b){jsonld.compact(b,DYMO_SIMPLE_CONTEXT,function(a,b){k(b);b["@context"]="http://tiny.cc/dymo-context";
b=JSON.stringify(b);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");c(b)})})})})}function e(a,b){var f=h.findObject(a,TYPE,null),f=h.recursiveFindAllTriples(a,f);c(f,a,function(a){b(null,JSON.parse(a))})}function k(a){if(a&&a instanceof Object)for(var b in a)"@id"==b&&a[b].includes("_:b")?delete a[b]:k(a[b])}var h=this;EasyStore.call(this);var l={};(function(){h.loadFileIntoStore("http://tiny.cc/dymo-ontology",!1,function(){h.loadFileIntoStore("http://tiny.cc/mobile-audio-ontology",!1,function(){a&&
a()})})})();this.addBasePath=function(a,b){l[a]=b};this.getBasePath=function(a){return b([a],function(a){return l[a]})};this.getSourcePath=function(a){var b=this.findObjectValue(a,HAS_SOURCE);if(b)return(a=this.getBasePath(a))?a+b:b;b=this.findParents(a);if(0<b.length)for(a=0;a<b.length;a++){var c=this.getSourcePath(b[a]);if(c)return c}};this.addSpecificParameterObserver=function(a,b){this.addValueObserver(a,VALUE,b)};this.addParameterObserver=function(a,b,c){if(a&&b)return a=this.setParameter(a,
b),this.addValueObserver(a,VALUE,c),a};this.getParameterObservers=function(a,b){if(a&&b&&(a=this.findObjectOfType(a,HAS_PARAMETER,b)))return this.getValueObservers(a,VALUE)};this.removeParameterObserver=function(a,b,c){a&&b&&(a=this.findObjectOfType(a,HAS_PARAMETER,b))&&this.removeValueObserver(a,VALUE,c)};this.addDymo=function(a,b,c,d,e){this.addTriple(a,TYPE,DYMO);b&&h.addObjectToList(b,HAS_PART,a);c&&h.addObjectToList(a,HAS_PART,c);d&&this.addTriple(a,HAS_SOURCE,N3.Util.createLiteral(d));e&&this.addTriple(a,
...
d)};this.setParameter=function(a,b,c){this.findParameterUri(a,b)||null!=c&&!isNaN(c)||(c=this.findObjectValue(b,HAS_STANDARD_VALUE,null));this.findObject(b,IS_INTEGER)&&(c=Math.round(c));return this.setObjectValue(a,HAS_PARAMETER,b,VALUE,c)};this.addControl=function(a,b,c){c||(c=this.createBlankNode());this.addTriple(c,NAME,N3.Util.createLiteral(a));this.addTriple(c,TYPE,b);return c};this.addRendering=function(a,b){this.addTriple(a,TYPE,RENDERING);this.addTriple(a,HAS_DYMO,b)};this.addMapping=function(a,
b,c,d,e){var f=this.createBlankNode();this.addTriple(f,TYPE,MAPPING);a&&this.addTriple(a,HAS_MAPPING,f);this.addTriple(f,HAS_FUNCTION,b);if(c)for(a=0;a<c.length;a++)this.addTriple(f,TO_TARGET,c[a]);else d&&this.addTriple(f,TO_TARGET,d);this.addTriple(f,HAS_RANGE,e);this.findObject(e,TYPE)||this.addTriple(e,TYPE,CUSTOM_PARAMETER);return f};this.addNavigator=function(a,b,c,d){var f=this.createBlankNode();this.addTriple(a,HAS_NAVIGATOR,f);this.addTriple(f,TYPE,b);a=this.addFunction(c,d);this.addTriple(f,
NAV_DYMOS,a);return f};this.addFunction=function(a,b){for(var c=this.createBlankNode(),d=Object.keys(a),e=0;e<d.length;e++){var g=this.createBlankNode();this.addTriple(c,HAS_ARGUMENT,g);this.addTriple(g,HAS_VARIABLE,N3.Util.createLiteral(d[e]));this.addTriple(g,HAS_VALUE,a[d[e]])}this.addTriple(c,HAS_BODY,N3.Util.createLiteral(b));return c};this.updatePartOrder=function(a,b){var c=this.findParts(a);0<c.length&&(c.sort(function(a,c){return h.findAttributeValue(a,b)-h.findAttributeValue(c,b)}),this.setParts(a,
...
this.findAllParents=function(a){for(var b=[];null!=a;)b.push(a),a=DYMO_STORE.findParents(a)[0];return b};this.findParents=function(a){var b=this.findContainingLists(a);return b[0].filter(function(a,c){return b[1][c]==HAS_PART})};this.findAllObjectsInHierarchy=function(a){var b=[a];a=this.findParts(a);for(var c=0;c<a.length;c++)b=b.concat(this.findAllObjectsInHierarchy(a[c]));return b};this.findDymoRelations=function(){var a=this.findAllSubjects(DOMAIN,DYMO),b=this.findAllSubjects(RANGE,DYMO);return[HAS_PART].concat(intersectArrays(a,
b))};this.findMappings=function(a){return this.findAllObjects(a,HAS_MAPPING)};this.findNavigators=function(a){return this.findAllObjects(a,HAS_NAVIGATOR)};this.findFunction=function(a){if(a){var b=h.findAllObjects(a,HAS_ARGUMENT),c=b.map(function(a){return h.findObjectValue(a,HAS_VARIABLE)}),b=b.map(function(a){return h.findObject(a,HAS_VALUE)});a=h.findObjectValue(a,HAS_BODY);return[c,b,a]}};this.findAttributeValue=function(a,b){var c=this.findParameterValue(a,b);null==c&&(c=this.findFeatureValue(a,
b));return c};this.findFeatureValue=function(a,b){return b===LEVEL_FEATURE?this.findLevel(a):b===INDEX_FEATURE?this.findPartIndex(a):this.findObjectValueOfType(a,HAS_FEATURE,b,VALUE)};this.findAllFeatureValues=function(a){return this.findAllObjectValuesOfType(a,HAS_FEATURE,VALUE)};this.findAllNumericFeatureValues=function(a){return this.findAllFeatureValues(a).filter(function(a){return!isNaN(a)})};this.findParameterValue=function(a,b){return this.findObjectValueOfType(a,HAS_PARAMETER,b,VALUE)};this.findParameterUri=
function(a,b){return a?this.findObjectOfType(a,HAS_PARAMETER,b):this.findSubject(null,b)};this.findPartIndex=function(a){var b=this.findParents(a)[0];return this.findObjectIndexInList(b,HAS_PART,a)};this.findLevel=function(a){var b=0;for(a=this.findParents(a)[0];a;)b++,a=this.findParents(a)[0];return b};this.findMaxLevel=function(){for(var a=this.findAllSubjects(TYPE,DYMO),b=0,c=0;c<a.length;c++)b=Math.max(b,this.findLevel(a[c]));return b};this.toJsonld=function(a){var b=this.findTopDymos()[0];this.toRdf(function(c){d(c,
b,a)})};this.toJsonGraph=function(a,b,c){var d={nodes:[],edges:[]},f={},g=this.findAllSubjects(TYPE,a),k=this.find(null,b,null);async.map(g,e,function(e,n){d.nodes=n;for(var m=0;m<g.length;m++)f[g[m]]=d.nodes[m];d.edges=[];for(m=0;m<k.length;m++)0==h.find(k[m].object,TYPE,a).length?0<h.find(k[m].object,FIRST).length&&(e=h.findObjectOrList(k[m].subject,b),e=e.map(function(a){return{source:f[k[m].subject],target:f[a],value:1}}),d.edges=d.edges.concat(e)):d.edges.push({source:f[k[m].subject],target:f[k[m].object],
value:1});c(d)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a){this.writeToJsonld=function(b,c){c||(c="dymo.json");a.toJsonld(function(a){fetch(b+c,{method:"post",body:a})})}};function EasyReasoner(){function a(a,c,d){var b=new XMLHttpRequest;b.open("POST",a);b.setRequestHeader("Content-Type","application/x-www-form-urlencoded");b.onload=function(){d(b.responseText)};b.error=function(a){console.log(a)};b.send(c)}this.queryAll=function(b,c){for(var d="",e=0;e<b.length;e++)d+=encodeURIComponent("data="+b[e])+"&";d+=encodeURIComponent("query={ ?a ?b ?c. } => { ?a ?b ?c. }.");a("http://eye.restdesc.org/",d,function(a){c(a)})}};function EasyStore(){function a(a,b,c){var d=[];g[a]&&g[a][b]&&(d=d.concat(g[a][b]));b=h.findObject(a,TYPE);p[b]&&(d=d.concat(p[b]));for(var f=0;f<d.length;f++)d[f].observedValueChanged&&d[f].observedValueChanged(a,b,c)}function b(a,b){a=l.find(null,a,b);if(0<a.length)return a[0].subject}function c(a){if(a){var b=h.findObject(a,FIRST);if(b){var c=[];c.push(b);for(a=h.findObject(a,REST);a!=NIL;)c.push(h.findObject(a,FIRST)),a=h.findObject(a,REST);return c}return a}}function d(a,b){if(a){for(var c=
0,d=h.findObject(a,REST);d!=NIL&&(null==b||c<b);)a=d,d=h.findObject(a,REST),c++;if(null==b||c==b)return a}}function e(a){var b=N3.Util.getLiteralValue(a);a=N3.Util.getLiteralType(a);"http://www.w3.org/2001/XMLSchema#string"!=a&&"http://www.w3.org/2001/XMLSchema#boolean"!=a&&(b=Number(b));return b}function k(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}var h=this,l=N3.Store(),g={},p={};this.addValueObserver=function(a,b,c){g[a]||(g[a]={});g[a][b]||(g[a][b]=[]);g[a][b].push(c)};
this.addTypeObserver=function(a,b,c){p[a]||(p[a]=[]);p[a].push(c)};this.removeValueObserver=function(a,b,c){g[a]&&g[a][b]&&(c=g[a][b].indexOf(c),-1<c&&(g[a][b].splice(c,1),g[a]&&0==g[a][b].length&&(delete g[a][b],0===Object.keys(g[a]).length&&delete g[a])))};this.removeTypeObserver=function(a,b,c){p[a]&&(b=p[a].indexOf(c),-1<b&&(p[a].splice(b,1),0==p[a].length&&delete p[a]))};this.getValueObservers=function(a,b){return g[a]?g[a][b]?g[a][b]:flattenArray(Object.values(g[a])):null==a&&null==b?flattenArray(Object.keys(g).map(function(a){return flattenArray(Object.values(g[a]))})):
[]};this.getTypeObservers=function(a){return p[a]?p[a]:null==a?flattenArray(Object.keys(p).map(function(a){return p[a]})):[]};this.addTriple=function(a,b,c){if(null!=a&&null!=b&&null!=c)return l.addTriple(a,b,c)};this.removeTriple=function(a,b,c){c||(c=this.findObject(a,b));return l.removeTriple(a,b,c)};this.createBlankNode=function(){return l.createBlankNode()};this.setTriple=function(a,b,c){this.removeTriple(a,b);this.addTriple(a,b,c)};this.setValue=function(b,c,d){var f=this.findObjectValue(b,
c);b&&c&&null!=d&&d!=f&&!Number.isNaN(d)&&(Array.isArray(d)?(d=d.map(function(a){return N3.Util.createLiteral(a)}),this.removeTriple(b,c),this.addObjectsToList(b,c,d)):this.setTriple(b,c,N3.Util.createLiteral(d)),a(b,c,d))};this.setObjectValue=function(a,b,c,d,e){var f;a&&b?f=this.findObjectOfType(a,b,c):a||(f=this.findSubject(TYPE,c));f||(f=this.createBlankNode(),a&&b&&this.addTriple(a,b,f),this.addTriple(f,TYPE,c));this.setValue(f,d,e);return f};this.addObjectToList=function(a,b,c){var f=this.findObject(a,
b),e=this.createBlankNode();f?(a=d(f),this.removeTriple(a,REST,NIL),this.addTriple(a,REST,e)):this.addTriple(a,b,e);this.addTriple(e,FIRST,c);this.addTriple(e,REST,NIL)};this.addObjectsToList=function(a,b,c){for(var d=0,f=c.length;d<f;d++)this.addObjectToList(a,b,c[d])};this.replaceObjectInList=function(a,b,c,e){a=this.findObject(a,b);e=d(a,e);a=this.findObject(e,FIRST);this.setTriple(e,FIRST,c);return a};this.removeObjectFromList=function(a,b,c){a=this.findObject(a,b);this.createBlankNode();c=d(a,
c-1);a=h.findObject(c,REST);b=h.findObject(a,REST);this.setTriple(c,REST,b);this.removeTriple(a,FIRST);this.removeTriple(a,REST)};this.deleteList=function(a,b){var c=this.findObject(a,b);if(c){for(;c!=NIL;){this.removeTriple(c,FIRST);var d=h.findObject(c,REST);this.removeTriple(c,REST);c=d}this.removeTriple(a,b)}};this.find=function(a,b,c){return l.find(a,b,c)};this.findObject=function(a,b){if(a&&b&&(a=l.find(a,b),0<a.length))return a[0].object};this.findObjectOrList=function(a,b){return c(this.findObject(a,
...
LogicTools.recursiveCreateGoalString=function(a,b,c,d,e){d||(d="");var k=LogicTools.recursiveCreateGoalString;if(a.isParenthesisNode)return k(a.content,b,c,d,e);if(a.isOperatorNode){for(var h=LogicTools.toLogicJsOperatorString(a),h=h+"(",l=0;l<a.args.length;l++){if(a.args[l].isSymbolNode){var g=a.args[l].name,h=h+g;if(0>b.indexOf(g))b.push(g);else return}else if(a.args[l].isConstantNode&&"number"==a.args[l].valueType)h+=a.args[l].value;else{g="v"+LogicTools.varCount++;c.push(g);h+=g;g=k(a.args[l],
b,c,d,g);if(!g)return;d+=g}l<a.args.length-1&&(h+=",")}e&&(h+=","+e);return d+(h+"),")}};LogicTools.toLogicJsOperatorString=function(a){if("=="==a.op)return"logic.eq";if("+"==a.op)return"logic.add";if("-"==a.op)return"logic.sub";if("*"==a.op)return"logic.mul";if("/"==a.op)return"logic.div"};LogicTools.toEquation=function(a){a=0<=a.indexOf(";")?a.substring(a.indexOf("return ")+7,a.indexOf(";")):a.substring(a.indexOf("return ")+7);return"ret == "+a};function PolygonTools(){}PolygonTools.isPointInPolygon=function(a,b){for(var c=!1,d=-1,e=a.length,k=e-1;++d<e;k=d)(a[d][1]<=b[1]&&b[1]<a[k][1]||a[k][1]<=b[1]&&b[1]<a[d][1])&&b[0]<(a[k][0]-a[d][0])*(b[1]-a[d][1])/(a[k][1]-a[d][1])+a[d][0]&&(c=!c);return c};PolygonTools.getArea=function(a){var b=0,c,d,e=0;for(d=a.length-1;e<a.length;d=e,e++)c=a[e],d=a[d],b+=c[0]*d[1],b-=c[1]*d[0];return b/2};
PolygonTools.getCentroid=function(a){var b,c,d,e=0,k=0,h=0;for(c=a.length-1;h<a.length;c=h,h++)b=a[h],c=a[c],d=b[0]*c[1]-c[0]*b[1],e+=(b[0]+c[0])*d,k+=(b[1]+c[1])*d;d=6*PolygonTools.getArea(a);return{0:e/d,1:k/d}};function sqDist(a,b){return Math.pow(a[0]-b[0],2)+Math.pow(a[1]-b[1],2)}
...
e=this._outputBuffer.endIndex,k=0,h=0;1>this.slopeCount;)d[e+2*h]=(1-this.slopeCount)*this.prevSampleL+this.slopeCount*b[c],d[e+2*h+1]=(1-this.slopeCount)*this.prevSampleR+this.slopeCount*b[c+1],h++,this.slopeCount+=this._rate;--this.slopeCount;if(1!=a)a:for(;;){for(;1<this.slopeCount;)if(--this.slopeCount,k++,k>=a-1)break a;var l=c+2*k;d[e+2*h]=(1-this.slopeCount)*b[l]+this.slopeCount*b[l+2];d[e+2*h+1]=(1-this.slopeCount)*b[l+1]+this.slopeCount*b[l+3];h++;this.slopeCount+=this._rate}this.prevSampleL=
...
b=Number.MIN_VALUE;for(d=a=0;d<this.seekLength;d++)c=this.calcCrossCorrStereo(2*d,this.pRefMidBuffer),c>b&&(b=c,a=d);return a},seekBestOverlapPositionStereoQuick:function(){var a,b,c,d,e,k,h;this.precalcCorrReferenceStereo();c=Number.MIN_VALUE;for(e=k=b=0;4>e;e++){for(a=0;_SCAN_OFFSETS[e][a];){h=k+_SCAN_OFFSETS[e][a];if(h>=this.seekLength)break;d=this.calcCrossCorrStereo(2*h,this.pRefMidBuffer);d>c&&(c=d,b=h);a++}k=b}return b},precalcCorrReferenceStereo:function(){var a,b,c;for(a=0;a<this.overlapLength;a++)c=
a*(this.overlapLength-a),b=2*a,this.pRefMidBuffer[b]=this.pMidBuffer[b]*c,this.pRefMidBuffer[b+1]=this.pMidBuffer[b+1]*c},calcCrossCorrStereo:function(a,b){var c=this._inputBuffer.vector;a+=this._inputBuffer.startIndex;var d,e,k;d=0;for(e=2;e<2*this.overlapLength;e+=2)k=e+a,d+=c[k]*b[e]+c[k+1]*b[e+1];return d},overlap:function(a){this.overlapStereo(2*a)},overlapStereo:function(a){var b=this._inputBuffer.vector;a+=this._inputBuffer.startIndex;var c=this._outputBuffer.vector,d=this._outputBuffer.endIndex,
e,k,h,l,g,p,f;l=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)h=(this.overlapLength-e)*l,g=e*l,k=2*e,p=k+a,f=k+d,c[f+0]=b[p+0]*g+this.pMidBuffer[k+0]*h,c[f+1]=b[p+1]*g+this.pMidBuffer[k+1]*h},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
...
function less_equal_c(a,b){return function(c){var d=c.walk(a),e=c.walk(b),d=get_domain(c,d),k=get_domain(c,e);return(e=intersection(d,make_domain(minus_inf,k.max)))?(d=intersection(k,make_domain(d.min,inf)))?c.extend_domain(a,e).extend_domain(b,d):!1:!1}}
function add_c(a,b,c){return function(d){var e=d.walk(a),k=d.walk(b),h=d.walk(c),e=get_domain(d,e),k=get_domain(d,k),h=get_domain(d,h);if(h=intersection(h,e.add(k)))if(e=intersection(e,h.sub(k)))if(k=intersection(k,h.sub(e)))return d.extend_domain(a,e).extend_domain(b,k).extend_domain(c,h);return!1}}
function mul_c(a,b,c){return function(d){var e=d.walk(a),k=d.walk(b),h=d.walk(c),e=get_domain(d,e),k=get_domain(d,k),h=get_domain(d,h);if(h=intersection(h,e.mul(k)))if(e=intersection(e,h.div(k)))if(k=intersection(k,h.div(e)))return d.extend_domain(a,e).extend_domain(b,k).extend_domain(c,h);return!1}}
var clpr={dom:function(a,b,c){assert("number"===typeof b&&"number"===typeof c,"#2-3 arguments of dom must be number.");return function(d){var e=make_domain(b,c);d.walk(a);var k=get_domain(d,a);return(e=intersection(k,e))?logic.win(d.extend_domain(a,e)):logic.fail()}},add:function(a,b,c){return goal_construct(add_c,[a,b,c],"+")},sub:function(a,b,c){return clpr.add(c,b,a)},mul:function(a,b,c){return goal_construct(mul_c,[a,b,c],"*")},div:function(a,b,c){return clpr.mul(c,b,a)},less_equal:function(a,
...
logic.eq=function(a,b){return function(c){var d=c.frame,e=logic.unify(a,b,d);if(e){var k=c.set_frame(e);return d==e||c.store.is_empty()?logic.win(k):(c=run_constraints(k.store,k))?logic.win(c):logic.fail()}return logic.fail()}};logic.win=function(a){return logic.make_stream(a||logic.nil)};logic.fail=function(){return EMPTY_STREAM};logic.disj=function(a,b){return function(c){return a(c).append(b(c))}};
...
logic.run=function(a,b,c){assert(logic.is_lvar(b)||logic.is_array(b),"#2 of run must be variable/array");c="undefined"===typeof c?inf:c;a=a(logic.nil);for(var d=[],e=0;e<c&&!a.is_empty();++e){var k=a.first,h=k.frame;if(logic.is_lvar(b)){var l=h.walk(b),l=logic.is_lvar(l)?k.get_value(b):l;d.push(l)}else{for(var g=[],p=0;p<b.length;++p)l=h.walk(b[p]),l=logic.is_lvar(l)?k.get_value(l):l,g.push(l);d.push(g)}a=a.rest()}return d};
