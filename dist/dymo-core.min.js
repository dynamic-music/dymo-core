...
0,d,c=$jscomp.makeIterator(n.values()),e=c.next();!e.done;e=c.next()){var e=e.value,f;f=e;var g=f.getDymo().getParameter(PLAYBACK_RATE).getValue();f=f.getDuration()/g;f>b&&(b=f,d=e)}return[a+b,d]}function r(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var k=new Map,B=0;B<a.length;B++)if(a[B].getSourcePath()){var g=d[a[B].getSourcePath()];k.set(a[B],new Source(a[B],c,g,e,f,p))}return k}}var v=new Map,w,y,n=[],t,k;b||(b=new DymoNavigator(a,
...
this.getSources=function(a){return v.get(a)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){n.loadData(a,!0,b)})}function d(a,b,c){w(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(t)&&(a=a.replace(t,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(t)&&(f=t+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
...
c.error=function(a){console.log(a)};c.send()}function y(a,b,c){w(a,function(a){n.loadData(a,b,c)})}var n=new EasyStore,t="";(function(){y("http://tiny.cc/dymo-ontology",!1,function(){y("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;t=a.substring(0,d);c(a,function(){b(f({}))})};this.parseDymoFromJson=function(a,b){n.loadData(a,!0,function(){b(f({}))})};this.loadRenderingFromJson=function(a,b,d){b||(b={});c(a,function(){for(var a=
b,c=n.findFirstSubjectUri(TYPE,RENDERING),e=new Rendering(a[n.findFirstObjectUri(c,HAS_DYMO)]),k=n.findAllObjectUris(c,HAS_MAPPING),f={},g=0;g<k.length;g++)for(var h=n.findAllObjectUris(k[g],HAS_DOMAIN_DIMENSION),q=0;q<h.length;q++){var m=n.findFirstObjectUri(h[q],TYPE),u=n.findFirstObjectValue(h[q],NAME);u||(u=h[q]);if(n.isSubclassOf(m,MOBILE_CONTROL)&&!f[h[q]]){var t;t=h[q];var r=m,m=void 0;r==ACCELEROMETER_X||r==ACCELEROMETER_Y||r==ACCELEROMETER_Z?m=new AccelerometerControl(r):r==TILT_X||r==TILT_Y?
m=new TiltControl(r):r==GEOLOCATION_LATITUDE||r==GEOLOCATION_LONGITUDE?m=new GeolocationControl(r):r==GEOLOCATION_DISTANCE?m=new DistanceControl:r==COMPASS_HEADING?m=new CompassControl:r==BEACON?(u=n.findFirstObjectValue(t,HAS_UUID),m=n.findFirstObjectValue(t,HAS_MAJOR),r=n.findFirstObjectValue(t,HAS_MINOR),m=new BeaconControl(u,m,r)):r==SLIDER||r==TOGGLE||r==BUTTON||r==CUSTOM_CONTROL?m=new Control(u,r):r==RANDOM?m=new RandomControl:r==BROWNIAN?(u=n.findFirstObjectValue(t,HAS_INITIAL_VALUE),m=new BrownianControl(u)):
r==RAMP&&(m=Math.round(1E3*n.findFirstObjectUri(t,HAS_DURATION)),u=n.findFirstObjectValue(t,HAS_INITIAL_VALUE),m=new RampControl(m,u));n.findFirstObjectUri(t,IS_SMOOTH)&&m.setSmooth&&m.setSmooth(!0);t=Number(n.findFirstObjectUri(t,IS_AVERAGE_OF));!isNaN(t)&&m.setAverageOf&&m.setAverageOf(t);t=m;u=Number(n.findFirstObjectUri(h[q],VALUE));isNaN(u)||t.update(u);f[h[q]]=t}}for(g=0;g<k.length;g++)e.addMapping(p(k[g],a,void 0,f));if(a=n.findFirstObjectUri(c,HAS_NAVIGATOR))c=n.findFirstObjectUri(a,TO_DYMO),
c=l(c),e.addNavigator(v(n.findFirstObjectUri(a,TYPE)),c);d([e,f])})};this.loadGraphFromJson=function(a,b,c){d(a,"",function(a){for(var d=0;d<a.length;d++)if(a[d])for(var e=0;e<a[d].length;e++){var f=b[CONTEXT_URI+"dymo"+d],k=b[CONTEXT_URI+"dymo"+a[d][e]];f&&k&&f.addSimilar(k)}c(void 0)})}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
function(a,b){c(b+"rendering.json",a)};this.writeDmoToRdf=function(a){a=N3.Writer({prefixes:{ch:"rdf/charm.n3#",dmo:"rdf/dmo.n3#",mb:"rdf/mobile.n3#"}});b(a);a.end(function(a,b){console.log(b)})}};function EasyStore(){function a(a,b,e){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){e(b)}):e(a)}var b=N3.Store();this.loadData=function(c,d,e){a(c,d,function(a){N3.Parser().parse(a,function(a,c,d){c?b.addTriple(c):e&&e()})})};this.find=function(a,d,e){return b.find(a,d,e)};this.findFirstObjectUri=function(a,d){var e=b.find(a,d,null);if(0<e.length)return e[0].object};this.findFirstSubjectUri=function(a,d){var e=b.find(null,a,d);if(0<e.length)return e[0].subject};this.findFirstObjectValue=
function(a,b){var e=this.findFirstObjectUri(a,b);if(e){var f=N3.Util.getLiteralValue(e);"http://www.w3.org/2001/XMLSchema#string"!=N3.Util.getLiteralType(e)&&(f=Number(f));return f}};this.findAllObjectUris=function(a,d){return b.find(a,d,null).map(function(a){return a.object})};this.findAllObjectValues=function(a,b){return this.findAllObjectUris(a,b).map(function(a){return N3.Util.getLiteralValue(a)})};this.isSubclassOf=function(a,b){for(var e=this.findFirstObjectUri(a,RDFS_URI+"subClassOf");e;){if(e==
