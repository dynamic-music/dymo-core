...
void 0,a,k,p,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSource(a);d&&b.push(d)}return b};this.getUrisOfPlayingDymos=function(){return m};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e){function f(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=A||x<c.duration)c=p(c,m(A,c),m(x+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=x/d;c=p(c,0,m(d+.02,c));x=d}else if(0!=A||x<c.duration)c=p(c,m(A,c),m(x+.02,c));n(c,c.length);y.buffer=c;l[PLAYBACK_RATE]=y.playbackRate;g(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function g(a,b){k(a,b.getValue());b.addObserver(q)}function k(a,b,c){c&&(b+=q.getParameterValue(a));0>b&&0<=v.indexOf(a)&&(b=
0);c=b;l[a]&&(l[a].value||0==l[a].value?l[a].value=c:l[a].setValue(c));0<=D.indexOf(a)?(0==l[DISTANCE].value&&(l[DISTANCE].value=-.01),E.setPosition(l[PAN].value,l[HEIGHT].value,l[DISTANCE].value)):a==LOOP&&(y.loop=1==b)}function h(){r=!1;var a=b.currentTime;l[AMPLITUDE].setValueAtTime(l[AMPLITUDE].value,a);l[AMPLITUDE].linearRampToValueAtTime(0,a+.02);y.stop(a+.04)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function p(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,
d,a.sampleRate),v=0;v<a.numberOfChannels;v++)for(var D=e.getChannelData(v),l=a.getChannelData(v),f=0;f<d;f++)D[f]=l[c+f];return e}function n(a,b){for(var c=.02*a.sampleRate,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),v=0;v<c;v++)e[v]*=v/c,e[b-v-1]*=v/c}function w(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));t("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function t(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType=
"arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var q=this,r,u,l={},z=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,FILTER,PAN,HEIGHT,DISTANCE,LOOP],v=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,FILTER],D=[PAN,HEIGHT,DISTANCE],y=b.createBufferSource(),B=b.createGain();B.connect(b.destination);var C=b.createGain();C.connect(d);C.gain.value=0;B.connect(C);var E=b.createPanner();E.connect(B);
d=b.createBiquadFilter();d.type="lowpass";d.frequency.value=2E4;d.connect(E);y.connect(d);var F=a.getSegment(),A=F[0],x=F[1];A||(A=0);!x&&c&&(x=c.duration-A);c?f():w(a.getSourcePath(),A,A+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=p(c,0,m(d+.02,c)),x=d):c=p(c,0,m(x+.02,c));n(c,c.length);y.buffer=c});l[AMPLITUDE]=B.gain;l[TIME_STRETCH_RATIO]={value:0};l[REVERB]=C.gain;l[FILTER]=d.frequency;l[PAN]={value:0};l[HEIGHT]=
{value:0};l[DISTANCE]={value:0};l[LOOP]={value:0};g(AMPLITUDE,a.getParameter(AMPLITUDE));g(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));g(REVERB,a.getParameter(REVERB));g(PAN,a.getParameter(PAN));g(HEIGHT,a.getParameter(HEIGHT));g(DISTANCE,a.getParameter(DISTANCE));g(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){k(a.getName(),a.getChange(),!0)};this.getDymo=function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return y.loop&&
r};this.getParameterValue=function(a){if(l[a])return l[a].value||0==l[a].value?l[a].value:l[a].getValue()};this.play=function(b){y.onended=function(){for(var b=0;b<z.length;b++){var c=a.getParameter(z[b]);c&&c.removeObserver(q)}y.disconnect();B.disconnect();C.disconnect();e&&e(q)};y.start(b);r=!0};this.pause=function(){r?(h(),u=!0):u&&(u=!1,this.play())};this.stop=function(){r&&h()}};function SchedulerThread(a,b,c,d,e,f,g){function k(){q=u?u:n();h(q);l||(l=q[0].getDymo().getParameter(ONSET).getValue());var a;a=r?r-c.currentTime:SCHEDULE_AHEAD_TIME;for(var d=c.currentTime+a,e=0;e<q.length;e++)q[e].play(d);setTimeout(function(){f()},a);(u=n())?(r=p(d),a=1E3*(r-c.currentTime-SCHEDULE_AHEAD_TIME),t=setTimeout(function(){k()},a)):(r=p(d),a=1E3*(r-c.currentTime),setTimeout(function(){b.reset();g&&g()},a))}function h(a){for(var b=0;b<a.length;b++)w.set(a[b].getDymo(),a[b])}function m(a){w.delete(a.getDymo());
0==w.size&&window.clearTimeout(t);f()}function p(a){if(u){var b=u[0].getDymo().getParameter(ONSET).getValue(),c=b-l;l=b;if(!isNaN(b))return a+c}b=q[0];c=b.getDymo().getParameter(PLAYBACK_RATE).getValue();b=b.getDuration()/c;return a+b}function n(){var a=b.getNextParts();console.log(a.map(function(a){return a.getIndex()}));if(a){for(var v=[],l=0;l<a.length;l++)if(a[l].getSourcePath()){var f=d[a[l].getSourcePath()];v.push(new Source(a[l],c,f,e,m))}return v}}var w=new Map,t,q=[],r,u,l;b||(b=new DymoNavigator(a,
new SequentialNavigator(a)));k();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=w.get(a[b]);d&&d.pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=w.get(a[b]);d&&d.stop()}};this.getSources=function(){return w};this.getSource=function(a){return w.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();f[b]=a;f[b].addObserver(e)}var e=this,f={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,f);var g;this.addParameter=d;this.getParameter=function(a){return f[a]};this.startUpdate=function(){g=setInterval(b,f[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(g);g=null;c&&c()};this.observedParameterChanged=function(a){a==f[AUTO_CONTROL_FREQUENCY]?
...
g.push(k):n==PARAMETER?(k=c?p(c,k,0):new Parameter(k,0),g.push(k)):(m=e&&e[k]?e[k]:w(m),e&&!e[k]&&(e[k]=m),g.push(m))}return new Mapping(g,b,a["function"],d,a.parameter,f)}function p(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function n(a,b){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=b["dymo"+c],f=b["dymo"+a[c][d]];e&&f&&e.addSimilar(f)}}function w(a){var c=a.type,d=a.name;if(c==ACCELEROMETER_X)return t(0);if(c==ACCELEROMETER_Y)return t(1);
...
function(a,b){c(b+"rendering.json",a)};this.writeDmoToRdf=function(a){a=N3.Writer({prefixes:{ch:"rdf/charm.n3#",dmo:"rdf/dmo.n3#",mb:"rdf/mobile.n3#"}});b(a);a.end(function(a,b){console.log(b)})}};function Control(a,b,c){function d(a,b){if(void 0==f||1E-6<Math.abs(a-f))f=a,e(b)}function e(a){for(var b=0;b<h.length;b++)h[b]!=a&&h[b].updateParameter(f,this)}var f,g,k,h=[],m,p,n;this.getName=function(){return a};this.getParameter=function(a){if(c)return c[a]};this.getValue=function(){return f};this.getType=function(){return b};this.getReferenceValue=function(){return g};this.setReferenceAverageCount=function(a){k=a;this.resetReferenceValue()};this.resetReferenceValue=function(){g=f=void 0;p=m=
...
b.getParts()[c],d)}function k(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)k(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var m=this,p=null,n=[],w=[],t={},q={},r=[],u=[],l="",z;q[PLAY]=new Parameter(PLAY,0,!0);q[LOOP]=new Parameter(LOOP,0,!0);
...
!l?p.getBasePath():l};this.setSourcePath=function(a){z=a};this.getSourcePath=function(){if(p&&!z)return p.getSourcePath();if(z)return this.getBasePath()+z};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){w.push(a)};this.getSimilars=function(a){return w};this.getFeatures=function(){return t};this.setFeature=
