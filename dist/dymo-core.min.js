...
function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e,f){function g(a,c){var d=b.createGain();d.connect(c);d.gain.value=0;a.connect(d);return d}function k(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=A||y<c.duration)c=u(c,m(A,c),m(y+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=y/d;c=u(c,0,m(d+.02,c));y=d}else if(0!=A||y<c.duration)c=u(c,m(A,c),m(y+.02,c));t(c,c.length);z.buffer=c;l[PLAYBACK_RATE]=z.playbackRate;h(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function h(a,b){p(a,b.getValue());b.addObserver(r)}
function p(a,b,c){c&&(b+=r.getParameterValue(a));0>b&&0<=G.indexOf(a)&&(b=0);c=b;l[a]&&(l[a].value||0==l[a].value?l[a].value=c:l[a].setValue(c));0<=H.indexOf(a)?(0==l[DISTANCE].value&&(l[DISTANCE].value=-.01),D.setPosition(l[PAN].value,l[HEIGHT].value,l[DISTANCE].value)):a==LOOP&&(z.loop=1==b)}function n(){w=!1;var a=b.currentTime;l[AMPLITUDE].setValueAtTime(l[AMPLITUDE].value,a);l[AMPLITUDE].linearRampToValueAtTime(0,a+.02);z.stop(a+.04)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}
function u(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),l=0;l<a.numberOfChannels;l++)for(var B=e.getChannelData(l),f=a.getChannelData(l),r=0;r<d;r++)B[r]=f[c+r];return e}function t(a,b){for(var c=.02*a.sampleRate,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),l=0;l<c;l++)e[l]*=l/c,e[b-l-1]*=l/c}function q(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));v("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+
c,function(a){d(a)})}function v(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var r=this,w,x,l={},B=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],G=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],z=b.createBufferSource(),C=b.createGain();C.connect(b.destination);
var E=g(C,d);d=g(C,e);var D=b.createPanner();D.connect(C);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(D);z.connect(e);var F=a.getSegment(),A=F[0],y=F[1];A||(A=0);!y&&c&&(y=c.duration-A);c?k():q(a.getSourcePath(),A,A+y+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=y/d,c=u(c,0,m(d+.02,c)),y=d):c=u(c,0,m(y+.02,c));t(c,c.length);z.buffer=c});l[AMPLITUDE]=C.gain;l[TIME_STRETCH_RATIO]={value:0};l[REVERB]=
...
!0)};this.getDymo=function(){return a};this.getDuration=function(){return y};this.isLoopingAndPlaying=function(){return z.loop&&w};this.getParameterValue=function(a){if(l[a])return l[a].value||0==l[a].value?l[a].value:l[a].getValue()};this.play=function(b){z.onended=function(){for(var b=0;b<B.length;b++){var c=a.getParameter(B[b]);c&&c.removeObserver(r)}z.disconnect();C.disconnect();E.disconnect();f&&f(r)};b||(b=0);z.start(b);w=!0};this.pause=function(){w?(n(),x=!0):x&&(x=!1,this.play())};this.stop=
function(){w&&n()}};function SchedulerThread(a,b,c,d,e,f,g,k){function h(){r=x?x:t();n(r);l||(l=r[0].getDymo().getParameter(ONSET).getValue());var a;a=w?w-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=0;d<r.length;d++)r[d].play(b);setTimeout(function(){g()},a);(x=t())?(w=u(b),a=1E3*(w-c.currentTime-SCHEDULE_AHEAD_TIME),v=setTimeout(function(){h()},a)):(w=u(b),a=1E3*(w-c.currentTime),setTimeout(function(){p()},a+100))}function p(){0==q.size&&(window.clearTimeout(v),b.reset(),k&&k())}function n(a){for(var b=
0;b<a.length;b++)q.set(a[b].getDymo(),a[b])}function m(a){q.delete(a.getDymo());g();p()}function u(a){if(x){var b=x[0].getDymo().getParameter(ONSET).getValue(),c=b-l;l=b;if(!isNaN(b))return a+c}b=r[0];c=b.getDymo().getParameter(PLAYBACK_RATE).getValue();b=b.getDuration()/c;return a+b}function t(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return a.getIndex()}));for(var l=[],r=0;r<a.length;r++)if(a[r].getSourcePath()){var h=d[a[r].getSourcePath()];l.push(new Source(a[r],c,h,e,f,m))}return l}}
var q=new Map,v,r=[],w,x,l;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));h();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);d&&d.pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);d&&d.stop()}};this.getSources=function(){return q};this.getSource=function(a){return q.get(a)}}
...
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b,e,l,f){var h=new XMLHttpRequest;h.open("GET",a,!0);h.onload=function(){if(!this.responseText.includes("Cannot GET")){var h;a:{try{JSON.parse(this.responseText)}catch(g){h=!1;break a}h=!0}h&&(b?(a.includes(v)&&(a=a.replace(v,"")),b=b.replace('"'+a+'"',this.responseText)):b=this.responseText);(h=d(b))?(h.includes(v)||(h=v+h),c(h,b,e,l,f)):b&&(h=f(JSON.parse(b),e),l(h))}};h.error=function(a){console.log(a)};h.send()}function d(a){var b=a.indexOf(".json");if(0<=
b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return d(a.substring(b+1))}}function e(a,b){var c=f(a,b);g(a,b);return[c,b]}function f(b,c){var d=new DynamicMusicObject(b["@id"],b.cdt,a);d.setBasePath(v);c[b["@id"]]=d;b.source&&d.setSourcePath(b.source);if(b.features)for(var e=0;e<b.features.length;e++)d.setFeature(b.features[e]["@id"],b.features[e].value);if(b.presets)for(e=0;e<b.presets.length;e++)n(d,b.presets[e].parameter,b.presets[e].value);
if(b.parts)for(e=0;e<b.parts.length;e++)d.addPart(f(b.parts[e],c));return d}function g(a,b){var c=b[a["@id"]];if(a.similars)for(var d=0;d<a.similars.length;d++)c.addSimilar(b[a.similars[d]]);if(a.mappings)for(d=0;d<a.mappings.length;d++)c.addMapping(h(a.mappings[d],b,c));if(a.parts)for(d=0;d<a.parts.length;d++)g(a.parts[d],b)}function k(a,b){for(var c=new Rendering(b[a.dymo]),d={},e=0;e<a.mappings.length;e++)c.addMapping(h(a.mappings[e],b,void 0,d));a.navigator&&(e=Function.apply(null,a.navigator.dymos.args.concat(a.navigator.dymos.body)),
c.addNavigator(a.navigator["@type"]==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0),e));return[c,d]}function h(b,c,d,e){if(b.controls){for(var f=[],h=0;h<b.controls.length;h++)f.push(e[b.controls[h]]);return p(b,c,d,f,e)}if(b.dymos){var f=[],g;if(b.dymos instanceof Array)for(h=0;h<b.dymos.length;h++)f.push(c[b.dymos[h]]);else g=Function.apply(null,b.dymos.args.concat(b.dymos.body)),h=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(f,h.filter(g));
return p(b,c,d,f,e,g)}return p(b,c,d,[a],e)}function p(a,b,c,d,e,f){b=a.relative;for(var h=[],g=0;g<a.domainDims.length;g++){var p=a.domainDims[g],k=p.name,m=p["@type"];m==FEATURE?h.push(k):m==PARAMETER?(p=c?n(c,k,0):new Parameter(k,0),h.push(p)):(m=e&&e[k]?e[k]:u(p),"value"in p&&m.update(p.value),e&&!e[k]&&(e[k]=m),h.push(m))}return new Mapping(h,b,a["function"],d,a.range,f)}function n(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function m(a,b){for(var c=
0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=b["dymo"+c],f=b["dymo"+a[c][d]];e&&f&&e.addSimilar(f)}}function u(a){var c=a["@type"],d=a.name;if(c==ACCELEROMETER_X)return t(0);if(c==ACCELEROMETER_Y)return t(1);if(c==ACCELEROMETER_Z)return t(2);if(c==TILT_X)return t(3);if(c==TILT_Y)return t(4);if(c==GEOLOCATION_LATITUDE)return q(0);if(c==GEOLOCATION_LONGITUDE)return q(1);if(c==GEOLOCATION_DISTANCE)return q(2);if(c==COMPASS_HEADING)return b.compassWatcher||(b.compassWatcher=new CompassWatcher),
a=b.compassWatcher.headingControl,a;if(c==SLIDER||c==TOGGLE||c==BUTTON||c==CUSTOM)return new Control(d,c);if(c==RANDOM)return new RandomControl;if(c==BROWNIAN)return new BrownianControl(parseFloat(a.value));if(c==RAMP)return c=Math.round(1E3*parseFloat(a.duration)),new RampControl(c,parseFloat(a.value))}function t(a){b.accelerometerWatcher||(b.accelerometerWatcher=new AccelerometerWatcher);if(0==a)return b.accelerometerWatcher.xControl;if(1==a)return b.accelerometerWatcher.yControl;if(2==a)return b.accelerometerWatcher.zControl;
if(3==a)return b.accelerometerWatcher.tiltXControl;if(4==a)return b.accelerometerWatcher.tiltYControl}function q(a){b.geolocationWatcher||(b.geolocationWatcher=new GeolocationWatcher);return 0==a?b.geolocationWatcher.latitudeControl:1==a?b.geolocationWatcher.longitudeControl:b.geolocationWatcher.distanceControl}var v="";this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;v=a.substring(0,d);c(a,"",{},b,e)};this.parseDymoFromJson=function(a,b){b(e(a,{}))};this.loadRenderingFromJson=function(a,
b,d){c(a,"",b,d,k)};this.loadGraphFromJson=function(a,b,d){c(a,"",b,d,m)}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
...
b.getParts()[c],d)}function k(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)k(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var p=this,n=null,m=[],u=[],t={},q={},v=[],r=[],w="",x;q[PLAY]=new Parameter(PLAY,0,!0);q[LOOP]=new Parameter(LOOP,0,!0);
