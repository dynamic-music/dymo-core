...
$jscomp.string.endsWith=function(a,b){$jscomp.string.noRegExp_(a,"endsWith");var c=this.toString();a+="";void 0===b&&(b=c.length);for(var d=Math.max(0,Math.min(b|0,c.length)),e=a.length;0<e&&0<d;)if(c[--d]!=a[--e])return!1;return 0>=e};$jscomp.string.endsWith$install=function(){String.prototype.endsWith||(String.prototype.endsWith=$jscomp.string.endsWith)};var SCHEDULE_AHEAD_TIME=.1,FADE_LENGTH=.02,DYMO_ONTOLOGY_URI="http://tiny.cc/dymo-ontology#";var RDFS_URI="http://www.w3.org/2000/01/rdf-schema#",CONTEXT_URI="http://tiny.cc/dymo-context/",TYPE="http://www.w3.org/1999/02/22-rdf-syntax-ns#type",NAME="http://schema.org/name",CDT="http://tiny.cc/charm-ontology#cdt",ADT="http://tiny.cc/charm-ontology#adt",VALUE="http://tiny.cc/charm-ontology#value",HAS_PART="http://tiny.cc/charm-ontology#hasPart",DYMO="http://tiny.cc/dymo-ontology#Dymo",DYMO_TYPE="http://tiny.cc/dymo-ontology#DymoType",CONJUNCTION="http://tiny.cc/dymo-ontology#Conjunction",DISJUNCTION=
"http://tiny.cc/dymo-ontology#Disjunction",SEQUENCE="http://tiny.cc/dymo-ontology#Sequence",FEATURE="http://tiny.cc/dymo-ontology#Feature",PARAMETER="http://tiny.cc/dymo-ontology#Parameter",FEATURE_TYPE="http://tiny.cc/dymo-ontology#FeatureType",PARAMETER_TYPE="http://tiny.cc/dymo-ontology#ParameterType",LEVEL_FEATURE="http://tiny.cc/dymo-ontology#LevelFeature",INDEX_FEATURE="http://tiny.cc/dymo-ontology#IndexFeature",ONSET_FEATURE="http://tiny.cc/dymo-ontology#OnsetFeature",DURATION_FEATURE="http://tiny.cc/dymo-ontology#DurationFeature",
TIME_FEATURE="http://tiny.cc/dymo-ontology#TimeFeature",SEGMENT_LABEL_FEATURE="http://tiny.cc/dymo-ontology#SegmentLabelFeature",CUSTOM_FEATURE="http://tiny.cc/dymo-ontology#CustomFeature",AUDIO_PARAMETER="http://tiny.cc/dymo-ontology#AudioParameter",HAS_STANDARD_VALUE="http://tiny.cc/dymo-ontology#hasStandardValue",IS_INTEGER="http://tiny.cc/dymo-ontology#isInteger",PLAY="http://tiny.cc/dymo-ontology#Play",LOOP="http://tiny.cc/dymo-ontology#Loop",ONSET="http://tiny.cc/dymo-ontology#Onset",DURATION_RATIO=
"http://tiny.cc/dymo-ontology#DurationRatio",AMPLITUDE="http://tiny.cc/dymo-ontology#Amplitude",PLAYBACK_RATE="http://tiny.cc/dymo-ontology#PlaybackRate",TIME_STRETCH_RATIO="http://tiny.cc/dymo-ontology#TimeStretchRatio",PAN="http://tiny.cc/dymo-ontology#Pan",DISTANCE="http://tiny.cc/dymo-ontology#Distance",HEIGHT="http://tiny.cc/dymo-ontology#Height",REVERB="http://tiny.cc/dymo-ontology#Reverb",DELAY="http://tiny.cc/dymo-ontology#Delay",FILTER="http://tiny.cc/dymo-ontology#Filter",STRUCTURAL_PARAMETER=
"http://tiny.cc/dymo-ontology#StructuralParameter",PART_COUNT="http://tiny.cc/dymo-ontology#PartCount",PART_DURATION_RATIO="http://tiny.cc/dymo-ontology#PartDurationRatio",PART_PROPORTION="http://tiny.cc/dymo-ontology#PartProportion",CUSTOM_PARAMETER="http://tiny.cc/dymo-ontology#CustomParameter",HAS_SOURCE="http://tiny.cc/dymo-ontology#hasSource",HAS_PARAMETER="http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_PARAMETER_TYPE="http://tiny.cc/dymo-ontology#hasParameterType",
HAS_FEATURE_TYPE="http://tiny.cc/dymo-ontology#hasFeatureType",HAS_SIMILAR="http://tiny.cc/dymo-ontology#hasSimilar",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",MAPPING="http://tiny.cc/mobile-audio-ontology#Mapping",FUNCTION="http://tiny.cc/mobile-audio-ontology#Function",MOBILE_CONTROL="http://tiny.cc/mobile-audio-ontology#MobileControl",SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",UI_CONTROL="http://tiny.cc/mobile-audio-ontology#UiControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",
...
"http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo";function DymoManager(a,b,c,d){var e=new Scheduler(a);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g,h={},m={};this.loadDymoAndRendering=function(a,b,l,w){var r=new DymoLoader(e,function(){r.loadDymoFromJson(a,function(a){r.loadRenderingFromJson(b,function(b){f=r.getStore();g=b[0];g.dymo=a[0];for(var p in b[1]){var n=b[1][p];f.isSubclassOf(n.getType(),UI_CONTROL)&&(h[p]=new UIControl(n,d));f.isSubclassOf(n.getType(),SENSOR_CONTROL)&&(m[p]=n)}c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.initEffectSends(f,
c);e.loadBuffers(g.dymo,w);l&&l()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};this.replacePartOfTopDymo=function(a,b){var c=g.dymo.getPart(a);g.dymo.replacePart(a,b);e.stop(c)};this.updateNavigatorPosition=function(a,b,c){e.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return e.getNavigatorPosition(a,
b)};this.syncNavigators=function(a,b,c){e.syncNavigators(a,b,c)};this.startPlaying=function(){g.dymo.updatePartOrder(ONSET);e.play(g.dymo)};this.stopPlaying=function(){e.stop(g.dymo)};this.getTopDymo=function(){return g.dymo};this.getRendering=function(){return g};this.getUIControls=function(){return h};this.getUIControl=function(a){return h[a]};this.getSensorControls=function(){return m}};var URI_TO_TERM={"http://tiny.cc/dymo-ontology#LevelFeature":"level","http://tiny.cc/dymo-ontology#IndexFeature":"index","http://tiny.cc/dymo-ontology#OnsetFeature":"onset","http://tiny.cc/dymo-ontology#DurationFeature":"duration","http://tiny.cc/dymo-ontology#TimeFeature":"time","http://tiny.cc/dymo-ontology#SegmentLabelFeature":"segmentLabel","http://tiny.cc/dymo-ontology#hasSource":"source","http://tiny.cc/dymo-ontology#hasParameter":"parameters","http://tiny.cc/dymo-ontology#hasFeature":"features",
...
DymoNode.prototype.removeAndDisconnect=function(){for(var a in this.parameters){var b=this.dymo.getParameter(a);b&&b.removeObserver(this)}this.dryGain.disconnect();this.reverbGain&&this.reverbGain.disconnect();this.delayGain&&this.delayGain.disconnect()};function AudioProcessor(a){function b(a){return{extract:function(b,e,f){for(var g=[],h=0;h<a.numberOfChannels;h++)g.push(a.getChannelData(h));for(h=0;h<e;h++)for(var m=0;m<g.length;m++)b[h*g.length+m%g.length]=g[m][h+f];return Math.min(e,g[0].length-f)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;for(var f=b(c),e=new SimpleFilter(f,e),f=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate),g=[],h=0;h<c.numberOfChannels;h++)g.push(f.getChannelData(h));for(var m=
new Float32Array(2048),p=e.extract(m,1024),n=0;p;){for(h=0;h<p;h++)for(var l=0;l<g.length;l++)g[l][h+n]=m[h*g.length+l%g.length];n+=p;p=e.extract(m,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),h=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(h,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=h[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b){function c(){0<n&&n--;0==n&&l&&l()}function d(a){h.splice(h.indexOf(a),1)}function e(){for(var a=[],c=0;c<h.length;c++)for(var d=$jscomp.makeIterator(h[c].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();m=a;b&&b()}function f(b,c){n++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,b)})};d.error=
function(){};d.send()}var g={},h=[],m=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var p,n=0,l;this.initEffectSends=function(b,d){0<b.find(null,null,REVERB).length&&(p=a.createConvolver(),p.connect(a.destination),f(d,function(a){p.buffer=a;c()}));if(0<b.find(null,null,DELAY).length){var e=a.createDelay();e.delayTime.value=.5;e.connect(a.destination);var g=a.createGain();g.gain.value=.6;e.connect(g);g.connect(e)}};this.loadBuffers=function(a,
b){l=b;for(var d=a.getAllSourcePaths(),e=0,h=d.length;e<h;e++)g[d[e]]||f(d[e],function(a,b){g[b]=a;c()})};this.getBuffer=function(a){return g[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,
a)};this.syncNavigators=function(a,b,c){for(var d,e,f=0,g=h.length;f<g;f++)h[f].hasDymo(a)&&(d=h[f].getNavigator()),h[f].hasDymo(b)&&(e=h[f].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,g,p,void 0,e,d);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSources(a);
if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return m};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function DymoSource(a,b,c,d,e,f){function g(b,d){var e=b[0],f=b[1],f=1!=d?f+.3:f+FADE_LENGTH;if(c||isNaN(e+f)){if(0!=e||f<c.duration)c=n(c,p(e,c),p(f,c));return h(c,f,d)}l(a.getSourcePath(),e,e+f,function(a){return h(a,f,d)})}function h(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=n(a,0,p(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var e=c.sampleRate*FADE_LENGTH,f=0;f<c.numberOfChannels;f++)for(var g=c.getChannelData(f),h=0;h<e;h++)g[h]*=h/e,g[d-h-1]*=h/e;return a}function m(){x=!1;var a=
b.currentTime;r.parameters[AMPLITUDE].setValueAtTime(r.parameters[AMPLITUDE].value,a);r.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);q.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function n(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),f=0;f<a.numberOfChannels;f++)for(var g=e.getChannelData(f),h=a.getChannelData(f),m=0;m<d;m++)g[m]=h[c+m];return e}function l(a,b,c,d){var e=a.lastIndexOf("/");e&&
(a=a.substring(e+1));w("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function w(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var r=this,x,k,u,q=b.createBufferSource();q.connect(this.getInput());(function(){var b=a.getSegment();b[0]||(b[0]=0);!b[1]&&c&&
(b[1]=c.duration-b[0]);if(a.hasParameter(DURATION_RATIO)){var d=a.getParameter(DURATION_RATIO).getValue();0<d&&1>d&&(b[1]*=d)}u=b[1];d=a.hasParameter(TIME_STRETCH_RATIO)?a.getParameter(TIME_STRETCH_RATIO).getValue():1;q.buffer=g(b,d)})();this.addParameter(PLAYBACK_RATE,q.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return u};this.isLoopingAndPlaying=function(){return q.loop&&x};this.play=function(a){q.onended=function(){q.disconnect();
r.removeAndDisconnect();f&&f(r)};a||(a=0);q.start(a);x=!0};this.pause=function(){x?(m(),k=!0):k&&(k=!1,this.play())};this.stop=function(){x&&m()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,f,g,h){function m(){y=q?q:r();p(y);if(!z){var a=y.keys().next().value;a.hasParameter(ONSET)&&(z=a.getParameter(ONSET).getValue())}a=v?v-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(y.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){g()},a);(q=r())&&0<q.size?(v=w(b),a=v[1],v=v[0],a.getDymo().hasParameter(LOOP)&&a.getDymo().getParameter(LOOP).getValue()&&(v-=FADE_LENGTH),a=1E3*(v-c.currentTime-SCHEDULE_AHEAD_TIME),
t=setTimeout(function(){m()},a)):(v=w(b),a=1E3*(v-c.currentTime),setTimeout(function(){l()},a+100))}function p(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,k.get(c)||k.set(c,[]),k.get(c).push(a.get(c))}function n(a){var b=k.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&k.delete(a.getDymo());g();l()}function l(){if(0==k.size&&(!q||0==q.size)){window.clearTimeout(t);b.reset();for(var c=a.getAllDymosInHierarchy(),d=0,e=c.length;d<e;d++){var f=u.get(c[d]);
f&&f.removeAndDisconnect()}h&&h()}}function w(a){if(q){var b=q.keys().next().value,c;b.hasParameter(ONSET)&&(c=b.getParameter(ONSET).getValue());b=c-z;z=c;if(!isNaN(c))return a+b}c=0;for(var d,b=$jscomp.makeIterator(y.values()),e=b.next();!e.done;e=b.next()){var e=e.value,f=e.getDuration();f>c&&(c=f,d=e)}return[a+c,d]}function r(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var y=new Map,g=0;g<a.length;g++)if(a[g].getSourcePath()){var v=
d[a[g].getSourcePath()],v=new DymoSource(a[g],c,v,e,f,n);x(v);y.set(a[g],v)}return y}}function x(a){var b=a;for(a=a.getDymo().getParent();a;){if(u.has(a)){b.connect(u.get(a).getInput());return}var d=new DymoNode(a,c,e,f);b.connect(d.getInput());u.set(a,d);a=a.getParent();b=d}b.connect(c.destination)}var k=new Map,u=new Map,q,t,y=[],v,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));m();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};
this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=k.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].stop();q&&(q.delete(a[b]),0>=q.size&&(q=void 0))}};this.getAllSources=function(){return k};this.getSources=function(a){return k.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();f[b]=a;f[b].addObserver(e)}var e=this,f={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,f);var g;this.addParameter=d;this.getParameter=function(a){return f[a]};this.startUpdate=function(){g=setInterval(b,f[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(g);g=null;c&&c()};this.observedParameterChanged=function(a){a==f[AUTO_CONTROL_FREQUENCY]?
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){k.loadData(a,!0,b)})}function d(a,b,c){r(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(u)&&(a=a.replace(u,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(u)&&(f=u+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function f(){var a=k.findTopDymos()[0],b=g(a);h(a);return[b,t]}function g(b){var c=k.findFirstObjectUri(b,CDT),c=new DynamicMusicObject(b,c,a);c.setBasePath(u);t[b]=c;c.setSourcePath(k.findFirstObjectValue(b,HAS_SOURCE));for(var d=k.findAllObjectUris(b,HAS_FEATURE),e=0;e<d.length;e++)c.setFeature(d[e],k.findFirstObjectValue(d[e],VALUE));d=k.findAllObjectUris(b,HAS_PARAMETER);for(e=0;e<d.length;e++)l(c,k.findFirstObjectUri(d[e],TYPE),k.findFirstObjectValue(d[e],VALUE));b=k.findAllObjectUris(b,
HAS_PART);for(e=0;e<b.length;e++)c.addPart(g(b[e]));return c}function h(a){for(var b=t[a],c=k.findAllObjectUris(a,HAS_SIMILAR),d=0;d<c.length;d++)b.addSimilar(t[c[d]]);c=k.findAllObjectUris(a,HAS_MAPPING);m(c);for(d=0;d<c.length;d++)b.addMapping(p(c[d],b));a=k.findAllObjectUris(a,HAS_PART);for(d=0;d<a.length;d++)h(a[d])}function m(a){for(var b=0;b<a.length;b++)for(var c=k.findAllObjectUris(a[b],HAS_DOMAIN_DIMENSION),d=0;d<c.length;d++){var e=k.findFirstObjectUri(c[d],TYPE),f=k.findFirstObjectValue(c[d],
NAME);f||(f=c[d]);if(k.isSubclassOf(e,MOBILE_CONTROL)&&!q[c[d]]){var g=c[d],h=e,e=void 0;h==ACCELEROMETER_X||h==ACCELEROMETER_Y||h==ACCELEROMETER_Z?e=new AccelerometerControl(h):h==TILT_X||h==TILT_Y?e=new TiltControl(h):h==GEOLOCATION_LATITUDE||h==GEOLOCATION_LONGITUDE?e=new GeolocationControl(h):h==GEOLOCATION_DISTANCE?e=new DistanceControl:h==COMPASS_HEADING?e=new CompassControl:h==BEACON?(e=k.findFirstObjectValue(g,HAS_UUID),f=k.findFirstObjectValue(g,HAS_MAJOR),h=k.findFirstObjectValue(g,HAS_MINOR),
e=new BeaconControl(e,f,h)):h==SLIDER||h==TOGGLE||h==BUTTON||h==CUSTOM_CONTROL?(e=new Control(f,h),f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e.update(f)):h==RANDOM?e=new RandomControl:h==BROWNIAN?(f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new BrownianControl(f)):h==RAMP&&(e=Math.round(1E3*k.findFirstObjectUri(g,HAS_DURATION)),f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new RampControl(e,f));k.findFirstObjectValue(g,IS_SMOOTH)&&e.setSmooth&&e.setSmooth(!0);g=k.findFirstObjectValue(g,
IS_AVERAGE_OF);!isNaN(g)&&e.setAverageOf&&e.setAverageOf(g);q[c[d]]=e}}}function p(b,c){var d=k.findAllObjectUris(b,TO_TARGET);if(0<d.length){var e=[],f=k.findFunction(d[0]);if(f)d=Object.keys(t).map(function(a){return t[a]}),Array.prototype.push.apply(e,d.filter(f));else for(var g=0;g<d.length;g++)k.findFirstObjectUri(d[g],TYPE)==DYMO?e.push(t[d[g]]):e.push(q[d[g]]);return n(b,c,e,f)}return n(b,c,[a])}function n(a,b,c,d){for(var e=k.findFirstObjectUri(a,IS_RELATIVE),f=[],g=k.findAllObjectUris(a,
HAS_DOMAIN_DIMENSION),h=0;h<g.length;h++){var m=k.findFirstObjectUri(g[h],TYPE),p=k.findFirstObjectValue(g[h],NAME);p||(p=g[h]);m==FEATURE_TYPE||k.isSubclassOf(m,FEATURE_TYPE)?f.push(p):m==PARAMETER_TYPE||k.isSubclassOf(m,PARAMETER_TYPE)?(m=b?l(b,p):new Parameter(p,0),f.push(m)):f.push(q[g[h]])}g=$jscomp.makeIterator(k.findArgsAndBody(k.findFirstObjectUri(a,HAS_FUNCTION)));b=g.next().value;g=g.next().value;a=k.findFirstObjectUri(a,HAS_RANGE);for(h=0;h<c.length;h++)c[h]instanceof DynamicMusicObject&&
!c[h].getParameter(a)&&l(c[h],a);return new Mapping(f,e,{args:b,body:g},c,a,d)}function l(a,b,c){var d=a.getParameter(b);d?d.update(c):(isNaN(c)&&(c=k.findFirstObjectValue(b,HAS_STANDARD_VALUE,null),isNaN(c)&&(c=0)),d=k.findFirstObjectValue(b,IS_INTEGER,null),d=new Parameter(b,c,d),a.addParameter(d));return d}function w(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function r(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};
c.error=function(a){console.log(a)};c.send()}function x(a,b,c){r(a,function(a){k.loadData(a,b,c)})}var k=new DymoStore,u="",q={},t={};(function(){x("http://tiny.cc/dymo-ontology",!1,function(){x("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;u=a.substring(0,d);c(a,function(){b(f())})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(f())})};this.loadRenderingFromJson=
function(a,b){c(a,function(){var a=k.findFirstSubjectUri(TYPE,RENDERING),c=new Rendering(t[k.findFirstObjectUri(a,HAS_DYMO)]),d=k.findAllObjectUris(a,HAS_MAPPING);m(d);for(var e=0;e<d.length;e++)c.addMapping(p(d[e]));if(a=k.findFirstObjectUri(a,HAS_NAVIGATOR))d=k.findFirstObjectUri(a,TO_DYMO),d=k.findFunction(d),c.addNavigator(w(k.findFirstObjectUri(a,TYPE)),d);b([c,q])})};this.loadGraphFromJson=function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=
t[CONTEXT_URI+"dymo"+c],f=t[CONTEXT_URI+"dymo"+a[c][d]];e&&f&&e.addSimilar(f)}b(void 0)})}};function DymoStore(){function a(a,c,d){e.triplesToRdf(a,function(a){b(a,c,d)})}function b(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,e){jsonld.frame(e,{"@id":b},function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context",function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context-simple",function(a,b){d(b);b=JSON.stringify(b,null,2);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");b=b.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");
c(b)})})})})}function c(b,c){var d=e.findFirstObjectUri(b,TYPE,null),d=e.recursiveFindAllTriplesExcept(b,d);a(d,b,function(a){c(null,JSON.parse(a))})}function d(a){if(a&&a instanceof Object)for(var b in a)"@id"==b&&a[b].includes("_:b")?delete a[b]:d(a[b])}var e=this;EasyStore.call(this);this.addDymo=function(a,b,c,d){this.addTriple(a,TYPE,DYMO);b&&this.addTriple(b,HAS_PART,a);c&&this.addTriple(a,HAS_PART,c);d&&this.addTriple(a,HAS_SOURCE,d)};this.setFeature=function(a,b,c){var d=this.findFirstObjectUriOfType(a,
HAS_FEATURE,b);d?this.removeTriple(d,VALUE):(d=this.createBlankNode(),this.addTriple(a,HAS_FEATURE,d),this.addTriple(d,TYPE,b));this.addTriple(d,VALUE,N3.Util.createLiteral(c))};this.findTopDymos=function(){var a=this.find(null,HAS_PART,null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})};this.findParts=function(a){return this.findAllObjectUris(a,
HAS_PART)};this.findFunction=function(a){var b=$jscomp.makeIterator(this.findArgsAndBody(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))};this.findArgsAndBody=function(a){var b=this.findAllObjectValues(a,HAS_ARGUMENT);a=this.findFirstObjectValue(a,HAS_BODY);return[b,a]};this.findFeature=function(a,b){var c=this.findFirstObjectUriOfType(a,HAS_FEATURE,b);return this.findFirstObjectValue(c,VALUE)};this.getLevel=function(a){for(var b=0,c=this.findFirstSubjectUri(HAS_PART,
a);c;)b++,c=this.findFirstSubjectUri(HAS_PART,a);return b};this.toJsonld=function(a){var c=this.findTopDymos()[0];this.toRdf(function(d){b(d,c,a)})};this.toJsonGraph=function(a,b,d){var e={nodes:[],links:[]},p={},n=this.find(null,TYPE,a).map(function(a){return a.subject}),l=this.find(null,b,null);async.map(n,c,function(a,b){e.nodes=b;for(var c=0;c<n.length;c++)p[n[c]]=e.nodes[c];e.links=l.map(function(a){return{source:p[a.subject],target:p[a.object],value:1}});d(e)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a,b){function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeToJsonld=function(b,e){e||(e="dymo.json");a.toJsonld(function(a){c(b+e,a)})}};function EasyStore(){function a(a,b,e){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){e(b)}):e(a)}var b=N3.Store();this.addTriple=function(a,d,e){return b.addTriple(a,d,e)};this.removeTriple=function(a,d,e){e||(e=this.findFirstObjectUri(a,d));return b.removeTriple(a,d,e)};this.createBlankNode=function(){return b.createBlankNode()};this.loadData=function(c,d,e){a(c,d,function(a){N3.Parser().parse(a,function(a,c,d){c?b.addTriple(c):e&&e()})})};this.find=function(a,d,e){return b.find(a,
d,e)};this.findFirstObjectUri=function(a,d){var e=b.find(a,d);if(0<e.length)return e[0].object};this.findFirstObjectUriOfType=function(a,d,e){a=b.find(a,d).map(function(a){return a.object});a=a.filter(function(a){return 0<b.find(a,TYPE,e).length});if(0<a.length)return a[0]};this.findFirstSubjectUri=function(a,d){var e=b.find(null,a,d);if(0<e.length)return e[0].subject};this.findFirstObjectValue=function(a,b){var e=this.findFirstObjectUri(a,b);if(e){var f=N3.Util.getLiteralValue(e);"http://www.w3.org/2001/XMLSchema#string"!=
N3.Util.getLiteralType(e)&&(f=Number(f));return f}};this.findAllSubjectUris=function(a,d){return b.find(null,a,d).map(function(a){return a.subject})};this.findAllObjectUris=function(a,d){return b.find(a,d,null).map(function(a){return a.object})};this.findAllObjectValues=function(a,b){return this.findAllObjectUris(a,b).map(function(a){return N3.Util.getLiteralValue(a)})};this.recursiveFindAllTriplesExcept=function(a,d){for(var e=b.find(a,null,null),f=[],g=e.length-1;0<=g;g--)0<b.find(e[g].object,TYPE,
d).length?e.splice(g,1):f=f.concat(this.recursiveFindAllTriplesExcept(e[g].object,d));return e.concat(f)};this.isSubclassOf=function(a,b){for(var e=this.findFirstObjectUri(a,RDFS_URI+"subClassOf");e;){if(e==b)return!0;e=this.findFirstObjectUri(e,RDFS_URI+"subClassOf")}return!1};this.toRdf=function(a){var d=b.find(null,null,null);this.triplesToRdf(d,a)};this.triplesToRdf=function(a,b){for(var e=N3.Writer({format:"application/nquads"}),f=0;f<a.length;f++)e.addTriple(a[f]);e.end(function(a,c){b(c)})};
this.logData=function(){var a=b.find(null).map(function(a){return a.subject+"\n"+a.predicate+"\n"+a.object}),d;for(d in a)console.log(a[d])}};function Control(a,b,c){this.name=a;this.type=b;this.parameters=c;this.mappings=[]}Control.prototype.getName=function(){return this.name};Control.prototype.getParameter=function(a){if(this.parameters)return this.parameters[a]};Control.prototype.getValue=function(){return this.value};Control.prototype.getType=function(){return this.type};Control.prototype.setUpdateFunction=function(a){this.updateFunction=a};
...
Control.prototype.setValue=function(a,b){if(void 0==this.value||1E-6<Math.abs(a-this.value))this.value=a,this.updateMappings(b)};Control.prototype.updateMappings=function(a){for(var b=0;b<this.mappings.length;b++)this.mappings[b]!=a&&this.mappings[b].updateParameter(this.value,this)};function DynamicMusicObject(a,b,c){function d(a,b){b[a.getUri()]=a;for(var c=0;c<a.getParts().length;c++)d(a.getParts()[c],b)}function e(a,b,c,d){var f=a-b,g=d.getParts();if(d.getLevel()==c&&0==f)return d;if(d.getLevel()>=c-1)return f<g.length?g[f]:b+g.length;for(d=0;d<g.length;d++)if(b=e(a,b,c,g[d]),isNaN(b))return b}function f(a,b,c){c(a,b);a=a.getParts();for(var d=0,e=a.length;d<e;d++)f(a[d],b,c)}function g(a,b,c){var d=b.toFlatJson();a.nodes.push(d);c&&a.links.push(m(c,d));for(c=0;c<b.getParts().length;c++)g(a,
b.getParts()[c],d)}function h(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(m(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)h(a,b.getParts()[e],c)}function m(a,b){return{source:a,target:b,value:1}}var p=this,n=null,l=[],w=[],r={},x={},k=[],u=[],q="",t;this.setType=function(a){b=a};this.getType=function(){return b};
this.getUri=function(){return a};this.setParent=function(a){n=a;a=n.getMappings();for(var b=this.getMapOfDymosInSubtree(),b=Object.keys(b).map(function(a){return b[a]}),c=0;c<a.length;c++){var d=a[c].getDymoConstraint();d&&(d=a[c].getTargets().concat(b.filter(d)),a[c].setTargets(d))}};this.removeParent=function(){for(var a=0;a<u.length;a++)u[a].disconnect();u=[];for(var b=n.getMappings(),c=this,a=0;a<b.length;a++){var d=b[a].getTargets(),d=d.filter(function(a){return!a.isSubDymoOf(c)});b[a].setTargets(d)}n=
null};this.getParent=function(){return n};this.isSubDymoOf=function(a){for(var b=this;b;){if(b==a)return!0;b=b.getParent()}return!1};this.getMapOfDymosInSubtree=function(){var a={};d(this,a);return a};this.getLevel=function(){return n?n.getLevel()+1:0};this.getIndex=function(){if(n)return n.getParts().indexOf(this)};this.addPart=function(a){l.push(a);a.setParent(this)};this.removePart=function(a){l.splice(l.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){l[a]&&l[a].removeParent(this);
l[a]=b;b.setParent(this)};this.getPart=function(a){return l[a]};this.getParts=function(){return l};this.hasParts=function(){return 0<l.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){q=a};this.getBasePath=function(){return n&&!q?n.getBasePath():q};this.setSourcePath=function(a){t=a};this.getSourcePath=function(){if(n&&!t)return n.getSourcePath();if(t)return this.getBasePath()+t};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();
d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){w.push(a)};this.getSimilars=function(a){return w};this.getFeatures=function(){return r};this.setFeature=function(a,b){r[a]=b};this.getFeature=function(a){if(a===LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(r.hasOwnProperty(a))return r[a];if(n)return n.getFeature(a);for(var b=[],c=0;c<l.length;c++)if(l[c]){var d=
l[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(r[a])return r[a]};this.getMappings=function(){return k};this.getSegment=function(){return[this.getFeature(TIME_FEATURE),this.getFeature(DURATION_FEATURE)]};this.addParameter=function(a){x[a.getName()]=a};this.getParameter=function(a){return x[a]};this.hasParameter=function(a){return a in x};this.addMapping=function(a){k.push(a)};this.observedParameterChanged=function(a){a.getName()==
PLAY&&c&&(0<a.getChange()?c.play(p):c.stop(p))};this.updatePartOrder=function(a){l&&l[0]&&!isNaN(l[0].getFeature(a))?l.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):l&&l[0]&&l[0].hasParameter(a)&&l.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=function(){for(var a=this.toFlatJson(),b=0;b<l.length;b++)a.parts.push(l[b].toJsonHierarchy());return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};
this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};h(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);t&&(c.source=t);for(var d in r)c[d]=this.getFeatureJson(d);if(0<k.length)for(c.mappings=[],d=0;d<k.length;d++)c.mappings.push(k[d].toJson());0<l.length&&(c.parts=[]);if(0<w.length)for(c.similars=[],d=0;d<w.length;d++)c.similars.push(w[d].getUri());return c};this.getFeatureJson=function(a){return{value:r[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+
a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
...
d=d?[d]:void 0;return d}};this.getNextParts=function(){c++;return this.getCurrentParts()}};function SimilarityNavigator(a){function b(b){if(b&&0<b.length)for(var f=0;f<b.length;f++)if(0<b[f].getSimilars().length&&Math.random()<c.leapingProbability.getValue()){var g=b[f].getSimilars(),h=Math.floor(Math.random()*g.length);if(c.continueAfterLeaping.getValue()){var m=a.getParts().indexOf(h);m&&(d=m+1)}b[f]=g[h]}return b}var c=this,d=0;this.leapingProbability=new Parameter(LEAPING_PROBABILITY,.5);this.continueAfterLeaping=new Parameter(CONTINUE_AFTER_LEAPING,0,!0);this.resetPartsPlayed=function(){d=
...
return this.getCurrentParts()}};function FunctionTools(){}FunctionTools.IDENTITY_JSON={args:["a"],body:"return a;"};FunctionTools.inverted={};FunctionTools.created={};FunctionTools.createFunction=function(a,b){FunctionTools.created[b]||(FunctionTools.created[b]=Function.apply(null,a.concat(b)));return FunctionTools.created[b]};
...
e=this._outputBuffer.endIndex,f=0,g=0;1>this.slopeCount;)d[e+2*g]=(1-this.slopeCount)*this.prevSampleL+this.slopeCount*b[c],d[e+2*g+1]=(1-this.slopeCount)*this.prevSampleR+this.slopeCount*b[c+1],g++,this.slopeCount+=this._rate;--this.slopeCount;if(1!=a)a:for(;;){for(;1<this.slopeCount;)if(--this.slopeCount,f++,f>=a-1)break a;var h=c+2*f;d[e+2*g]=(1-this.slopeCount)*b[h]+this.slopeCount*b[h+2];d[e+2*g+1]=(1-this.slopeCount)*b[h+1]+this.slopeCount*b[h+3];g++;this.slopeCount+=this._rate}this.prevSampleL=
...
e,f,g,h,m,p,n;h=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*h,m=e*h,f=2*e,p=f+a,n=f+d,c[n+0]=b[p+0]*m+this.pMidBuffer[f+0]*g,c[n+1]=b[p+1]*m+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
