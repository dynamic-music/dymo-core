...
var SCHEDULE_AHEAD_TIME=.1,FADE_LENGTH=.02,RDF_URI="http://www.w3.org/1999/02/22-rdf-syntax-ns#",RDFS_URI="http://www.w3.org/2000/01/rdf-schema#",SCHEMA_URI="http://schema.org/",CHARM_URI="http://tiny.cc/charm-ontology#",DYMO_URI="http://tiny.cc/dymo-ontology#",MOBILE_URI="http://tiny.cc/mobile-audio-ontology#",CONTEXT_URI="http://tiny.cc/dymo-context/",DYMO=DYMO_URI+"Dymo",PARALLEL=DYMO_URI+"Conjunction",SEQUENTIAL=DYMO_URI+"Sequence",DYMO_TYPES=[PARALLEL,SEQUENTIAL],FEATURE=DYMO_URI+"Feature",PARAMETER=
DYMO_URI+"Parameter",ONE_SHOT_NAVIGATOR="OneShotNavigator",SEQUENTIAL_NAVIGATOR="SequentialNavigator",SIMILARITY_NAVIGATOR="SimilarityNavigator",PLAY=DYMO_URI+"Play",LOOP=DYMO_URI+"Loop",ONSET=DYMO_URI+"Onset",DURATION_RATIO=DYMO_URI+"DurationRatio",AMPLITUDE=DYMO_URI+"Amplitude",PLAYBACK_RATE=DYMO_URI+"PlaybackRate",TIME_STRETCH_RATIO=DYMO_URI+"TimeStretchRatio",PAN=DYMO_URI+"Pan",DISTANCE=DYMO_URI+"Distance",HEIGHT=DYMO_URI+"Height",REVERB=DYMO_URI+"Reverb",DELAY=DYMO_URI+"Delay",FILTER=DYMO_URI+
"Filter",PART_INDEX=DYMO_URI+"PartIndex",PART_COUNT=DYMO_URI+"PartCount",PART_ORDER=DYMO_URI+"PartOrder",LISTENER_ORIENTATION=DYMO_URI+"ListenerOrientation",AUTO_CONTROL_FREQUENCY=DYMO_URI+"AutoControlFrequency",AUTO_CONTROL_TRIGGER=DYMO_URI+"AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE=DYMO_URI+"BrownianMaxStepSize",LEAPING_PROBABILITY=DYMO_URI+"LeapingProbability",CONTINUE_AFTER_LEAPING=DYMO_URI+"ContinueAfterLeaping",PARAMETERS=[PLAY,LOOP,ONSET,DURATION_RATIO,AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,
PAN,DISTANCE,HEIGHT,REVERB,DELAY,FILTER,PART_INDEX,PART_COUNT,PART_ORDER,LISTENER_ORIENTATION,AUTO_CONTROL_FREQUENCY,AUTO_CONTROL_TRIGGER],LEVEL=CONTEXT_URI+"level",INDEX=CONTEXT_URI+"index",ONSET_FEATURE=CONTEXT_URI+"onset",PITCH_FEATURE=CONTEXT_URI+"pitch",DURATION_FEATURE=CONTEXT_URI+"duration",AUTO_CONTROL=MOBILE_URI+"AutoControl",SLIDER=MOBILE_URI+"Slider",TOGGLE=MOBILE_URI+"Toggle",BUTTON=MOBILE_URI+"Button",CUSTOM=MOBILE_URI+"Custom",ACCELEROMETER_X=MOBILE_URI+"AccelerometerX",ACCELEROMETER_Y=
MOBILE_URI+"AccelerometerY",ACCELEROMETER_Z=MOBILE_URI+"AccelerometerZ",TILT_X=MOBILE_URI+"TiltX",TILT_Y=MOBILE_URI+"TiltY",GEOLOCATION_LATITUDE=MOBILE_URI+"GeolocationLatitude",GEOLOCATION_LONGITUDE=MOBILE_URI+"GeolocationLongitude",GEOLOCATION_DISTANCE=MOBILE_URI+"GeolocationDistance",COMPASS_HEADING=MOBILE_URI+"CompassHeading",BEACON=MOBILE_URI+"Beacon",RANDOM=MOBILE_URI+"Random",BROWNIAN=MOBILE_URI+"Brownian",RAMP=MOBILE_URI+"Ramp",CONTROLS=[SLIDER,TOGGLE,BUTTON,CUSTOM,ACCELEROMETER_X,ACCELEROMETER_Y,
ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,RANDOM,BROWNIAN,RAMP],UI_CONTROLS=[SLIDER,TOGGLE,BUTTON,CUSTOM],SENSOR_CONTROLS=[ACCELEROMETER_X,ACCELEROMETER_Y,ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,BEACON];function DymoManager(a,b,c,d){var e=new Scheduler(a,function(){});c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.setReverbFile(c);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g={},l={};this.loadDymoAndRendering=function(a,b,c,q){var v=new DymoLoader(e,function(){v.loadDymoFromJson(a,function(a){v.loadRenderingFromJson(b,a[1],function(b){f=b[0];f.dymo=a[0];for(var h in b[1]){var p=b[1][h];0<=UI_CONTROLS.indexOf(p.getType())&&(g[h]=new UIControl(p,d));0<=SENSOR_CONTROLS.indexOf(p.getType())&&
(l[h]=p)}e.loadBuffers(f.dymo,q);c&&c()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};this.replacePartOfTopDymo=function(a,b){var c=f.dymo.getPart(a);f.dymo.replacePart(a,b);e.stop(c)};this.updateNavigatorPosition=function(a,b,c){e.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return e.getNavigatorPosition(a,
...
new Float32Array(2048),p=e.extract(h,1024),m=0;p;){for(l=0;l<p;l++)for(var q=0;q<g.length;q++)g[q][l+m]=h[l*g.length+q%g.length];m+=p;p=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
...
b)})};d.error=function(){};d.send()}var l={},h=[],p=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var m=a.createConvolver();m.connect(a.destination);var q=a.createDelay();q.delayTime.value=.5;q.connect(a.destination);var v=a.createGain();v.gain.value=.6;q.connect(v);v.connect(q);var r=0;this.setReverbFile=function(a){g(a,function(a){m.buffer=a;d()})};this.loadBuffers=function(a,b){for(var c=a.getAllSourcePaths(),e=0,f=c.length;e<f;e++)l[c[e]]||
...
1))}}function f(a){var b=g()[0],c=p(b,a);m(b,a);return[c,a]}function g(){var a=n.find(null,CHARM_URI+"hasPart",null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function l(a){var b=$jscomp.makeIterator(h(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function h(a){var b=n.findAllObjectValues(a,
MOBILE_URI+"hasArgument");a=n.findFirstObjectValue(a,MOBILE_URI+"hasBody");return[b,a]}function p(b,c){var d=n.findFirstObjectUri(b,CHARM_URI+"cdt"),d=new DynamicMusicObject(b,d,a);d.setBasePath(t);c[b]=d;d.setSourcePath(n.findFirstObjectValue(b,DYMO_URI+"hasSource"));for(var e=n.findAllObjectUris(b,DYMO_URI+"hasFeature"),f=0;f<e.length;f++)d.setFeature(e[f],n.findFirstObjectUri(e[f],CHARM_URI+"value"));e=n.findAllObjectUris(b,DYMO_URI+"hasParameter");for(f=0;f<e.length;f++)r(d,n.findFirstObjectUri(e[f],
RDF_URI+"type"),n.findFirstObjectValue(e[f],CHARM_URI+"value"));e=n.findAllObjectUris(b,CHARM_URI+"hasPart");for(f=0;f<e.length;f++)d.addPart(p(e[f],c));return d}function m(a,b){for(var c=b[a],d=n.findAllObjectUris(a,DYMO_URI+"hasSimilar"),e=0;e<d.length;e++)c.addSimilar(b[d[e]]);d=n.findAllObjectUris(a,MOBILE_URI+"hasMapping");for(e=0;e<d.length;e++)c.addMapping(q(d[e],b,c));c=n.findAllObjectUris(a,CHARM_URI+"hasPart");for(e=0;e<c.length;e++)m(c[e],b)}function q(b,c,d,e){var f=n.findAllObjectUris(b,
MOBILE_URI+"toTarget"),h=n.findAllObjectUris(b,MOBILE_URI+"toDymo");if(0<f.length){for(var h=[],g=0;g<f.length;g++){var p=n.findFirstSubjectUri(SCHEMA_URI+"name",f[g]);h.push(e[p])}return v(b,c,d,h,e)}if(0<h.length){f=[];if(p=l(h[0]))g=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(f,g.filter(p));else for(g=0;g<h.length;g++)f.push(c[h[g]]);return v(b,c,d,f,e,p)}return v(b,c,d,[a],e)}function v(a,b,c,d,e,f){b=n.findFirstObjectUri(a,MOBILE_URI+"isRelative");for(var g=[],p=n.findAllObjectUris(a,
MOBILE_URI+"hasDomainDimension"),l=0;l<p.length;l++){var q=n.findFirstObjectUri(p[l],RDF_URI+"type"),m=n.findFirstObjectValue(p[l],SCHEMA_URI+"name");m||(m=p[l]);q==FEATURE?g.push(m):q==PARAMETER?(q=c?r(c,m,0):new Parameter(m,0),g.push(q)):g.push(e[p[l]])}e=$jscomp.makeIterator(h(n.findFirstObjectUri(a,MOBILE_URI+"hasFunction")));c=e.next().value;e=e.next().value;a=n.findFirstObjectUri(a,MOBILE_URI+"toParameter");return new Mapping(g,b,{args:c,body:e},d,a,f)}function r(a,b,c){var d=a.getParameter(b);
d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function u(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function w(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};c.error=function(a){console.log(a)};c.send()}function y(a,b,c){w(a,function(a){n.loadData(a,b,c)})}var n=new EasyStore,t="";(function(){y("http://tiny.cc/dymo-ontology",!1,function(){y("http://tiny.cc/mobile-audio-ontology",!1,
...
n.findAllObjectUris(k[g],MOBILE_URI+"hasDomainDimension"),p=0;p<h.length;p++){var m=n.findFirstObjectUri(h[p],RDF_URI+"type"),v=n.findFirstObjectValue(h[p],SCHEMA_URI+"name");v||(v=h[p]);if(n.isSubclassOf(m,MOBILE_URI+"MobileControl")&&!f[h[p]]){var t;t=h[p];var r=m,m=void 0;r==ACCELEROMETER_X||r==ACCELEROMETER_Y||r==ACCELEROMETER_Z?m=new AccelerometerControl(r):r==TILT_X||r==TILT_Y?m=new TiltControl(r):r==GEOLOCATION_LATITUDE||r==GEOLOCATION_LONGITUDE?m=new GeolocationControl(r):r==GEOLOCATION_DISTANCE?
m=new DistanceControl:r==COMPASS_HEADING?m=new CompassControl:r==BEACON?m=new BeaconControl(void 0,void 0,void 0):r==SLIDER||r==TOGGLE||r==BUTTON||r==CUSTOM?m=new Control(v,r):r==RANDOM?m=new RandomControl:r==BROWNIAN?m=new BrownianControl(0):r==RAMP&&(v=n.findFirstObjectValue(t,CHARM_URI+"value"),m=new RampControl(3E3,v));n.findFirstObjectUri(t,MOBILE_URI+"isSmooth")&&m.setSmooth&&m.setSmooth(!0);t=Number(n.findFirstObjectUri(t,MOBILE_URI+"isAverageOf"));!isNaN(t)&&m.setAverageOf&&m.setAverageOf(t);
t=m;v=Number(n.findFirstObjectUri(h[p],CHARM_URI+"value"));isNaN(v)||t.update(v);f[h[p]]=t}}for(g=0;g<k.length;g++)e.addMapping(q(k[g],a,void 0,f));if(a=n.findFirstObjectUri(c,DYMO_URI+"hasNavigator"))c=n.findFirstObjectUri(a,MOBILE_URI+"toDymo"),c=l(c),e.addNavigator(u(n.findFirstObjectUri(a,RDF_URI+"type")),c);d([e,f])})};this.loadGraphFromJson=function(a,b,c){d(a,"",function(a){for(var d=0;d<a.length;d++)if(a[d])for(var e=0;e<a[d].length;e++){var f=b[CONTEXT_URI+"dymo"+d],k=b[CONTEXT_URI+"dymo"+
...
b.getParts()[c],d)}function l(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)l(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var p=this,m=null,q=[],v=[],r={},u={},w=[],y=[],n="",t;u[PLAY]=new Parameter(PLAY,0,!0);u[LOOP]=new Parameter(LOOP,0,!0);
u[ONSET]=new Parameter(ONSET,void 0);u[DURATION_RATIO]=new Parameter(DURATION_RATIO,1);u[AMPLITUDE]=new Parameter(AMPLITUDE,1);u[PLAYBACK_RATE]=new Parameter(PLAYBACK_RATE,1);u[TIME_STRETCH_RATIO]=new Parameter(TIME_STRETCH_RATIO,1);u[PAN]=new Parameter(PAN,0);u[DISTANCE]=new Parameter(DISTANCE,0);u[HEIGHT]=new Parameter(HEIGHT,0);u[REVERB]=new Parameter(REVERB,0);u[DELAY]=new Parameter(DELAY,0);u[FILTER]=new Parameter(FILTER,2E4);u[PART_INDEX]=new Parameter(PART_INDEX,0,!0);u[PART_COUNT]=new Parameter(PART_COUNT,
Number.POSITIVE_INFINITY,!0);u[PLAY].addObserver(p);u[PART_INDEX].addObserver(p);u[PART_COUNT].addObserver(p);this.setType=function(a){b=a};this.getType=function(){return b};this.getUri=function(){return a};this.setParent=function(a){m=a;for(var b in u)b!=PLAY&&b!=PART_COUNT&&b!=PART_INDEX&&y.push(new Mapping([a.getParameter(b)],!0,void 0,[this],b));a=m.getMappings();var c=this.getDymoMap(),c=Object.keys(c).map(function(a){return c[a]});for(b=0;b<a.length;b++){var d=a[b].getDymoConstraint();d&&(d=
...
m.getLevel()+1:0};this.getIndex=function(){if(m)return m.getParts().indexOf(this)};this.addPart=function(a){q.push(a);a.setParent(this)};this.removePart=function(a){q.splice(q.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){q[a]&&q[a].removeParent(this);q[a]=b;b.setParent(this)};this.getPart=function(a){return q[a]};this.getParts=function(){return q};this.hasParts=function(){return 0<q.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){n=a};this.getBasePath=
function(){return m&&!n?m.getBasePath():n};this.setSourcePath=function(a){t=a};this.getSourcePath=function(){if(m&&!t)return m.getSourcePath();if(t)return this.getBasePath()+t};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){v.push(a)};this.getSimilars=function(a){return v};this.getFeatures=function(){return r};
this.setFeature=function(a,b){r[a]=b};this.getFeature=function(a){if(a===LEVEL)return this.getLevel();if(a===INDEX)return this.getIndex();if(r.hasOwnProperty(a))return r[a];if(m)return m.getFeature(a);for(var b=[],c=0;c<q.length;c++)if(q[c]){var d=q[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(r[a])return r[a]};this.getMappings=function(){return w};this.getSegment=function(){return[this.getFeature("time"),this.getFeature("duration")]};
this.addParameter=function(a){u[a.getName()]=a};this.getParameter=function(a){return u[a]};this.addMapping=function(a){w.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(p):c.stop(p))};this.updatePartOrder=function(a){q&&q[0]&&!isNaN(q[0].getFeature(a))?q.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):q&&q.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=function(){for(var a=this.toFlatJson(),
b=0;b<q.length;b++)a.parts.push(q[b].toJsonHierarchy());return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};l(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);t&&(c.source=t);for(var d in r)c[d]=this.getFeatureJson(d);if(0<w.length)for(c.mappings=[],d=0;d<w.length;d++)c.mappings.push(w[d].toJson());0<q.length&&(c.parts=[]);if(0<v.length)for(c.similars=[],d=
0;d<v.length;d++)c.similars.push(v[d].getUri());return c};this.getFeatureJson=function(a){return{value:r[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
...
e,f,g,l,h,p,m;l=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*l,h=e*l,f=2*e,p=f+a,m=f+d,c[m+0]=b[p+0]*h+this.pMidBuffer[f+0]*g,c[m+1]=b[p+1]*h+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
