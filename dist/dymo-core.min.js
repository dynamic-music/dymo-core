...
PART_PROPORTION="http://tiny.cc/dymo-ontology#PartProportion",CUSTOM_PARAMETER="http://tiny.cc/dymo-ontology#CustomParameter",HAS_SOURCE="http://tiny.cc/dymo-ontology#hasSource",HAS_PARAMETER="http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_PARAMETER_TYPE="http://tiny.cc/dymo-ontology#hasParameterType",HAS_FEATURE_TYPE="http://tiny.cc/dymo-ontology#hasFeatureType",HAS_SIMILAR="http://tiny.cc/dymo-ontology#hasSimilar",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",
...
CONTINUE_AFTER_LEAPING="http://tiny.cc/mobile-audio-ontology#ContinueAfterLeaping",NAVIGATOR="http://tiny.cc/mobile-audio-ontology#Navigator",ONE_SHOT_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#OneShotNavigator",SEQUENTIAL_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SimilarityNavigator",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MAPPING_TARGET="http://tiny.cc/mobile-audio-ontology#MappingTarget",
...
HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo";function DymoManager(a,b,c,d){var e=new Scheduler(a);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g,h={},q={};this.loadDymoAndRendering=function(a,b,m,w){var t=new DymoLoader(e,function(){t.loadDymoFromJson(a,function(a){t.loadRenderingFromJson(b,function(b){f=t.getStore();g=b[0];g.dymo=a[0];for(var p in b[1]){var n=b[1][p];f.isSubclassOf(n.getType(),UI_CONTROL)&&(h[p]=new UIControl(n,d));f.isSubclassOf(n.getType(),SENSOR_CONTROL)&&(q[p]=n)}c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.initEffectSends(f,
c);e.loadBuffers(g.dymo,w);m&&m()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};this.replacePartOfTopDymo=function(a,b){var c=g.dymo.getPart(a);g.dymo.replacePart(a,b);e.stop(c)};this.updateNavigatorPosition=function(a,b,c){e.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return e.getNavigatorPosition(a,
b)};this.syncNavigators=function(a,b,c){e.syncNavigators(a,b,c)};this.startPlaying=function(){g.dymo.updatePartOrder(ONSET);e.play(g.dymo)};this.stopPlaying=function(){e.stop(g.dymo)};this.getTopDymo=function(){return g.dymo};this.getRendering=function(){return g};this.getUIControls=function(){return h};this.getUIControl=function(a){return h[a]};this.getSensorControls=function(){return q}};function DymoNode(a,b,c,d){this.POSITION_PARAMS=[PAN,HEIGHT,DISTANCE];this.dymo=a;this.parameters={};this.init(b,c,d)}
...
if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return q};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function DymoSource(a,b,c,d,e,f){function g(b,d){var e=b[0],f=b[1],f=1!=d?f+.3:f+FADE_LENGTH;if(c||isNaN(e+f)){if(0!=e||f<c.duration)c=n(c,p(e,c),p(f,c));return h(c,f,d)}m(a.getSourcePath(),e,e+f,function(a){return h(a,f,d)})}function h(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=n(a,0,p(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var e=c.sampleRate*FADE_LENGTH,B=0;B<c.numberOfChannels;B++)for(var f=c.getChannelData(B),A=0;A<e;A++)f[A]*=A/e,f[d-A-1]*=A/e;return a}function q(){x=!1;var a=
b.currentTime;t.parameters[AMPLITUDE].setValueAtTime(t.parameters[AMPLITUDE].value,a);t.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);r.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function n(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),B=0;B<a.numberOfChannels;B++)for(var f=e.getChannelData(B),A=a.getChannelData(B),g=0;g<d;g++)f[g]=A[c+g];return e}function m(a,b,c,d){var e=a.lastIndexOf("/");e&&
(a=a.substring(e+1));w("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function w(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var t=this,x,u,z,r=b.createBufferSource();r.connect(this.getInput());(function(){var b=a.getSegment();b[0]||(b[0]=0);!b[1]&&c&&
(b[1]=c.duration-b[0]);if(a.hasParameter(DURATION_RATIO)){var d=a.getParameter(DURATION_RATIO).getValue();0<d&&1>d&&(b[1]*=d)}z=b[1];d=a.hasParameter(TIME_STRETCH_RATIO)?a.getParameter(TIME_STRETCH_RATIO).getValue():1;r.buffer=g(b,d)})();this.addParameter(PLAYBACK_RATE,r.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return z};this.isLoopingAndPlaying=function(){return r.loop&&x};this.play=function(a){r.onended=function(){r.disconnect();
t.removeAndDisconnect();f&&f(t)};a||(a=0);r.start(a);x=!0};this.pause=function(){x?(q(),u=!0):u&&(u=!1,this.play())};this.stop=function(){x&&q()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,f,g,h){function q(){l=r?r:t();p(l);if(!y){var a=l.keys().next().value;a.hasParameter(ONSET)&&(y=a.getParameter(ONSET).getValue())}a=v?v-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(l.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){g()},a);(r=t())&&0<r.size?(v=w(b),a=v[1],v=v[0],a.getDymo().hasParameter(LOOP)&&a.getDymo().getParameter(LOOP).getValue()&&(v-=FADE_LENGTH),a=1E3*(v-c.currentTime-SCHEDULE_AHEAD_TIME),
k=setTimeout(function(){q()},a)):(v=w(b),a=1E3*(v-c.currentTime),setTimeout(function(){m()},a+100))}function p(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,u.get(c)||u.set(c,[]),u.get(c).push(a.get(c))}function n(a){var b=u.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&u.delete(a.getDymo());g();m()}function m(){if(0==u.size&&(!r||0==r.size)){window.clearTimeout(k);b.reset();for(var c=a.getAllDymosInHierarchy(),d=0,e=c.length;d<e;d++){var f=z.get(c[d]);
f&&f.removeAndDisconnect()}h&&h()}}function w(a){if(r){var b=r.keys().next().value,c;b.hasParameter(ONSET)&&(c=b.getParameter(ONSET).getValue());b=c-y;y=c;if(!isNaN(c))return a+b}c=0;for(var d,b=$jscomp.makeIterator(l.values()),e=b.next();!e.done;e=b.next()){var e=e.value,f=e.getDuration();f>c&&(c=f,d=e)}return[a+c,d]}function t(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var l=new Map,g=0;g<a.length;g++)if(a[g].getSourcePath()){var h=
d[a[g].getSourcePath()],h=new DymoSource(a[g],c,h,e,f,n);x(h);l.set(a[g],h)}return l}}function x(a){var b=a;for(a=a.getDymo().getParent();a;){if(z.has(a)){b.connect(z.get(a).getInput());return}var d=new DymoNode(a,c,e,f);b.connect(d.getInput());z.set(a,d);a=a.getParent();b=d}b.connect(c.destination)}var u=new Map,z=new Map,r,k,l=[],v,y;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));q();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};
this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=u.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].stop();r&&(r.delete(a[b]),0>=r.size&&(r=void 0))}};this.getAllSources=function(){return u};this.getSources=function(a){return u.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();f[b]=a;f[b].addObserver(e)}var e=this,f={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,f);var g;this.addParameter=d;this.getParameter=function(a){return f[a]};this.startUpdate=function(){g=setInterval(b,f[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(g);g=null;c&&c()};this.observedParameterChanged=function(a){a==f[AUTO_CONTROL_FREQUENCY]?
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){k.loadData(a,!0,b)})}function d(a,b,c){z(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(l)&&(a=a.replace(l,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(l)&&(f=l+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function f(){var a=g()[0],b=p(a);n(a);return[b,y]}function g(){var a=k.find(null,HAS_PART,null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function h(a){var b=$jscomp.makeIterator(q(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function q(a){var b=k.findAllObjectValues(a,HAS_ARGUMENT);
a=k.findFirstObjectValue(a,HAS_BODY);return[b,a]}function p(b){var c=k.findFirstObjectUri(b,CDT),c=new DynamicMusicObject(b,c,a);c.setBasePath(l);y[b]=c;c.setSourcePath(k.findFirstObjectValue(b,HAS_SOURCE));for(var d=k.findAllObjectUris(b,HAS_FEATURE),e=0;e<d.length;e++)c.setFeature(d[e],k.findFirstObjectValue(d[e],VALUE));d=k.findAllObjectUris(b,HAS_PARAMETER);for(e=0;e<d.length;e++)x(c,k.findFirstObjectUri(d[e],TYPE),k.findFirstObjectValue(d[e],VALUE));b=k.findAllObjectUris(b,HAS_PART);for(e=0;e<
b.length;e++)c.addPart(p(b[e]));return c}function n(a){for(var b=y[a],c=k.findAllObjectUris(a,HAS_SIMILAR),d=0;d<c.length;d++)b.addSimilar(y[c[d]]);c=k.findAllObjectUris(a,HAS_MAPPING);m(c);for(d=0;d<c.length;d++)b.addMapping(w(c[d],b));a=k.findAllObjectUris(a,HAS_PART);for(d=0;d<a.length;d++)n(a[d])}function m(a){for(var b=0;b<a.length;b++)for(var c=k.findAllObjectUris(a[b],HAS_DOMAIN_DIMENSION),d=0;d<c.length;d++){var e=k.findFirstObjectUri(c[d],TYPE),f=k.findFirstObjectValue(c[d],NAME);f||(f=c[d]);
if(k.isSubclassOf(e,MOBILE_CONTROL)&&!v[c[d]]){var g=c[d],l=e,e=void 0;l==ACCELEROMETER_X||l==ACCELEROMETER_Y||l==ACCELEROMETER_Z?e=new AccelerometerControl(l):l==TILT_X||l==TILT_Y?e=new TiltControl(l):l==GEOLOCATION_LATITUDE||l==GEOLOCATION_LONGITUDE?e=new GeolocationControl(l):l==GEOLOCATION_DISTANCE?e=new DistanceControl:l==COMPASS_HEADING?e=new CompassControl:l==BEACON?(e=k.findFirstObjectValue(g,HAS_UUID),f=k.findFirstObjectValue(g,HAS_MAJOR),l=k.findFirstObjectValue(g,HAS_MINOR),e=new BeaconControl(e,
f,l)):l==SLIDER||l==TOGGLE||l==BUTTON||l==CUSTOM_CONTROL?(e=new Control(f,l),f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e.update(f)):l==RANDOM?e=new RandomControl:l==BROWNIAN?(f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new BrownianControl(f)):l==RAMP&&(e=Math.round(1E3*k.findFirstObjectUri(g,HAS_DURATION)),f=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),e=new RampControl(e,f));k.findFirstObjectValue(g,IS_SMOOTH)&&e.setSmooth&&e.setSmooth(!0);g=k.findFirstObjectValue(g,IS_AVERAGE_OF);!isNaN(g)&&
e.setAverageOf&&e.setAverageOf(g);v[c[d]]=e}}}function w(b,c){var d=k.findAllObjectUris(b,TO_TARGET);if(0<d.length){var e=[],f=h(d[0]);if(f)d=Object.keys(y).map(function(a){return y[a]}),Array.prototype.push.apply(e,d.filter(f));else for(var l=0;l<d.length;l++)k.findFirstObjectUri(d[l],TYPE)==DYMO?e.push(y[d[l]]):e.push(v[d[l]]);return t(b,c,e,f)}return t(b,c,[a])}function t(a,b,c,d){for(var e=k.findFirstObjectUri(a,IS_RELATIVE),f=[],l=k.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),g=0;g<l.length;g++){var h=
k.findFirstObjectUri(l[g],TYPE),p=k.findFirstObjectValue(l[g],NAME);p||(p=l[g]);h==FEATURE_TYPE||k.isSubclassOf(h,FEATURE_TYPE)?f.push(p):h==PARAMETER_TYPE||k.isSubclassOf(h,PARAMETER_TYPE)?(h=b?x(b,p):new Parameter(p,0),f.push(h)):f.push(v[l[g]])}l=$jscomp.makeIterator(q(k.findFirstObjectUri(a,HAS_FUNCTION)));b=l.next().value;l=l.next().value;a=k.findFirstObjectUri(a,HAS_RANGE);for(g=0;g<c.length;g++)c[g]instanceof DynamicMusicObject&&!c[g].getParameter(a)&&x(c[g],a);return new Mapping(f,e,{args:b,
body:l},c,a,d)}function x(a,b,c){var d=a.getParameter(b);d?d.update(c):(isNaN(c)&&(c=k.findFirstObjectValue(b,HAS_STANDARD_VALUE,null),isNaN(c)&&(c=0)),d=k.findFirstObjectValue(b,IS_INTEGER,null),d=new Parameter(b,c,d),a.addParameter(d));return d}function u(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function z(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};c.error=function(a){console.log(a)};c.send()}
function r(a,b,c){z(a,function(a){k.loadData(a,b,c)})}var k=new EasyStore,l="",v={},y={};(function(){r("http://tiny.cc/dymo-ontology",!1,function(){r("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;l=a.substring(0,d);c(a,function(){b(f())})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(f())})};this.loadRenderingFromJson=function(a,b){c(a,function(){var a=k.findFirstSubjectUri(TYPE,
RENDERING),c=new Rendering(y[k.findFirstObjectUri(a,HAS_DYMO)]),d=k.findAllObjectUris(a,HAS_MAPPING);m(d);for(var e=0;e<d.length;e++)c.addMapping(w(d[e]));if(a=k.findFirstObjectUri(a,HAS_NAVIGATOR))d=k.findFirstObjectUri(a,TO_DYMO),d=h(d),c.addNavigator(u(k.findFirstObjectUri(a,TYPE)),d);b([c,v])})};this.loadGraphFromJson=function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=y[CONTEXT_URI+"dymo"+c],f=y[CONTEXT_URI+"dymo"+a[c][d]];e&&f&&e.addSimilar(f)}b(void 0)})}}
;function DymoWriter(a,b){function c(a){if(a&&a instanceof Object)for(var b in a)"@id"==b&&a[b].includes("_:b")?delete a[b]:c(a[b])}function d(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeToJsonld=function(a,b){b||(b="dymo.json");this.getJsonld(function(c){d(a+b,c)})};this.getJsonld=function(a){this.getRdf(function(b){b=b.split("_b").join("b");
jsonld.fromRDF(b,{format:"application/nquads"},function(b,d){jsonld.frame(d,{"@id":"http://tiny.cc/dymo-context/dymo0"},function(b,d){jsonld.compact(d,"http://tiny.cc/dymo-context",function(b,d){jsonld.compact(d,"http://tiny.cc/dymo-context-simple",function(b,d){c(d);d=JSON.stringify(d,null,2);d=d.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");a(d)})})})})})};this.getRdf=function(b){for(var c=a.find(null,null,null),d=N3.Writer({format:"application/nquads"}),h=0;h<c.length;h++)d.addTriple(c[h]);
...
this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};h(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);k&&(c.source=k);for(var d in t)c[d]=this.getFeatureJson(d);if(0<u.length)for(c.mappings=[],d=0;d<u.length;d++)c.mappings.push(u[d].toJson());0<m.length&&(c.parts=[]);if(0<w.length)for(c.similars=[],d=0;d<w.length;d++)c.similars.push(w[d].getUri());return c};this.getFeatureJson=function(a){return{value:t[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+
...
e,f,g,h,q,p,n;h=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*h,q=e*h,f=2*e,p=f+a,n=f+d,c[n+0]=b[p+0]*q+this.pMidBuffer[f+0]*g,c[n+1]=b[p+1]*q+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
