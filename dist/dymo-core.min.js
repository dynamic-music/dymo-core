...
d.race=function(a){return new d(function(b,c){for(var f=$jscomp.makeIterator(a),e=f.next();!e.done;e=f.next())d.resolve(e.value).callWhenSettled_(b,c)})};d.all=function(a){var b=$jscomp.makeIterator(a),c=b.next();return c.done?d.resolve([]):new d(function(a,e){function g(b){return function(c){f[b]=c;n--;0==n&&a(f)}}var f=[],n=0;do f.push(void 0),n++,d.resolve(c.value).callWhenSettled_(g(f.length-1),e),c=b.next();while(!c.done)})};$jscomp.EXPOSE_ASYNC_EXECUTOR&&(d.$jscomp$new$AsyncExecutor=function(){return new b});
...
$jscomp.polyfill("Number.isNaN",function(a){return a?a:function(a){return"number"===typeof a&&isNaN(a)}},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.polyfill("Set",function(a){if(!$jscomp.ASSUME_NO_NATIVE_SET&&function(){if(!a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),d=new a($jscomp.makeIterator([b]));if(!d.has(b)||1!=d.size||d.add(b)!=d||1!=d.size||d.add({x:4})!=d||2!=d.size)return!1;var e=d.entries(),k=e.next();if(k.done||k.value[0]!=b||k.value[1]!=b)return!1;k=e.next();return k.done||k.value[0]==b||4!=k.value[0].x||k.value[1]!=k.value[0]?!1:e.next().done}catch(h){return!1}}())return a;
...
function DymoManager(a,b,c,d,e,k,h){function m(a,b,c,e){p=b;g=c[0];u=a.getMappings();for(var h in c[1])a=c[1][h],DYMO_STORE.isSubclassOf(a.getType(),UI_CONTROL)&&(l[h]=new UIControl(a,k)),DYMO_STORE.isSubclassOf(a.getType(),SENSOR_CONTROL)&&(n[h]=a);d||(d="bower_components/dymo-core/audio/impulse_rev.wav");f.init(d,b,e)}DYMO_STORE=new DymoStore(e);var f=new Scheduler(a,h);c&&(OPTIMIZED_MODE=!0);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var p,g,l={},n={},u={};this.loadDymoAndRenderingFromStore=function(a,
b){DYMO_STORE=a;a=new DymoLoader(DYMO_STORE);m(a,a.createDymoFromStore(),a.createRenderingFromStore(),b)};this.loadDymoAndRendering=function(a,b,c,d){var g=new DymoLoader(DYMO_STORE);g.loadDymoFromJson(a,function(a){g.loadRenderingFromJson(b,function(b){m(g,a,b,d);c&&c()})})};this.loadDymoFromJson=function(a,b){(new DymoLoader(DYMO_STORE)).loadDymoFromJson(a,b)};this.parseDymoFromJson=function(a,b){(new DymoLoader(DYMO_STORE)).parseDymoFromJson(a,b)};this.replacePartOfTopDymo=function(a,b){a=DYMO_STORE.replacePartAt(p[0],
...
new Float32Array(2048);for(var m=e.extract(c,1024),f=0;m;){for(h=0;h<m;h++)for(var p=0;p<k.length;p++)k[p][h+f]=c[h*k.length+p%k.length];f+=m;m=e.extract(c,1024)}return d}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var k=new SimpleFilter({extract:function(a,c,d){for(var g=[],f=0;f<b.numberOfChannels;f++)g.push(b.getChannelData(f));for(f=0;f<c;f++)for(var e=0;e<g.length;e++)a[f*g.length+e%g.length]=g[e][f+d];return Math.min(c,g[0].length-d)}},e),h=a.createScriptProcessor(1024,
2,b.numberOfChannels),m=new Float32Array(2048);h.onaudioprocess=function(a){for(var c=[],g=0;g<b.numberOfChannels;g++)c.push(a.outputBuffer.getChannelData(g));a=k.extract(m,1024);0==a&&d.stop();for(g=0;g<a;g++)for(var f=0;f<c.length;f++)c[f][g]=m[g*c.length+f%c.length]};this.start=function(a){setTimeout(function(){h.connect(c)},a)};this.stop=function(){h.disconnect()}};function Scheduler(a,b){function c(a,b){for(var c=[],d=0,g=a.length;d<g;d++)var f=DYMO_STORE.findAllObjectsInHierarchy(a[d]),c=c.concat(f.map(function(a){return DYMO_STORE.getSourcePath(a)}));d=0;for(g=c.length;d<g;d++)c[d]&&!m[c[d]]&&k(c[d],function(a,c){m[c]=a;0<l&&l--;0==l&&b&&b()});0==l&&b&&b()}function d(a){f.splice(f.indexOf(a),1)}function e(a){OPTIMIZED_MODE||(a=Array.from(a.getAllSources().keys()),a=flattenArray(a.map(function(a){return DYMO_STORE.findAllParents(a)})),a=removeDuplicates(a),
a.sort(),p=a,b&&b(p))}function k(b,c){l++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,b)})};d.error=function(){};d.send()}var h=this,m={},f=[],p=[],g,l=0;this.init=function(b,d,f){DYMO_STORE.addParameter(null,LISTENER_ORIENTATION,0,h);c(d,f);b&&0<DYMO_STORE.find(null,null,REVERB).length&&(g=a.createConvolver(),g.connect(a.destination),k(b,function(a){g.buffer=a;0<l&&l--;0==l&&f&&f()}));0<DYMO_STORE.find(null,
null,DELAY).length&&(b=a.createDelay(),b.delayTime.value=.5,b.connect(a.destination),d=a.createGain(),d.gain.value=.6,b.connect(d),d.connect(b));DYMO_STORE.addTypeObserver(PLAY,VALUE,h)};this.getBuffer=function(a){return m[DYMO_STORE.getSourcePath(a)]};this.updateNavigatorPosition=function(a,b,c){for(var d=0,g=f.length;d<g;d++)f[d].hasDymo(a)&&f[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=f.length;c<d;c++)if(f[c].hasDymo(a))return f[c].getNavigator().getPosition(b,
a)};this.syncNavigators=function(a,b,c){for(var d,g,e=0,l=f.length;e<l;e++)f[e].hasDymo(a)&&(d=f[e].getNavigator()),f[e].hasDymo(b)&&(g=f[e].getNavigator());g&&(b=g.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b,c){b=new SchedulerThread(b,c,a,m,g,void 0,e,d);f.push(b)};this.pause=function(a){if(a)for(var b=0;b<f.length;b++)f[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<f.length;b++)f[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<f.length;c++){var d=f[c].getSources(a);
if(d)for(var g=0;g<d.length;g++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return p};this.observedValueChanged=function(b,c,d){c==LISTENER_ORIENTATION?(d=d/180*Math.PI,a.listener.setOrientation(Math.sin(d),0,-Math.cos(d),0,1,0)):c==PLAY&&(b=DYMO_STORE.findSubject(HAS_PARAMETER,b),0<d?this.play(b):this.stop(b))}};function DymoSource(a,b,c,d,e,k){function h(b,d){var f=b[0],e=b[1],e=1!=d?e+.3:e+FADE_LENGTH;if(c||isNaN(f+e)){if(0!=f||e<c.duration)c=g(c,p(f,c),p(e,c));return m(c,e,d)}l(DYMO_STORE.getSourcePath(a),f,f+e,function(a){return m(a,e,d)})}function m(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=g(a,0,p(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var f=c.sampleRate*FADE_LENGTH,e=0;e<c.numberOfChannels;e++)for(var l=c.getChannelData(e),n=0;n<f;n++)l[n]*=n/f,l[d-n-1]*=n/f;return a}function f(){t=
!1;var a=b.currentTime;u.parameters[AMPLITUDE].setValueAtTime(u.parameters[AMPLITUDE].value,a);u.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);q.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function g(a,c,d){d=Math.min(a.length-c,d);for(var g=b.createBuffer(a.numberOfChannels,d,a.sampleRate),f=0;f<a.numberOfChannels;f++)for(var e=g.getChannelData(f),l=a.getChannelData(f),n=0;n<d;n++)e[n]=l[c+n];return g}function l(a,b,c,d){var g=a.lastIndexOf("/");
g&&(a=a.substring(g+1));n("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function n(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var u=this,t,w,v,q=b.createBufferSource();q.connect(this.getInput());(function(){var b=[DYMO_STORE.findFeatureValue(a,TIME_FEATURE),
DYMO_STORE.findFeatureValue(a,DURATION_FEATURE)];b[0]||(b[0]=0);!b[1]&&c&&(b[1]=c.duration-b[0]);var d=DYMO_STORE.findParameterValue(a,DURATION_RATIO);d&&0<d&&1>d&&(b[1]*=d);v=b[1];d=DYMO_STORE.findParameterValue(a,TIME_STRETCH_RATIO);q.buffer=h(b,d?d:1)})();this.addParameter(PLAYBACK_RATE,q.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return v};this.isLoopingAndPlaying=function(){return q.loop&&t};this.play=function(b){q.onended=
function(){q.disconnect();u.removeAndDisconnect();k&&k(u)};b||(b=0);q.start(b);DYMO_STORE.findParameterValue(a,LOOP)&&(q.loop=!0);t=!0};this.pause=function(){t?(f(),w=!0):w&&(w=!1,this.play())};this.stop=function(){t&&f()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,k,h,m){function f(){var a=y;y=x?x:u();p(y);if(!z){var b=y.keys().next().value;z=DYMO_STORE.findParameterValue(b,ONSET)}for(var b=r?r-c.currentTime:SCHEDULE_AHEAD_TIME,d=c.currentTime+b,g=$jscomp.makeIterator(y.values()),e=g.next();!e.done;e=g.next())e=e.value,e.play(d);a=$jscomp.makeIterator(a.values());for(e=a.next();!e.done;e=a.next())e=e.value,DYMO_STORE.findParameterValue(e.getDymoUri(),LOOP)&&e.stop(d);setTimeout(function(){h(w)},b);(x=u())&&0<x.size?(r=n(d),
a=r[1],r=r[0],DYMO_STORE.findParameterValue(a.getDymoUri(),LOOP)&&(r-=FADE_LENGTH),a=1E3*(r-c.currentTime-SCHEDULE_AHEAD_TIME),A=setTimeout(function(){f()},a)):(r=n(d),a=1E3*(r-c.currentTime),setTimeout(function(){l()},a+100))}function p(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,v.get(c)||v.set(c,[]),v.get(c).push(a.get(c))}function g(a){var b=v.get(a.getDymoUri());b.splice(b.indexOf(a),1);0>=b.length&&v.delete(a.getDymoUri());h(w);l()}function l(){if(0==
v.size&&(!x||0==x.size)){window.clearTimeout(A);b.reset();for(var c=DYMO_STORE.findAllObjectsInHierarchy(a),d=0,g=c.length;d<g;d++){var f=q.get(c[d]);f&&f.removeAndDisconnect()}m&&m()}}function n(a){if(x){var b=x.keys().next().value,b=DYMO_STORE.findParameterValue(b,ONSET),c=b-z;z=b;if(!isNaN(b))return a+c}for(var b=0,d,c=$jscomp.makeIterator(y.values()),g=c.next();!g.done;g=c.next()){var g=g.value,f=g.getDuration();f>b&&(b=f,d=g)}return[a+b,d]}function u(){var a=b.getNextParts();if(a){t(a);for(var f=
new Map,l=0;l<a.length;l++){var n=DYMO_STORE.getSourcePath(a[l]);if(n){n=new DymoSource(a[l],c,d[n],e,k,g);a:{for(var p=n,h=DYMO_STORE.findParents(n.getDymoUri())[0];h;){if(q.has(h)){p.connect(q.get(h).getInput());break a}var u=new DymoNode(h,c,e,k);p.connect(u.getInput());q.set(h,u);h=DYMO_STORE.findParents(h)[0];p=u}p.connect(c.destination)}f.set(a[l],n)}}return f}}function t(a){console.log(a.map(function(a){a=DYMO_STORE.findPartIndex(a);return isNaN(a)?"top":a}))}var w=this,v=new Map,q=new Map,
x,A,y=new Map,r,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));f();this.hasDymo=function(b){if(DYMO_STORE.findAllObjectsInHierarchy(a).indexOf(b))return!0};this.getNavigator=function(){return b};this.stop=function(a){a=DYMO_STORE.findAllObjectsInHierarchy(a);for(var b=0,c=a.length;b<c;b++){var d=v.get(a[b]);if(d)for(var g=0;g<d.length;g++)d[g].stop();x&&(x.delete(a[b]),0>=x.size&&(x=void 0))}};this.getAllSources=function(){return v};this.getSources=function(a){return v.get(a)}};var AutoControl=function(a,b,c){Control.call(this,a,b,AUTO_CONTROL);c||(c=100);DYMO_STORE.addParameter(a,AUTO_CONTROL_FREQUENCY,c,this);DYMO_STORE.addParameter(a,AUTO_CONTROL_TRIGGER,0,this);this.intervalID=null};$jscomp.inherits(AutoControl,Control);AutoControl.prototype.startUpdate=function(a){var b=this;a||(a=DYMO_STORE.findParameterValue(this.uri,AUTO_CONTROL_FREQUENCY));this.update();this.intervalID=setInterval(function(){return b.update()},a)};AutoControl.prototype.update=function(){};
AutoControl.prototype.reset=function(){clearInterval(this.intervalID);this.intervalID=null};AutoControl.prototype.observedValueChanged=function(a,b,c){b==AUTO_CONTROL_FREQUENCY?this.intervalID&&(this.reset(),this.startUpdate(c)):b==AUTO_CONTROL_TRIGGER&&(!this.intervalID&&0<c?this.startUpdate():this.intervalID&&0==c&&this.reset())};var DataControl=function(a,b,c,d){d||(d=6E4);AutoControl.call(this,a,DATA_CONTROL,d);this.url=b;this.jsonMap=c;DYMO_STORE.setParameter(a,AUTO_CONTROL_TRIGGER,1)};$jscomp.inherits(DataControl,AutoControl);DataControl.prototype.update=function(){var a=this;fetch(this.url).then(function(a){return a.json()}).then(function(b){return a.jsonMap(b)}).then(function(b){console.log("data received:",b);a.updateValue(b)}).catch(function(a){return console.log(a)})};function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(d){a.getType()==TOGGLE?c.value=1==d?!0:!1:c.value=d;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.updateValue(1):0==this.value?a.updateValue(0):a.updateValue(this.value)}};function DymoGenerator(a,b){function c(){var a=CONTEXT_URI+"dymo"+q;q++;return a}function d(a){var b=[];if(a&&0<a.length){for(var c=0;c<a.length;c++)a[c].value&&a[c].value.constructor!==Array&&(a[c].value=[a[c].value]);for(var c=a[0].value.length,d=0;d<c;d++)if("string"==typeof a[0].value[d])b[d]=a[0].value[d];else if(w==SUMMARY.FIRST)b[d]=a[0].value[d];else if(w==SUMMARY.MEAN)b[d]=a.reduce(function(a,b){return a+b.value[d]},0)/a.length;else if(w==SUMMARY.MEDIAN){a.sort(function(a,b){return a.value[d]-
b.value[d]});var g=Math.floor(a.length/2);b[d]=a[g].value[d];0==a.length%2&&(b[d]+=a[g-1].value[d])}return 1==b.length?b[0]:b}return 0}function e(){0==q?l=this.addDymo(null,v):u&&(l=this.addDymo(g,v),u=!1)}function k(b,c,d){d||(d=l);var g=d;for(d=a.findLevel(d);d<c;){var f=a.findParts(g);if(0<f.length){f=f.map(function(b){return[a.findFeatureValue(b,TIME_FEATURE),b]});f.sort(function(a,b){return a[0]-b[0]});for(var e=0;e<f.length;e++)if(f[e][0]<=b)g=f[e][1];else if(0==e)g=f[e][1];else break;d++}else break}return g}
function h(a,b){void 0==a.max?(a.min=b,a.max=b):(a.min=Math.min(b,a.min),a.max=Math.max(b,a.max))}function m(a,b){for(var c=0;c<t.length;c++)if(t[c].name==a||t[c].uri==b)return t[c];return f(a,b)}function f(c,d,g,f){!c&&d&&(c=URI_TO_TERM[d]);c&&!d&&(d=CONTEXT_URI+c);c=void 0!=g&&void 0!=f?{name:c,uri:d,min:g,max:f}:{name:c,uri:d,min:1E3,max:0};2>t.length?t.push(c):t.splice(t.length-2,0,c);a.findObject(d,TYPE)||a.addTriple(d,TYPE,FEATURE_TYPE);b(c);return c}var p=this,g,l,n,u,t,w=SUMMARY.MEAN,v,q=
0,x=0;this.resetDymo=function(){l=g=void 0;u=!1;t=[];f("level",LEVEL_FEATURE);f("random",null,0,1)};this.setStore=function(b){a=b};this.getStore=function(){return a};this.addRendering=function(){var b=CONTEXT_URI+"rendering"+x;x++;n=b;a.addRendering(n,l)};this.addMapping=function(b,c,d,g){a.addMapping(b,c,d,g)};this.addNavigator=function(b,c,d){a.addNavigator(n,b,c,d)};this.getCurrentTopDymo=function(){return l};this.getFeatures=function(){return t};this.setSummarizingMode=function(a){w=a};this.setCurrentSourcePath=
function(a){v=a};this.setAudioFileChanged=function(){u=!0;if(l){var b=c();a.addDymo(b,null,l);l=b}};this.addDymo=function(b,d,g,f){f||(f=c());a.addDymo(f,b,null,d,g);b||(l=f);return f};this.addFeature=function(b,c,g){g||(g=l);Benchmarker.startTask("addFeature");e();b=m(b);g=a.findAllObjectsInHierarchy(g);for(var f=0;f<g.length;f++){var n=a.findFeatureValue(g[f],TIME_FEATURE),p=a.findFeatureValue(g[f],DURATION_FEATURE),k=c;isNaN(n)||(k=k.filter(function(a){return n<=a.time&&(isNaN(p)||a.time<n+p)}));
if(1>k.length)var h=c.filter(function(a){return a.time.value<=n}),k=0<h.length?[h[k.length-1]]:[c[0]];Benchmarker.startTask("summarize");k=d(k);this.setDymoFeature(g[f],b.uri,k)}};this.addSegmentation=function(b,c){e();for(var d=a.findMaxLevel(),g=0;g<b.length;g++){var f=k(b[g].time,d,c),l=b[g].time,n;if(b[g].duration)n=b[g].duration;else if(b[g+1])n=b[g+1].time-l;else{var h=a.findFeatureValue(f,TIME_FEATURE),u=a.findFeatureValue(f,DURATION_FEATURE);h&&u&&(n=h+u-l)}if(0<n){h=this.addDymo(f);this.setDymoFeature(h,
TIME_FEATURE,l);this.setDymoFeature(h,DURATION_FEATURE,n);var m=h,l=a.findFeatureValue(f,TIME_FEATURE),h=a.findFeatureValue(m,TIME_FEATURE);if(isNaN(l)||Array.isArray(l)||h<l)p.setDymoFeature(f,TIME_FEATURE,h),l=h;u=a.findFeatureValue(f,DURATION_FEATURE);m=a.findFeatureValue(m,DURATION_FEATURE);(isNaN(u)||Array.isArray(u)||l+u<h+m)&&p.setDymoFeature(f,DURATION_FEATURE,h+m-l)}}};this.setDymoFeature=function(b,c,d){a.setFeature(b,c,d);if(!isNaN(d))h(m(null,c),d);else if(d instanceof Array)for(b=0;b<
d.length;b++)h(m(null,c),d[b])};this.resetDymo()};function DymoTemplates(){}DymoTemplates.createSingleSourceDymoFromFeatures=function(a,b,c,d,e){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,e)};DymoTemplates.createMultiSourceDymo=function(a,b,c,d,e,k){var h=a.addDymo(b,null,c);b=d.map(function(b,c){return new Promise(function(d){var g=a.addDymo(h,b);DymoTemplates.loadMultipleFeatures(a,g,e[c],null,d)})});Promise.all(b).then(function(a){return k(h)})};
DymoTemplates.createSimilarityDymoFromFeatures=function(a,b,c,d,e,k){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,function(){Similarity.addSimilaritiesTo(a.getCurrentTopDymo(),a.getStore(),e);a.addRendering();a.addNavigator(SIMILARITY_NAVIGATOR,{d:LEVEL_FEATURE},"return d == 0");k()})};
DymoTemplates.createSimilaritySuccessorDymoFromFeatures=function(a,b,c,d,e,k){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,function(){Similarity.addSimilaritiesTo(a.getCurrentTopDymo(),a.getStore(),e);Similarity.addSuccessionGraphTo(a.getCurrentTopDymo(),a.getStore(),e);a.addRendering();a.addNavigator(GRAPH_NAVIGATOR,{d:LEVEL_FEATURE},"return d == 0");k()})};
DymoTemplates.createAnnotatedBarAndBeatDymo=function(a,b,c){for(var d=[b[0],b[0]],e=["1",""],k=1;k<b.length;k++)d[k+1]=b[k],e[k+1]="";DymoTemplates.loadMultipleFeatures(a,null,d,e,c)};function getUris(a,b,c,d){for(var e=[],k=[],h=0,m=c.length;h<m;h++){var f=b.filter(function(a){return 0<a.indexOf(c[h])})[0];f&&(e.push(a+f),k.push(d[h]))}return[e,k]}
...
Number.parseInt(k[4].substring(1),10),m=Number.parseInt(k[6].substring(2),10)/1E3,f=Number.parseInt(k[7].substring(2),10)/1E3,p=Number.parseInt(k[8].substring(2),10),g=Number.parseInt(k[9].substring(2),10)/1E3,k=Number.parseInt(k[10].substring(2),10)/1E3,l=a.addDymo(c,"audio/Chopin_Op028-11_003_20100611-SMD-cut/"+b[d]);a.setDymoFeature(l,PITCH_FEATURE,h);a.setDymoFeature(l,ONSET_FEATURE,m);a.setDymoFeature(l,DURATION_FEATURE,f);a.setDymoFeature(l,"velocity",p);a.setDymoFeature(l,"onsetS",g);a.setDymoFeature(l,
"durationS",k);l.getParameter(ONSET).update(m)}DYMO_STORE.updatePartOrder(c,ONSET_FEATURE)})};
DymoTemplates.createAchBachDymo=function(a,b){var c=a.getFeature(ONSET_FEATURE),d=a.getFeature(PITCH_FEATURE),e=a.getFeature(DURATION_FEATURE),k=a.getFeature("onsetS"),h=a.getFeature("durationS"),m=a.getFeature("time"),f=a.addDymo();a.setDymoFeature(f,c,0);a.setDymoFeature(f,d,0);a.setDymoFeature(f,e,0);$http.get("audio/achachbach10/01-AchGottundHerr.txt").success(function(b){b=b.split("\n");for(var g=0;g<b.length;g++)b[g]=b[g].split("\t");b.sort(function(a,b){return a[0]-b[0]});for(var l=[],g=0;g<
b.length;g++){var n=b[g][0],p=b[g][1],t=Number.parseInt(b[g][3],10);if(l[t]){var w=l[t][0],v=p-l[t][2];b[w][4]=n-l[t][1];b[w][5]=v}l[t]=[g,n,p]}for(g=b.length-4;g<b.length;g++)b[g][4]=2700,b[g][5]=2700;for(g=0;g<b.length;g++)if(6==b[g].length){var l=b[g],n=Number.parseInt(l[2],10),p=Number.parseInt(l[0],10)/1E3,t=Number.parseInt(l[1],10)/1E3,w=Number.parseInt(l[4],10)/1E3,v=Number.parseInt(l[5],10)/1E3,q;1==l[3]?q=a.addDymo(f,"audio/achachbach10/01-AchGottundHerr-violin.wav"):2==l[3]?q=a.addDymo(f,
"audio/achachbach10/01-AchGottundHerr-clarinet.wav"):3==l[3]?q=a.addDymo(f,"audio/achachbach10/01-AchGottundHerr-saxphone.wav"):4==l[3]&&(q=a.addDymo(f,"audio/achachbach10/01-AchGottundHerr-bassoon.wav"));a.setDymoFeature(q,d,n);a.setDymoFeature(q,m,p);a.setDymoFeature(q,c,p);a.setDymoFeature(q,e,w);a.setDymoFeature(q,k,t);a.setDymoFeature(q,h,v);q.getParameter(ONSET).update(p)}DYMO_STORE.updatePartOrder(f,c.name)});$http.get("getsourcefilesindir/",{params:{directory:"audio/achachbach10/"}}).success(function(a){a=
a.filter(function(a){return 0<=a.indexOf("wav")});for(var b=0;b<a.length;b++);})};function createRandomTriangle(){return[{0:Math.random(),1:Math.random()},{0:Math.random(),1:Math.random()},{0:Math.random(),1:Math.random()}]};function FeatureLoader(a,b){function c(c,g,f){v(c,function(l){d(l,function(d){e(d,function(e){0<e.length?(p(c,g,e),f&&f()):k(d,function(d){var g=d.name;g||(g=c.split("_"),g=g[g.length-1].split(".")[0]);a.addFeature(g,d.values,b);f&&f()})})})})}function d(a,b){var c=N3.Store();N3.Parser().parse(a,function(a,d,g){d?c.addTriple(d):b(c)})}function e(a,b){for(var c=[],d=a.find(null,"http://purl.org/NET/c4dm/event.owl#time",null),g=0,e=d.length;g<e;g++){var l=h(a,d[g].object,"http://purl.org/NET/c4dm/timeline.owl#at");
l||(l=h(a,d[g].object,"http://purl.org/NET/c4dm/timeline.owl#beginsAt"));var n=h(a,d[g].object,"http://purl.org/NET/c4dm/timeline.owl#duration"),l={time:f(l),label:m(h(a,d[g].subject,"http://www.w3.org/2000/01/rdf-schema#label"))};n&&(l.duration=f(n));c.push(l)}b(c)}function k(a,b){var c=m(h(a,null,"http://purl.org/dc/elements/1.1/title")),d=m(h(a,null,"http://purl.org/ontology/af/value")),d=d.split(" ").map(function(a){return parseFloat(a)}),g=m(h(a,null,"http://purl.org/ontology/af/dimensions")),
g=g.split(" ").map(function(a){return Number.parseInt(a,10)}),e=h(a,null,"http://purl.org/ontology/vamp/computed_by"),l=f(h(a,e,"http://purl.org/ontology/vamp/step_size"));a=f(h(a,e,"http://purl.org/ontology/vamp/sample_rate"));for(var e=[],n=0;n<d.length;){for(var p=[],k=0;k<g[0];k++)p[k]=d[n+k];e.push({time:{value:n*l/a},value:p});n+=g[0]}b({name:c,values:e})}function h(a,b,c){a=a.find(b,c,null);if(0<a.length)return a[0].object}function m(a){if(a)return N3.Util.getLiteralValue(a)}function f(a){a=
N3.Util.getLiteralValue(a);"P"==a.charAt(0)&&(a=a.substring(2,a.length-1));return Number(a)}function p(c,d,g){q[c]=g.sort(function(a,b){return a.time.value-b.time.value});g=q[c];d&&q[c][0].label&&(g=g.filter(function(a){return a.label.value==d}));a.addSegmentation(g,b)}function g(a,b,c){v(a,function(a){l(JSON.parse(a),b,c)})}function l(a,b,c){"file_metadata"==Object.keys(a)[0]?n(a,b,c):u(a,b,c)}function n(c,d,g){c=c[Object.keys(c)[1]][0];var f=c.annotation_metadata.annotator.output_id;"beats"==f||
"onsets"==f||"segmentation"==f?(c=c.data,d&&c[0].value&&(c=c.filter(function(a){return a.value==d})),a.addSegmentation(c,b)):a.addFeature(f,c.data,b);g&&g()}function u(c,d,g){var f=c["@type"];"afv:BarandBeatTracker"==f||"afv:Onsets"==f?(c=c["afo:values"],d&&c[0]["afo:value"]&&(c=c.filter(function(a){return a["afo:value"]==d})),c=t(c),a.addSegmentation(c,b)):(c=w(c["afo:values"]),a.addFeature(f,c,b));g&&g()}function t(a){for(var b=[],c=0;c<a.length;c++)b.push({time:{value:a[c]["tl:at"]},label:{value:a[c]["afo:value"]}});
return b}function w(a){for(var b=[],c=0;c<a.length;c++)b.push({time:{value:a[c]["tl:at"]},value:[a[c]["afo:value"]]});return b}function v(a,b){var c=new XMLHttpRequest;c.addEventListener("load",function(){b(this.responseText)});c.addEventListener("error",function(){b(this.responseText)});c.open("GET",a);c.send()}var q={};this.loadFeature=function(a,b,d){if(a.constructor==Object)l(a,b,d);else{var f=a.split("."),f=f[f.length-1];"n3"==f?c(a,b,d):"json"==f&&g(a,b,d)}}};var SUMMARY={MEAN:"mean",MEDIAN:"median",FIRST:"first"};function Similarity(){}Similarity.addSimilaritiesTo=function(a,b,c){for(a=[a];0<a.length;){if(1<a.length){var d=Similarity.toVectors(a,b),d=Similarity.getCosineSimilarities(d);Similarity.addSimilaritiesAbove(b,d,c)}a=Similarity.getAllParts(a,b)}};
...
Similarity.toVectors=function(a,b,c){for(var d=[],e=0,k=a.length;e<k;e++){for(var h=[],m=b.findAllFeatureValues(a[e]).filter(function(a){return"string"!=typeof a}),f=0,p=m.length;f<p;f++){var g=m[f];c&&1<g.length&&(g=Similarity.reduce(g));1<g.length?h=h.concat(g):(g=Number(g),h.push(g))}d[e]=h}for(var l=[],n=[],e=0;e<d[0].length;e++){b=[];for(f=0;f<a.length;f++)isNaN(d[f][e])||b.push(d[f][e]);l[e]=math.mean(b);n[e]=math.var(b)}d=d.map(function(a){return a.map(function(a,b){return(a-l[b])/n[b]})});
...
1))}}function e(b){b=b?a.findAllObjects(b,HAS_MAPPING):a.findAllSubjects(TYPE,MAPPING);for(var c=a.recursiveFindAllSubClasses(MOBILE_CONTROL),d=0;d<c.length;d++)for(var f=a.findAllSubjects(TYPE,c[d]),e=0;e<f.length;e++){var n=a.findObjectValue(f[e],NAME);n||(n=f[e]);if(!g[f[e]]){var p=f[e],h=f[e],m=n,r=c[d],n=void 0;r==ACCELEROMETER_X||r==ACCELEROMETER_Y||r==ACCELEROMETER_Z?n=new AccelerometerControl(r):r==TILT_X||r==TILT_Y?n=new TiltControl(r):r==GEOLOCATION_LATITUDE||r==GEOLOCATION_LONGITUDE?n=
new GeolocationControl(r):r==GEOLOCATION_DISTANCE?n=new DistanceControl:r==COMPASS_HEADING?n=new CompassControl:r==BEACON?(n=a.findObjectValue(h,HAS_UUID),m=a.findObjectValue(h,HAS_MAJOR),r=a.findObjectValue(h,HAS_MINOR),n=new BeaconControl(n,m,r)):r==SLIDER||r==TOGGLE||r==BUTTON||r==CUSTOM_CONTROL?(n=new Control(h,m,r),m=a.findObjectValue(h,HAS_INITIAL_VALUE),n.updateValue(m)):r==RANDOM?n=new RandomControl(h):r==BROWNIAN?(m=a.findObjectValue(h,HAS_INITIAL_VALUE),n=new BrownianControl(h,m)):r==RAMP?
(n=Math.round(1E3*a.findObject(h,HAS_DURATION)),m=a.findObjectValue(h,HAS_INITIAL_VALUE),n=new RampControl(h,n,m)):r==DATA_CONTROL&&(n=a.findObjectValue(h,HAS_URL),m=a.findObjectValue(h,HAS_JSON_MAP),m=new Function("json",m),n=new DataControl(h,n,m));a.findObjectValue(h,IS_SMOOTH)&&n.setSmooth&&n.setSmooth(!0);h=a.findObjectValue(h,IS_AVERAGE_OF);!isNaN(h)&&n.setAverageOf&&n.setAverageOf(h);g[p]=n}}for(c=0;c<b.length;c++)l[b[c]]||(e=DYMO_STORE.findSubject(HAS_MAPPING,b[c]),DYMO_STORE.findObject(e,
TYPE)!=DYMO&&(e=null),d=b[c],f=b[c],p=e,e=a.findObjectValue(f,IS_UNIDIRECTIONAL),h=a.findObject(f,HAS_FUNCTION),p=k(h,e,p),h=a.findAllObjects(f,TO_TARGET),h=0<h.length?(n=k(h[0],!0))?n:h:void 0,f=a.findObject(f,HAS_RANGE),f=new Mapping(p,h,f,e),l[d]=f)}function k(b,c,d){var g=$jscomp.makeIterator(a.findFunction(b));b=g.next().value;var f=g.next().value,g=g.next().value;if(b&&f&&g)return d=$jscomp.makeIterator(h(f,d)),f=d.next().value,d=d.next().value,new DymoFunction(b,f,d,g,c)}function h(b,c){for(var d=
[],f=[],e=0;e<b.length;e++){var l=a.findObject(b[e],TYPE);l==FEATURE_TYPE||a.isSubtypeOf(l,FEATURE_TYPE)?(l==FEATURE_TYPE&&(l=b[e]),d.push(l),f.push(FEATURE_TYPE)):l==PARAMETER_TYPE||a.isSubclassOf(l,PARAMETER_TYPE)||a.isSubclassOf(a.findObject(l,TYPE),PARAMETER_TYPE)?(l==CUSTOM_PARAMETER&&(l=b[e]),l=c?a.setParameter(c,l):b[e],d.push(l),f.push(PARAMETER_TYPE)):(d.push(g[b[e]]),f.push(MOBILE_CONTROL))}return[d,f]}function m(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):a==GRAPH_NAVIGATOR?
new GraphNavigator(void 0):new SequentialNavigator(void 0)}var f=this,p="",g={},l={};this.getMappings=function(){return l};this.loadDymoFromJson=function(a,c){var d=a.lastIndexOf("/")+1;p=a.substring(0,d);b(a,function(){c(f.createDymoFromStore())})};this.parseDymoFromJson=function(b,c){a.loadData(b,!0,function(){c(f.createDymoFromStore())})};this.loadRenderingFromJson=function(a,c){b(a,function(){c(f.createRenderingFromStore())})};this.parseDymoFromTurtle=function(b,c){a.loadData(b,!1,function(){c(f.createDymoFromStore())})};
this.createDymoFromStore=function(){for(var b=a.findTopDymos(),c=0;c<b.length;c++)a.addBasePath(b[c],p),e();return b};this.createRenderingFromStore=function(){var b=a.findSubject(TYPE,RENDERING),c=new Rendering(a.findObject(b,HAS_DYMO));e(b);for(var b=a.findAllObjects(b,HAS_NAVIGATOR),d=0;d<b.length;d++){var f=k(a.findObject(b[d],NAV_DYMOS),!0);c.addSubsetNavigator(f,m(a.findObject(b[d],TYPE)))}return[c,g]}};function DymoStore(a){function b(a,c){for(var d=0;d<a.length;d++){var f=c(a[d]);if(f)return f}for(d=0;d<a.length;d++)if(f=b(h.findParents(a[d]),c))return f}function c(a,b,c){h.triplesToRdf(a,function(a){d(a,b,c)})}function d(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,d){jsonld.frame(d,{"@id":b},function(a,b){jsonld.compact(b,DYMO_CONTEXT,function(a,b){jsonld.compact(b,DYMO_SIMPLE_CONTEXT,function(a,b){k(b);b["@context"]="http://tiny.cc/dymo-context";
b=JSON.stringify(b);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");c(b)})})})})}function e(a,b){var d=h.findObject(a,TYPE,null),d=h.recursiveFindAllTriples(a,d);c(d,a,function(a){b(null,JSON.parse(a))})}function k(a){if(a&&a instanceof Object)for(var b in a)"@id"==b&&a[b].includes("_:b")?delete a[b]:k(a[b])}var h=this;EasyStore.call(this);var m={};(function(){h.loadFileIntoStore("http://tiny.cc/dymo-ontology",!1,function(){h.loadFileIntoStore("http://tiny.cc/mobile-audio-ontology",!1,function(){a&&
a()})})})();this.addBasePath=function(a,b){m[a]=b};this.getBasePath=function(a){return b([a],function(a){return m[a]})};this.getSourcePath=function(a){var b=this.findObjectValue(a,HAS_SOURCE);if(b)return(a=this.getBasePath(a))?a+b:b;b=this.findParents(a);if(0<b.length)for(a=0;a<b.length;a++){var c=this.getSourcePath(b[a]);if(c)return c}};this.addSpecificParameterObserver=function(a,b){this.addValueObserver(a,VALUE,b)};this.addParameterObserver=function(a,b,c){if(a&&b)return a=this.setParameter(a,
b),this.addValueObserver(a,VALUE,c),a};this.getParameterObservers=function(a,b){if(a&&b&&(a=this.findObjectOfType(a,HAS_PARAMETER,b)))return this.getValueObservers(a,VALUE)};this.removeParameterObserver=function(a,b,c){a&&b&&(a=this.findObjectOfType(a,HAS_PARAMETER,b))&&this.removeValueObserver(a,VALUE,c)};this.addDymo=function(a,b,c,d,e){this.addTriple(a,TYPE,DYMO);b&&this.addPart(b,a);c&&this.addPart(a,c);d&&this.addTriple(a,HAS_SOURCE,N3.Util.createLiteral(d));e&&this.addTriple(a,CDT,e)};this.addPart=
function(a,b){h.addObjectToList(a,HAS_PART,b)};this.setParts=function(a,b){this.deleteList(a,HAS_PART);this.addObjectsToList(a,HAS_PART,b)};this.replacePartAt=function(a,b,c){if(a!=b)return this.replaceObjectInList(a,HAS_PART,b,c)};this.addSimilar=function(a,b){this.addTriple(a,HAS_SIMILAR,b)};this.addSuccessor=function(a,b){this.addTriple(a,HAS_SUCCESSOR,b)};this.setFeature=function(a,b,c){return this.setObjectValue(a,HAS_FEATURE,b,VALUE,c)};this.addParameter=function(a,b,c,d){this.setParameter(a,
b,c);d&&this.addParameterObserver(a,b,d)};this.addCustomParameter=function(a,b){this.addTriple(a,HAS_PARAMETER,b);this.addTriple(b,TYPE,CUSTOM_PARAMETER);return b};this.setParameter=function(a,b,c){this.findParameterUri(a,b)||null!=c&&!isNaN(c)||(c=this.findObjectValue(b,HAS_STANDARD_VALUE,null));this.findObject(b,IS_INTEGER)&&(c=Math.round(c));return this.setObjectValue(a,HAS_PARAMETER,b,VALUE,c)};this.addControl=function(a,b,c){c||(c=this.createBlankNode());a&&this.addTriple(c,NAME,N3.Util.createLiteral(a));
this.addTriple(c,TYPE,b);return c};this.addDataControl=function(a,b){var c=this.addControl(null,DATA_CONTROL);this.addTriple(c,HAS_URL,N3.Util.createLiteral(a));this.addTriple(c,HAS_JSON_MAP,N3.Util.createLiteral(b));return c};this.addRendering=function(a,b){this.addTriple(a,TYPE,RENDERING);this.addTriple(a,HAS_DYMO,b)};this.addMapping=function(a,b,c,d,e){var g=this.createBlankNode();this.addTriple(g,TYPE,MAPPING);a&&this.addTriple(a,HAS_MAPPING,g);this.addTriple(g,HAS_FUNCTION,b);if(c)for(a=0;a<
c.length;a++)this.addTriple(g,TO_TARGET,c[a]);else d&&this.addTriple(g,TO_TARGET,d);this.addTriple(g,HAS_RANGE,e);this.findObject(e,TYPE)||this.addTriple(e,TYPE,CUSTOM_PARAMETER);return g};this.addNavigator=function(a,b,c,d){var g=this.createBlankNode();this.addTriple(a,HAS_NAVIGATOR,g);this.addTriple(g,TYPE,b);a=this.addFunction(c,d);this.addTriple(g,NAV_DYMOS,a);return g};this.addFunction=function(a,b){for(var c=this.createBlankNode(),d=Object.keys(a),e=0;e<d.length;e++){var f=this.createBlankNode();
this.addTriple(c,HAS_ARGUMENT,f);this.addTriple(f,HAS_VARIABLE,N3.Util.createLiteral(d[e]));this.addTriple(f,HAS_VALUE,a[d[e]])}this.addTriple(c,HAS_BODY,N3.Util.createLiteral(b));return c};this.updatePartOrder=function(a,b){var c=this.findParts(a);0<c.length&&(c.sort(function(a,c){return h.findAttributeValue(a,b)-h.findAttributeValue(c,b)}),this.setParts(a,c))};this.findTopDymos=function(){var a=this.findAllSubjects(TYPE,DYMO),b=this.findAllSubjects(HAS_PART),c=[].concat.apply([],b.map(function(a){return h.findParts(a)}));
return a.filter(function(a){return 0>c.indexOf(a)})};this.findParts=function(a){return this.findAllObjects(a,HAS_PART)};this.findPartAt=function(a,b){return this.findObjectInListAt(a,HAS_PART,b)};this.findSimilars=function(a){return this.findAllObjects(a,HAS_SIMILAR)};this.findSuccessors=function(a){return this.findAllObjects(a,HAS_SUCCESSOR)};this.findAllParents=function(a){for(var b=[];null!=a;)b.push(a),a=DYMO_STORE.findParents(a)[0];return b};this.findParents=function(a){var b=this.findContainingLists(a);
...
HAS_NAVIGATOR)};this.findFunction=function(a){if(a){var b=h.findAllObjects(a,HAS_ARGUMENT),c=b.map(function(a){return h.findObjectValue(a,HAS_VARIABLE)}),b=b.map(function(a){return h.findObject(a,HAS_VALUE)});a=h.findObjectValue(a,HAS_BODY);return[c,b,a]}};this.findAttributeValue=function(a,b){var c=this.findParameterValue(a,b);null==c&&(c=this.findFeatureValue(a,b));return c};this.findFeatureValue=function(a,b){return b===LEVEL_FEATURE?this.findLevel(a):b===INDEX_FEATURE?this.findPartIndex(a):this.findObjectValueOfType(a,
HAS_FEATURE,b,VALUE)};this.findAllFeatureValues=function(a){return this.findAllObjectValuesOfType(a,HAS_FEATURE,VALUE)};this.findAllNumericFeatureValues=function(a){return this.findAllFeatureValues(a).filter(function(a){return!isNaN(a)})};this.findParameterValue=function(a,b){return this.findObjectValueOfType(a,HAS_PARAMETER,b,VALUE)};this.findParameterUri=function(a,b){return a?this.findObjectOfType(a,HAS_PARAMETER,b):this.findSubject(null,b)};this.findPartIndex=function(a){var b=this.findParents(a)[0];
return this.findObjectIndexInList(b,HAS_PART,a)};this.findLevel=function(a){var b=0;for(a=this.findParents(a)[0];a;)b++,a=this.findParents(a)[0];return b};this.findMaxLevel=function(){for(var a=this.findAllSubjects(TYPE,DYMO),b=0,c=0;c<a.length;c++)b=Math.max(b,this.findLevel(a[c]));return b};this.toJsonld=function(a){var b=this.findTopDymos()[0];this.toRdf(function(c){d(c,b,a)})};this.toJsonGraph=function(a,b,c){var d={nodes:[],edges:[]},g={},f=this.findAllSubjects(TYPE,a),k=this.find(null,b,null);
async.map(f,e,function(e,l){d.nodes=l;for(var n=0;n<f.length;n++)g[f[n]]=d.nodes[n];d.edges=[];for(n=0;n<k.length;n++)0==h.find(k[n].object,TYPE,a).length?0<h.find(k[n].object,FIRST).length&&(e=h.findObjectOrList(k[n].subject,b),e=e.map(function(a){return{source:g[k[n].subject],target:g[a],value:1}}),d.edges=d.edges.concat(e)):d.edges.push({source:g[k[n].subject],target:g[k[n].object],value:1});c(d)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a){this.writeToJsonld=function(b,c){c||(c="dymo.json");a.toJsonld(function(a){fetch(b+c,{method:"post",body:a})})}};function EasyReasoner(){function a(a,c,d){var b=new XMLHttpRequest;b.open("POST",a);b.setRequestHeader("Content-Type","application/x-www-form-urlencoded");b.onload=function(){d(b.responseText)};b.error=function(a){console.log(a)};b.send(c)}this.queryAll=function(b,c){for(var d="",e=0;e<b.length;e++)d+=encodeURIComponent("data="+b[e])+"&";d+=encodeURIComponent("query={ ?a ?b ?c. } => { ?a ?b ?c. }.");a("http://eye.restdesc.org/",d,function(a){c(a)})}};function EasyStore(){function a(a,b,c){var d=[];f[a]&&f[a][b]&&(d=d.concat(f[a][b]));b=h.findObject(a,TYPE);p[b]&&(d=d.concat(p[b]));for(var g=0;g<d.length;g++)d[g].observedValueChanged&&d[g].observedValueChanged(a,b,c)}function b(a,b){a=m.find(null,a,b);if(0<a.length)return a[0].subject}function c(a){if(a){var b=h.findObject(a,FIRST);if(b){var c=[];c.push(b);for(a=h.findObject(a,REST);a!=NIL;)c.push(h.findObject(a,FIRST)),a=h.findObject(a,REST);return c}return a}}function d(a,b){if(a){for(var c=
0,d=h.findObject(a,REST);d!=NIL&&(null==b||c<b);)a=d,d=h.findObject(a,REST),c++;if(null==b||c==b)return a}}function e(a){var b=N3.Util.getLiteralValue(a);a=N3.Util.getLiteralType(a);"http://www.w3.org/2001/XMLSchema#string"!=a&&"http://www.w3.org/2001/XMLSchema#boolean"!=a&&(b=Number(b));return b}function k(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}var h=this,m=N3.Store(),f={},p={};this.addValueObserver=function(a,b,c){f[a]||(f[a]={});f[a][b]||(f[a][b]=[]);f[a][b].push(c)};
...
[]};this.getTypeObservers=function(a){return p[a]?p[a]:null==a?flattenArray(Object.keys(p).map(function(a){return p[a]})):[]};this.addTriple=function(a,b,c){if(null!=a&&null!=b&&null!=c)return m.addTriple(a,b,c)};this.removeTriple=function(a,b,c){c||(c=this.findObject(a,b));return m.removeTriple(a,b,c)};this.createBlankNode=function(){return m.createBlankNode()};this.setTriple=function(a,b,c){this.removeTriple(a,b);this.addTriple(a,b,c)};this.setValue=function(b,c,d){var g=this.findObjectValue(b,
...
e);g;)e=g,g=this.findSubject(REST,e);if(e=this.find(null,null,e)[0])b[d]=e.subject,c[d]=e.predicate}return[b,c]};this.recursiveFindAllTriples=function(a,b){a=m.find(a,null,null);for(var c=[],d=a.length-1;0<=d;d--)b&&0<m.find(a[d].object,TYPE,b).length?a.splice(d,1):c=c.concat(this.recursiveFindAllTriples(a[d].object,b));return a.concat(c)};this.recursiveDeleteAllTriples=function(a,b){a=this.recursiveFindAllTriples(a,b);for(b=0;b<a.length;b++){var c=a[b].subject;this.removeTriple(c,a[b].predicate,
...
this.findObject(a,TYPE);a;){if(a==b)return!0;a=this.findObject(a,TYPE)}return!1};this.loadData=function(a,b,c){k(a,b,function(a){N3.Parser().parse(a,function(a,b,d){b?m.addTriple(b):c&&c()})})};this.loadFileIntoStore=function(a,b,c){loadFile(a,function(a){h.loadData(a,b,c)})};this.toRdf=function(a){var b=m.find(null,null,null);this.triplesToRdf(b,a)};this.triplesToRdf=function(a,b){for(var c=N3.Writer({format:"application/nquads"}),d=0;d<a.length;d++)c.addTriple(a[d]);c.end(function(a,c){b(c)})};
this.logData=function(){var a=m.find(null).map(function(a){return a.subject+"\n"+a.predicate+"\n"+a.object}),b;for(b in a)console.log(a[b])}};function FunctionTools(){}FunctionTools.IDENTITY_JSON={args:["a"],body:"return a;"};FunctionTools.inverted={};FunctionTools.created={};FunctionTools.createFunction=function(a,b){FunctionTools.created[b]||(FunctionTools.created[b]=Function.apply(null,a.concat(b)));return FunctionTools.created[b]};
...
e=this._outputBuffer.endIndex,k=0,h=0;1>this.slopeCount;)d[e+2*h]=(1-this.slopeCount)*this.prevSampleL+this.slopeCount*b[c],d[e+2*h+1]=(1-this.slopeCount)*this.prevSampleR+this.slopeCount*b[c+1],h++,this.slopeCount+=this._rate;--this.slopeCount;if(1!=a)a:for(;;){for(;1<this.slopeCount;)if(--this.slopeCount,k++,k>=a-1)break a;var m=c+2*k;d[e+2*h]=(1-this.slopeCount)*b[m]+this.slopeCount*b[m+2];d[e+2*h+1]=(1-this.slopeCount)*b[m+1]+this.slopeCount*b[m+3];h++;this.slopeCount+=this._rate}this.prevSampleL=
...
e,k,h,m,f,p,g;m=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)h=(this.overlapLength-e)*m,f=e*m,k=2*e,p=k+a,g=k+d,c[g+0]=b[p+0]*f+this.pMidBuffer[k+0]*h,c[g+1]=b[p+1]*f+this.pMidBuffer[k+1]*h},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
...
logic.run=function(a,b,c){assert(logic.is_lvar(b)||logic.is_array(b),"#2 of run must be variable/array");c="undefined"===typeof c?inf:c;a=a(logic.nil);for(var d=[],e=0;e<c&&!a.is_empty();++e){var k=a.first,h=k.frame;if(logic.is_lvar(b)){var m=h.walk(b),m=logic.is_lvar(m)?k.get_value(b):m;d.push(m)}else{for(var f=[],p=0;p<b.length;++p)m=h.walk(b[p]),m=logic.is_lvar(m)?k.get_value(m):m,f.push(m);d.push(f)}a=a.rest()}return d};
