...
"http://tiny.cc/mobile-audio-ontology#MobileControl",CUSTOM_CONTROL="http://tiny.cc/mobile-audio-ontology#CustomControl",SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",UI_CONTROL="http://tiny.cc/mobile-audio-ontology#UiControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",ACCELEROMETER_X="http://tiny.cc/mobile-audio-ontology#AccelerometerX",ACCELEROMETER_Y="http://tiny.cc/mobile-audio-ontology#AccelerometerY",ACCELEROMETER_Z="http://tiny.cc/mobile-audio-ontology#AccelerometerZ",
TILT_X="http://tiny.cc/mobile-audio-ontology#TiltX",TILT_Y="http://tiny.cc/mobile-audio-ontology#TiltY",TILT_Z="http://tiny.cc/mobile-audio-ontology#TiltZ",GEOLOCATION_LATITUDE="http://tiny.cc/mobile-audio-ontology#GeolocationLatitude",GEOLOCATION_LONGITUDE="http://tiny.cc/mobile-audio-ontology#GeolocationLongitude",GEOLOCATION_DISTANCE="http://tiny.cc/mobile-audio-ontology#GeolocationDistance",COMPASS_HEADING="http://tiny.cc/mobile-audio-ontology#CompassHeading",BEACON="http://tiny.cc/mobile-audio-ontology#Beacon",
SLIDER="http://tiny.cc/mobile-audio-ontology#Slider",TOGGLE="http://tiny.cc/mobile-audio-ontology#Toggle",BUTTON="http://tiny.cc/mobile-audio-ontology#Button",RANDOM="http://tiny.cc/mobile-audio-ontology#Random",BROWNIAN="http://tiny.cc/mobile-audio-ontology#Brownian",RAMP="http://tiny.cc/mobile-audio-ontology#Ramp",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MOBILE_PARAMETER="http://tiny.cc/mobile-audio-ontology#MobileParameter",GLOBAL_PARAMETER="http://tiny.cc/mobile-audio-ontology#GlobalParameter",
...
"http://tiny.cc/mobile-audio-ontology#toParameter",IS_RELATIVE="http://tiny.cc/mobile-audio-ontology#isRelative",HAS_INITIAL_VALUE="http://tiny.cc/mobile-audio-ontology#hasInitialValue",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",
DYMO_TYPES=[CONJUNCTION,DISJUNCTION,SEQUENCE],PARAMETERS=[PLAY,LOOP,ONSET,DURATION_RATIO,AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,PAN,DISTANCE,HEIGHT,REVERB,DELAY,FILTER,PART_COUNT,LISTENER_ORIENTATION,AUTO_CONTROL_FREQUENCY,AUTO_CONTROL_TRIGGER],CONTROLS=[SLIDER,TOGGLE,BUTTON,CUSTOM_CONTROL,ACCELEROMETER_X,ACCELEROMETER_Y,ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,RANDOM,BROWNIAN,RAMP],UI_CONTROLS=[SLIDER,TOGGLE,BUTTON,CUSTOM_CONTROL],
SENSOR_CONTROLS=[ACCELEROMETER_X,ACCELEROMETER_Y,ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,BEACON];function DymoManager(a,b,c,d){var e=new Scheduler(a,function(){});c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.setReverbFile(c);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g={},l={};this.loadDymoAndRendering=function(a,b,c,p){var u=new DymoLoader(e,function(){u.loadDymoFromJson(a,function(a){u.loadRenderingFromJson(b,a[1],function(b){f=b[0];f.dymo=a[0];for(var h in b[1]){var q=b[1][h];0<=UI_CONTROLS.indexOf(q.getType())&&(g[h]=new UIControl(q,d));0<=SENSOR_CONTROLS.indexOf(q.getType())&&
(l[h]=q)}e.loadBuffers(f.dymo,p);c&&c()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};this.replacePartOfTopDymo=function(a,b){var c=f.dymo.getPart(a);f.dymo.replacePart(a,b);e.stop(c)};this.updateNavigatorPosition=function(a,b,c){e.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return e.getNavigatorPosition(a,
b)};this.syncNavigators=function(a,b,c){e.syncNavigators(a,b,c)};this.startPlaying=function(){f.dymo.updatePartOrder(ONSET);e.play(f.dymo)};this.stopPlaying=function(){e.stop(f.dymo)};this.getTopDymo=function(){return f.dymo};this.getRendering=function(){return f};this.getUIControls=function(){return g};this.getUIControl=function(a){return g[a]};this.getSensorControls=function(){return l}};function AudioProcessor(a){function b(a){return{extract:function(b,e,f){for(var g=[],l=0;l<a.numberOfChannels;l++)g.push(a.getChannelData(l));for(l=0;l<e;l++)for(var h=0;h<g.length;h++)b[l*g.length+h%g.length]=g[h][l+f];return Math.min(e,g[0].length-f)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;for(var f=b(c),e=new SimpleFilter(f,e),f=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate),g=[],l=0;l<c.numberOfChannels;l++)g.push(f.getChannelData(l));for(var h=
new Float32Array(2048),q=e.extract(h,1024),m=0;q;){for(l=0;l<q;l++)for(var p=0;p<g.length;p++)g[p][l+m]=h[l*g.length+p%g.length];m+=q;q=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),l=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(l,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=l[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b,c){function d(a){0<r&&r--;0==r&&(b&&b(r),a&&a())}function e(a){h.splice(h.indexOf(a),1)}function f(){for(var a=[],b=0;b<h.length;b++)for(var d=$jscomp.makeIterator(h[b].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();q=a;c&&c()}function g(b,c){r++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,
b)})};d.error=function(){};d.send()}var l={},h=[],q=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var m=a.createConvolver();m.connect(a.destination);var p=a.createDelay();p.delayTime.value=.5;p.connect(a.destination);var u=a.createGain();u.gain.value=.6;p.connect(u);u.connect(p);var r=0;this.setReverbFile=function(a){g(a,function(a){m.buffer=a;d()})};this.loadBuffers=function(a,b){for(var c=a.getAllSourcePaths(),e=0,f=c.length;e<f;e++)l[c[e]]||
g(c[e],function(a,c){l[c]=a;d(b)})};this.getBuffer=function(a){return l[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,k=0,
B=h.length;k<B;k++)h[k].hasDymo(a)&&(d=h[k].getNavigator()),h[k].hasDymo(b)&&(e=h[k].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,l,m,p,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSources(a);if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};
this.getUrisOfPlayingDymos=function(){return q};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e,f){function g(a,c){var d=b.createGain();d.connect(c);d.gain.value=0;a.connect(d);return d}function l(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=z||x<c.duration)c=u(c,p(z,c),p(x+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=x/d;c=u(c,0,p(d+FADE_LENGTH,c));x=d}else if(0!=z||x<c.duration)c=u(c,p(z,c),p(x+FADE_LENGTH,c));r(c,c.length);A.buffer=c;k[PLAYBACK_RATE]=A.playbackRate;h(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function h(a,b){q(a,
b.getValue());b.addObserver(y)}function q(a,b,c){c&&(b+=y.getParameterValue(a));0>b&&0<=C.indexOf(a)&&(b=0);k[a]&&(k[a].value||0==k[a].value?k[a].value=b:k[a].setValue(b));0<=H.indexOf(a)&&(0==k[DISTANCE].value&&(k[DISTANCE].value=-.01),F.setPosition(k[PAN].value,k[HEIGHT].value,k[DISTANCE].value))}function m(){n=!1;var a=b.currentTime;k[AMPLITUDE].setValueAtTime(k[AMPLITUDE].value,a);k[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);A.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*
b.sampleRate)}function u(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),k=0;k<a.numberOfChannels;k++)for(var B=e.getChannelData(k),f=a.getChannelData(k),C=0;C<d;C++)B[C]=f[c+C];return e}function r(a,b){for(var c=a.sampleRate*FADE_LENGTH,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),k=0;k<c;k++)e[k]*=k/c,e[b-k-1]*=k/c}function v(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));w("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+
b+"&toSecond="+c,function(a){d(a)})}function w(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var y=this,n,t,k={},B=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],C=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],A=b.createBufferSource(),D=b.createGain();
D.connect(b.destination);var G=g(D,d);d=g(D,e);var F=b.createPanner();F.connect(D);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(F);A.connect(e);var E=a.getSegment(),z=E[0],x=E[1];z||(z=0);!x&&c&&(x=c.duration-z);E=a.getParameter(DURATION_RATIO).getValue();0<E&&1>E&&(x*=E);c?l():isNaN(z+x)||v(a.getSourcePath(),z,z+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=u(c,0,p(d+FADE_LENGTH,c)),x=d):
c=u(c,0,p(x+FADE_LENGTH,c));r(c,c.length);A.buffer=c});k[AMPLITUDE]=D.gain;k[TIME_STRETCH_RATIO]={value:0};k[REVERB]=G.gain;k[DELAY]=d.gain;k[FILTER]=e.frequency;k[PAN]={value:0};k[HEIGHT]={value:0};k[DISTANCE]={value:0};k[LOOP]={value:0};h(AMPLITUDE,a.getParameter(AMPLITUDE));h(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));h(REVERB,a.getParameter(REVERB));h(DELAY,a.getParameter(DELAY));h(FILTER,a.getParameter(FILTER));h(PAN,a.getParameter(PAN));h(HEIGHT,a.getParameter(HEIGHT));h(DISTANCE,
a.getParameter(DISTANCE));h(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){q(a.getName(),a.getChange(),!0)};this.getDymo=function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return A.loop&&n};this.getParameterValue=function(a){if(k[a])return k[a].value||0==k[a].value?k[a].value:k[a].getValue()};this.play=function(b){A.onended=function(){for(var b=0;b<B.length;b++){var c=a.getParameter(B[b]);c&&c.removeObserver(y)}A.disconnect();D.disconnect();
G.disconnect();f&&f(y)};b||(b=0);A.start(b);n=!0};this.pause=function(){n?(m(),t=!0):t&&(t=!1,this.play())};this.stop=function(){n&&m()}};function SchedulerThread(a,b,c,d,e,f,g,l){function h(){n=w?w:r();m(n);k||(k=n.keys().next().value.getParameter(ONSET).getValue());var a;a=t?t-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(n.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){g()},a);(w=r())&&0<w.size?(t=u(b),a=t[1],t=t[0],a.getDymo().getParameter(LOOP).getValue()&&(t-=FADE_LENGTH),a=1E3*(t-c.currentTime-SCHEDULE_AHEAD_TIME),y=setTimeout(function(){h()},a)):(t=u(b),a=1E3*
(t-c.currentTime),setTimeout(function(){q()},a+100))}function q(){0!=v.size||w&&0!=w.size||(window.clearTimeout(y),b.reset(),l&&l())}function m(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,v.get(c)||v.set(c,[]),v.get(c).push(a.get(c))}function p(a){var b=v.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&v.delete(a.getDymo());g();q()}function u(a){if(w){var b=w.keys().next().value.getParameter(ONSET).getValue(),c=b-k;k=b;if(!isNaN(b))return a+c}for(var b=
0,d,c=$jscomp.makeIterator(n.values()),e=c.next();!e.done;e=c.next()){var e=e.value,f;f=e;var h=f.getDymo().getParameter(PLAYBACK_RATE).getValue();f=f.getDuration()/h;f>b&&(b=f,d=e)}return[a+b,d]}function r(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var k=new Map,h=0;h<a.length;h++)if(a[h].getSourcePath()){var g=d[a[h].getSourcePath()];k.set(a[h],new Source(a[h],c,g,e,f,p))}return k}}var v=new Map,w,y,n=[],t,k;b||(b=new DymoNavigator(a,
...
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){n.loadData(a,!0,b)})}function d(a,b,c){w(a,function(f){if(0>f.indexOf("Cannot GET")){var h;a:{try{JSON.parse(f)}catch(g){h=!1;break a}h=!0}h&&(b?(0<=a.indexOf(t)&&(a=a.replace(t,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(t)&&(f=t+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function f(a){var b=g()[0],c=q(b,a);m(b,a);return[c,a]}function g(){var a=n.find(null,HAS_PART,null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function l(a){var b=$jscomp.makeIterator(h(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function h(a){var b=n.findAllObjectValues(a,HAS_ARGUMENT);
a=n.findFirstObjectValue(a,HAS_BODY);return[b,a]}function q(b,c){var d=n.findFirstObjectUri(b,CDT),d=new DynamicMusicObject(b,d,a);d.setBasePath(t);c[b]=d;d.setSourcePath(n.findFirstObjectValue(b,HAS_SOURCE));for(var e=n.findAllObjectUris(b,HAS_FEATURE),f=0;f<e.length;f++)d.setFeature(e[f],n.findFirstObjectUri(e[f],VALUE));e=n.findAllObjectUris(b,HAS_PARAMETER);for(f=0;f<e.length;f++)r(d,n.findFirstObjectUri(e[f],TYPE),n.findFirstObjectValue(e[f],VALUE));e=n.findAllObjectUris(b,HAS_PART);for(f=0;f<
e.length;f++)d.addPart(q(e[f],c));return d}function m(a,b){for(var c=b[a],d=n.findAllObjectUris(a,HAS_SIMILAR),e=0;e<d.length;e++)c.addSimilar(b[d[e]]);d=n.findAllObjectUris(a,HAS_MAPPING);for(e=0;e<d.length;e++)c.addMapping(p(d[e],b,c));c=n.findAllObjectUris(a,HAS_PART);for(e=0;e<c.length;e++)m(c[e],b)}function p(b,c,d,e){var f=n.findAllObjectUris(b,TO_TARGET),h=n.findAllObjectUris(b,TO_DYMO);if(0<f.length){for(var h=[],g=0;g<f.length;g++){var q=n.findFirstSubjectUri(NAME,f[g]);h.push(e[q])}return u(b,
c,d,h,e)}if(0<h.length){f=[];if(q=l(h[0]))g=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(f,g.filter(q));else for(g=0;g<h.length;g++)f.push(c[h[g]]);return u(b,c,d,f,e,q)}return u(b,c,d,[a],e)}function u(a,b,c,d,e,f){b=n.findFirstObjectUri(a,IS_RELATIVE);for(var g=[],q=n.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),l=0;l<q.length;l++){var p=n.findFirstObjectUri(q[l],TYPE),m=n.findFirstObjectValue(q[l],NAME);m||(m=q[l]);p==FEATURE?g.push(m):p==PARAMETER?(p=c?r(c,m,0):new Parameter(m,
0),g.push(p)):g.push(e[q[l]])}e=$jscomp.makeIterator(h(n.findFirstObjectUri(a,HAS_FUNCTION)));c=e.next().value;e=e.next().value;a=n.findFirstObjectUri(a,TO_PARAMETER);return new Mapping(g,b,{args:c,body:e},d,a,f)}function r(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function v(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function w(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};
c.error=function(a){console.log(a)};c.send()}function y(a,b,c){w(a,function(a){n.loadData(a,b,c)})}var n=new EasyStore,t="";(function(){y("http://tiny.cc/dymo-ontology",!1,function(){y("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();this.getStore=function(){return n};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;t=a.substring(0,d);c(a,function(){b(f({}))})};this.parseDymoFromJson=function(a,b){n.loadData(a,!0,function(){b(f({}))})};this.loadRenderingFromJson=function(a,
b,d){b||(b={});c(a,function(){for(var a=b,c=n.findFirstSubjectUri(TYPE,RENDERING),e=new Rendering(a[n.findFirstObjectUri(c,HAS_DYMO)]),f=n.findAllObjectUris(c,HAS_MAPPING),k={},h=0;h<f.length;h++)for(var g=n.findAllObjectUris(f[h],HAS_DOMAIN_DIMENSION),q=0;q<g.length;q++){var m=n.findFirstObjectUri(g[q],TYPE),u=n.findFirstObjectValue(g[q],NAME);u||(u=g[q]);if(n.isSubclassOf(m,MOBILE_CONTROL)&&!k[g[q]]){var t;t=g[q];var r=m,m=void 0;r==ACCELEROMETER_X||r==ACCELEROMETER_Y||r==ACCELEROMETER_Z?m=new AccelerometerControl(r):
r==TILT_X||r==TILT_Y?m=new TiltControl(r):r==GEOLOCATION_LATITUDE||r==GEOLOCATION_LONGITUDE?m=new GeolocationControl(r):r==GEOLOCATION_DISTANCE?m=new DistanceControl:r==COMPASS_HEADING?m=new CompassControl:r==BEACON?(u=n.findFirstObjectValue(t,HAS_UUID),m=n.findFirstObjectValue(t,HAS_MAJOR),r=n.findFirstObjectValue(t,HAS_MINOR),m=new BeaconControl(u,m,r)):r==SLIDER||r==TOGGLE||r==BUTTON||r==CUSTOM_CONTROL?m=new Control(u,r):r==RANDOM?m=new RandomControl:r==BROWNIAN?(u=n.findFirstObjectValue(t,HAS_INITIAL_VALUE),
m=new BrownianControl(u)):r==RAMP&&(m=Math.round(1E3*n.findFirstObjectUri(t,HAS_DURATION)),u=n.findFirstObjectValue(t,HAS_INITIAL_VALUE),m=new RampControl(m,u));n.findFirstObjectUri(t,IS_SMOOTH)&&m.setSmooth&&m.setSmooth(!0);t=Number(n.findFirstObjectUri(t,IS_AVERAGE_OF));!isNaN(t)&&m.setAverageOf&&m.setAverageOf(t);t=m;u=Number(n.findFirstObjectUri(g[q],VALUE));isNaN(u)||t.update(u);k[g[q]]=t}}for(h=0;h<f.length;h++)e.addMapping(p(f[h],a,void 0,k));if(a=n.findFirstObjectUri(c,HAS_NAVIGATOR))c=n.findFirstObjectUri(a,
TO_DYMO),c=l(c),e.addNavigator(v(n.findFirstObjectUri(a,TYPE)),c);d([e,k])})};this.loadGraphFromJson=function(a,b,c){d(a,"",function(a){for(var d=0;d<a.length;d++)if(a[d])for(var e=0;e<a[d].length;e++){var f=b[CONTEXT_URI+"dymo"+d],k=b[CONTEXT_URI+"dymo"+a[d][e]];f&&k&&f.addSimilar(k)}c(void 0)})}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
...
b.getParts()[c],d)}function l(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)l(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var q=this,m=null,p=[],u=[],r={},v={},w=[],y=[],n="",t;v[PLAY]=new Parameter(PLAY,0,!0);v[LOOP]=new Parameter(LOOP,0,!0);
...
LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(r.hasOwnProperty(a))return r[a];if(m)return m.getFeature(a);for(var b=[],c=0;c<p.length;c++)if(p[c]){var d=p[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(r[a])return r[a]};this.getMappings=function(){return w};this.getSegment=function(){return[this.getFeature("time"),this.getFeature("duration")]};this.addParameter=function(a){v[a.getName()]=
a};this.getParameter=function(a){return v[a]};this.addMapping=function(a){w.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(q):c.stop(q))};this.updatePartOrder=function(a){p&&p[0]&&!isNaN(p[0].getFeature(a))?p.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):p&&p.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=function(){for(var a=this.toFlatJson(),b=0;b<p.length;b++)a.parts.push(p[b].toJsonHierarchy());
return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};l(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);t&&(c.source=t);for(var d in r)c[d]=this.getFeatureJson(d);if(0<w.length)for(c.mappings=[],d=0;d<w.length;d++)c.mappings.push(w[d].toJson());0<p.length&&(c.parts=[]);if(0<u.length)for(c.similars=[],d=0;d<u.length;d++)c.similars.push(u[d].getUri());return c};
...
e,f,g,l,h,q,m;l=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*l,h=e*l,f=2*e,q=f+a,m=f+d,c[m+0]=b[q+0]*h+this.pMidBuffer[f+0]*g,c[m+1]=b[q+1]*h+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
