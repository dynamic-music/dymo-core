...
var SCHEDULE_AHEAD_TIME=.1,DYMO="Dymo",PARALLEL="parallel",SEQUENTIAL="sequential",DYMO_TYPES=[PARALLEL,SEQUENTIAL],FEATURE="Feature",PARAMETER="Parameter",ONE_SHOT_NAVIGATOR="OneShotNavigator",SEQUENTIAL_NAVIGATOR="SequentialNavigator",SIMILARITY_NAVIGATOR="SimilarityNavigator",PLAY="Play",LOOP="Loop",ONSET="Onset",DURATION_RATIO="DurationRatio",AMPLITUDE="Amplitude",PLAYBACK_RATE="PlaybackRate",TIME_STRETCH_RATIO="TimeStretchRatio",PAN="Pan",DISTANCE="Distance",HEIGHT="Height",REVERB="Reverb",FILTER=
"Filter",PART_INDEX="PartIndex",PART_COUNT="PartCount",PART_ORDER="PartOrder",LISTENER_ORIENTATION="ListenerOrientation",AUTO_CONTROL_FREQUENCY="AutoControlFrequency",AUTO_CONTROL_TRIGGER="AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE="BrownianMaxStepSize",LEAPING_PROBABILITY="LeapingProbability",CONTINUE_AFTER_LEAPING="ContinueAfterLeaping",PARAMETERS=[PLAY,LOOP,ONSET,DURATION_RATIO,AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,PAN,DISTANCE,HEIGHT,REVERB,FILTER,PART_INDEX,PART_COUNT,PART_ORDER,LISTENER_ORIENTATION,
AUTO_CONTROL_FREQUENCY,AUTO_CONTROL_TRIGGER],LEVEL="level",INDEX="index",ONSET_FEATURE="onset",PITCH_FEATURE="pitch",DURATION_FEATURE="duration",AUTO_CONTROL="AutoControl",SLIDER="Slider",TOGGLE="Toggle",BUTTON="Button",ACCELEROMETER_X="AccelerometerX",ACCELEROMETER_Y="AccelerometerY",ACCELEROMETER_Z="AccelerometerZ",TILT_X="TiltX",TILT_Y="TiltY",GEOLOCATION_LATITUDE="GeolocationLatitude",GEOLOCATION_LONGITUDE="GeolocationLongitude",GEOLOCATION_DISTANCE="GeolocationDistance",COMPASS_HEADING="CompassHeading",
RANDOM="Random",BROWNIAN="Brownian",RAMP="Ramp",CONTROLS=[SLIDER,TOGGLE,ACCELEROMETER_X,ACCELEROMETER_Y,ACCELEROMETER_Z,TILT_X,TILT_Y,GEOLOCATION_LATITUDE,GEOLOCATION_LONGITUDE,GEOLOCATION_DISTANCE,COMPASS_HEADING,RANDOM,BROWNIAN,RAMP],UI_CONTROLS=[SLIDER,TOGGLE,BUTTON];function DymoManager(a,b,c){var d=new Scheduler(a,function(){});c||(c="bower_components/dymo-core/audio/impulse_rev.wav");d.setReverbFile(c);SCHEDULE_AHEAD_TIME=b;var e,f={};this.loadDymoAndRendering=function(a,b,c){var m=new DymoLoader(d);m.loadDymoFromJson(a,function(a){m.loadRenderingFromJson(b,a[1],function(b){e=b[0];e.dymo=a[0];for(var g in b[1]){var m=b[1][g];0<=UI_CONTROLS.indexOf(m.getType())&&(f[g]=new UIControl(m))}d.loadBuffers(e.dymo);c&&c()})})};this.loadDymoFromJson=function(a,b){(new DymoLoader(d)).loadDymoFromJson(a,
function(a){b&&b(a[0])})};this.parseDymoFromJson=function(a,b){(new DymoLoader(d)).parseDymoFromJson(a,function(a){b(a[0])})};this.replacePartOfTopDymo=function(a,b){var c=e.dymo.getPart(a);e.dymo.replacePart(a,b);d.stop(c)};this.updateNavigatorPosition=function(a,b,c){d.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return d.getNavigatorPosition(a,b)};this.syncNavigators=function(a,b,c){d.syncNavigators(a,b,c)};this.startPlaying=function(){e.dymo.updatePartOrder(ONSET);d.play(e.dymo)};
this.stopPlaying=function(){d.stop(e.dymo)};this.getTopDymo=function(){return e.dymo};this.getUIControl=function(a){return f[a]}};function Control(a,b,c){function d(a,b){if(void 0==f||1E-6<Math.abs(a-f))f=a,e(b)}function e(a){for(var b=0;b<h.length;b++)h[b]!=a&&h[b].updateParameter(f,this)}var f,g,k,h=[],m,p,n;this.getName=function(){return a};this.getParameter=function(a){if(c)return c[a]};this.getValue=function(){return f};this.getType=function(){return b};this.getReferenceValue=function(){return g};this.setReferenceAverageCount=function(a){k=a;this.resetReferenceValue()};this.resetReferenceValue=function(){g=f=void 0;p=m=
0};this.setUpdateFunction=function(a){n=a};this.addMapping=function(a){h.push(a);a.updateParameter(f,this)};this.removeMapping=function(a){a=h.indexOf(a);-1<a&&h.splice(a,1)};this.backpropagate=function(a,b){isFinite(a)&&(d(a,b),n&&n(f))};this.update=function(a){k&&m<k?(p+=a,m++,m==k&&(g=p/=k)):isNaN(a)||(g&&(a-=g),d(a))}};function DynamicMusicObject(a,b,c){function d(a,b){b[a.getUri()]=a;for(var c=0;c<a.getParts().length;c++)d(a.getParts()[c],b)}function e(a,b,c,d){var l=a-b,f=d.getParts();if(d.getLevel()==c&&0==l)return d;if(d.getLevel()>=c-1)return l<f.length?f[l]:b+f.length;for(d=0;d<f.length;d++)if(b=e(a,b,c,f[d]),isNaN(b))return b}function f(a,b,c){c(a,b);a=a.getParts();for(var d=0,e=a.length;d<e;d++)f(a[d],b,c)}function g(a,b,c){var d=b.toFlatJson();a.nodes.push(d);c&&a.links.push(h(c,d));for(c=0;c<b.getParts().length;c++)g(a,
b.getParts()[c],d)}function k(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var l=b.getSimilars()[e];c[l.getUri()]||(c[l.getUri()]=l.toFlatJson());a.links.push(h(d,c[l.getUri()]))}for(e=0;e<b.getParts().length;e++)k(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var m=this,p=null,n=[],v=[],t={},q={},r=[],u=[],l="",x;q[PLAY]=new Parameter(PLAY,0,!0);q[LOOP]=new Parameter(LOOP,0,!0);
q[ONSET]=new Parameter(ONSET,void 0);q[DURATION_RATIO]=new Parameter(DURATION_RATIO,1);q[AMPLITUDE]=new Parameter(AMPLITUDE,1);q[PLAYBACK_RATE]=new Parameter(PLAYBACK_RATE,1);q[TIME_STRETCH_RATIO]=new Parameter(TIME_STRETCH_RATIO,1);q[PAN]=new Parameter(PAN,0);q[DISTANCE]=new Parameter(DISTANCE,0);q[HEIGHT]=new Parameter(HEIGHT,0);q[REVERB]=new Parameter(REVERB,0);q[FILTER]=new Parameter(FILTER,0);q[PART_INDEX]=new Parameter(PART_INDEX,0,!0);q[PART_COUNT]=new Parameter(PART_COUNT,Number.POSITIVE_INFINITY,
!0);q[PLAY].addObserver(m);q[PART_INDEX].addObserver(m);q[PART_COUNT].addObserver(m);this.setType=function(a){b=a};this.getType=function(){return b};this.getUri=function(){return a};this.setParent=function(a){p=a;for(var b in q)b!=PLAY&&b!=PART_COUNT&&b!=PART_INDEX&&u.push(new Mapping([a.getParameter(b)],!0,void 0,[this],b));a=p.getMappings();var c=this.getDymoMap(),c=Object.keys(c).map(function(a){return c[a]});for(b=0;b<a.length;b++){var d=a[b].getDymoConstraint();d&&(d=a[b].getTargets().concat(c.filter(d)),
a[b].setTargets(d))}};this.removeParent=function(){for(var a=0;a<u.length;a++)u[a].disconnect();u=[];for(var b=p.getMappings(),c=this,a=0;a<b.length;a++){var d=b[a].getTargets(),d=d.filter(function(a){return!a.isSubDymoOf(c)});b[a].setTargets(d)}p=null};this.getParent=function(){return p};this.isSubDymoOf=function(a){for(var b=this;b;){if(b==a)return!0;b=b.getParent()}return!1};this.getDymoMap=function(){var a={};d(this,a);return a};this.getLevel=function(){return p?p.getLevel()+1:0};this.getIndex=
function(){if(p)return p.getParts().indexOf(this)};this.addPart=function(a){n.push(a);a.setParent(this)};this.removePart=function(a){n.splice(n.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){n[a]&&n[a].removeParent(this);n[a]=b;b.setParent(this)};this.getPart=function(a){return n[a]};this.getParts=function(){return n};this.hasParts=function(){return 0<n.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){l=a};this.getBasePath=function(){return p&&
!l?p.getBasePath():l};this.setSourcePath=function(a){x=a};this.getSourcePath=function(){if(p&&!x)return p.getSourcePath();if(x)return this.getBasePath()+x};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){v.push(a)};this.getSimilars=function(a){return v};this.getFeatures=function(){return t};this.setFeature=
function(a,b){t[a]=b};this.getFeature=function(a){if(a===LEVEL)return this.getLevel();if(a===INDEX)return this.getIndex();if(t.hasOwnProperty(a))return t[a];if(p)return p.getFeature(a);for(var b=[],c=0;c<n.length;c++)if(n[c]){var d=n[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(t[a])return t[a]};this.getMappings=function(){return r};this.getSegment=function(){return[this.getFeature("time"),q[DURATION_RATIO].getValue()*
this.getFeature("duration")]};this.addParameter=function(a){q[a.getName()]=a};this.getParameter=function(a){return q[a]};this.addMapping=function(a){r.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(m):c.stop(m))};this.updatePartOrder=function(a){n&&n[0]&&!isNaN(n[0].getFeature(a))?n.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):n&&n.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=
function(){for(var a=this.toFlatJson(),b=0;b<n.length;b++)a.parts.push(n[b].toJsonHierarchy());return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};k(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);x&&(c.source=x);for(var d in t)c[d]=this.getFeatureJson(d);if(0<r.length)for(c.mappings=[],d=0;d<r.length;d++)c.mappings.push(r[d].toJson());0<n.length&&(c.parts=
[]);if(0<v.length)for(c.similars=[],d=0;d<v.length;d++)c.similars.push(v[d].getUri());return c};this.getFeatureJson=function(a){return{value:t[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
...
return d}};function AudioProcessor(a){function b(a){return{extract:function(b,e,f){for(var g=[],k=0;k<a.numberOfChannels;k++)g.push(a.getChannelData(k));for(k=0;k<e;k++)for(var h=0;h<g.length;h++)b[k*g.length+h%g.length]=g[h][k+f];return Math.min(e,g[0].length-f)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;for(var f=b(c),e=new SimpleFilter(f,e),f=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate),g=[],k=0;k<c.numberOfChannels;k++)g.push(f.getChannelData(k));for(var h=
new Float32Array(2048),m=e.extract(h,1024),p=0;m;){for(k=0;k<m;k++)for(var n=0;n<g.length;n++)g[n][k+p]=h[k*g.length+n%g.length];p+=m;m=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),k=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(k,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=k[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b,c){function d(){0<n&&n--;0==n&&b&&b(n)}function e(a){h.splice(h.indexOf(a),1)}function f(){for(var a=[],b=0;b<h.length;b++)for(var d=$jscomp.makeIterator(h[b].getSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();m=a;c&&c()}function g(b,c){console.log(b);n++;var e=new XMLHttpRequest;e.open("GET",b,!0);e.responseType="arraybuffer";e.onload=function(){a.decodeAudioData(e.response,function(a){c?
c(a):(k[b]=a,d())})};e.error=function(){};e.send()}var k={},h=[],m=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var p=a.createConvolver();p.connect(a.destination);var n=0;this.setReverbFile=function(a){g(a,function(a){p.buffer=a;d()})};this.loadBuffers=function(a){a=a.getAllSourcePaths();for(var b=0,c=a.length;b<c;b++)k[a[b]]||g(a[b])};this.getBuffer=function(a){return k[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};
this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,l=0,f=h.length;l<f;l++)h[l].hasDymo(a)&&(d=h[l].getNavigator()),h[l].hasDymo(b)&&(e=h[l].getNavigator());b=e.getPosition(c,b);d.setPosition(b,c,a)};this.play=function(b){b=new SchedulerThread(b,
void 0,a,k,p,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSource(a);d&&b.push(d)}return b};this.getUrisOfPlayingDymos=function(){return m};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e){function f(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=z||w<c.duration)c=p(c,m(z,c),m(w+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=w/d;c=p(c,0,m(d+.02,c));w=d}else if(0!=z||w<c.duration)c=p(c,m(z,c),m(w+.02,c));n(c,c.length);y.buffer=c;l[PLAYBACK_RATE]=y.playbackRate;g(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function g(a,b){k(a,b.getValue());b.addObserver(q)}function k(a,b,c){c&&(b+=q.getParameterValue(a));0>b&&0<=E.indexOf(a)&&(b=
0);c=b;l[a]&&(l[a].value||0==l[a].value?l[a].value=c:l[a].setValue(c));0<=F.indexOf(a)?(0==l[DISTANCE].value&&(l[DISTANCE].value=-.01),C.setPosition(l[PAN].value,l[HEIGHT].value,l[DISTANCE].value)):a==LOOP&&(y.loop=1==b)}function h(){r=!1;var a=b.currentTime;l[AMPLITUDE].setValueAtTime(l[AMPLITUDE].value,a);l[AMPLITUDE].linearRampToValueAtTime(0,a+.02);y.stop(a+.04)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function p(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,
d,a.sampleRate),l=0;l<a.numberOfChannels;l++)for(var f=e.getChannelData(l),x=a.getChannelData(l),g=0;g<d;g++)f[g]=x[c+g];return e}function n(a,b){for(var c=.02*a.sampleRate,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),l=0;l<c;l++)e[l]*=l/c,e[b-l-1]*=l/c}function v(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));t("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function t(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType=
"arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var q=this,r,u,l={},x=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,FILTER,PAN,HEIGHT,DISTANCE,LOOP],E=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,FILTER],F=[PAN,HEIGHT,DISTANCE],y=b.createBufferSource(),A=b.createGain();A.connect(b.destination);var B=b.createGain();B.connect(d);B.gain.value=0;A.connect(B);var C=b.createPanner();C.connect(A);
d=b.createBiquadFilter();d.type="lowpass";d.frequency.value=2E4;d.connect(C);y.connect(d);var D=a.getSegment(),z=D[0],w=D[1];z||(z=0);!w&&c&&(w=c.duration-z);c?f():v(a.getSourcePath(),z,z+w+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=w/d,c=p(c,0,m(d+.02,c)),w=d):c=p(c,0,m(w+.02,c));n(c,c.length);y.buffer=c});l[AMPLITUDE]=A.gain;l[TIME_STRETCH_RATIO]={value:0};l[REVERB]=B.gain;l[FILTER]=d.frequency;l[PAN]={value:0};l[HEIGHT]=
{value:0};l[DISTANCE]={value:0};l[LOOP]={value:0};g(AMPLITUDE,a.getParameter(AMPLITUDE));g(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));g(REVERB,a.getParameter(REVERB));g(PAN,a.getParameter(PAN));g(HEIGHT,a.getParameter(HEIGHT));g(DISTANCE,a.getParameter(DISTANCE));g(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){k(a.getName(),a.getChange(),!0)};this.getDymo=function(){return a};this.getDuration=function(){return w};this.isLoopingAndPlaying=function(){return y.loop&&
r};this.getParameterValue=function(a){if(l[a])return l[a].value||0==l[a].value?l[a].value:l[a].getValue()};this.play=function(b){y.onended=function(){for(var b=0;b<x.length;b++){var c=a.getParameter(x[b]);c&&c.removeObserver(q)}y.disconnect();A.disconnect();B.disconnect();e&&e(q)};y.start(b);r=!0};this.pause=function(){r?(h(),u=!0):u&&(u=!1,this.play())};this.stop=function(){r&&h()}};function SchedulerThread(a,b,c,d,e,f,g){function k(){q=u?u:n();h(q);l||(l=q[0].getDymo().getParameter(ONSET).getValue());var a;a=r?r-c.currentTime:SCHEDULE_AHEAD_TIME;for(var d=c.currentTime+a,e=0;e<q.length;e++)q[e].play(d);setTimeout(function(){f()},a);(u=n())?(r=p(d),a=1E3*(r-c.currentTime-SCHEDULE_AHEAD_TIME),t=setTimeout(function(){k()},a)):(r=p(d),a=1E3*(r-c.currentTime),setTimeout(function(){b.reset();g&&g()},a))}function h(a){for(var b=0;b<a.length;b++)v.set(a[b].getDymo(),a[b])}function m(a){v.delete(a.getDymo());
0==v.size&&window.clearTimeout(t);f()}function p(a){if(u){var b=u[0].getDymo().getParameter(ONSET).getValue(),c=b-l;l=b;if(!isNaN(b))return a+c}b=q[0];c=b.getDymo().getParameter(PLAYBACK_RATE).getValue();b=b.getDuration()/c;return a+b}function n(){var a=b.getNextParts();if(a){for(var l=[],f=0;f<a.length;f++)if(a[f].getSourcePath()){var g=d[a[f].getSourcePath()];l.push(new Source(a[f],c,g,e,m))}return l}}var v=new Map,t,q=[],r,u,l;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));k();this.hasDymo=
function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=v.get(a[b]);d&&d.pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=v.get(a[b]);d&&d.stop()}};this.getSources=function(){return v};this.getSource=function(a){return v.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();f[b]=a;f[b].addObserver(e)}var e=this,f={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,f);var g;this.addParameter=d;this.getParameter=function(a){return f[a]};this.startUpdate=function(){g=setInterval(b,f[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(g);g=null;c&&c()};this.observedParameterChanged=function(a){a==f[AUTO_CONTROL_FREQUENCY]?
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b,e,f,g){var h=new XMLHttpRequest;h.open("GET",u+a,!0);h.onload=function(){var h;a:{try{JSON.parse(this.responseText)}catch(m){h=!1;break a}h=!0}h&&(b=b?b.replace('"'+a+'"',this.responseText):this.responseText);(h=d(b))?c(h,b,e,f,g):b&&(h=g(JSON.parse(b),e),f(h))};h.error=function(a){console.log(a)};h.send()}function d(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return d(a.substring(b+
1))}}function e(a,b){var c=f(a,b);g(a,b);return[c,b]}function f(b,c){var d=new DynamicMusicObject(b["@id"],b.ct,a);d.setBasePath(u);c[b["@id"]]=d;b.source&&d.setSourcePath(b.source);for(var e in b)0>r.indexOf(e)&&(b[e].type==FEATURE?d.setFeature(e,b[e].value):b[e].type==PARAMETER&&p(d,e,b[e].value));if(b.parts)for(e=0;e<b.parts.length;e++)d.addPart(f(b.parts[e],c));return d}function g(a,b){var c=b[a["@id"]];if(a.similars)for(var d=0;d<a.similars.length;d++)c.addSimilar(b[a.similars[d]]);if(a.mappings)for(d=
0;d<a.mappings.length;d++)c.addMapping(h(a.mappings[d],b,c));if(a.parts)for(d=0;d<a.parts.length;d++)g(a.parts[d],b)}function k(a,b){for(var c=new Rendering(b[a.topDymo]),d={},e=0;e<a.mappings.length;e++)c.addMapping(h(a.mappings[e],b,void 0,d));a.navigator&&(e=Function.apply(null,a.navigator.dymos.args.concat(a.navigator.dymos.body)),c.addNavigator(a.navigator.type==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0),e));return[c,d]}function h(b,c,d,e){if(b.controls){for(var f=
[],g=0;g<b.controls.length;g++)f.push(e[b.controls[g]]);return m(b,c,d,f,e)}if(b.dymos){var f=[],h;if(b.dymos instanceof Array)for(g=0;g<b.dymos.length;g++)f.push(c[b.dymos[g]]);else h=Function.apply(null,b.dymos.args.concat(b.dymos.body)),g=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(f,g.filter(h));return m(b,c,d,f,e,h)}return m(b,c,d,[a],e)}function m(a,b,c,d,e,f){b=a.relative;for(var g=[],h=0;h<a.domainDims.length;h++){var m=a.domainDims[h],k=m.name,n=m.type;n==FEATURE?
g.push(k):n==PARAMETER?(k=c?p(c,k,0):new Parameter(k,0),g.push(k)):(m=e&&e[k]?e[k]:v(m),e&&!e[k]&&(e[k]=m),g.push(m))}return new Mapping(g,b,a["function"],d,a.parameter,f)}function p(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function n(a,b){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var e=b["dymo"+c],f=b["dymo"+a[c][d]];e&&f&&e.addSimilar(f)}}function v(a){var c=a.type,d=a.name;if(c==ACCELEROMETER_X)return t(0);if(c==ACCELEROMETER_Y)return t(1);
if(c==ACCELEROMETER_Z)return t(2);if(c==TILT_X)return t(3);if(c==TILT_Y)return t(4);if(c==GEOLOCATION_LATITUDE)return q(0);if(c==GEOLOCATION_LONGITUDE)return q(1);if(c==GEOLOCATION_DISTANCE)return q(2);if(c==COMPASS_HEADING)return b.compassWatcher||(b.compassWatcher=new CompassWatcher),a=b.compassWatcher.headingControl,a;if(c==SLIDER||c==TOGGLE||c==BUTTON)return new Control(d,c);if(c==RANDOM)return new RandomControl;if(c==BROWNIAN)return new BrownianControl(parseFloat(a.value));if(c==RAMP)return c=
Math.round(1E3*parseFloat(a.duration)),new RampControl(c,parseFloat(a.value))}function t(a){b.accelerometerWatcher||(b.accelerometerWatcher=new AccelerometerWatcher);if(0==a)return b.accelerometerWatcher.xControl;if(1==a)return b.accelerometerWatcher.yControl;if(2==a)return b.accelerometerWatcher.zControl;if(3==a)return b.accelerometerWatcher.tiltXControl;if(4==a)return b.accelerometerWatcher.tiltYControl}function q(a){b.geolocationWatcher||(b.geolocationWatcher=new GeolocationWatcher);return 0==
a?b.geolocationWatcher.latitudeControl:1==a?b.geolocationWatcher.longitudeControl:b.geolocationWatcher.distanceControl}var r="@id @type ct source navigator similars mappings parts".split(" "),u="";this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;u=a.substring(0,d);a=a.substring(d);c(a,"",{},b,e)};this.parseDymoFromJson=function(a,b){b(e(a,{}))};this.loadRenderingFromJson=function(a,b,d){c(a,"",b,d,k)};this.loadGraphFromJson=function(a,b,d){c(a,"",b,d,n)}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
function(a,b){c(b+"rendering.json",a)};this.writeDmoToRdf=function(a){a=N3.Writer({prefixes:{ch:"rdf/charm.n3#",dmo:"rdf/dmo.n3#",mb:"rdf/mobile.n3#"}});b(a);a.end(function(a,b){console.log(b)})}};function FunctionTools(){}FunctionTools.IDENTITY_JSON={args:["a"],body:"return a;"};FunctionTools.inverted={};FunctionTools.created={};FunctionTools.createFunction=function(a,b){FunctionTools.created[b]||(FunctionTools.created[b]=Function.apply(null,a.concat(b)));return FunctionTools.created[b]};
...
e,f,g,k,h,m,p;k=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*k,h=e*k,f=2*e,m=f+a,p=f+d,c[p+0]=b[m+0]*h+this.pMidBuffer[f+0]*g,c[p+1]=b[m+1]*h+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
