...
q(d.value));return a+b}function q(a){var b=a.getDymo().getParameter(PLAYBACK_RATE).getValue();return a.getDuration()/b}function p(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var k=new Map,q=0;q<a.length;q++)if(a[q].getSourcePath()){var p=d[a[q].getSourcePath()];k.set(a[q],new Source(a[q],c,p,e,f,m))}return k}}var v=new Map,u,y,w=[],k,B;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));h();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};
...
return h(b,c,d,f,e,k)}return h(b,c,d,[a],e)}function h(a,b,c,d,e,f){b=a.relative;for(var k=[],g=0;g<a.domainDims.length;g++){var h=a.domainDims[g],l=h.name,n=h["@type"];n==FEATURE?k.push(l):n==PARAMETER?(h=c?r(c,l,0):new Parameter(l,0),k.push(h)):(e&&e[l]?n=e[l]:(n=m(h),h.smooth&&n.setSmooth&&n.setSmooth(!0),!isNaN(h.average)&&n.setAverageOf&&n.setAverageOf(h.average)),"value"in h&&n.update(h.value),e&&!e[l]&&(e[l]=n),k.push(n))}return new Mapping(k,b,a["function"],d,a.range,f)}function r(a,b,c){var d=
...
b.getParts()[c],d)}function l(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)l(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var r=this,n=null,m=[],t=[],q={},p={},v=[],u=[],y="",w;p[PLAY]=new Parameter(PLAY,0,!0);p[LOOP]=new Parameter(LOOP,0,!0);
