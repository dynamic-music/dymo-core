...
CUSTOM_FEATURE="http://tiny.cc/dymo-ontology#CustomFeature",AUDIO_PARAMETER="http://tiny.cc/dymo-ontology#AudioParameter",PLAY="http://tiny.cc/dymo-ontology#Play",LOOP="http://tiny.cc/dymo-ontology#Loop",ONSET="http://tiny.cc/dymo-ontology#Onset",DURATION_RATIO="http://tiny.cc/dymo-ontology#DurationRatio",AMPLITUDE="http://tiny.cc/dymo-ontology#Amplitude",PLAYBACK_RATE="http://tiny.cc/dymo-ontology#PlaybackRate",TIME_STRETCH_RATIO="http://tiny.cc/dymo-ontology#TimeStretchRatio",PAN="http://tiny.cc/dymo-ontology#Pan",
DISTANCE="http://tiny.cc/dymo-ontology#Distance",HEIGHT="http://tiny.cc/dymo-ontology#Height",REVERB="http://tiny.cc/dymo-ontology#Reverb",DELAY="http://tiny.cc/dymo-ontology#Delay",FILTER="http://tiny.cc/dymo-ontology#Filter",STRUCTURAL_PARAMETER="http://tiny.cc/dymo-ontology#StructuralParameter",PART_COUNT="http://tiny.cc/dymo-ontology#PartCount",PART_DURATION_RATIO="http://tiny.cc/dymo-ontology#PartDurationRatio",PART_PROPORTION="http://tiny.cc/dymo-ontology#PartProportion",CUSTOM_PARAMETER="http://tiny.cc/dymo-ontology#CustomParameter",
HAS_SOURCE="http://tiny.cc/dymo-ontology#hasSource",HAS_PARAMETER="http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_PARAMETER_TYPE="http://tiny.cc/dymo-ontology#hasParameterType",HAS_FEATURE_TYPE="http://tiny.cc/dymo-ontology#hasFeatureType",HAS_SIMILAR="http://tiny.cc/dymo-ontology#hasSimilar",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",MAPPING="http://tiny.cc/mobile-audio-ontology#Mapping",FUNCTION="http://tiny.cc/mobile-audio-ontology#Function",
MOBILE_CONTROL="http://tiny.cc/mobile-audio-ontology#MobileControl",SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",UI_CONTROL="http://tiny.cc/mobile-audio-ontology#UiControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",ACCELEROMETER_X="http://tiny.cc/mobile-audio-ontology#AccelerometerX",ACCELEROMETER_Y="http://tiny.cc/mobile-audio-ontology#AccelerometerY",ACCELEROMETER_Z="http://tiny.cc/mobile-audio-ontology#AccelerometerZ",TILT_X="http://tiny.cc/mobile-audio-ontology#TiltX",
TILT_Y="http://tiny.cc/mobile-audio-ontology#TiltY",TILT_Z="http://tiny.cc/mobile-audio-ontology#TiltZ",GEOLOCATION_LATITUDE="http://tiny.cc/mobile-audio-ontology#GeolocationLatitude",GEOLOCATION_LONGITUDE="http://tiny.cc/mobile-audio-ontology#GeolocationLongitude",GEOLOCATION_DISTANCE="http://tiny.cc/mobile-audio-ontology#GeolocationDistance",COMPASS_HEADING="http://tiny.cc/mobile-audio-ontology#CompassHeading",BEACON="http://tiny.cc/mobile-audio-ontology#Beacon",SLIDER="http://tiny.cc/mobile-audio-ontology#Slider",
TOGGLE="http://tiny.cc/mobile-audio-ontology#Toggle",BUTTON="http://tiny.cc/mobile-audio-ontology#Button",CUSTOM_CONTROL="http://tiny.cc/mobile-audio-ontology#CustomControl",RANDOM="http://tiny.cc/mobile-audio-ontology#Random",BROWNIAN="http://tiny.cc/mobile-audio-ontology#Brownian",RAMP="http://tiny.cc/mobile-audio-ontology#Ramp",MOBILE_PARAMETER="http://tiny.cc/mobile-audio-ontology#MobileParameter",GLOBAL_PARAMETER="http://tiny.cc/mobile-audio-ontology#GlobalParameter",CONTROL_PARAMETER="http://tiny.cc/mobile-audio-ontology#ControlParameter",
LISTENER_ORIENTATION="http://tiny.cc/mobile-audio-ontology#ListenerOrientation",AUTO_CONTROL_FREQUENCY="http://tiny.cc/mobile-audio-ontology#AutoControlFrequency",AUTO_CONTROL_TRIGGER="http://tiny.cc/mobile-audio-ontology#AutoControlTrigger",BROWNIAN_MAX_STEP_SIZE="http://tiny.cc/mobile-audio-ontology#BrownianMaxStepSize",LEAPING_PROBABILITY="http://tiny.cc/mobile-audio-ontology#LeapingProbability",CONTINUE_AFTER_LEAPING="http://tiny.cc/mobile-audio-ontology#ContinueAfterLeaping",NAVIGATOR="http://tiny.cc/mobile-audio-ontology#Navigator",
ONE_SHOT_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#OneShotNavigator",SEQUENTIAL_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SimilarityNavigator",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MAPPING_TARGET="http://tiny.cc/mobile-audio-ontology#MappingTarget",MAPPING_RANGE="http://tiny.cc/mobile-audio-ontology#MappingRange",HAS_DYMO="http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING=
"http://tiny.cc/mobile-audio-ontology#hasMapping",HAS_DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#hasDomainDimension",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",HAS_RANGE="http://tiny.cc/mobile-audio-ontology#hasRange",IS_RELATIVE="http://tiny.cc/mobile-audio-ontology#isRelative",HAS_INITIAL_VALUE=
"http://tiny.cc/mobile-audio-ontology#hasInitialValue",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",TO_DYMO="http://tiny.cc/mobile-audio-ontology#toDymo";function DymoManager(a,b,c,d){var e=new Scheduler(a,function(){});c||(c="bower_components/dymo-core/audio/impulse_rev.wav");e.setReverbFile(c);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var f,g,k={},h={};this.loadDymoAndRendering=function(a,b,c,u){var r=new DymoLoader(e,function(){r.loadDymoFromJson(a,function(a){r.loadRenderingFromJson(b,a[1],function(b){f=r.getStore();g=b[0];g.dymo=a[0];for(var p in b[1]){var l=b[1][p];f.isSubclassOf(l.getType(),UI_CONTROL)&&(k[p]=new UIControl(l,d));f.isSubclassOf(l.getType(),
SENSOR_CONTROL)&&(h[p]=l)}e.loadBuffers(g.dymo,u);c&&c()})})})};this.loadDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.loadDymoFromJson(a,function(a){b&&b(a[0])})})};this.parseDymoFromJson=function(a,b){var c=new DymoLoader(e,function(){c.parseDymoFromJson(a,function(a){b(a[0])})})};this.replacePartOfTopDymo=function(a,b){var c=g.dymo.getPart(a);g.dymo.replacePart(a,b);e.stop(c)};this.updateNavigatorPosition=function(a,b,c){e.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=
function(a,b){return e.getNavigatorPosition(a,b)};this.syncNavigators=function(a,b,c){e.syncNavigators(a,b,c)};this.startPlaying=function(){g.dymo.updatePartOrder(ONSET);e.play(g.dymo)};this.stopPlaying=function(){e.stop(g.dymo)};this.getTopDymo=function(){return g.dymo};this.getRendering=function(){return g};this.getUIControls=function(){return k};this.getUIControl=function(a){return k[a]};this.getSensorControls=function(){return h}};function AudioProcessor(a){function b(a){return{extract:function(b,e,f){for(var g=[],k=0;k<a.numberOfChannels;k++)g.push(a.getChannelData(k));for(k=0;k<e;k++)for(var h=0;h<g.length;h++)b[k*g.length+h%g.length]=g[h][k+f];return Math.min(e,g[0].length-f)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;for(var f=b(c),e=new SimpleFilter(f,e),f=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate),g=[],k=0;k<c.numberOfChannels;k++)g.push(f.getChannelData(k));for(var h=
new Float32Array(2048),p=e.extract(h,1024),m=0;p;){for(k=0;k<p;k++)for(var q=0;q<g.length;q++)g[q][k+m]=h[k*g.length+q%g.length];m+=p;p=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),k=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(k,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=k[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b,c){function d(a){0<r&&r--;0==r&&(b&&b(r),a&&a())}function e(a){h.splice(h.indexOf(a),1)}function f(){for(var a=[],b=0;b<h.length;b++)for(var d=$jscomp.makeIterator(h[b].getAllSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();p=a;c&&c()}function g(b,c){r++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,
b)})};d.error=function(){};d.send()}var k={},h=[],p=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var m=a.createConvolver();m.connect(a.destination);var q=a.createDelay();q.delayTime.value=.5;q.connect(a.destination);var u=a.createGain();u.gain.value=.6;q.connect(u);u.connect(q);var r=0;this.setReverbFile=function(a){g(a,function(a){m.buffer=a;d()})};this.loadBuffers=function(a,b){for(var c=a.getAllSourcePaths(),e=0,f=c.length;e<f;e++)k[c[e]]||
g(c[e],function(a,c){k[c]=a;d(b)})};this.getBuffer=function(a){return k[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,n=0,
B=h.length;n<B;n++)h[n].hasDymo(a)&&(d=h[n].getNavigator()),h[n].hasDymo(b)&&(e=h[n].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,k,m,q,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSources(a);if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};
this.getUrisOfPlayingDymos=function(){return p};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e,f){function g(a,c){var d=b.createGain();d.connect(c);d.gain.value=0;a.connect(d);return d}function k(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=z||x<c.duration)c=u(c,q(z,c),q(x+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=x/d;c=u(c,0,q(d+FADE_LENGTH,c));x=d}else if(0!=z||x<c.duration)c=u(c,q(z,c),q(x+FADE_LENGTH,c));r(c,c.length);A.buffer=c;n[PLAYBACK_RATE]=A.playbackRate;h(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function h(a,b){p(a,
b.getValue());b.addObserver(y)}function p(a,b,c){c&&(b+=y.getParameterValue(a));0>b&&0<=C.indexOf(a)&&(b=0);n[a]&&(n[a].value||0==n[a].value?n[a].value=b:n[a].setValue(b));0<=H.indexOf(a)&&(0==n[DISTANCE].value&&(n[DISTANCE].value=-.01),F.setPosition(n[PAN].value,n[HEIGHT].value,n[DISTANCE].value))}function m(){l=!1;var a=b.currentTime;n[AMPLITUDE].setValueAtTime(n[AMPLITUDE].value,a);n[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);A.stop(a+2*FADE_LENGTH)}function q(a,b){if(a||0==a)return Math.round(a*
b.sampleRate)}function u(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),n=0;n<a.numberOfChannels;n++)for(var B=e.getChannelData(n),f=a.getChannelData(n),C=0;C<d;C++)B[C]=f[c+C];return e}function r(a,b){for(var c=a.sampleRate*FADE_LENGTH,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),n=0;n<c;n++)e[n]*=n/c,e[b-n-1]*=n/c}function v(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));w("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+
b+"&toSecond="+c,function(a){d(a)})}function w(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var y=this,l,t,n={},B=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],C=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],A=b.createBufferSource(),D=b.createGain();
D.connect(b.destination);var G=g(D,d);d=g(D,e);var F=b.createPanner();F.connect(D);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(F);A.connect(e);var E=a.getSegment(),z=E[0],x=E[1];z||(z=0);!x&&c&&(x=c.duration-z);E=a.getParameter(DURATION_RATIO).getValue();0<E&&1>E&&(x*=E);c?k():isNaN(z+x)||v(a.getSourcePath(),z,z+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=u(c,0,q(d+FADE_LENGTH,c)),x=d):
c=u(c,0,q(x+FADE_LENGTH,c));r(c,c.length);A.buffer=c});n[AMPLITUDE]=D.gain;n[TIME_STRETCH_RATIO]={value:0};n[REVERB]=G.gain;n[DELAY]=d.gain;n[FILTER]=e.frequency;n[PAN]={value:0};n[HEIGHT]={value:0};n[DISTANCE]={value:0};n[LOOP]={value:0};h(AMPLITUDE,a.getParameter(AMPLITUDE));h(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));h(REVERB,a.getParameter(REVERB));h(DELAY,a.getParameter(DELAY));h(FILTER,a.getParameter(FILTER));h(PAN,a.getParameter(PAN));h(HEIGHT,a.getParameter(HEIGHT));h(DISTANCE,
a.getParameter(DISTANCE));h(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){p(a.getName(),a.getChange(),!0)};this.getDymo=function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return A.loop&&l};this.getParameterValue=function(a){if(n[a])return n[a].value||0==n[a].value?n[a].value:n[a].getValue()};this.play=function(b){A.onended=function(){for(var b=0;b<B.length;b++){var c=a.getParameter(B[b]);c&&c.removeObserver(y)}A.disconnect();D.disconnect();
G.disconnect();f&&f(y)};b||(b=0);A.start(b);l=!0};this.pause=function(){l?(m(),t=!0):t&&(t=!1,this.play())};this.stop=function(){l&&m()}};function SchedulerThread(a,b,c,d,e,f,g,k){function h(){l=w?w:r();m(l);n||(n=l.keys().next().value.getParameter(ONSET).getValue());var a;a=t?t-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(l.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){g()},a);(w=r())&&0<w.size?(t=u(b),a=t[1],t=t[0],a.getDymo().getParameter(LOOP).getValue()&&(t-=FADE_LENGTH),a=1E3*(t-c.currentTime-SCHEDULE_AHEAD_TIME),y=setTimeout(function(){h()},a)):(t=u(b),a=1E3*
(t-c.currentTime),setTimeout(function(){p()},a+100))}function p(){0!=v.size||w&&0!=w.size||(window.clearTimeout(y),b.reset(),k&&k())}function m(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,v.get(c)||v.set(c,[]),v.get(c).push(a.get(c))}function q(a){var b=v.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&v.delete(a.getDymo());g();p()}function u(a){if(w){var b=w.keys().next().value.getParameter(ONSET).getValue(),c=b-n;n=b;if(!isNaN(b))return a+c}for(var b=
0,d,c=$jscomp.makeIterator(l.values()),e=c.next();!e.done;e=c.next()){var e=e.value,f;f=e;var g=f.getDymo().getParameter(PLAYBACK_RATE).getValue();f=f.getDuration()/g;f>b&&(b=f,d=e)}return[a+b,d]}function r(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var n=new Map,g=0;g<a.length;g++)if(a[g].getSourcePath()){var h=d[a[g].getSourcePath()];n.set(a[g],new Source(a[g],c,h,e,f,q))}return n}}var v=new Map,w,y,l=[],t,n;b||(b=new DymoNavigator(a,
new SequentialNavigator(a)));h();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=v.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=v.get(a[b]);if(d)for(var e=0;e<d.length;e++)d[e].stop();w&&w.delete(a[b])}};this.getAllSources=function(){return v};
this.getSources=function(a){return v.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();f[b]=a;f[b].addObserver(e)}var e=this,f={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,f);var g;this.addParameter=d;this.getParameter=function(a){return f[a]};this.startUpdate=function(){g=setInterval(b,f[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(g);g=null;c&&c()};this.observedParameterChanged=function(a){a==f[AUTO_CONTROL_FREQUENCY]?
g&&(this.reset(),this.startUpdate()):a==f[AUTO_CONTROL_TRIGGER]&&(g?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){l.loadData(a,!0,b)})}function d(a,b,c){w(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(t)&&(a=a.replace(t,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(t)&&(f=t+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function f(a){var b=g()[0],c=p(b,a);m(b,a);return[c,a]}function g(){var a=l.find(null,HAS_PART,null),b=Array.from(new Set(a.map(function(a){return a.subject})),function(a){return a}),c=Array.from(new Set(a.map(function(a){return a.object})),function(a){return a});return b.filter(function(a){return 0>c.indexOf(a)})}function k(a){var b=$jscomp.makeIterator(h(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))}function h(a){var b=l.findAllObjectValues(a,HAS_ARGUMENT);
a=l.findFirstObjectValue(a,HAS_BODY);return[b,a]}function p(b,c){var d=l.findFirstObjectUri(b,CDT),d=new DynamicMusicObject(b,d,a);d.setBasePath(t);c[b]=d;d.setSourcePath(l.findFirstObjectValue(b,HAS_SOURCE));for(var e=l.findAllObjectUris(b,HAS_FEATURE),f=0;f<e.length;f++)d.setFeature(e[f],l.findFirstObjectUri(e[f],VALUE));e=l.findAllObjectUris(b,HAS_PARAMETER);for(f=0;f<e.length;f++)r(d,l.findFirstObjectUri(e[f],TYPE),l.findFirstObjectValue(e[f],VALUE));e=l.findAllObjectUris(b,HAS_PART);for(f=0;f<
e.length;f++)d.addPart(p(e[f],c));return d}function m(a,b){for(var c=b[a],d=l.findAllObjectUris(a,HAS_SIMILAR),e=0;e<d.length;e++)c.addSimilar(b[d[e]]);d=l.findAllObjectUris(a,HAS_MAPPING);for(e=0;e<d.length;e++)c.addMapping(q(d[e],b,c));c=l.findAllObjectUris(a,HAS_PART);for(e=0;e<c.length;e++)m(c[e],b)}function q(b,c,d,e){var f=l.findAllObjectUris(b,TO_TARGET);console.log(b,f);if(0<f.length){var g=[],h=k(f[0]);if(h)f=Object.keys(c).map(function(a){return c[a]}),Array.prototype.push.apply(g,f.filter(h));
else for(var p=0;p<f.length;p++)l.findFirstObjectUri(f[p],TYPE)==DYMO?g.push(c[f[p]]):g.push(e[f[p]]);return u(b,c,d,g,e,h)}return u(b,c,d,[a],e)}function u(a,b,c,d,e,f){b=l.findFirstObjectUri(a,IS_RELATIVE);for(var g=[],p=l.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),k=0;k<p.length;k++){var q=l.findFirstObjectUri(p[k],TYPE),m=l.findFirstObjectValue(p[k],NAME);m||(m=p[k]);q==FEATURE_TYPE?g.push(m):q==PARAMETER_TYPE?(q=c?r(c,m,0):new Parameter(m,0),g.push(q)):(console.log(p[k],e,q,m),g.push(e[p[k]]))}e=
$jscomp.makeIterator(h(l.findFirstObjectUri(a,HAS_FUNCTION)));c=e.next().value;e=e.next().value;a=l.findFirstObjectUri(a,HAS_RANGE);return new Mapping(g,b,{args:c,body:e},d,a,f)}function r(a,b,c){var d=a.getParameter(b);d?d.update(c):(d=new Parameter(b,c),a.addParameter(d));return d}function v(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):new SequentialNavigator(void 0)}function w(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.onload=function(){b(this.responseText)};c.error=
function(a){console.log(a)};c.send()}function y(a,b,c){w(a,function(a){l.loadData(a,b,c)})}var l=new EasyStore,t="";(function(){y("http://tiny.cc/dymo-ontology",!1,function(){y("http://tiny.cc/mobile-audio-ontology",!1,function(){b&&b()})})})();this.getStore=function(){return l};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;t=a.substring(0,d);c(a,function(){b(f({}))})};this.parseDymoFromJson=function(a,b){l.loadData(a,!0,function(){b(f({}))})};this.loadRenderingFromJson=function(a,
b,d){b||(b={});c(a,function(){for(var a=b,c=l.findFirstSubjectUri(TYPE,RENDERING),e=new Rendering(a[l.findFirstObjectUri(c,HAS_DYMO)]),f=l.findAllObjectUris(c,HAS_MAPPING),n={},g=0;g<f.length;g++)for(var h=l.findAllObjectUris(f[g],HAS_DOMAIN_DIMENSION),p=0;p<h.length;p++){var m=l.findFirstObjectUri(h[p],TYPE),u=l.findFirstObjectValue(h[p],NAME);u||(u=h[p]);if(l.isSubclassOf(m,MOBILE_CONTROL)&&!n[h[p]]){var t;t=h[p];var r=m,m=void 0;r==ACCELEROMETER_X||r==ACCELEROMETER_Y||r==ACCELEROMETER_Z?m=new AccelerometerControl(r):
r==TILT_X||r==TILT_Y?m=new TiltControl(r):r==GEOLOCATION_LATITUDE||r==GEOLOCATION_LONGITUDE?m=new GeolocationControl(r):r==GEOLOCATION_DISTANCE?m=new DistanceControl:r==COMPASS_HEADING?m=new CompassControl:r==BEACON?(u=l.findFirstObjectValue(t,HAS_UUID),m=l.findFirstObjectValue(t,HAS_MAJOR),r=l.findFirstObjectValue(t,HAS_MINOR),m=new BeaconControl(u,m,r)):r==SLIDER||r==TOGGLE||r==BUTTON||r==CUSTOM_CONTROL?m=new Control(u,r):r==RANDOM?m=new RandomControl:r==BROWNIAN?(u=l.findFirstObjectValue(t,HAS_INITIAL_VALUE),
m=new BrownianControl(u)):r==RAMP&&(m=Math.round(1E3*l.findFirstObjectUri(t,HAS_DURATION)),u=l.findFirstObjectValue(t,HAS_INITIAL_VALUE),m=new RampControl(m,u));l.findFirstObjectUri(t,IS_SMOOTH)&&m.setSmooth&&m.setSmooth(!0);t=Number(l.findFirstObjectUri(t,IS_AVERAGE_OF));!isNaN(t)&&m.setAverageOf&&m.setAverageOf(t);t=m;u=Number(l.findFirstObjectUri(h[p],VALUE));isNaN(u)||t.update(u);n[h[p]]=t}}for(g=0;g<f.length;g++)e.addMapping(q(f[g],a,void 0,n));if(a=l.findFirstObjectUri(c,HAS_NAVIGATOR))c=l.findFirstObjectUri(a,
TO_DYMO),c=k(c),e.addNavigator(v(l.findFirstObjectUri(a,TYPE)),c);d([e,n])})};this.loadGraphFromJson=function(a,b,c){d(a,"",function(a){for(var d=0;d<a.length;d++)if(a[d])for(var e=0;e<a[d].length;e++){var f=b[CONTEXT_URI+"dymo"+d],n=b[CONTEXT_URI+"dymo"+a[d][e]];f&&n&&f.addSimilar(n)}c(void 0)})}};function DymoWriter(a){function b(a){a.addTriple("_:","http://www.w3.org/1999/02/22-rdf-syntax-ns#type","dmo:DMO");a.addTriple("_:","ch:hasPart","ch:test2")}function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeDymoToJson=function(a,b,f){a["@context"]="http://purl.org/ontology/dymo/context.json";f||(f="dymo.json");c(b+f,a)};this.writeRenderingToJson=
function(a,b){c(b+"rendering.json",a)};this.writeDmoToRdf=function(a){a=N3.Writer({prefixes:{ch:"rdf/charm.n3#",dmo:"rdf/dmo.n3#",mb:"rdf/mobile.n3#"}});b(a);a.end(function(a,b){console.log(b)})}};function EasyStore(){function a(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}function b(a){if(a&&a instanceof Object)for(var c in a)"@id"==c&&a[c].includes("_:b")?delete a[c]:b(a[c])}var c=N3.Store();this.loadData=function(b,e,f){a(b,e,function(a){N3.Parser().parse(a,function(a,b,d){b?c.addTriple(b):f&&f()})})};this.logData=function(){var a=c.find(null).map(function(a){return a.subject+"\n"+a.predicate+"\n"+a.object}),b;for(b in a)console.log(a[b])};this.writeJsonld=
function(a){for(var e=c.find(null,null,null),f=N3.Writer({format:"application/nquads"}),g=0;g<e.length;g++)f.addTriple(e[g]);f.end(function(c,e){e=e.split("_b").join("b");jsonld.fromRDF(e,{format:"application/nquads"},function(c,e){jsonld.frame(e,{"@id":"http://tiny.cc/dymo-context/dymo0"},function(c,e){jsonld.compact(e,"http://tiny.cc/dymo-context",function(c,e){jsonld.compact(e,"http://tiny.cc/dymo-context-simple",function(c,e){b(e);e=JSON.stringify(e,null,2);e=e.replace("http://tiny.cc/dymo-context-simple",
"http://tiny.cc/dymo-context");console.log(e);a(e)})})})})})};this.find=function(a,b,f){return c.find(a,b,f)};this.findFirstObjectUri=function(a,b){var f=c.find(a,b,null);if(0<f.length)return f[0].object};this.findFirstSubjectUri=function(a,b){var f=c.find(null,a,b);if(0<f.length)return f[0].subject};this.findFirstObjectValue=function(a,b){var c=this.findFirstObjectUri(a,b);if(c){var g=N3.Util.getLiteralValue(c);"http://www.w3.org/2001/XMLSchema#string"!=N3.Util.getLiteralType(c)&&(g=Number(g));return g}};
this.findAllObjectUris=function(a,b){return c.find(a,b,null).map(function(a){return a.object})};this.findAllObjectValues=function(a,b){return this.findAllObjectUris(a,b).map(function(a){return N3.Util.getLiteralValue(a)})};this.isSubclassOf=function(a,b){for(var c=this.findFirstObjectUri(a,RDFS_URI+"subClassOf");c;){if(c==b)return!0;c=this.findFirstObjectUri(c,RDFS_URI+"subClassOf")}return!1}};function Control(a,b,c){this.name=a;this.type=b;this.parameters=c;this.mappings=[]}Control.prototype.getName=function(){return this.name};Control.prototype.getParameter=function(a){if(this.parameters)return this.parameters[a]};Control.prototype.getValue=function(){return this.value};Control.prototype.getType=function(){return this.type};Control.prototype.setUpdateFunction=function(a){this.updateFunction=a};
...
Control.prototype.setValue=function(a,b){if(void 0==this.value||1E-6<Math.abs(a-this.value))this.value=a,this.updateMappings(b)};Control.prototype.updateMappings=function(a){for(var b=0;b<this.mappings.length;b++)this.mappings[b]!=a&&this.mappings[b].updateParameter(this.value,this)};function DynamicMusicObject(a,b,c){function d(a,b){b[a.getUri()]=a;for(var c=0;c<a.getParts().length;c++)d(a.getParts()[c],b)}function e(a,b,c,d){var f=a-b,g=d.getParts();if(d.getLevel()==c&&0==f)return d;if(d.getLevel()>=c-1)return f<g.length?g[f]:b+g.length;for(d=0;d<g.length;d++)if(b=e(a,b,c,g[d]),isNaN(b))return b}function f(a,b,c){c(a,b);a=a.getParts();for(var d=0,e=a.length;d<e;d++)f(a[d],b,c)}function g(a,b,c){var d=b.toFlatJson();a.nodes.push(d);c&&a.links.push(h(c,d));for(c=0;c<b.getParts().length;c++)g(a,
b.getParts()[c],d)}function k(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)k(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var p=this,m=null,q=[],u=[],r={},v={},w=[],y=[],l="",t;v[PLAY]=new Parameter(PLAY,0,!0);v[LOOP]=new Parameter(LOOP,0,!0);
v[ONSET]=new Parameter(ONSET,void 0);v[DURATION_RATIO]=new Parameter(DURATION_RATIO,1);v[AMPLITUDE]=new Parameter(AMPLITUDE,1);v[PLAYBACK_RATE]=new Parameter(PLAYBACK_RATE,1);v[TIME_STRETCH_RATIO]=new Parameter(TIME_STRETCH_RATIO,1);v[PAN]=new Parameter(PAN,0);v[DISTANCE]=new Parameter(DISTANCE,0);v[HEIGHT]=new Parameter(HEIGHT,0);v[REVERB]=new Parameter(REVERB,0);v[DELAY]=new Parameter(DELAY,0);v[FILTER]=new Parameter(FILTER,2E4);v[PART_COUNT]=new Parameter(PART_COUNT,Number.POSITIVE_INFINITY,!0);
v[PLAY].addObserver(p);v[PART_COUNT].addObserver(p);this.setType=function(a){b=a};this.getType=function(){return b};this.getUri=function(){return a};this.setParent=function(a){m=a;for(var b in v)b!=PLAY&&b!=PART_COUNT&&y.push(new Mapping([a.getParameter(b)],!0,void 0,[this],b));a=m.getMappings();var c=this.getDymoMap(),c=Object.keys(c).map(function(a){return c[a]});for(b=0;b<a.length;b++){var d=a[b].getDymoConstraint();d&&(d=a[b].getTargets().concat(c.filter(d)),a[b].setTargets(d))}};this.removeParent=
function(){for(var a=0;a<y.length;a++)y[a].disconnect();y=[];for(var b=m.getMappings(),c=this,a=0;a<b.length;a++){var d=b[a].getTargets(),d=d.filter(function(a){return!a.isSubDymoOf(c)});b[a].setTargets(d)}m=null};this.getParent=function(){return m};this.isSubDymoOf=function(a){for(var b=this;b;){if(b==a)return!0;b=b.getParent()}return!1};this.getDymoMap=function(){var a={};d(this,a);return a};this.getLevel=function(){return m?m.getLevel()+1:0};this.getIndex=function(){if(m)return m.getParts().indexOf(this)};
this.addPart=function(a){q.push(a);a.setParent(this)};this.removePart=function(a){q.splice(q.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){q[a]&&q[a].removeParent(this);q[a]=b;b.setParent(this)};this.getPart=function(a){return q[a]};this.getParts=function(){return q};this.hasParts=function(){return 0<q.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){l=a};this.getBasePath=function(){return m&&!l?m.getBasePath():l};this.setSourcePath=function(a){t=
a};this.getSourcePath=function(){if(m&&!t)return m.getSourcePath();if(t)return this.getBasePath()+t};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){u.push(a)};this.getSimilars=function(a){return u};this.getFeatures=function(){return r};this.setFeature=function(a,b){r[a]=b};this.getFeature=function(a){if(a===
LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(r.hasOwnProperty(a))return r[a];if(m)return m.getFeature(a);for(var b=[],c=0;c<q.length;c++)if(q[c]){var d=q[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(r[a])return r[a]};this.getMappings=function(){return w};this.getSegment=function(){return[this.getFeature("time"),this.getFeature("duration")]};this.addParameter=function(a){v[a.getName()]=
a};this.getParameter=function(a){return v[a]};this.addMapping=function(a){w.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(p):c.stop(p))};this.updatePartOrder=function(a){q&&q[0]&&!isNaN(q[0].getFeature(a))?q.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):q&&q.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=function(){for(var a=this.toFlatJson(),b=0;b<q.length;b++)a.parts.push(q[b].toJsonHierarchy());
return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};k(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);t&&(c.source=t);for(var d in r)c[d]=this.getFeatureJson(d);if(0<w.length)for(c.mappings=[],d=0;d<w.length;d++)c.mappings.push(w[d].toJson());0<q.length&&(c.parts=[]);if(0<u.length)for(c.similars=[],d=0;d<u.length;d++)c.similars.push(u[d].getUri());return c};
this.getFeatureJson=function(a){return{value:r[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
...
e=this._outputBuffer.endIndex,f=0,g=0;1>this.slopeCount;)d[e+2*g]=(1-this.slopeCount)*this.prevSampleL+this.slopeCount*b[c],d[e+2*g+1]=(1-this.slopeCount)*this.prevSampleR+this.slopeCount*b[c+1],g++,this.slopeCount+=this._rate;--this.slopeCount;if(1!=a)a:for(;;){for(;1<this.slopeCount;)if(--this.slopeCount,f++,f>=a-1)break a;var k=c+2*f;d[e+2*g]=(1-this.slopeCount)*b[k]+this.slopeCount*b[k+2];d[e+2*g+1]=(1-this.slopeCount)*b[k+1]+this.slopeCount*b[k+3];g++;this.slopeCount+=this._rate}this.prevSampleL=
...
e,f,g,k,h,p,m;k=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)g=(this.overlapLength-e)*k,h=e*k,f=2*e,p=f+a,m=f+d,c[m+0]=b[p+0]*h+this.pMidBuffer[f+0]*g,c[m+1]=b[p+1]*h+this.pMidBuffer[f+1]*g},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
