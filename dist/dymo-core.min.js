...
function r(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),k=0;k<a.numberOfChannels;k++)for(var f=e.getChannelData(k),C=a.getChannelData(k),p=0;p<d;p++)f[p]=C[c+p];return e}function p(a,b){for(var c=.02*a.sampleRate,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),k=0;k<c;k++)e[k]*=k/c,e[b-k-1]*=k/c}function q(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));y("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+
c,function(a){d(a)})}function y(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var u=this,v,w,k={},C=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],G=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],z=b.createBufferSource(),B=b.createGain();B.connect(b.destination);
var E=g(B,d);d=g(B,e);var D=b.createPanner();D.connect(B);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(D);z.connect(e);var F=a.getSegment(),A=F[0],x=F[1];A||(A=0);!x&&c&&(x=c.duration-A);c?l():q(a.getSourcePath(),A,A+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=r(c,0,m(d+.02,c)),x=d):c=r(c,0,m(x+.02,c));p(c,c.length);z.buffer=c});k[AMPLITUDE]=B.gain;k[TIME_STRETCH_RATIO]={value:0};k[REVERB]=
...
!0)};this.getDymo=function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return z.loop&&v};this.getParameterValue=function(a){if(k[a])return k[a].value||0==k[a].value?k[a].value:k[a].getValue()};this.play=function(b){z.onended=function(){for(var b=0;b<C.length;b++){var c=a.getParameter(C[b]);c&&c.removeObserver(u)}z.disconnect();B.disconnect();E.disconnect();f&&f(u)};b||(b=0);z.start(b);v=!0};this.pause=function(){v?(n(),w=!0):w&&(w=!1,this.play())};this.stop=
function(){v&&n()}};function SchedulerThread(a,b,c,d,e,f,g,l){function h(){u=w?w:p();n(u);k||(k=u[0].getDymo().getParameter(ONSET).getValue());var a;a=v?v-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=0;d<u.length;d++)u[d].play(b);setTimeout(function(){g()},a);(w=p())?(v=r(b),a=1E3*(v-c.currentTime-SCHEDULE_AHEAD_TIME),y=setTimeout(function(){h()},a)):(v=r(b),a=1E3*(v-c.currentTime),setTimeout(function(){t()},a+100))}function t(){0==q.size&&(window.clearTimeout(y),b.reset(),l&&l())}function n(a){for(var b=
0;b<a.length;b++)q.set(a[b].getDymo(),a[b])}function m(a){q.delete(a.getDymo());g();t()}function r(a){if(w){var b=w[0].getDymo().getParameter(ONSET).getValue(),c=b-k;k=b;if(!isNaN(b))return a+c}b=u[0];c=b.getDymo().getParameter(PLAYBACK_RATE).getValue();b=b.getDuration()/c;return a+b}function p(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return a.getIndex()}));for(var k=[],p=0;p<a.length;p++)if(a[p].getSourcePath()){var h=d[a[p].getSourcePath()];k.push(new Source(a[p],c,h,e,f,m))}return k}}
var q=new Map,y,u=[],v,w,k;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));h();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);d&&d.pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);d&&d.stop()}};this.getSources=function(){return q};this.getSource=function(a){return q.get(a)}}
...
b.getParts()[c],d)}function l(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(h(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)l(a,b.getParts()[e],c)}function h(a,b){return{source:a,target:b,value:1}}var t=this,n=null,m=[],r=[],p={},q={},y=[],u=[],v="",w;q[PLAY]=new Parameter(PLAY,0,!0);q[LOOP]=new Parameter(LOOP,0,!0);
...
this.getFeature("duration")]};this.addParameter=function(a){q[a.getName()]=a};this.getParameter=function(a){return q[a]};this.addMapping=function(a){y.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(t):c.stop(t))};this.updatePartOrder=function(a){m&&m[0]&&!isNaN(m[0].getFeature(a))?m.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):m&&m.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=
