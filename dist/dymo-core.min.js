...
ONE_SHOT_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#OneShotNavigator",REPEATED_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#RepeatedNavigator",SEQUENTIAL_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SequentialNavigator",SIMILARITY_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#SimilarityNavigator",GRAPH_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#GraphNavigator",DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#DomainDimension",MAPPING_TARGET="http://tiny.cc/mobile-audio-ontology#MappingTarget",
MAPPING_RANGE="http://tiny.cc/mobile-audio-ontology#MappingRange",MAPPING_OWNERS="http://tiny.cc/mobile-audio-ontology#MappingOwners",HAS_DYMO="http://tiny.cc/mobile-audio-ontology#hasDymo",HAS_MAPPING="http://tiny.cc/mobile-audio-ontology#hasMapping",HAS_DOMAIN_DIMENSION="http://tiny.cc/mobile-audio-ontology#hasDomainDimension",HAS_FUNCTION="http://tiny.cc/mobile-audio-ontology#hasFunction",HAS_ARGUMENT="http://tiny.cc/mobile-audio-ontology#hasArgument",HAS_BODY="http://tiny.cc/mobile-audio-ontology#hasBody",
TO_TARGET="http://tiny.cc/mobile-audio-ontology#toTarget",HAS_RANGE="http://tiny.cc/mobile-audio-ontology#hasRange",IS_RELATIVE="http://tiny.cc/mobile-audio-ontology#isRelative",HAS_INITIAL_VALUE="http://tiny.cc/mobile-audio-ontology#hasInitialValue",IS_SMOOTH="http://tiny.cc/mobile-audio-ontology#isSmooth",IS_AVERAGE_OF="http://tiny.cc/mobile-audio-ontology#isAverageOf",HAS_UUID="http://tiny.cc/mobile-audio-ontology#hasUuid",HAS_MAJOR="http://tiny.cc/mobile-audio-ontology#hasMajor",HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",
HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",NAV_DYMOS="http://tiny.cc/mobile-audio-ontology#navDymos";function DymoManager(a,b,c,d,e){function g(a,b){m=b[0];m.dymos=a[0];l=a[1];for(var e in b[1]){var g=b[1][e];h.isSubclassOf(g.getType(),UI_CONTROL)&&(n[e]=new UIControl(g,d));h.isSubclassOf(g.getType(),SENSOR_CONTROL)&&(p[e]=g)}c||(c="bower_components/dymo-core/audio/impulse_rev.wav");f.initEffectSends(h,c)}var f=new Scheduler(a,e);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var h,l,m,n={},p={};this.loadDymoAndRenderingFromStore=function(a,b){h=a;var c=new DymoLoader(f);c.setStore(h);g(c.createDymoFromStore(),
...
"http://tiny.cc/mobile-audio-ontology#hasDuration":"rampDuration","http://tiny.cc/mobile-audio-ontology#hasNavigator":"navigators","http://tiny.cc/mobile-audio-ontology#navDymos":"dymos"};function DymoNode(a,b,c,d){this.POSITION_PARAMS=[PAN,HEIGHT,DISTANCE];this.dymo=a;this.parameters={};this.init(b,c,d)}
...
{},f=[],h=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var l,m=0;this.initEffectSends=function(b,c){0<b.find(null,null,REVERB).length&&(l=a.createConvolver(),l.connect(a.destination),e(c,function(a){l.buffer=a;0<m&&m--}));if(0<b.find(null,null,DELAY).length){var d=a.createDelay();d.delayTime.value=.5;d.connect(a.destination);var f=a.createGain();f.gain.value=.6;d.connect(f);f.connect(d)}};this.loadBuffers=function(a,b){for(var c=[],d=
0,f=a.length;d<f;d++)c=c.concat(a[d].getAllSourcePaths());d=0;for(f=c.length;d<f;d++)g[c[d]]||e(c[d],function(a,c){g[c]=a;0<m&&m--;0==m&&b&&b()})};this.getBuffer=function(a){return g[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=f.length;d<e;d++)f[d].hasDymo(a)&&f[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=f.length;c<d;c++)if(f[c].hasDymo(a))return f[c].getNavigator().getPosition(b,
a)};this.syncNavigators=function(a,b,c){for(var d,e,g=0,h=f.length;g<h;g++)f[g].hasDymo(a)&&(d=f[g].getNavigator()),f[g].hasDymo(b)&&(e=f[g].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b,e){var h=new SchedulerThread(b,e,a,g,l,void 0,d,c);f.push(h)};this.pause=function(a){if(a)for(var b=0;b<f.length;b++)f[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<f.length;b++)f[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<f.length;c++){var d=f[c].getSources(a);
if(d)for(var e=0;e<d.length;e++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return h};this.observedParameterChanged=function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function DymoSource(a,b,c,d,e,g){function f(b,d){var f=b[0],e=b[1],e=1!=d?e+.3:e+FADE_LENGTH;if(c||isNaN(f+e)){if(0!=f||e<c.duration)c=n(c,m(f,c),m(e,c));return h(c,e,d)}p(a.getSourcePath(),f,f+e,function(a){return h(a,e,d)})}function h(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=n(a,0,m(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var f=c.sampleRate*FADE_LENGTH,e=0;e<c.numberOfChannels;e++)for(var g=c.getChannelData(e),h=0;h<f;h++)g[h]*=h/f,g[d-h-1]*=h/f;return a}function l(){v=!1;var a=
b.currentTime;k.parameters[AMPLITUDE].setValueAtTime(k.parameters[AMPLITUDE].value,a);k.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);u.stop(a+2*FADE_LENGTH)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function n(a,c,d){d=Math.min(a.length-c,d);for(var f=b.createBuffer(a.numberOfChannels,d,a.sampleRate),e=0;e<a.numberOfChannels;e++)for(var g=f.getChannelData(e),h=a.getChannelData(e),l=0;l<d;l++)g[l]=h[c+l];return f}function p(a,b,c,d){var f=a.lastIndexOf("/");f&&
(a=a.substring(f+1));r("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function r(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var k=this,v,q,t,u=b.createBufferSource();u.connect(this.getInput());(function(){var b=a.getSegment();b[0]||(b[0]=0);!b[1]&&c&&
(b[1]=c.duration-b[0]);if(a.hasParameter(DURATION_RATIO)){var d=a.getParameter(DURATION_RATIO).getValue();0<d&&1>d&&(b[1]*=d)}t=b[1];d=a.hasParameter(TIME_STRETCH_RATIO)?a.getParameter(TIME_STRETCH_RATIO).getValue():1;u.buffer=f(b,d)})();this.addParameter(PLAYBACK_RATE,u.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return t};this.isLoopingAndPlaying=function(){return u.loop&&v};this.play=function(a){u.onended=function(){u.disconnect();
k.removeAndDisconnect();g&&g(k)};a||(a=0);u.start(a);v=!0};this.pause=function(){v?(l(),q=!0):q&&(q=!1,this.play())};this.stop=function(){v&&l()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,g,f,h){function l(){x=u?u:k();m(x);if(!z){var a=x.keys().next().value;a.hasParameter(ONSET)&&(z=a.getParameter(ONSET).getValue())}a=w?w-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(x.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){f()},a);(u=k())&&0<u.size?(w=r(b),a=w[1],w=w[0],a.getDymo().hasParameter(LOOP)&&a.getDymo().getParameter(LOOP).getValue()&&(w-=FADE_LENGTH),a=1E3*(w-c.currentTime-SCHEDULE_AHEAD_TIME),
y=setTimeout(function(){l()},a)):(w=r(b),a=1E3*(w-c.currentTime),setTimeout(function(){p()},a+100))}function m(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,q.get(c)||q.set(c,[]),q.get(c).push(a.get(c))}function n(a){var b=q.get(a.getDymo());b.splice(b.indexOf(a),1);0>=b.length&&q.delete(a.getDymo());f();p()}function p(){if(0==q.size&&(!u||0==u.size)){window.clearTimeout(y);b.reset();for(var c=a.getAllDymosInHierarchy(),d=0,f=c.length;d<f;d++){var e=t.get(c[d]);
e&&e.removeAndDisconnect()}h&&h()}}function r(a){if(u){var b=u.keys().next().value,c;b.hasParameter(ONSET)&&(c=b.getParameter(ONSET).getValue());b=c-z;z=c;if(!isNaN(c))return a+b}c=0;for(var d,b=$jscomp.makeIterator(x.values()),f=b.next();!f.done;f=b.next()){var f=f.value,e=f.getDuration();e>c&&(c=e,d=f)}return[a+c,d]}function k(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return isNaN(a.getIndex())?"top":a.getIndex()}));for(var f=new Map,h=0;h<a.length;h++)if(a[h].getSourcePath()){var x=
d[a[h].getSourcePath()],x=new DymoSource(a[h],c,x,e,g,n);v(x);f.set(a[h],x)}return f}}function v(a){var b=a;for(a=a.getDymo().getParent();a;){if(t.has(a)){b.connect(t.get(a).getInput());return}var d=new DymoNode(a,c,e,g);b.connect(d.getInput());t.set(a,d);a=a.getParent();b=d}b.connect(c.destination)}var q=new Map,t=new Map,u,y,x=[],w,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));l();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};
this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);if(d)for(var f=0;f<d.length;f++)d[f].stop();u&&(u.delete(a[b]),0>=u.size&&(u=void 0))}};this.getAllSources=function(){return q};this.getSources=function(a){return q.get(a)}};function AutoControl(a,b,c){function d(a){var b=a.getName();g[b]=a;g[b].addObserver(e)}var e=this,g={};d(new Parameter(AUTO_CONTROL_FREQUENCY,100));d(new Parameter(AUTO_CONTROL_TRIGGER,0));Control.call(this,a,AUTO_CONTROL,g);var f;this.addParameter=d;this.getParameter=function(a){return g[a]};this.startUpdate=function(){f=setInterval(b,g[AUTO_CONTROL_FREQUENCY].getValue())};this.reset=function(){clearInterval(f);f=null;c&&c()};this.observedParameterChanged=function(a){a==g[AUTO_CONTROL_FREQUENCY]?
f&&(this.reset(),this.startUpdate()):a==g[AUTO_CONTROL_TRIGGER]&&(f?this.reset():this.startUpdate())}}inheritPrototype(AutoControl,Control);function BrownianControl(a){var b=this;a||(a=.5);AutoControl.call(this,BROWNIAN,function(){var a=b.getParameter(BROWNIAN_MAX_STEP_SIZE).getValue(),a=2*a*Math.random()-a,a=b.getValue()+a,a=Math.min(Math.max(a,0),1);b.update(a)});this.addParameter(new Parameter(BROWNIAN_MAX_STEP_SIZE,.1));this.update(a);this.startUpdate()}inheritPrototype(BrownianControl,AutoControl);function RampControl(a,b){var c=this;a||(a=1E4);var d=0;b&&(d=b);var e=1!=d;AutoControl.call(this,RAMP,function(){var b=1/a*c.getParameter(AUTO_CONTROL_FREQUENCY).getValue();e||(b*=-1);d+=b;0<d&&1>d?c.update(d):1<=d?(c.update(1),c.reset()):0>=d&&(c.update(0),c.reset())},function(){e=!e});this.update(d)}inheritPrototype(RampControl,AutoControl);function RandomControl(){var a=this;AutoControl.call(this,RANDOM,function(){a.update(Math.random())});this.startUpdate()}inheritPrototype(RandomControl,AutoControl);function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(a){c.value=a;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.update(1):0==this.value?a.update(0):a.update(this.value)}};function OntologyLoader2(a,b,c){};function DymoLoader(a,b){function c(a,b){d(a,"",function(a){k.loadData(a,!0,b)})}function d(a,b,c){loadFile(a,function(f){if(0>f.indexOf("Cannot GET")){var g;a:{try{JSON.parse(f)}catch(h){g=!1;break a}g=!0}g&&(b?(0<=a.indexOf(v)&&(a=a.replace(v,"")),b=b.replace('"'+a+'"',f)):b=f);(f=e(b))?(0>f.indexOf(v)&&(f=v+f),d(f,b,c)):b&&c(JSON.parse(b))}})}function e(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return e(a.substring(b+
1))}}function g(b){var c=k.findFirstObjectUri(b,CDT),c=new DynamicMusicObject(b,c,a);c.setBasePath(v);t[b]=c;c.setSourcePath(k.findFirstObjectValue(b,HAS_SOURCE));for(var d=k.findAllObjectUris(b,HAS_FEATURE),f=0;f<d.length;f++)k.findFirstObjectUri(d[f],TYPE),c.setFeature(k.findFirstObjectUri(d[f],TYPE),k.findFeatureValue(d[f]));d=k.findAllObjectUris(b,HAS_PARAMETER);for(f=0;f<d.length;f++)n(c,k.findFirstObjectUri(d[f],TYPE),k.findFirstObjectValue(d[f],VALUE));b=k.findParts(b);for(f=0;f<b.length;f++)c.addPart(g(b[f]));
return c}function f(a){for(var b=t[a],c=k.findAllObjectUris(a,HAS_SIMILAR),d=0;d<c.length;d++)b.addSimilar(t[c[d]]);c=k.findAllObjectUris(a,HAS_MAPPING);h(c);for(d=0;d<c.length;d++)b.addMapping(l(c[d],b));a=k.findParts(a);for(d=0;d<a.length;d++)f(a[d])}function h(a){for(var b=0;b<a.length;b++)for(var c=k.findAllObjectUris(a[b],HAS_DOMAIN_DIMENSION),d=0;d<c.length;d++){var f=k.findFirstObjectUri(c[d],TYPE),e=k.findFirstObjectValue(c[d],NAME);e||(e=c[d]);if(k.isSubclassOf(f,MOBILE_CONTROL)&&!q[c[d]]){var g=
c[d],h=f,f=void 0;h==ACCELEROMETER_X||h==ACCELEROMETER_Y||h==ACCELEROMETER_Z?f=new AccelerometerControl(h):h==TILT_X||h==TILT_Y?f=new TiltControl(h):h==GEOLOCATION_LATITUDE||h==GEOLOCATION_LONGITUDE?f=new GeolocationControl(h):h==GEOLOCATION_DISTANCE?f=new DistanceControl:h==COMPASS_HEADING?f=new CompassControl:h==BEACON?(f=k.findFirstObjectValue(g,HAS_UUID),e=k.findFirstObjectValue(g,HAS_MAJOR),h=k.findFirstObjectValue(g,HAS_MINOR),f=new BeaconControl(f,e,h)):h==SLIDER||h==TOGGLE||h==BUTTON||h==
CUSTOM_CONTROL?(f=new Control(e,h),e=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),f.update(e)):h==RANDOM?f=new RandomControl:h==BROWNIAN?(e=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),f=new BrownianControl(e)):h==RAMP&&(f=Math.round(1E3*k.findFirstObjectUri(g,HAS_DURATION)),e=k.findFirstObjectValue(g,HAS_INITIAL_VALUE),f=new RampControl(f,e));k.findFirstObjectValue(g,IS_SMOOTH)&&f.setSmooth&&f.setSmooth(!0);g=k.findFirstObjectValue(g,IS_AVERAGE_OF);!isNaN(g)&&f.setAverageOf&&f.setAverageOf(g);q[c[d]]=
f}}}function l(b,c){var d=k.findAllObjectUris(b,TO_TARGET);if(0<d.length){var f=[],e=k.findFunction(d[0]);if(e)d=Object.keys(t).map(function(a){return t[a]}),Array.prototype.push.apply(f,d.filter(e));else for(var h=0;h<d.length;h++)k.findFirstObjectUri(d[h],TYPE)==DYMO?f.push(t[d[h]]):f.push(q[d[h]]);return m(b,c,f,e)}return m(b,c,[a])}function m(a,b,c,d){for(var f=k.findFirstObjectUri(a,IS_RELATIVE),e=[],h=k.findAllObjectUris(a,HAS_DOMAIN_DIMENSION),g=0;g<h.length;g++){var l=k.findFirstObjectUri(h[g],
TYPE),m=k.findFirstObjectValue(h[g],NAME);m||(m=h[g]);l==FEATURE_TYPE||k.isSubclassOf(l,FEATURE_TYPE)?e.push(m):l==PARAMETER_TYPE||k.isSubclassOf(l,PARAMETER_TYPE)?(l=b?n(b,m):new Parameter(m,0),e.push(l)):e.push(q[h[g]])}h=$jscomp.makeIterator(k.findArgsAndBody(k.findFirstObjectUri(a,HAS_FUNCTION)));b=h.next().value;h=h.next().value;a=k.findFirstObjectUri(a,HAS_RANGE);for(g=0;g<c.length;g++)c[g]instanceof DynamicMusicObject&&!c[g].getParameter(a)&&n(c[g],a);return new Mapping(e,f,{args:b,body:h},
c,a,d)}function n(a,b,c){var d=a.getParameter(b);d?d.update(c):(isNaN(c)&&(c=k.findFirstObjectValue(b,HAS_STANDARD_VALUE,null),isNaN(c)&&(c=0)),d=k.findFirstObjectValue(b,IS_INTEGER,null),d=new Parameter(b,c,d),a.addParameter(d));return d}function p(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):a==GRAPH_NAVIGATOR?new GraphNavigator(void 0):a==ONE_SHOT_NAVIGATOR?new OneShotNavigator(void 0):a==REPEATED_NAVIGATOR?new RepeatedNavigator(void 0):new SequentialNavigator(void 0)}var r=
this,k=new DymoStore(b),v="",q={},t={};this.setStore=function(a){k=a};this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;v=a.substring(0,d);c(a,function(){b(r.createDymoFromStore())})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(r.createDymoFromStore())})};this.loadRenderingFromJson=function(a,b){c(a,function(){b(r.createRenderingFromStore())})};this.loadGraphFromJson=function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=
0;d<a[c].length;d++){var f=t[CONTEXT_URI+"dymo"+c],e=t[CONTEXT_URI+"dymo"+a[c][d]];f&&e&&f.addSimilar(e)}b(void 0)})};this.createDymoFromStore=function(){for(var a=[],b=k.findTopDymos(),c=0;c<b.length;c++)a.push(g(b[c])),f(b[c]);return[a,t]};this.createRenderingFromStore=function(){var a=k.findFirstSubjectUri(TYPE,RENDERING),b=new Rendering(t[k.findFirstObjectUri(a,HAS_DYMO)]),c=k.findAllObjectUris(a,HAS_MAPPING);h(c);for(var d=0;d<c.length;d++)b.addMapping(l(c[d]));a=k.findAllObjectUris(a,HAS_NAVIGATOR);
for(d=0;d<a.length;d++)c=k.findFirstObjectUri(a[d],NAV_DYMOS),c=k.findFunction(c),b.addSubsetNavigator(c,p(k.findFirstObjectUri(a[d],TYPE)));return[b,q]}};function DymoStore(a){function b(a,b,d){g.triplesToRdf(a,function(a){c(a,b,d)})}function c(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,d){jsonld.frame(d,{"@id":b},function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context",function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context-simple",function(a,b){e(b);b=JSON.stringify(b,null,2);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");b=b.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");
...
TYPE,DYMO);b&&g.addObjectToList(b,HAS_PART,a);c&&g.addObjectToList(a,HAS_PART,c);d&&this.addTriple(a,HAS_SOURCE,N3.Util.createLiteral(d))};this.addSimilar=function(a,b){this.addTriple(a,HAS_SIMILAR,b)};this.setFeature=function(a,b,c){var d=this.findFirstObjectUriOfType(a,HAS_FEATURE,b);d?this.removeTriple(d,VALUE):(d=this.createBlankNode(),this.addTriple(a,HAS_FEATURE,d),this.addTriple(d,TYPE,b));if(Array.isArray(c))for(a=0;a<c.length;a++)this.addObjectToList(d,VALUE,N3.Util.createLiteral(c[a]));
else this.addTriple(d,VALUE,N3.Util.createLiteral(c))};this.addRendering=function(a,b){this.addTriple(a,TYPE,RENDERING);this.addTriple(a,HAS_DYMO,b)};this.addMapping=function(a,b,c,d,e,g){var r=this.createBlankNode();this.addTriple(a,HAS_MAPPING,r);for(a=0;a<b.length;a++){var k=this.createBlankNode();this.addTriple(r,HAS_DOMAIN_DIMENSION,k);b[a].name&&this.addTriple(k,NAME,b[a].name);b[a].type&&this.addTriple(k,TYPE,b[a].type)}b=this.addFunction(c[0],c[1]);this.addTriple(r,HAS_FUNCTION,b);if(d)for(a=
0;a<d.length;a++)this.addTriple(r,TO_TARGET,d[a]);e&&(b=this.addFunction(e[0],e[1]),this.addTriple(r,TO_TARGET,b));this.addTriple(r,HAS_RANGE,g)};this.addNavigator=function(a,b,c,d){var e=this.createBlankNode();this.addTriple(a,HAS_NAVIGATOR,e);this.addTriple(e,TYPE,b);a=this.addFunction(c,d);this.addTriple(e,NAV_DYMOS,a)};this.addFunction=function(a,b){var c=this.createBlankNode();this.addTriple(c,HAS_ARGUMENT,N3.Util.createLiteral(a));this.addTriple(c,HAS_BODY,N3.Util.createLiteral(b));return c};
this.findTopDymos=function(){var a=this.findAllSubjectUris(TYPE,DYMO),b=this.findAllSubjectUris(HAS_PART),c=[].concat.apply([],b.map(function(a){return g.findParts(a)}));return a.filter(function(a){return 0>c.indexOf(a)})};this.findParts=function(a){return this.findAllObjectUris(a,HAS_PART)};this.findParents=function(a){var b=this.findContainingLists(a);return b[0].filter(function(a,c){return b[1][c]==HAS_PART})};this.findAllObjectsInHierarchy=function(a){var b=[a];a=this.findParts(a);for(var c=0;c<
a.length;c++)b=b.concat(this.findAllObjectsInHierarchy(a[c]));return b};this.findMappings=function(a){return this.findAllObjectUris(a,HAS_MAPPING)};this.findNavigators=function(a){return this.findAllObjectUris(a,HAS_NAVIGATOR)};this.findFunction=function(a){var b=$jscomp.makeIterator(this.findArgsAndBody(a));a=b.next().value;b=b.next().value;if(a&&b)return Function.apply(null,a.concat(b))};this.findArgsAndBody=function(a){var b=this.findAllObjectValues(a,HAS_ARGUMENT);a=this.findFirstObjectValue(a,
HAS_BODY);return[b,a]};this.findFeature=function(a,b){var c=this.findFirstObjectUriOfType(a,HAS_FEATURE,b);if(c)return this.findFeatureValue(c)};this.findAllFeatureValues=function(a){var b=[];a=this.findAllObjectUris(a,HAS_FEATURE);for(var c=0;c<a.length;c++)b.push(this.findFeatureValue(a[c]));return b};this.findAllNumericFeatureValues=function(a){return this.findAllFeatureValues(a).filter(function(a){return!isNaN(a)})};this.findFeatureValue=function(a){a=this.findAllObjectValues(a,VALUE);1==a.length&&
(a=a[0]);return a};this.getLevel=function(a){var b=0;for(a=this.findParents(a)[0];a;)b++,a=this.findParents(a)[0];return b};this.getMaxLevel=function(){for(var a=this.findAllSubjectUris(TYPE,DYMO),b=0,c=0;c<a.length;c++)b=Math.max(b,this.getLevel(a[c]));return b};this.toJsonld=function(a){var b=this.findTopDymos()[0];this.toRdf(function(d){c(d,b,a)})};this.toJsonGraph=function(a,b,c){var e={nodes:[],links:[]},n={},p=this.findAllSubjectUris(TYPE,a),r=this.find(null,b,null);async.map(p,d,function(d,
v){e.nodes=v;for(var q=0;q<p.length;q++)n[p[q]]=e.nodes[q];e.links=[];for(q=0;q<r.length;q++)if(0==g.find(r[q].object,TYPE,a).length){if(0<g.find(r[q].object,FIRST).length){var t=g.findObjectListUris(r[q].subject,b),t=t.map(function(a){return{source:n[r[q].subject],target:n[a],value:1}});e.links=e.links.concat(t)}}else e.links.push({source:n[r[q].subject],target:n[r[q].object],value:1});c(e)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a,b){function c(a,b){var c=new XMLHttpRequest;c.send(b);c.addEventListener("save",function(){console.log("saved "+a)});c.addEventListener("error",function(){console.log("saving "+a+" failed")});c.open("POST",a);c.send()}this.writeToJsonld=function(b,e){e||(e="dymo.json");a.toJsonld(function(a){c(b+e,a)})}};function EasyStore(){function a(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}function b(a){var b=d.findFirstObjectUri(a,FIRST);if(b){var c=[];c.push(b);for(a=d.findFirstObjectUri(a,REST);a!=NIL;)c.push(d.findFirstObjectUri(a,FIRST)),a=d.findFirstObjectUri(a,REST);return c}}function c(a){var b=N3.Util.getLiteralValue(a);"http://www.w3.org/2001/XMLSchema#string"!=N3.Util.getLiteralType(a)&&(b=Number(b));return b}var d=this,e=N3.Store();this.addTriple=function(a,b,
...
this.findFirstSubjectUri=function(a,b){var c=e.find(null,a,b);if(0<c.length)return c[0].subject};this.findFirstObjectValue=function(a,b){var d=this.findFirstObjectUri(a,b);if(d)return c(d)};this.findAllSubjectUris=function(a,b){return e.find(null,a,b).map(function(a){return a.subject})};this.findAllObjectUris=function(a,c){for(var d=e.find(a,c,null).map(function(a){return a.object}),l=0;l<d.length;l++){var m=b(d[l]);m&&(d[l]=m)}return flattenArray(d)};this.findAllObjectValues=function(a,b){return this.findAllObjectUris(a,
...
b.getParts()[c],d)}function h(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(l(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)h(a,b.getParts()[e],c)}function l(a,b){return{source:a,target:b,value:1}}var m=this,n=null,p=[],r=[],k={},v={},q=[],t=[],u="",y;this.setType=function(a){b=a};this.getType=function(){return b};
this.getUri=function(){return a};this.setParent=function(a){n=a;a=n.getMappings();for(var b=this.getMapOfDymosInSubtree(),b=Object.keys(b).map(function(a){return b[a]}),c=0;c<a.length;c++){var d=a[c].getDymoConstraint();d&&(d=a[c].getTargets().concat(b.filter(d)),a[c].setTargets(d))}};this.removeParent=function(){for(var a=0;a<t.length;a++)t[a].disconnect();t=[];for(var b=n.getMappings(),c=this,a=0;a<b.length;a++){var d=b[a].getTargets(),d=d.filter(function(a){return!a.isSubDymoOf(c)});b[a].setTargets(d)}n=
...
p[a]=b;b.setParent(this)};this.getPart=function(a){return p[a]};this.getParts=function(){return p};this.hasParts=function(){return 0<p.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){u=a};this.getBasePath=function(){return n&&!u?n.getBasePath():u};this.setSourcePath=function(a){y=a};this.getSourcePath=function(){if(n&&!y)return n.getSourcePath();if(y)return this.getBasePath()+y};this.getAllSourcePaths=function(){var a=[];g(this,a,function(b,c){var d=b.getSourcePath();
d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];g(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){r.push(a)};this.getSimilars=function(a){return r};this.getFeatures=function(){return k};this.setFeature=function(a,b){k[a]=b};this.getFeature=function(a){if(a===LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(k.hasOwnProperty(a))return k[a];if(n)return n.getFeature(a);for(var b=[],c=0;c<p.length;c++)if(p[c]){var d=
p[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(k[a])return k[a]};this.getMappings=function(){return q};this.getSegment=function(){return[this.getFeature(TIME_FEATURE),this.getFeature(DURATION_FEATURE)]};this.addParameter=function(a){v[a.getName()]=a};this.getParameter=function(a){return v[a]};this.hasParameter=function(a){return a in v};this.addMapping=function(a){q.push(a)};this.observedParameterChanged=function(a){a.getName()==
...
this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};h(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);y&&(c.source=y);for(var d in k)c[d]=this.getFeatureJson(d);if(0<q.length)for(c.mappings=[],d=0;d<q.length;d++)c.mappings.push(q[d].toJson());0<p.length&&(c.parts=[]);if(0<r.length)for(c.similars=[],d=0;d<r.length;d++)c.similars.push(r[d].getUri());return c};this.getFeatureJson=function(a){return{value:k[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+
...
PolygonTools.getInterpolatedPolygonFunctionArgs=function(a){var b=getPolygonOrPointString(a);a=getPolygonOrPointString(PolygonTools.getCentroid(a));return["a","b","return PolygonTools.howFarIsPointInPolygon("+b+","+a+", {0:a, 1:b});"]};function getPolygonOrPointString(a){return JSON.stringify(a).replace(/"/g,"'")};function GraphNavigator(a){var b=this,c=0;this.leapingProbability=new Parameter(LEAPING_PROBABILITY,.8);this.resetPartsPlayed=function(){c=0};this.getType=function(){return GRAPH_NAVIGATOR};this.getCopy=function(a){a=new GraphNavigator(a);a.leapingProbability.update(this.leapingProbability.getValue(),this);return a};this.getCurrentParts=function(){if(0<a.getParts().length){var d;d=(d=a.getPart(c))?[d]:void 0;if(d&&0<d.length){var e=d[0].getSimilars();0<e.length&&Math.random()<b.leapingProbability.getValue()?
(e=e[Math.floor(Math.random()*e.length)],c=a.getParts().indexOf(e)):c+=1}else c=void 0;return d}};this.getNextParts=function(){return this.getCurrentParts()}};function DymoNavigator(a,b,c){function d(){l=new Map;m=[];c||(c=new OneShotNavigator(void 0))}function e(a){if(a){var b=f(a);if(b){m[a.getLevel()]=b;if(b.getType()==ONE_SHOT_NAVIGATOR||b.getType()==REPEATED_NAVIGATOR)return b.getCurrentParts();a=b.getCurrentParts();return(a=g(a))?a:g(b.getNextParts())}return[a]}}function g(a){if(a&&0<a.length){for(var b=[],c=0,d=a.length;c<d;c++){var f=e(a[c]);f&&(f.length?b=b.concat(f):b.push(f))}if(0<b.length)return b}}function f(a){if(!l.has(a)){for(var d=0,e=
h.length;d<e;d++)h[d][0](a)&&l.set(a,h[d][1].getCopy(a));l.has(a)||(b&&a.hasParts()?l.set(a,b.getCopy(a)):l.set(a,c.getCopy(a)))}return l.get(a)}var h=[],l,m;d();this.reset=function(a){if(a){var b=a.getAllDymosInHierarchy();b.splice(b.indexOf(a),1);a=0;for(var c=b.length;a<c;a++){var e=l.delete(b[a]);(e=m.indexOf(e))&&m.splice(e,1)}}else d()};this.addSubsetNavigator=function(a,b){h.push([a,b])};this.getSubsetNavigators=function(){return h};this.getPosition=function(b,c){c||(c=a);for(var d=0;d<b;){if(!l.has(c))return;
c=l.get(c).getCurrentParts()[0];d++}if(l.has(c))return l.get(c).getPartsNavigated()};this.setPosition=function(b,c,d){d||(d=a);for(var e=0;e<=c&&d;){var g=f(d);e==c?(g.setPartsNavigated(b),this.reset(d)):d=g.getCurrentParts()?g.getCurrentParts()[0]:void 0;e++}};this.getNextParts=function(){return e(a)}};function OneShotNavigator(a){var b=!1;this.getType=function(){return ONE_SHOT_NAVIGATOR};this.getCopy=function(a){return new OneShotNavigator(a)};this.getCurrentParts=function(){if(!b)return a.getParameter(LOOP)&&1==a.getParameter(LOOP).getValue()||(b=!0),[a]};this.getNextParts=function(){return this.getCurrentParts()}};function RepeatedNavigator(a){this.getType=function(){return REPEATED_NAVIGATOR};this.getCopy=function(a){return new RepeatedNavigator(a)};this.getCurrentParts=function(){return[a]};this.getNextParts=function(){return this.getCurrentParts()}};function SequentialNavigator(a,b){var c=0;this.resetPartsNavigated=function(){c=0};this.setPartsNavigated=function(a){c=a};this.getPartsNavigated=function(){return c};this.getType=function(){return SEQUENTIAL_NAVIGATOR};this.getCopy=function(a){return new SequentialNavigator(a,b)};this.getDymo=function(){return a};this.getCurrentParts=function(){if(0<a.getParts().length){if(a.getType()==CONJUNCTION){var d;d=0>=c?a.getParts():void 0;return d}b?(d=a.getParts().length,d=a.getPart(d-c)):d=a.getPart(c);
d=d?[d]:void 0;return d}};this.getNextParts=function(){c++;return this.getCurrentParts()}};function SimilarityNavigator(a){function b(b){if(b){if(b&&0<b.length)for(var g=0;g<b.length;g++)if(0<b[g].getSimilars().length&&Math.random()<c.leapingProbability.getValue()){var f=b[g].getSimilars(),h=Math.floor(Math.random()*f.length);if(0<c.continueAfterLeaping.getValue()){var l=a.getParts().indexOf(h);l&&(d=l+1)}b[g]=f[h]}return b}}var c=this,d=0;this.leapingProbability=new Parameter(LEAPING_PROBABILITY,.5);this.continueAfterLeaping=new Parameter(CONTINUE_AFTER_LEAPING,0,!0);this.resetPartsPlayed=
