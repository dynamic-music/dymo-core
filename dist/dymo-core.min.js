...
new Float32Array(2048),n=e.extract(h,1024),p=0;n;){for(k=0;k<n;k++)for(var m=0;m<g.length;m++)g[m][k+p]=h[k*g.length+m%g.length];p+=n;n=e.extract(h,1024)}return f}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var f=new SimpleFilter({extract:function(a,c,d){for(var e=[],f=0;f<b.numberOfChannels;f++)e.push(b.getChannelData(f));for(f=0;f<c;f++)for(var g=0;g<e.length;g++)a[f*e.length+g%e.length]=e[g][f+d];return Math.min(c,e[0].length-d)}},e),g=a.createScriptProcessor(1024,
2,b.numberOfChannels),k=new Float32Array(2048);g.onaudioprocess=function(a){for(var c=[],e=0;e<b.numberOfChannels;e++)c.push(a.outputBuffer.getChannelData(e));a=f.extract(k,1024);0==a&&d.stop();for(e=0;e<a;e++)for(var g=0;g<c.length;g++)c[g][e]=k[e*c.length+g%c.length]};this.start=function(a){setTimeout(function(){g.connect(c)},a)};this.stop=function(){g.disconnect()}};function Scheduler(a,b,c){function d(){0<t&&t--;0==t&&b&&b(t)}function e(a){h.splice(h.indexOf(a),1)}function f(){for(var a=[],b=0;b<h.length;b++)for(var d=$jscomp.makeIterator(h[b].getSources().keys()),e=d.next();!e.done;e=d.next())for(e=e.value;null!=e;)0>a.indexOf(e.getUri())&&a.push(e.getUri()),e=e.getParent();a.sort();n=a;c&&c()}function g(b,c){t++;var e=new XMLHttpRequest;e.open("GET",b,!0);e.responseType="arraybuffer";e.onload=function(){a.decodeAudioData(e.response,function(a){c?c(a):(k[b]=
a,d())})};e.error=function(){};e.send()}var k={},h=[],n=[];this.listenerOrientation=new Parameter(LISTENER_ORIENTATION,0);this.listenerOrientation.addObserver(this);var p=a.createConvolver();p.connect(a.destination);var m=a.createDelay();m.delayTime.value=.5;m.connect(a.destination);var u=a.createGain();u.gain.value=.6;m.connect(u);u.connect(m);var t=0;this.setReverbFile=function(a){g(a,function(a){p.buffer=a;d()})};this.loadBuffers=function(a){a=a.getAllSourcePaths();for(var b=0,c=a.length;b<c;b++)k[a[b]]||
g(a[b])};this.getBuffer=function(a){return k[a.getSourcePath()]};this.getParameter=function(a){if(a==LISTENER_ORIENTATION)return this.listenerOrientation};this.updateNavigatorPosition=function(a,b,c){for(var d=0,e=h.length;d<e;d++)h[d].hasDymo(a)&&h[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=h.length;c<d;c++)if(h[c].hasDymo(a))return h[c].getNavigator().getPosition(b,a)};this.syncNavigators=function(a,b,c){for(var d,e,l=0,B=h.length;l<B;l++)h[l].hasDymo(a)&&
(d=h[l].getNavigator()),h[l].hasDymo(b)&&(e=h[l].getNavigator());e&&(b=e.getPosition(c,b),d.setPosition(b+1,c,a))};this.play=function(b){b=new SchedulerThread(b,void 0,a,k,p,m,f,e);h.push(b)};this.pause=function(a){if(a)for(var b=0;b<h.length;b++)h[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<h.length;b++)h[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<h.length;c++){var d=h[c].getSource(a);d&&b.push(d)}return b};this.getUrisOfPlayingDymos=function(){return n};this.observedParameterChanged=
function(b){b=this.listenerOrientation.getValue()/180*Math.PI;a.listener.setOrientation(Math.sin(b),0,-Math.cos(b),0,1,0)}};function Source(a,b,c,d,e,f){function g(a,c){var d=b.createGain();d.connect(c);d.gain.value=0;a.connect(d);return d}function k(){var d=a.getParameter(TIME_STRETCH_RATIO).getValue();if(1!=d){if(0!=A||x<c.duration)c=u(c,m(A,c),m(x+.3,c));c=(new AudioProcessor(b)).timeStretch(c,d);d=x/d;c=u(c,0,m(d+.02,c));x=d}else if(0!=A||x<c.duration)c=u(c,m(A,c),m(x+.02,c));t(c,c.length);z.buffer=c;l[PLAYBACK_RATE]=z.playbackRate;h(PLAYBACK_RATE,a.getParameter(PLAYBACK_RATE))}function h(a,b){n(a,b.getValue());b.addObserver(v)}
function n(a,b,c){c&&(b+=v.getParameterValue(a));0>b&&0<=G.indexOf(a)&&(b=0);c=b;l[a]&&(l[a].value||0==l[a].value?l[a].value=c:l[a].setValue(c));0<=H.indexOf(a)?(0==l[DISTANCE].value&&(l[DISTANCE].value=-.01),D.setPosition(l[PAN].value,l[HEIGHT].value,l[DISTANCE].value)):a==LOOP&&(z.loop=1==b)}function p(){r=!1;var a=b.currentTime;l[AMPLITUDE].setValueAtTime(l[AMPLITUDE].value,a);l[AMPLITUDE].linearRampToValueAtTime(0,a+.02);z.stop(a+.04)}function m(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}
function u(a,c,d){d=Math.min(a.length-c,d);for(var e=b.createBuffer(a.numberOfChannels,d,a.sampleRate),l=0;l<a.numberOfChannels;l++)for(var B=e.getChannelData(l),f=a.getChannelData(l),r=0;r<d;r++)B[r]=f[c+r];return e}function t(a,b){for(var c=.02*a.sampleRate,d=0;d<a.numberOfChannels;d++)for(var e=a.getChannelData(d),l=0;l<c;l++)e[l]*=l/c,e[b-l-1]*=l/c}function q(a,b,c,d){var e=a.lastIndexOf("/");e&&(a=a.substring(e+1));y("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+
c,function(a){d(a)})}function y(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}var v=this,r,w,l={},B=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER,PAN,HEIGHT,DISTANCE,LOOP],G=[AMPLITUDE,PLAYBACK_RATE,TIME_STRETCH_RATIO,REVERB,DELAY,FILTER],H=[PAN,HEIGHT,DISTANCE],z=b.createBufferSource(),C=b.createGain();C.connect(b.destination);
var E=g(C,d);d=g(C,e);var D=b.createPanner();D.connect(C);e=b.createBiquadFilter();e.type="lowpass";e.frequency.value=2E4;e.connect(D);z.connect(e);var F=a.getSegment(),A=F[0],x=F[1];A||(A=0);!x&&c&&(x=c.duration-A);c?k():q(a.getSourcePath(),A,A+x+.3,function(d){c=d;d=a.getParameter(TIME_STRETCH_RATIO).getValue();1!=d?(c=(new AudioProcessor(b)).timeStretch(c,d),d=x/d,c=u(c,0,m(d+.02,c)),x=d):c=u(c,0,m(x+.02,c));t(c,c.length);z.buffer=c});l[AMPLITUDE]=C.gain;l[TIME_STRETCH_RATIO]={value:0};l[REVERB]=
E.gain;l[DELAY]=d.gain;l[FILTER]=e.frequency;l[PAN]={value:0};l[HEIGHT]={value:0};l[DISTANCE]={value:0};l[LOOP]={value:0};h(AMPLITUDE,a.getParameter(AMPLITUDE));h(TIME_STRETCH_RATIO,a.getParameter(TIME_STRETCH_RATIO));h(REVERB,a.getParameter(REVERB));h(DELAY,a.getParameter(DELAY));h(FILTER,a.getParameter(FILTER));h(PAN,a.getParameter(PAN));h(HEIGHT,a.getParameter(HEIGHT));h(DISTANCE,a.getParameter(DISTANCE));h(LOOP,a.getParameter(LOOP));this.observedParameterChanged=function(a){n(a.getName(),a.getChange(),
!0)};this.getDymo=function(){return a};this.getDuration=function(){return x};this.isLoopingAndPlaying=function(){return z.loop&&r};this.getParameterValue=function(a){if(l[a])return l[a].value||0==l[a].value?l[a].value:l[a].getValue()};this.play=function(b){z.onended=function(){for(var b=0;b<B.length;b++){var c=a.getParameter(B[b]);c&&c.removeObserver(v)}z.disconnect();C.disconnect();E.disconnect();f&&f(v)};b||(b=0);z.start(b);r=!0};this.pause=function(){r?(p(),w=!0):w&&(w=!1,this.play())};this.stop=
function(){r&&p()}};function SchedulerThread(a,b,c,d,e,f,g,k){function h(){v=w?w:t();p(v);l||(l=v[0].getDymo().getParameter(ONSET).getValue());var a;a=r?r-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=0;d<v.length;d++)v[d].play(b);setTimeout(function(){g()},a);(w=t())?(r=u(b),a=1E3*(r-c.currentTime-SCHEDULE_AHEAD_TIME),y=setTimeout(function(){h()},a)):(r=u(b),a=1E3*(r-c.currentTime),setTimeout(function(){n()},a+100))}function n(){0==q.size&&(window.clearTimeout(y),b.reset(),k&&k())}function p(a){for(var b=
0;b<a.length;b++)q.set(a[b].getDymo(),a[b])}function m(a){q.delete(a.getDymo());g();n()}function u(a){if(w){var b=w[0].getDymo().getParameter(ONSET).getValue(),c=b-l;l=b;if(!isNaN(b))return a+c}b=v[0];c=b.getDymo().getParameter(PLAYBACK_RATE).getValue();b=b.getDuration()/c;return a+b}function t(){var a=b.getNextParts();if(a){console.log(a.map(function(a){return a.getIndex()}));for(var l=[],r=0;r<a.length;r++)if(a[r].getSourcePath()){var h=d[a[r].getSourcePath()];l.push(new Source(a[r],c,h,e,f,m))}return l}}
var q=new Map,y,v=[],r,w,l;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));h();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};this.pause=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);d&&d.pause()}};this.stop=function(a){a=a.getAllDymosInHierarchy();for(var b=0,c=a.length;b<c;b++){var d=q.get(a[b]);d&&d.stop()}};this.getSources=function(){return q};this.getSource=function(a){return q.get(a)}}
...
p.getLevel()+1:0};this.getIndex=function(){if(p)return p.getParts().indexOf(this)};this.addPart=function(a){m.push(a);a.setParent(this)};this.removePart=function(a){m.splice(m.indexOf(a));a.removeParent(this)};this.replacePart=function(a,b){m[a]&&m[a].removeParent(this);m[a]=b;b.setParent(this)};this.getPart=function(a){return m[a]};this.getParts=function(){return m};this.hasParts=function(){return 0<m.length};this.getNthPart=function(a,b){return e(a,0,b,this)};this.setBasePath=function(a){r=a};this.getBasePath=
function(){return p&&!r?p.getBasePath():r};this.setSourcePath=function(a){w=a};this.getSourcePath=function(){if(p&&!w)return p.getSourcePath();if(w)return this.getBasePath()+w};this.getAllSourcePaths=function(){var a=[];f(this,a,function(b,c){var d=b.getSourcePath();d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];f(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){u.push(a)};this.getSimilars=function(a){return u};this.getFeatures=function(){return t};
this.setFeature=function(a,b){t[a]=b};this.getFeature=function(a){if(a===LEVEL)return this.getLevel();if(a===INDEX)return this.getIndex();if(t.hasOwnProperty(a))return t[a];if(p)return p.getFeature(a);for(var b=[],c=0;c<m.length;c++)if(m[c]){var d=m[c].getFeatureWithoutLookingFurther(a);isNaN(d)||b.push(d)}if(0<b.length)return b};this.getFeatureWithoutLookingFurther=function(a){if(t[a])return t[a]};this.getMappings=function(){return y};this.getSegment=function(){return[this.getFeature("time"),q[DURATION_RATIO].getValue()*
this.getFeature("duration")]};this.addParameter=function(a){q[a.getName()]=a};this.getParameter=function(a){return q[a]};this.addMapping=function(a){y.push(a)};this.observedParameterChanged=function(a){a.getName()==PLAY&&c&&(0<a.getChange()?c.play(n):c.stop(n))};this.updatePartOrder=function(a){m&&m[0]&&!isNaN(m[0].getFeature(a))?m.sort(function(b,c){return b.getFeature(a)-c.getFeature(a)}):m&&m.sort(function(b,c){return b.getParameter(a).getValue()-c.getParameter(a).getValue()})};this.toJsonHierarchy=
function(){for(var a=this.toFlatJson(),b=0;b<m.length;b++)a.parts.push(m[b].toJsonHierarchy());return a};this.toJsonHierarchyGraph=function(){var a={nodes:[],links:[]};g(a,this);return a};this.toJsonSimilarityGraph=function(){var a={nodes:[],links:[]};k(a,this);return a};this.toFlatJson=function(){var c={"@id":a,"@type":DYMO};b&&(c.ct=b);w&&(c.source=w);for(var d in t)c[d]=this.getFeatureJson(d);if(0<y.length)for(c.mappings=[],d=0;d<y.length;d++)c.mappings.push(y[d].toJson());0<m.length&&(c.parts=
[]);if(0<u.length)for(c.similars=[],d=0;d<u.length;d++)c.similars.push(u[d].getUri());return c};this.getFeatureJson=function(a){return{value:t[a],type:FEATURE,adt:a.charAt(0).toUpperCase()+a.slice(1)}}};function Mapping(a,b,c,d,e,f){this.relative=b;this.functionJson=c;this.parameterName=e;this.setTargets(d);this.domainDims=a;this.dymoConstraint=f;this.init()}
