...
HAS_SOURCE="http://tiny.cc/dymo-ontology#hasSource",HAS_PARAMETER="http://tiny.cc/dymo-ontology#hasParameter",HAS_FEATURE="http://tiny.cc/dymo-ontology#hasFeature",HAS_PARAMETER_TYPE="http://tiny.cc/dymo-ontology#hasParameterType",HAS_FEATURE_TYPE="http://tiny.cc/dymo-ontology#hasFeatureType",HAS_SIMILAR="http://tiny.cc/dymo-ontology#hasSimilar",HAS_SUCCESSOR="http://tiny.cc/dymo-ontology#hasSuccessor",RENDERING="http://tiny.cc/mobile-audio-ontology#Rendering",MAPPING="http://tiny.cc/mobile-audio-ontology#Mapping",
FUNCTION="http://tiny.cc/mobile-audio-ontology#Function",MOBILE_CONTROL="http://tiny.cc/mobile-audio-ontology#MobileControl",SENSOR_CONTROL="http://tiny.cc/mobile-audio-ontology#SensorControl",UI_CONTROL="http://tiny.cc/mobile-audio-ontology#UiControl",AUTO_CONTROL="http://tiny.cc/mobile-audio-ontology#AutoControl",ACCELEROMETER_X="http://tiny.cc/mobile-audio-ontology#AccelerometerX",ACCELEROMETER_Y="http://tiny.cc/mobile-audio-ontology#AccelerometerY",ACCELEROMETER_Z="http://tiny.cc/mobile-audio-ontology#AccelerometerZ",
...
"http://tiny.cc/mobile-audio-ontology#hasMinor":"minor","http://tiny.cc/mobile-audio-ontology#hasDuration":"rampDuration","http://tiny.cc/mobile-audio-ontology#hasNavigator":"navigators","http://tiny.cc/mobile-audio-ontology#navDymos":"dymos"};function DymoNode(a,b,c,d){this.POSITION_PARAMS=[PAN,HEIGHT,DISTANCE];this.dymo=a;this.parameters={};this.init(b,c,d)}
...
k.removeAndDisconnect();g&&g(k)};a||(a=0);v.start(a);u=!0};this.pause=function(){u?(l(),q=!0):q&&(q=!1,this.play())};this.stop=function(){u&&l()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,g,f,h){function l(){x=v?v:k();m(x);if(!z){var a=x.keys().next().value;a.hasParameter(ONSET)&&(z=a.getParameter(ONSET).getValue())}a=w?w-c.currentTime:SCHEDULE_AHEAD_TIME;for(var b=c.currentTime+a,d=$jscomp.makeIterator(x.values()),e=d.next();!e.done;e=d.next())e.value.play(b);setTimeout(function(){f()},a);(v=k())&&0<v.size?(w=r(b),a=w[1],w=w[0],a.getDymo().hasParameter(LOOP)&&a.getDymo().getParameter(LOOP).getValue()&&(w-=FADE_LENGTH),a=1E3*(w-c.currentTime-SCHEDULE_AHEAD_TIME),
...
d[a[w].getSourcePath()],h=new DymoSource(a[w],c,h,e,g,n);u(h);f.set(a[w],h)}return f}}function u(a){var b=a;for(a=a.getDymo().getParent();a;){if(t.has(a)){b.connect(t.get(a).getInput());return}var d=new DymoNode(a,c,e,g);b.connect(d.getInput());t.set(a,d);a=a.getParent();b=d}b.connect(c.destination)}var q=new Map,t=new Map,v,y,x=[],w,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));l();this.hasDymo=function(b){if(a.getAllDymosInHierarchy().indexOf(b))return!0};this.getNavigator=function(){return b};
...
HAS_DOMAIN_DIMENSION),g=0;g<h.length;g++){var l=k.findFirstObjectUri(h[g],TYPE),m=k.findFirstObjectValue(h[g],NAME);m||(m=h[g]);l==FEATURE_TYPE||k.isSubclassOf(l,FEATURE_TYPE)?e.push(m):l==PARAMETER_TYPE||k.isSubclassOf(l,PARAMETER_TYPE)?(l=b?n(b,m):new Parameter(m,0),e.push(l)):e.push(q[h[g]])}h=$jscomp.makeIterator(k.findArgsAndBody(k.findFirstObjectUri(a,HAS_FUNCTION)));b=h.next().value;h=h.next().value;a=k.findFirstObjectUri(a,HAS_RANGE);for(g=0;g<c.length;g++)c[g]instanceof DynamicMusicObject&&
!c[g].getParameter(a)&&n(c[g],a);return new Mapping(e,f,{args:b,body:h},c,a,d)}function n(a,b,c){var d=a.getParameter(b);d?d.update(c):(isNaN(c)&&(c=k.findFirstObjectValue(b,HAS_STANDARD_VALUE,null),isNaN(c)&&(c=0)),d=k.findFirstObjectValue(b,IS_INTEGER,null),d=new Parameter(b,c,d),a.addParameter(d));return d}function p(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):a==GRAPH_NAVIGATOR?new GraphNavigator(void 0):a==ONE_SHOT_NAVIGATOR?new OneShotNavigator(void 0):a==REPEATED_NAVIGATOR?
new RepeatedNavigator(void 0):new SequentialNavigator(void 0)}var r=this,k=new DymoStore(b),u="",q={},t={};this.setStore=function(a){k=a};this.getStore=function(){return k};this.loadDymoFromJson=function(a,b){var d=a.lastIndexOf("/")+1;u=a.substring(0,d);c(a,function(){b(r.createDymoFromStore())})};this.parseDymoFromJson=function(a,b){k.loadData(a,!0,function(){b(r.createDymoFromStore())})};this.loadRenderingFromJson=function(a,b){c(a,function(){b(r.createRenderingFromStore())})};this.loadGraphFromJson=
function(a,b){d(a,"",function(a){for(var c=0;c<a.length;c++)if(a[c])for(var d=0;d<a[c].length;d++){var f=t[CONTEXT_URI+"dymo"+c],e=t[CONTEXT_URI+"dymo"+a[c][d]];f&&e&&f.addSimilar(e)}b(void 0)})};this.createDymoFromStore=function(){for(var a=[],b=k.findTopDymos(),c=0;c<b.length;c++)a.push(g(b[c])),f(b[c]);return[a,t]};this.createRenderingFromStore=function(){var a=k.findFirstSubjectUri(TYPE,RENDERING),b=new Rendering(t[k.findFirstObjectUri(a,HAS_DYMO)]),c=k.findAllObjectUris(a,HAS_MAPPING);h(c);for(var d=
0;d<c.length;d++)b.addMapping(l(c[d]));a=k.findAllObjectUris(a,HAS_NAVIGATOR);for(d=0;d<a.length;d++)c=k.findFirstObjectUri(a[d],NAV_DYMOS),c=k.findFunction(c),b.addSubsetNavigator(c,p(k.findFirstObjectUri(a[d],TYPE)));return[b,q]}};function DymoStore(a){function b(a,b,d){g.triplesToRdf(a,function(a){c(a,b,d)})}function c(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,d){jsonld.frame(d,{"@id":b},function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context",function(a,b){jsonld.compact(b,"http://tiny.cc/dymo-context-simple",function(a,b){e(b);b=JSON.stringify(b,null,2);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");b=b.replace("http://tiny.cc/dymo-context-simple","http://tiny.cc/dymo-context");
...
b.getParts()[c],d)}function h(a,b,c){c||(c={});c[b.getUri()]||(c[b.getUri()]=b.toFlatJson());var d=c[b.getUri()];a.nodes.push(d);for(var e=0;e<b.getSimilars().length;e++){var f=b.getSimilars()[e];c[f.getUri()]||(c[f.getUri()]=f.toFlatJson());a.links.push(l(d,c[f.getUri()]))}for(e=0;e<b.getParts().length;e++)h(a,b.getParts()[e],c)}function l(a,b){return{source:a,target:b,value:1}}var m=this,n=null,p=[],r=[],k=[],u={},q={},t=[],v=[],y="",x;this.setType=function(a){b=a};this.getType=function(){return b};
...
d&&0>a.indexOf(d)&&c.push(d)});return a};this.getAllDymosInHierarchy=function(){var a=[];g(this,a,function(a,b){b.push(a)});return a};this.addSimilar=function(a){r.push(a)};this.getSimilars=function(a){return r};this.addSuccessor=function(a){k.push(a)};this.getSuccessors=function(a){return k};this.getFeatures=function(){return u};this.setFeature=function(a,b){u[a]=b};this.getFeature=function(a){if(a===LEVEL_FEATURE)return this.getLevel();if(a===INDEX_FEATURE)return this.getIndex();if(u.hasOwnProperty(a))return u[a];
