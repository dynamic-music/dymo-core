...
a.value]})};c.prototype.keys=function(){return e(this,function(a){return a.key})};c.prototype.values=function(){return e(this,function(a){return a.value})};c.prototype.forEach=function(a,b){for(var c=this.entries(),g;!(g=c.next()).done;)g=g.value,a.call(b,g[1],g[0],this)};c.prototype[Symbol.iterator]=c.prototype.entries;var d=function(a,c){var d;d=c&&typeof c;"object"==d||"function"==d?b.has(c)?d=b.get(c):(d=""+ ++h,b.set(c,d)):d="p_"+c;var g=a.data_[d];if(g&&$jscomp.owns(a.data_,d))for(a=0;a<g.length;a++){var f=
g[a];if(c!==c&&f.key!==f.key||c===f.key)return{id:d,list:g,index:a,entry:f}}return{id:d,list:g,index:-1,entry:void 0}},e=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},k=function(){var a={};return a.previous=a.next=a.head=a},h=0;return c},"es6-impl","es3");
...
function DymoManager(a,b,c,d,e,k,h){function l(a,b,c,e){p=b;g=c[0];q=a.getMappings();for(var h in c[1])a=c[1][h],DYMO_STORE.isSubclassOf(a.getType(),UI_CONTROL)&&(n[h]=new UIControl(a,k)),DYMO_STORE.isSubclassOf(a.getType(),SENSOR_CONTROL)&&(m[h]=a);d||(d="bower_components/dymo-core/audio/impulse_rev.wav");f.init(d,b,e)}DYMO_STORE=new DymoStore(e);var f=new Scheduler(a,h);c&&(OPTIMIZED_MODE=!0);isNaN(b)||(SCHEDULE_AHEAD_TIME=b);var p,g,n={},m={},q={};this.loadDymoAndRenderingFromStore=function(a,
b){DYMO_STORE=a;a=new DymoLoader(DYMO_STORE);l(a,a.createDymoFromStore(),a.createRenderingFromStore(),b)};this.loadDymoAndRendering=function(a,b,c,g){var d=new DymoLoader(DYMO_STORE);d.loadDymoFromJson(a,function(a){d.loadRenderingFromJson(b,function(b){l(d,a,b,g);c&&c()})})};this.loadDymoFromJson=function(a,b){(new DymoLoader(DYMO_STORE)).loadDymoFromJson(a,b)};this.parseDymoFromJson=function(a,b){(new DymoLoader(DYMO_STORE)).parseDymoFromJson(a,b)};this.replacePartOfTopDymo=function(a,b){a=DYMO_STORE.replacePartAt(p[0],
b,a);f.stop(a)};this.updateNavigatorPosition=function(a,b,c){f.updateNavigatorPosition(a,b,c)};this.getNavigatorPosition=function(a,b){return f.getNavigatorPosition(a,b)};this.syncNavigators=function(a,b,c){f.syncNavigators(a,b,c)};this.startPlayingUri=function(a){f.play(a)};this.stopPlayingUri=function(a){f.stop(a)};this.startPlaying=function(){for(var a=0;a<p.length;a++)DYMO_STORE.updatePartOrder(p[a],ONSET),f.play(p[a],g.getNavigator())};this.stopPlaying=function(){for(var a=0;a<p.length;a++)f.stop(p[a])};
this.getStore=function(){return DYMO_STORE};this.getTopDymo=function(){return p[0]};this.getRendering=function(){return g};this.getMappings=function(){return q};this.getUIControls=function(){return n};this.getUIControl=function(a){return n[a]};this.getSensorControls=function(){return m}};function DymoNode(a,b,c,d){this.POSITION_PARAMS=[PAN,HEIGHT,DISTANCE];this.dymoUri=a;this.parameters={};this.init(b,c,d)}
...
DymoNode.prototype.removeAndDisconnect=function(){for(var a in this.parameters)DYMO_STORE.removeParameterObserver(this.dymoUri,a,this);this.dryGain.disconnect();this.reverbGain&&this.reverbGain.disconnect();this.delayGain&&this.delayGain.disconnect()};function AudioProcessor(a){function b(a){return{extract:function(b,c,k){for(var d=[],e=0;e<a.numberOfChannels;e++)d.push(a.getChannelData(e));for(e=0;e<c;e++)for(var f=0;f<d.length;f++)b[e*d.length+f%d.length]=d[f][e+k];return Math.min(c,d[0].length-k)}}}this.timeStretch=function(c,d){var e=new SoundTouch(c.sampleRate);e.tempo=d;var k=b(c),e=new SimpleFilter(k,e);d=a.createBuffer(c.numberOfChannels,1/d*c.length,c.sampleRate);for(var k=[],h=0;h<c.numberOfChannels;h++)k.push(d.getChannelData(h));c=
new Float32Array(2048);for(var l=e.extract(c,1024),f=0;l;){for(h=0;h<l;h++)for(var p=0;p<k.length;p++)k[p][h+f]=c[h*k.length+p%k.length];f+=l;l=e.extract(c,1024)}return d}};function AudioProcessorSource(a,b,c){var d=this,e=new SoundTouch(b.sampleRate);this.stretchRatio={setValue:function(a){e.tempo=a},getValue:function(){return e.tempo}};this.playbackRate={setValue:function(a){e.rate=a},getValue:function(){return e.rate}};var k=new SimpleFilter({extract:function(a,c,g){for(var d=[],f=0;f<b.numberOfChannels;f++)d.push(b.getChannelData(f));for(f=0;f<c;f++)for(var e=0;e<d.length;e++)a[f*d.length+e%d.length]=d[e][f+g];return Math.min(c,d[0].length-g)}},e),h=a.createScriptProcessor(1024,
2,b.numberOfChannels),l=new Float32Array(2048);h.onaudioprocess=function(a){for(var c=[],g=0;g<b.numberOfChannels;g++)c.push(a.outputBuffer.getChannelData(g));a=k.extract(l,1024);0==a&&d.stop();for(g=0;g<a;g++)for(var f=0;f<c.length;f++)c[f][g]=l[g*c.length+f%c.length]};this.start=function(a){setTimeout(function(){h.connect(c)},a)};this.stop=function(){h.disconnect()}};function Scheduler(a,b){function c(a,b){for(var c=[],d=0,g=a.length;d<g;d++)var f=DYMO_STORE.findAllObjectsInHierarchy(a[d]),c=c.concat(f.map(function(a){return DYMO_STORE.getSourcePath(a)}));d=0;for(g=c.length;d<g;d++)c[d]&&!l[c[d]]&&k(c[d],function(a,c){l[c]=a;0<n&&n--;0==n&&b&&b()});0==n&&b&&b()}function d(a){f.splice(f.indexOf(a),1)}function e(a){OPTIMIZED_MODE||(a=Array.from(a.getAllSources().keys()),a=flattenArray(a.map(function(a){return DYMO_STORE.findAllParents(a)})),a=removeDuplicates(a),
a.sort(),p=a,b&&b(p))}function k(b,c){n++;var d=new XMLHttpRequest;d.open("GET",b,!0);d.responseType="arraybuffer";d.onload=function(){a.decodeAudioData(d.response,function(a){c(a,b)})};d.error=function(){};d.send()}var h=this,l={},f=[],p=[],g,n=0;this.init=function(b,d,f){DYMO_STORE.addParameter(null,LISTENER_ORIENTATION,0,h);c(d,f);b&&0<DYMO_STORE.find(null,null,REVERB).length&&(g=a.createConvolver(),g.connect(a.destination),k(b,function(a){g.buffer=a;0<n&&n--;0==n&&f&&f()}));0<DYMO_STORE.find(null,
null,DELAY).length&&(b=a.createDelay(),b.delayTime.value=.5,b.connect(a.destination),d=a.createGain(),d.gain.value=.6,b.connect(d),d.connect(b));DYMO_STORE.addTypeObserver(PLAY,VALUE,h)};this.getBuffer=function(a){return l[DYMO_STORE.getSourcePath(a)]};this.updateNavigatorPosition=function(a,b,c){for(var d=0,g=f.length;d<g;d++)f[d].hasDymo(a)&&f[d].getNavigator().setPosition(c,b,a)};this.getNavigatorPosition=function(a,b){for(var c=0,d=f.length;c<d;c++)if(f[c].hasDymo(a))return f[c].getNavigator().getPosition(b,
a)};this.syncNavigators=function(a,b,c){for(var d,g,n=0,e=f.length;n<e;n++)f[n].hasDymo(a)&&(d=f[n].getNavigator()),f[n].hasDymo(b)&&(g=f[n].getNavigator());g&&(b=g.getPosition(c,b),d.setPosition(b,c,a))};this.play=function(b,c){b=new SchedulerThread(b,c,a,l,g,void 0,e,d);f.push(b)};this.pause=function(a){if(a)for(var b=0;b<f.length;b++)f[b].pause(a)};this.stop=function(a){if(a)for(var b=0;b<f.length;b++)f[b].stop(a)};this.getSources=function(a){for(var b=[],c=0;c<f.length;c++){var d=f[c].getSources(a);
if(d)for(var g=0;g<d.length;g++)b=b.concat(d)}return b};this.getUrisOfPlayingDymos=function(){return p};this.observedValueChanged=function(b,c,d){c==LISTENER_ORIENTATION?(d=d/180*Math.PI,a.listener.setOrientation(Math.sin(d),0,-Math.cos(d),0,1,0)):c==PLAY&&(b=DYMO_STORE.findSubject(HAS_PARAMETER,b),0<d?this.play(b):this.stop(b))}};function DymoSource(a,b,c,d,e,k){function h(b,d){var f=b[0],e=b[1],e=1!=d?e+.3:e+FADE_LENGTH;if(c||isNaN(f+e)){if(0!=f||e<c.duration)c=g(c,p(f,c),p(e,c));return l(c,e,d)}n(DYMO_STORE.getSourcePath(a),f,f+e,function(a){return l(a,e,d)})}function l(a,c,d){1!=d&&(a=(new AudioProcessor(b)).timeStretch(a,d),a=g(a,0,p(c/d+FADE_LENGTH,a)));c=a;d=a.length;for(var f=c.sampleRate*FADE_LENGTH,n=0;n<c.numberOfChannels;n++)for(var e=c.getChannelData(n),m=0;m<f;m++)e[m]*=m/f,e[d-m-1]*=m/f;return a}function f(){u=
!1;var a=b.currentTime;q.parameters[AMPLITUDE].setValueAtTime(q.parameters[AMPLITUDE].value,a);q.parameters[AMPLITUDE].linearRampToValueAtTime(0,a+FADE_LENGTH);r.stop(a+2*FADE_LENGTH)}function p(a,b){if(a||0==a)return Math.round(a*b.sampleRate)}function g(a,c,d){d=Math.min(a.length-c,d);for(var g=b.createBuffer(a.numberOfChannels,d,a.sampleRate),f=0;f<a.numberOfChannels;f++)for(var n=g.getChannelData(f),e=a.getChannelData(f),m=0;m<d;m++)n[m]=e[c+m];return g}function n(a,b,c,d){var g=a.lastIndexOf("/");
g&&(a=a.substring(g+1));m("http://localhost:8060/getAudioChunk?filename="+a+"&fromSecond="+b+"&toSecond="+c,function(a){d(a)})}function m(a,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){b.decodeAudioData(d.response,function(a){c(a)},function(a){console.log("audio from server is faulty")})};d.send()}DymoNode.call(this,a,b,d,e);var q=this,u,v,w,r=b.createBufferSource();r.connect(this.getInput());(function(){var b=[DYMO_STORE.findFeatureValue(a,TIME_FEATURE),
DYMO_STORE.findFeatureValue(a,DURATION_FEATURE)];b[0]||(b[0]=0);!b[1]&&c&&(b[1]=c.duration-b[0]);var d=DYMO_STORE.findParameterValue(a,DURATION_RATIO);d&&0<d&&1>d&&(b[1]*=d);w=b[1];d=DYMO_STORE.findParameterValue(a,TIME_STRETCH_RATIO);r.buffer=h(b,d?d:1)})();this.addParameter(PLAYBACK_RATE,r.playbackRate);this.addParameter(TIME_STRETCH_RATIO,{value:0});this.addParameter(LOOP,{value:0});this.getDuration=function(){return w};this.isLoopingAndPlaying=function(){return r.loop&&u};this.play=function(b){r.onended=
function(){r.disconnect();q.removeAndDisconnect();k&&k(q)};b||(b=0);DYMO_STORE.findParameterValue(a,LOOP)&&(r.loop=!0);r.start(b);u=!0};this.pause=function(){u?(f(),v=!0):v&&(v=!1,this.play())};this.stop=function(){u&&f()}}inheritPrototype(DymoSource,DymoNode);function SchedulerThread(a,b,c,d,e,k,h,l){function f(){var a=y;y=x?x:q();p(y);if(!z){var b=y.keys().next().value;z=DYMO_STORE.findParameterValue(b,ONSET)}b=t?t-c.currentTime:SCHEDULE_AHEAD_TIME;for(var d=c.currentTime+b,g=$jscomp.makeIterator(y.values()),e=g.next();!e.done;e=g.next())e=e.value,e.play(d);a=$jscomp.makeIterator(a.values());for(e=a.next();!e.done;e=a.next())e=e.value,DYMO_STORE.findParameterValue(e.getDymoUri(),LOOP)&&e.stop();setTimeout(function(){h(v)},b);(x=q())&&0<x.size?(t=m(d),
a=t[1],t=t[0],DYMO_STORE.findParameterValue(a.getDymoUri(),LOOP)&&(t-=FADE_LENGTH),a=1E3*(t-c.currentTime-SCHEDULE_AHEAD_TIME),A=setTimeout(function(){f()},a)):(t=m(d),a=1E3*(t-c.currentTime),setTimeout(function(){n()},a+100))}function p(a){for(var b=$jscomp.makeIterator(a.keys()),c=b.next();!c.done;c=b.next())c=c.value,w.get(c)||w.set(c,[]),w.get(c).push(a.get(c))}function g(a){var b=w.get(a.getDymoUri());b.splice(b.indexOf(a),1);0>=b.length&&w.delete(a.getDymoUri());h(v);n()}function n(){if(0==
w.size&&(!x||0==x.size)){window.clearTimeout(A);b.reset();for(var c=DYMO_STORE.findAllObjectsInHierarchy(a),d=0,g=c.length;d<g;d++){var f=r.get(c[d]);f&&f.removeAndDisconnect()}l&&l()}}function m(a){if(x){var b=x.keys().next().value,b=DYMO_STORE.findParameterValue(b,ONSET),c=b-z;z=b;if(!isNaN(b))return a+c}for(var b=0,d,c=$jscomp.makeIterator(y.values()),g=c.next();!g.done;g=c.next()){var g=g.value,f=g.getDuration();f>b&&(b=f,d=g)}return[a+b,d]}function q(){var a=b.getNextParts();if(a){u(a);for(var f=
new Map,n=0;n<a.length;n++){var m=DYMO_STORE.getSourcePath(a[n]);if(m){m=new DymoSource(a[n],c,d[m],e,k,g);a:{for(var p=m,h=DYMO_STORE.findParents(m.getDymoUri())[0];h;){if(r.has(h)){p.connect(r.get(h).getInput());break a}var q=new DymoNode(h,c,e,k);p.connect(q.getInput());r.set(h,q);h=DYMO_STORE.findParents(h)[0];p=q}p.connect(c.destination)}f.set(a[n],m)}}return f}}function u(a){console.log(a.map(function(a){a=DYMO_STORE.findPartIndex(a);return isNaN(a)?"top":a}))}var v=this,w=new Map,r=new Map,
x,A,y=new Map,t,z;b||(b=new DymoNavigator(a,new SequentialNavigator(a)));f();this.hasDymo=function(b){if(DYMO_STORE.findAllObjectsInHierarchy(a).indexOf(b))return!0};this.getNavigator=function(){return b};this.stop=function(a){a=DYMO_STORE.findAllObjectsInHierarchy(a);for(var b=0,c=a.length;b<c;b++){var d=w.get(a[b]);if(d)for(var g=0;g<d.length;g++)d[g].stop();x&&(x.delete(a[b]),0>=x.size&&(x=void 0))}};this.getAllSources=function(){return w};this.getSources=function(a){return w.get(a)}};var AutoControl=function(a,b,c){Control.call(this,a,b,AUTO_CONTROL);c||(c=100);DYMO_STORE.addParameter(a,AUTO_CONTROL_FREQUENCY,c,this);DYMO_STORE.addParameter(a,AUTO_CONTROL_TRIGGER,0,this);this.intervalID=null};$jscomp.inherits(AutoControl,Control);AutoControl.prototype.startUpdate=function(a){var b=this;a||(a=DYMO_STORE.findParameterValue(this.uri,AUTO_CONTROL_FREQUENCY));this.intervalID=setInterval(function(){return b.update()},a)};AutoControl.prototype.update=function(){};
AutoControl.prototype.reset=function(){clearInterval(this.intervalID);this.intervalID=null};AutoControl.prototype.observedValueChanged=function(a,b,c){b==AUTO_CONTROL_FREQUENCY?this.intervalID&&(this.reset(),this.startUpdate(c)):b==AUTO_CONTROL_TRIGGER&&(!this.intervalID&&0<c?this.startUpdate():this.intervalID&&0==c&&this.reset())};var DataControl=function(a,b,c,d){d||(d=1001);AutoControl.call(this,a,DATA_CONTROL,d);this.url=b;this.jsonMap=c};$jscomp.inherits(DataControl,AutoControl);DataControl.prototype.update=function(){var a=this;fetch(this.url).then(function(a){return a.json()}).then(function(b){return a.jsonMap(b)}).then(function(b){console.log("data received:",b);a.updateValue(b)})};function UIControl(a,b){var c=this;this.value=a.getValue();a.setUpdateFunction(function(d){a.getType()==TOGGLE?c.value=1==d?!0:!1:c.value=d;b&&setTimeout(function(){b.$apply()},10)});this.getName=function(){return a.getName()};this.getType=function(){return a.getType()};this.update=function(){a.getType()==BUTTON&&(isNaN(this.value)&&(this.value=0),this.value=1-this.value);1==this.value?a.updateValue(1):0==this.value?a.updateValue(0):a.updateValue(this.value)}};function DymoGenerator(a,b){function c(b,c,g){var f=d();a.addDymo(f,b,null,c,g);b||(m=f);return f}function d(){var a=CONTEXT_URI+"dymo"+x;x++;return a}function e(a){var b=[];if(a&&0<a.length){for(var c=0;c<a.length;c++)a[c].value&&a[c].value.constructor!==Array&&(a[c].value=[a[c].value]);for(var c=a[0].value.length,d=0;d<c;d++)if("string"==typeof a[0].value[d])b[d]=a[0].value[d];else if(w==SUMMARY.FIRST)b[d]=a[0].value[d];else if(w==SUMMARY.MEAN)b[d]=a.reduce(function(a,b){return a+b.value[d]},0)/
a.length;else if(w==SUMMARY.MEDIAN){a.sort(function(a,b){return a.value[d]-b.value[d]});var g=Math.floor(a.length/2);b[d]=a[g].value[d];0==a.length%2&&(b[d]+=a[g-1].value[d])}return 1==b.length?b[0]:b}return 0}function k(){0==x?m=c(void 0,r):u&&(m=c(n,r),u=!1)}function h(b,c,d){d||(d=m);var g=d;for(d=a.findLevel(d);d<c;){var f=a.findParts(g);if(0<f.length){f=f.map(function(b){return[a.findFeatureValue(b,TIME_FEATURE),b]});f.sort(function(a,b){return a[0]-b[0]});for(var e=0;e<f.length;e++)if(f[e][0]<=
b)g=f[e][1];else if(0==e)g=f[e][1];else break;d++}else break}return g}function l(a,b){void 0==a.max?(a.min=b,a.max=b):(a.min=Math.min(b,a.min),a.max=Math.max(b,a.max))}function f(a,b){for(var c=0;c<v.length;c++)if(v[c].name==a||v[c].uri==b)return v[c];return p(a,b)}function p(c,d,g,f){!c&&d&&(c=URI_TO_TERM[d]);c&&!d&&(d=CONTEXT_URI+c);c=void 0!=g&&void 0!=f?{name:c,uri:d,min:g,max:f}:{name:c,uri:d,min:1E3,max:0};2>v.length?v.push(c):v.splice(v.length-2,0,c);a.findObject(d,TYPE)||a.addTriple(d,TYPE,
FEATURE_TYPE);b(c);return c}var g=this,n,m,q,u,v,w=SUMMARY.MEAN,r,x=0;this.resetDymo=function(){m=n=void 0;u=!1;v=[];p("level",LEVEL_FEATURE);p("random",null,0,1)};this.setStore=function(b){a=b};this.getStore=function(){return a};this.addRendering=function(){var b=CONTEXT_URI+"rendering0";b++;q=b;a.addRendering(q,m)};this.addMapping=function(b,c,d,g){a.addMapping(b,c,d,g)};this.addNavigator=function(b,c,d){a.addNavigator(q,b,c,d)};this.getCurrentTopDymo=function(){return m};this.getFeatures=function(){return v};
this.setSummarizingMode=function(a){w=a};this.setCurrentSourcePath=function(a){r=a};this.setAudioFileChanged=function(){u=!0;if(m){var b=d();a.addDymo(b,null,m);m=b}};this.addDymo=function(a,b,d){return c(a,b,d)};this.addFeature=function(b,c,d){d||(d=m);Benchmarker.startTask("addFeature");k();b=f(b);d=a.findAllObjectsInHierarchy(d);for(var g=0;g<d.length;g++){var n=a.findFeatureValue(d[g],TIME_FEATURE),p=a.findFeatureValue(d[g],DURATION_FEATURE),h=c;isNaN(n)||(h=h.filter(function(a){return n<=a.time&&
(isNaN(p)||a.time<n+p)}));if(1>h.length)var q=c.filter(function(a){return a.time.value<=n}),h=0<q.length?[q[h.length-1]]:[c[0]];Benchmarker.startTask("summarize");h=e(h);this.setDymoFeature(d[g],b.uri,h)}};this.addSegmentation=function(b,d){k();for(var f=a.findMaxLevel(),e=0;e<b.length;e++){var n=h(b[e].time,f,d),m=b[e].time,p;if(b[e].duration)p=b[e].duration;else if(b[e+1])p=b[e+1].time-m;else{var q=a.findFeatureValue(n,TIME_FEATURE),x=a.findFeatureValue(n,DURATION_FEATURE);q&&x&&(p=q+x-m)}if(0<
p){q=c(n);this.setDymoFeature(q,TIME_FEATURE,m);this.setDymoFeature(q,DURATION_FEATURE,p);var l=q,m=a.findFeatureValue(n,TIME_FEATURE),q=a.findFeatureValue(l,TIME_FEATURE);if(isNaN(m)||Array.isArray(m)||q<m)g.setDymoFeature(n,TIME_FEATURE,q),m=q;x=a.findFeatureValue(n,DURATION_FEATURE);l=a.findFeatureValue(l,DURATION_FEATURE);(isNaN(x)||Array.isArray(x)||m+x<q+l)&&g.setDymoFeature(n,DURATION_FEATURE,q+l-m)}}};this.setDymoFeature=function(b,c,d){a.setFeature(b,c,d);if(!isNaN(d))l(f(null,c),d);else if(d instanceof
Array)for(b=0;b<d.length;b++)l(f(null,c),d[b])};this.resetDymo()};function DymoTemplates(){}DymoTemplates.createSingleSourceDymoFromFeatures=function(a,b,c,d,e){b=a.addDymo(void 0,b);DymoTemplates.loadMultipleFeatures(a,b,c,d,e)};DymoTemplates.createConjunctionDymo=function(a,b,c,d,e){var k=a.addDymo(b,null,CONJUNCTION);b=c.map(function(b,c){return new Promise(function(f){var e=a.addDymo(k,b);DymoTemplates.loadMultipleFeatures(a,e,d[c],null,f)})});Promise.all(b).then(function(a){return e(k)})};
...
Number.parseInt(k[4].substring(1),10),l=Number.parseInt(k[6].substring(2),10)/1E3,f=Number.parseInt(k[7].substring(2),10)/1E3,p=Number.parseInt(k[8].substring(2),10),g=Number.parseInt(k[9].substring(2),10)/1E3,k=Number.parseInt(k[10].substring(2),10)/1E3,n=a.addDymo(c,"audio/Chopin_Op028-11_003_20100611-SMD-cut/"+b[d]);a.setDymoFeature(n,PITCH_FEATURE,h);a.setDymoFeature(n,ONSET_FEATURE,l);a.setDymoFeature(n,DURATION_FEATURE,f);a.setDymoFeature(n,"velocity",p);a.setDymoFeature(n,"onsetS",g);a.setDymoFeature(n,
"durationS",k);n.getParameter(ONSET).update(l)}DYMO_STORE.updatePartOrder(c,ONSET_FEATURE)})};
DymoTemplates.createAchBachDymo=function(a,b){var c=a.getFeature(ONSET_FEATURE),d=a.getFeature(PITCH_FEATURE),e=a.getFeature(DURATION_FEATURE),k=a.getFeature("onsetS"),h=a.getFeature("durationS"),l=a.getFeature("time"),f=a.addDymo();a.setDymoFeature(f,c,0);a.setDymoFeature(f,d,0);a.setDymoFeature(f,e,0);$http.get("audio/achachbach10/01-AchGottundHerr.txt").success(function(b){b=b.split("\n");for(var g=0;g<b.length;g++)b[g]=b[g].split("\t");b.sort(function(a,b){return a[0]-b[0]});for(var n=[],g=0;g<
b.length;g++){var m=b[g][0],p=b[g][1],u=Number.parseInt(b[g][3],10);if(n[u]){var v=n[u][0],w=p-n[u][2];b[v][4]=m-n[u][1];b[v][5]=w}n[u]=[g,m,p]}for(g=b.length-4;g<b.length;g++)b[g][4]=2700,b[g][5]=2700;for(g=0;g<b.length;g++)if(6==b[g].length){var n=b[g],m=Number.parseInt(n[2],10),p=Number.parseInt(n[0],10)/1E3,u=Number.parseInt(n[1],10)/1E3,v=Number.parseInt(n[4],10)/1E3,w=Number.parseInt(n[5],10)/1E3,r;1==n[3]?r=a.addDymo(f,"audio/achachbach10/01-AchGottundHerr-violin.wav"):2==n[3]?r=a.addDymo(f,
"audio/achachbach10/01-AchGottundHerr-clarinet.wav"):3==n[3]?r=a.addDymo(f,"audio/achachbach10/01-AchGottundHerr-saxphone.wav"):4==n[3]&&(r=a.addDymo(f,"audio/achachbach10/01-AchGottundHerr-bassoon.wav"));a.setDymoFeature(r,d,m);a.setDymoFeature(r,l,p);a.setDymoFeature(r,c,p);a.setDymoFeature(r,e,v);a.setDymoFeature(r,k,u);a.setDymoFeature(r,h,w);r.getParameter(ONSET).update(p)}DYMO_STORE.updatePartOrder(f,c.name)});$http.get("getsourcefilesindir/",{params:{directory:"audio/achachbach10/"}}).success(function(a){a=
a.filter(function(a){return 0<=a.indexOf("wav")});for(var b=0;b<a.length;b++);})};function createRandomTriangle(){return[{0:Math.random(),1:Math.random()},{0:Math.random(),1:Math.random()},{0:Math.random(),1:Math.random()}]};function FeatureLoader(a,b){function c(c,g,f){w(c,function(n){d(n,function(d){e(d,function(e){0<e.length?(p(c,g,e),f&&f()):k(d,function(d){var g=d.name;g||(g=c.split("_"),g=g[g.length-1].split(".")[0]);a.addFeature(g,d.values,b);f&&f()})})})})}function d(a,b){var c=N3.Store();N3.Parser().parse(a,function(a,d,g){d?c.addTriple(d):b(c)})}function e(a,b){for(var c=[],d=a.find(null,"http://purl.org/NET/c4dm/event.owl#time",null),g=0,e=d.length;g<e;g++){var n=h(a,d[g].object,"http://purl.org/NET/c4dm/timeline.owl#at");
n||(n=h(a,d[g].object,"http://purl.org/NET/c4dm/timeline.owl#beginsAt"));var m=h(a,d[g].object,"http://purl.org/NET/c4dm/timeline.owl#duration"),n={time:f(n),label:l(h(a,d[g].subject,"http://www.w3.org/2000/01/rdf-schema#label"))};m&&(n.duration=f(m));c.push(n)}b(c)}function k(a,b){var c=l(h(a,null,"http://purl.org/dc/elements/1.1/title")),d=l(h(a,null,"http://purl.org/ontology/af/value")),d=d.split(" ").map(function(a){return parseFloat(a)}),g=l(h(a,null,"http://purl.org/ontology/af/dimensions")),
g=g.split(" ").map(function(a){return Number.parseInt(a,10)}),e=h(a,null,"http://purl.org/ontology/vamp/computed_by"),n=f(h(a,e,"http://purl.org/ontology/vamp/step_size"));a=f(h(a,e,"http://purl.org/ontology/vamp/sample_rate"));for(var e=[],m=0;m<d.length;){for(var p=[],k=0;k<g[0];k++)p[k]=d[m+k];e.push({time:{value:m*n/a},value:p});m+=g[0]}b({name:c,values:e})}function h(a,b,c){a=a.find(b,c,null);if(0<a.length)return a[0].object}function l(a){if(a)return N3.Util.getLiteralValue(a)}function f(a){a=
N3.Util.getLiteralValue(a);"P"==a.charAt(0)&&(a=a.substring(2,a.length-1));return Number(a)}function p(c,d,g){r[c]=g.sort(function(a,b){return a.time.value-b.time.value});g=r[c];d&&r[c][0].label&&(g=g.filter(function(a){return a.label.value==d}));a.addSegmentation(g,b)}function g(a,b,c){w(a,function(a){n(JSON.parse(a),b,c)})}function n(a,b,c){"file_metadata"==Object.keys(a)[0]?m(a,b,c):q(a,b,c)}function m(c,d,g){c=c[Object.keys(c)[1]][0];var f=c.annotation_metadata.annotator.output_id;"beats"==f||
"onsets"==f||"segmentation"==f?(c=c.data,d&&c[0].value&&(c=c.filter(function(a){return a.value==d})),a.addSegmentation(c,b)):a.addFeature(f,c.data,b);g&&g()}function q(c,d,g){var f=c["@type"];"afv:BarandBeatTracker"==f||"afv:Onsets"==f?(c=c["afo:values"],d&&c[0]["afo:value"]&&(c=c.filter(function(a){return a["afo:value"]==d})),c=u(c),a.addSegmentation(c,b)):(c=v(c["afo:values"]),a.addFeature(f,c,b));g&&g()}function u(a){for(var b=[],c=0;c<a.length;c++)b.push({time:{value:a[c]["tl:at"]},label:{value:a[c]["afo:value"]}});
return b}function v(a){for(var b=[],c=0;c<a.length;c++)b.push({time:{value:a[c]["tl:at"]},value:[a[c]["afo:value"]]});return b}function w(a,b){var c=new XMLHttpRequest;c.addEventListener("load",function(){b(this.responseText)});c.addEventListener("error",function(){b(this.responseText)});c.open("GET",a);c.send()}var r={};this.loadFeature=function(a,b,d){if(a.constructor==Object)n(a,b,d);else{var f=a.split("."),f=f[f.length-1];"n3"==f?c(a,b,d):"json"==f&&g(a,b,d)}}};var SUMMARY={MEAN:"mean",MEDIAN:"median",FIRST:"first"};function Similarity(){}Similarity.addSimilaritiesTo=function(a,b,c){for(a=[a];0<a.length;){if(1<a.length){var d=Similarity.toVectors(a,b),d=Similarity.getCosineSimilarities(d);Similarity.addSimilaritiesAbove(b,d,c)}a=Similarity.getAllParts(a,b)}};
...
Similarity.toVectors=function(a,b,c){for(var d=[],e=0,k=a.length;e<k;e++){for(var h=[],l=b.findAllFeatureValues(a[e]).filter(function(a){return"string"!=typeof a}),f=0,p=l.length;f<p;f++){var g=l[f];c&&1<g.length&&(g=Similarity.reduce(g));1<g.length?h=h.concat(g):(g=Number(g),h.push(g))}d[e]=h}for(var n=[],m=[],e=0;e<d[0].length;e++){b=[];for(f=0;f<a.length;f++)isNaN(d[f][e])||b.push(d[f][e]);n[e]=math.mean(b);m[e]=math.var(b)}d=d.map(function(a){return a.map(function(a,b){return(a-n[b])/m[b]})});
...
HAS_MINOR="http://tiny.cc/mobile-audio-ontology#hasMinor",HAS_DURATION="http://tiny.cc/mobile-audio-ontology#hasDuration",HAS_NAVIGATOR="http://tiny.cc/mobile-audio-ontology#hasNavigator",NAV_DYMOS="http://tiny.cc/mobile-audio-ontology#navDymos";function OntologyLoader2(a,b,c){};function DymoLoader(a){function b(b,d){c(b,"",function(b){a.loadData(b,!0,d)})}function c(a,b,g){loadFile(a,function(f){if(0>f.indexOf("Cannot GET")){var e;a:{try{JSON.parse(f)}catch(r){e=!1;break a}e=!0}e&&(b?(0<=a.indexOf(p)&&(a=a.replace(p,"")),b=b.replace('"'+a+'"',f)):b=f);(f=d(b))?(0>f.indexOf(p)&&(f=p+f),c(f,b,g)):b&&g(JSON.parse(b))}})}function d(a){var b=a.indexOf(".json");if(0<=b){if(b!=a.indexOf("context.json")+7){var c=a.substring(0,b).lastIndexOf('"');return a.substring(c+1,b+5)}return d(a.substring(b+
1))}}function e(b){b=b?a.findAllObjects(b,HAS_MAPPING):a.findAllSubjects(TYPE,MAPPING);for(var c=a.recursiveFindAllSubClasses(MOBILE_CONTROL),d=0;d<c.length;d++)for(var f=a.findAllSubjects(TYPE,c[d]),e=0;e<f.length;e++){var m=a.findObjectValue(f[e],NAME);m||(m=f[e]);if(!g[f[e]]){var p=f[e],h=f[e],l=m,t=c[d],m=void 0;t==ACCELEROMETER_X||t==ACCELEROMETER_Y||t==ACCELEROMETER_Z?m=new AccelerometerControl(t):t==TILT_X||t==TILT_Y?m=new TiltControl(t):t==GEOLOCATION_LATITUDE||t==GEOLOCATION_LONGITUDE?m=
...
(m=Math.round(1E3*a.findObject(h,HAS_DURATION)),l=a.findObjectValue(h,HAS_INITIAL_VALUE),m=new RampControl(h,m,l)):t==DATA_CONTROL&&(m=a.findObjectValue(h,HAS_URL),l=a.findObjectValue(h,HAS_JSON_MAP),l=new Function("json",l),m=new DataControl(h,m,l));a.findObjectValue(h,IS_SMOOTH)&&m.setSmooth&&m.setSmooth(!0);h=a.findObjectValue(h,IS_AVERAGE_OF);!isNaN(h)&&m.setAverageOf&&m.setAverageOf(h);g[p]=m}}for(c=0;c<b.length;c++)n[b[c]]||(e=DYMO_STORE.findSubject(HAS_MAPPING,b[c]),DYMO_STORE.findObject(e,
TYPE)!=DYMO&&(e=null),d=b[c],f=b[c],p=e,e=a.findObjectValue(f,IS_UNIDIRECTIONAL),h=a.findObject(f,HAS_FUNCTION),p=k(h,e,p),h=a.findAllObjects(f,TO_TARGET),h=0<h.length?(m=k(h[0],!0))?m:h:void 0,f=a.findObject(f,HAS_RANGE),f=new Mapping(p,h,f,e),n[d]=f)}function k(b,c,d){var g=$jscomp.makeIterator(a.findFunction(b));b=g.next().value;var f=g.next().value,g=g.next().value;if(b&&f&&g)return d=$jscomp.makeIterator(h(f,d)),f=d.next().value,d=d.next().value,new DymoFunction(b,f,d,g,c)}function h(b,c){for(var d=
[],f=[],e=0;e<b.length;e++){var n=a.findObject(b[e],TYPE);n==FEATURE_TYPE||a.isSubtypeOf(n,FEATURE_TYPE)?(n==FEATURE_TYPE&&(n=b[e]),d.push(n),f.push(FEATURE_TYPE)):n==PARAMETER_TYPE||a.isSubclassOf(n,PARAMETER_TYPE)||a.isSubclassOf(a.findObject(n,TYPE),PARAMETER_TYPE)?(n==CUSTOM_PARAMETER&&(n=b[e]),n=c?a.setParameter(c,n):b[e],d.push(n),f.push(PARAMETER_TYPE)):(d.push(g[b[e]]),f.push(MOBILE_CONTROL))}return[d,f]}function l(a){return a==SIMILARITY_NAVIGATOR?new SimilarityNavigator(void 0):a==GRAPH_NAVIGATOR?
new GraphNavigator(void 0):a==ONE_SHOT_NAVIGATOR?new OneShotNavigator(void 0):a==REPEATED_NAVIGATOR?new RepeatedNavigator(void 0):new SequentialNavigator(void 0)}var f=this,p="",g={},n={};this.getMappings=function(){return n};this.loadDymoFromJson=function(a,c){var d=a.lastIndexOf("/")+1;p=a.substring(0,d);b(a,function(){c(f.createDymoFromStore())})};this.parseDymoFromJson=function(b,c){a.loadData(b,!0,function(){c(f.createDymoFromStore())})};this.loadRenderingFromJson=function(a,c){b(a,function(){c(f.createRenderingFromStore())})};
this.parseDymoFromTurtle=function(b,c){a.loadData(b,!1,function(){c(f.createDymoFromStore())})};this.createDymoFromStore=function(){for(var b=a.findTopDymos(),c=0;c<b.length;c++)a.addBasePath(b[c],p),e();return b};this.createRenderingFromStore=function(){var b=a.findSubject(TYPE,RENDERING),c=new Rendering(a.findObject(b,HAS_DYMO));e(b);for(var b=a.findAllObjects(b,HAS_NAVIGATOR),d=0;d<b.length;d++){var f=k(a.findObject(b[d],NAV_DYMOS),!0);c.addSubsetNavigator(f,l(a.findObject(b[d],TYPE)))}return[c,
g]}};function DymoStore(a){function b(a,c){for(var d=0;d<a.length;d++){var f=c(a[d]);if(f)return f}for(d=0;d<a.length;d++)if(f=b(h.findParents(a[d]),c))return f}function c(a,b,c){h.triplesToRdf(a,function(a){d(a,b,c)})}function d(a,b,c){a=a.split("_b").join("b");jsonld.fromRDF(a,{format:"application/nquads"},function(a,d){jsonld.frame(d,{"@id":b},function(a,b){jsonld.compact(b,DYMO_CONTEXT,function(a,b){jsonld.compact(b,DYMO_SIMPLE_CONTEXT,function(a,b){k(b);b["@context"]="http://tiny.cc/dymo-context";
b=JSON.stringify(b);b=b.replace(/http:\/\/tiny.cc\/dymo-context\//g,"");c(b)})})})})}function e(a,b){var d=h.findObject(a,TYPE,null),d=h.recursiveFindAllTriples(a,d);c(d,a,function(a){b(null,JSON.parse(a))})}function k(a){if(a&&a instanceof Object)for(var b in a)"@id"==b&&a[b].includes("_:b")?delete a[b]:k(a[b])}var h=this;EasyStore.call(this);var l={};(function(){h.loadFileIntoStore("http://tiny.cc/dymo-ontology",!1,function(){h.loadFileIntoStore("http://tiny.cc/mobile-audio-ontology",!1,function(){a&&
...
b,c,d,e){var g=this.createBlankNode();this.addTriple(g,TYPE,MAPPING);a&&this.addTriple(a,HAS_MAPPING,g);this.addTriple(g,HAS_FUNCTION,b);if(c)for(a=0;a<c.length;a++)this.addTriple(g,TO_TARGET,c[a]);else d&&this.addTriple(g,TO_TARGET,d);this.addTriple(g,HAS_RANGE,e);this.findObject(e,TYPE)||this.addTriple(e,TYPE,CUSTOM_PARAMETER);return g};this.addNavigator=function(a,b,c,d){var g=this.createBlankNode();this.addTriple(a,HAS_NAVIGATOR,g);this.addTriple(g,TYPE,b);a=this.addFunction(c,d);this.addTriple(g,
NAV_DYMOS,a);return g};this.addFunction=function(a,b){for(var c=this.createBlankNode(),d=Object.keys(a),e=0;e<d.length;e++){var f=this.createBlankNode();this.addTriple(c,HAS_ARGUMENT,f);this.addTriple(f,HAS_VARIABLE,N3.Util.createLiteral(d[e]));this.addTriple(f,HAS_VALUE,a[d[e]])}this.addTriple(c,HAS_BODY,N3.Util.createLiteral(b));return c};this.updatePartOrder=function(a,b){var c=this.findParts(a);0<c.length&&(c.sort(function(a,c){return h.findAttributeValue(a,b)-h.findAttributeValue(c,b)}),this.setParts(a,
...
b,a)})};this.toJsonGraph=function(a,b,c){var d={nodes:[],edges:[]},g={},f=this.findAllSubjects(TYPE,a),k=this.find(null,b,null);async.map(f,e,function(e,n){d.nodes=n;for(var m=0;m<f.length;m++)g[f[m]]=d.nodes[m];d.edges=[];for(m=0;m<k.length;m++)0==h.find(k[m].object,TYPE,a).length?0<h.find(k[m].object,FIRST).length&&(e=h.findObjectOrList(k[m].subject,b),e=e.map(function(a){return{source:g[k[m].subject],target:g[a],value:1}}),d.edges=d.edges.concat(e)):d.edges.push({source:g[k[m].subject],target:g[k[m].object],
value:1});c(d)})}}inheritPrototype(DymoStore,EasyStore);function DymoWriter(a){this.writeToJsonld=function(b,c){c||(c="dymo.json");a.toJsonld(function(a){fetch(b+c,{method:"post",body:a})})}};function EasyReasoner(){function a(a,c,d){var b=new XMLHttpRequest;b.open("POST",a);b.setRequestHeader("Content-Type","application/x-www-form-urlencoded");b.onload=function(){d(b.responseText)};b.error=function(a){console.log(a)};b.send(c)}this.queryAll=function(b,c){for(var d="",e=0;e<b.length;e++)d+=encodeURIComponent("data="+b[e])+"&";d+=encodeURIComponent("query={ ?a ?b ?c. } => { ?a ?b ?c. }.");a("http://eye.restdesc.org/",d,function(a){c(a)})}};function EasyStore(){function a(a,b,c){var d=[];f[a]&&f[a][b]&&(d=d.concat(f[a][b]));b=h.findObject(a,TYPE);p[b]&&(d=d.concat(p[b]));for(var g=0;g<d.length;g++)d[g].observedValueChanged&&d[g].observedValueChanged(a,b,c)}function b(a,b){a=l.find(null,a,b);if(0<a.length)return a[0].subject}function c(a){if(a){var b=h.findObject(a,FIRST);if(b){var c=[];c.push(b);for(a=h.findObject(a,REST);a!=NIL;)c.push(h.findObject(a,FIRST)),a=h.findObject(a,REST);return c}return a}}function d(a,b){if(a){for(var c=
0,d=h.findObject(a,REST);d!=NIL&&(null==b||c<b);)a=d,d=h.findObject(a,REST),c++;if(null==b||c==b)return a}}function e(a){var b=N3.Util.getLiteralValue(a);a=N3.Util.getLiteralType(a);"http://www.w3.org/2001/XMLSchema#string"!=a&&"http://www.w3.org/2001/XMLSchema#boolean"!=a&&(b=Number(b));return b}function k(a,b,c){b?jsonld.toRDF(a,{format:"application/nquads"},function(a,b){c(b)}):c(a)}var h=this,l=N3.Store(),f={},p={};this.addValueObserver=function(a,b,c){f[a]||(f[a]={});f[a][b]||(f[a][b]=[]);f[a][b].push(c)};
this.addTypeObserver=function(a,b,c){p[a]||(p[a]=[]);p[a].push(c)};this.removeValueObserver=function(a,b,c){f[a]&&f[a][b]&&(c=f[a][b].indexOf(c),-1<c&&(f[a][b].splice(c,1),f[a]&&0==f[a][b].length&&(delete f[a][b],0===Object.keys(f[a]).length&&delete f[a])))};this.removeTypeObserver=function(a,b,c){p[a]&&(b=p[a].indexOf(c),-1<b&&(p[a].splice(b,1),0==p[a].length&&delete p[a]))};this.getValueObservers=function(a,b){return f[a]?f[a][b]?f[a][b]:flattenArray(Object.values(f[a])):null==a&&null==b?flattenArray(Object.keys(f).map(function(a){return flattenArray(Object.values(f[a]))})):
[]};this.getTypeObservers=function(a){return p[a]?p[a]:null==a?flattenArray(Object.keys(p).map(function(a){return p[a]})):[]};this.addTriple=function(a,b,c){if(null!=a&&null!=b&&null!=c)return l.addTriple(a,b,c)};this.removeTriple=function(a,b,c){c||(c=this.findObject(a,b));return l.removeTriple(a,b,c)};this.createBlankNode=function(){return l.createBlankNode()};this.setTriple=function(a,b,c){this.removeTriple(a,b);this.addTriple(a,b,c)};this.setValue=function(b,c,d){var g=this.findObjectValue(b,
c);b&&c&&null!=d&&d!=g&&!Number.isNaN(d)&&(Array.isArray(d)?(d=d.map(function(a){return N3.Util.createLiteral(a)}),this.removeTriple(b,c),this.addObjectsToList(b,c,d)):this.setTriple(b,c,N3.Util.createLiteral(d)),a(b,c,d))};this.setObjectValue=function(a,b,c,d,e){var g;a&&b?g=this.findObjectOfType(a,b,c):a||(g=this.findSubject(TYPE,c));g||(g=this.createBlankNode(),a&&b&&this.addTriple(a,b,g),this.addTriple(g,TYPE,c));this.setValue(g,d,e);return g};this.addObjectToList=function(a,b,c){var g=this.findObject(a,
b),e=this.createBlankNode();g?(a=d(g),this.removeTriple(a,REST,NIL),this.addTriple(a,REST,e)):this.addTriple(a,b,e);this.addTriple(e,FIRST,c);this.addTriple(e,REST,NIL)};this.addObjectsToList=function(a,b,c){for(var d=0,g=c.length;d<g;d++)this.addObjectToList(a,b,c[d])};this.replaceObjectInList=function(a,b,c,e){a=this.findObject(a,b);e=d(a,e);a=this.findObject(e,FIRST);this.setTriple(e,FIRST,c);return a};this.removeObjectFromList=function(a,b,c){a=this.findObject(a,b);this.createBlankNode();c=d(a,
...
e,k,h,l,f,p,g;l=1/this.overlapLength;for(e=0;e<this.overlapLength;e++)h=(this.overlapLength-e)*l,f=e*l,k=2*e,p=k+a,g=k+d,c[g+0]=b[p+0]*f+this.pMidBuffer[k+0]*h,c[g+1]=b[p+1]*f+this.pMidBuffer[k+1]*h},process:function(){var a,b;if(null==this.pMidBuffer){if(this._inputBuffer.frameCount<this.overlapLength)return;this.pMidBuffer=new Float32Array(2*this.overlapLength);this._inputBuffer.receiveSamples(this.pMidBuffer,this.overlapLength)}for(;this._inputBuffer.frameCount>=this.sampleReq;)a=this.seekBestOverlapPosition(),
...
logic.run=function(a,b,c){assert(logic.is_lvar(b)||logic.is_array(b),"#2 of run must be variable/array");c="undefined"===typeof c?inf:c;a=a(logic.nil);for(var d=[],e=0;e<c&&!a.is_empty();++e){var k=a.first,h=k.frame;if(logic.is_lvar(b)){var l=h.walk(b),l=logic.is_lvar(l)?k.get_value(b):l;d.push(l)}else{for(var f=[],p=0;p<b.length;++p)l=h.walk(b[p]),l=logic.is_lvar(l)?k.get_value(l):l,f.push(l);d.push(f)}a=a.rest()}return d};
