...
DymoTemplates.createMultiSourceDymo = function(generator, parentDymo, dymoType, sources, featureUris, onLoad) {
...
DymoTemplates.createSebastianDymo = function(generator, scheduler, $http) {
	...
	$http.get('getsourcefilesindir/', {params:{directory:dirPath}}).success(function(data) {
		...
		DYMO_STORE.updatePartOrder(topDymo, onsetFeature.name);
...
DymoTemplates.createSebastianDymo2 = function(generator, scheduler) {
...
DymoTemplates.createSebastianDymo3 = function(generator, $http) {
	...
	$http.get('getsourcefilesindir/', {params:{directory:dirPath}}).success(function(data) {
		...
		DYMO_STORE.updatePartOrder(topDymo, ONSET_FEATURE);
	});
}

DymoTemplates.createAchBachDymo = function(generator, scheduler) {
