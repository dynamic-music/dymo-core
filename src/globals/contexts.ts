export const DYMO_CONTEXT = {
	"@context": {
		...
		"isfunction": { "@id": "ex:isFunction", "@type": "xsd:boolean" },
		...
		"tFunction": { "@id": "ex:tFunction", "@type": "xsd:string" },
		"tArgs": { "@id": "ex:tArgs", "@type": "xsd:string" },
